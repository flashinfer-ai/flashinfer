...
struct vec_cast<__hip_bfloat16, __hip_fp8_e4m3_fnuz> {
  template <size_t vec_size>
  FLASHINFER_INLINE static void cast(__hip_bfloat16* dst, const __hip_fp8_e4m3_fnuz* src) {
    if constexpr (vec_size == 1) {
...
struct vec_cast<__hip_bfloat16, __hip_fp8_e5m2_fnuz> {
  template <size_t vec_size>
  FLASHINFER_INLINE static void cast(__hip_bfloat16* dst, const __hip_fp8_e5m2_fnuz* src) {
    if constexpr (vec_size == 1) {
      dst[0] = __hip_bfloat16(src[0]);
    } else if constexpr (vec_size == 2) {
      dst[0] = __hip_bfloat16(src[0]);
...
FLASHINFER_INLINE void vec_t<__hip_fp8_e4m3_fnuz, 1>::load(const __hip_fp8_e4m3_fnuz* ptr) {
  data = *ptr;
}

FLASHINFER_INLINE void vec_t<__hip_fp8_e4m3_fnuz, 1>::store(__hip_fp8_e4m3_fnuz* ptr) const {
  *ptr = data;
}
...
FLASHINFER_INLINE void vec_t<__hip_fp8_e5m2_fnuz, 1>::load(const __hip_fp8_e5m2_fnuz* ptr) {
  data = *ptr;
}

FLASHINFER_INLINE void vec_t<__hip_fp8_e5m2_fnuz, 1>::store(__hip_fp8_e5m2_fnuz* ptr) const {
  *ptr = data;
}
...
FLASHINFER_INLINE void vec_t<__hip_bfloat16, 1>::memcpy(__hip_bfloat16* dst,
...
FLASHINFER_INLINE void vec_t<__hip_bfloat16, 2>::memcpy(__hip_bfloat16* dst,
                                                        const __hip_bfloat16* src) {
...
FLASHINFER_INLINE void vec_t<__hip_bfloat16, 4>::memcpy(__hip_bfloat16* dst,
                                                        const __hip_bfloat16* src) {
  *((uint2*)dst) = *((uint2*)src);
}
