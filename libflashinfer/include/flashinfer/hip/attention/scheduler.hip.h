...
inline hipError_t BatchDecodeWithPagedKVCacheWorkEstimationDispatched(
  ...
  DISPATCH_COMPUTE_CAP_DECODE_NUM_STAGES_SMEM(compute_capacity, NUM_STAGES_SMEM, {
    ...
    FLASHINFER_CUDA_CALL(hipDeviceGetAttribute(&num_sm, hipDeviceAttributeMultiprocessorCount, dev_id));
    FLASHINFER_CUDA_CALL(hipOccupancyMaxActiveBlocksPerMultiprocessor(&num_blocks_per_sm, kernel,
