 ...
 *
 * The code is based on the Chapter 10 of Hacker's Delight book by Henry S.
 * Warren, Jr. The struct is adapted from
 * https://github.com/milakov/int_fastdiv/blob/master/int_fastdiv.h by Maxim
 * Milakov, the difference is that here we use uint32_t instead of int32_t.
 *
