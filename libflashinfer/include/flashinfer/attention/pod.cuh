    ...
    DISPATCH_NUM_MMA_KV(min(max_num_mma_kv_smem_p, max_num_mma_kv_reg_p), NUM_MMA_KV_P, {
      ...
      if constexpr (KTraits_P::IsInvalid()) {
        ...
        err_msg << "FlashInfer Internal Error: Invalid "
                ...
                << " NUM_MMA_D_VO=" << NUM_MMA_D_VO << " NUM_MMA_KV=" << NUM_MMA_KV_P
                << " NUM_WARPS_Q=" << NUM_WARPS_Q_P << " NUM_WARPS_KV=" << NUM_WARPS_KV_P
        ...
        DISPATCH_NUM_MMA_KV(min(max_num_mma_kv_smem_d, max_num_mma_kv_reg_d), NUM_MMA_KV_D, {
          ...
          if constexpr (KTraits_D::IsInvalid()) {
            ...
            err_msg << "FlashInfer Internal Error: Invalid "
                       "configuration : NUM_MMA_Q="
                    << NUM_MMA_Q_D << " NUM_MMA_D_QK=" << NUM_MMA_D_QK
                    << " NUM_MMA_D_VO=" << NUM_MMA_D_VO << " NUM_MMA_KV=" << NUM_MMA_KV_D
                    << " NUM_WARPS_Q=" << NUM_WARPS_Q_D << " NUM_WARPS_KV=" << NUM_WARPS_KV_D
                    << " please create an issue "
