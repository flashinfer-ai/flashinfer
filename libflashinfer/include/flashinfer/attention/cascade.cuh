...
cudaError_t MergeState(DTypeIn *v_a,
                       float *s_a,
                       DTypeIn *v_b,
                       float *s_b,
                       DTypeO *v_merged,
                       ...
                       cudaStream_t stream = nullptr)
{
    DISPATCH_HEAD_DIM(head_dim, HEAD_DIM, {
        ...
        void *args[] = {&v_a,      &s_a,      &v_b,       &s_b,
                        &v_merged, &s_merged, &num_heads, &head_dim};
...
cudaError_t MergeStateInPlace(DType *v,
                              float *s,
                              DType *v_other,
                              float *s_other,
                              uint32_t seq_len,
 ...
 */
template <typename DTypeIn, typename DTypeO>
cudaError_t MergeStates(DTypeIn *v,
                        float *s,
                        DTypeO *v_merged,
                        float *s_merged,
                        uint32_t num_index_sets,
                        ...
                        cudaStream_t stream = nullptr)
{
    DISPATCH_HEAD_DIM(head_dim, HEAD_DIM, {
        ...
        if (num_index_sets >= seq_len) {
            ...
            void *args[] = {
                &v,         &s,       &v_merged, &s_merged, &num_index_sets,
                &num_heads, &head_dim};
            FLASHINFER_CUDA_CALL(cudaLaunchKernel((void *)kernel, nblks, nthrs,
                                                  args, 0, stream));
        }
...
template <typename DTypeIn, typename DTypeO>
cudaError_t AttentionSum(DTypeIn *v,
                         DTypeO *v_sum,
                         uint32_t num_index_sets,
                         uint32_t seq_len,
                         uint32_t num_heads,
...
template <typename DTypeIn, typename DTypeO, typename IdType>
cudaError_t VariableLengthAttentionSum(DTypeIn *v,
                                       IdType *indptr,
                                       DTypeO *v_sum,
                                       uint32_t max_seq_len,
                                       uint32_t *seq_len,
