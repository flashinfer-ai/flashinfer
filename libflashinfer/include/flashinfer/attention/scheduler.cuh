    ...
    cudaStream_t stream)
{
    ...
    // cudaOccupancyMaxActiveBlocksPerMultiprocessor at times, and we fill smem
...
inline cudaError_t DecodePlan(void *float_buffer,
                              ...
                              WorkEstimationFunc work_estimation_func)
{
    ...
    FLASHINFER_CUDA_CALL(cudaMemcpyAsync(int_buffer, page_locked_int_buffer,
                                         num_bytes_to_copy,
...
template <typename IdType>
inline cudaError_t PrefillPlan(void *float_buffer,
                               size_t float_workspace_size_in_bytes,
                               void *int_buffer,
                               void *page_locked_int_buffer,
                               size_t int_workspace_size_in_bytes,
...
template <typename IdType>
inline cudaError_t PrefillSM90Plan(void *float_buffer,
                                   size_t float_workspace_size_in_bytes,
                                   void *int_buffer,
                                   void *page_locked_int_buffer,
                                   size_t int_workspace_size_in_bytes,
                                   ...
                                   cudaStream_t stream)
{
    ...
    int num_sm90_ctas = 0;
    FLASHINFER_CUDA_CALL(cudaDeviceGetAttribute(
        &num_sm90_ctas, cudaDevAttrMultiProcessorCount, device));
...
template <typename IdType>
inline cudaError_t MLAPlan(void *float_buffer,
                           size_t float_workspace_size_in_bytes,
                           void *int_buffer,
                           void *page_locked_int_buffer,
                           size_t int_workspace_size_in_bytes,
