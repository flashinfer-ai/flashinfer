...
inline gpuError_t DecodePlan(void *float_buffer,
                             ...
                             WorkEstimationFunc work_estimation_func)
{
    ...
    FI_GPU_CALL(work_estimation_func(split_kv, max_grid_size,
                                     kv_chunk_size_in_pages, new_batch_size,
                                     gdy, batch_size, indptr_h, num_qo_heads,
    ...
    FI_GPU_CALL(gpuMemcpyAsync(int_buffer, page_locked_int_buffer,
                               num_bytes_to_copy, gpuMemcpyHostToDevice,
                               stream));
    return gpuSuccess;
}
...
template <typename IdType>
inline gpuError_t PrefillPlan(void *float_buffer,
                              size_t float_workspace_size_in_bytes,
                              void *int_buffer,
                              void *page_locked_int_buffer,
                              size_t int_workspace_size_in_bytes,
...
template <typename IdType>
inline gpuError_t PrefillSM90Plan(void *float_buffer,
                                  size_t float_workspace_size_in_bytes,
                                  void *int_buffer,
                                  void *page_locked_int_buffer,
                                  size_t int_workspace_size_in_bytes,
                                  ...
                                  gpuStream_t stream)
{
    ...
    int num_sm90_ctas = 0;
    FI_GPU_CALL(gpuDeviceGetAttribute(&num_sm90_ctas,
...
template <typename IdType>
inline gpuError_t MLAPlan(void *float_buffer,
                          size_t float_workspace_size_in_bytes,
                          void *int_buffer,
                          void *page_locked_int_buffer,
                          size_t int_workspace_size_in_bytes,
