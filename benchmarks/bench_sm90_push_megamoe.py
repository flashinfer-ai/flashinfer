...
def collect_provenance(device: torch.device) -> dict:
    ...
    source_paths = (
        ...
        "flashinfer/moe_ep/kernel_src/sm90/push_style_megamoe/__init__.py",
        "flashinfer/moe_ep/kernel_src/sm90/push_style_megamoe/shim/gemm.py",
        "flashinfer/moe_ep/kernel_src/sm90/push_style_megamoe/shim/jit.py",
        ...
        "flashinfer/moe_ep/kernel_src/sm90/push_style_megamoe/shim/weights.py",
        "flashinfer/moe_ep/kernel_src/sm90/push_style_megamoe/src/a2a/sm90_push_a2a_ops.cu",
        "flashinfer/moe_ep/kernel_src/sm90/push_style_megamoe/src/a2a/sm90_push_a2a.cuh",
        "flashinfer/moe_ep/kernel_src/sm90/push_style_megamoe/src/fp8_gemm/fp8_moe_binding.cu",
        "flashinfer/moe_ep/kernel_src/sm90/push_style_megamoe/src/fp8_gemm/fp8_moe_fc1_fused.cuh",
        "flashinfer/moe_ep/kernel_src/sm90/push_style_megamoe/src/fp8_gemm/fp8_moe_jit.cuh",
        "flashinfer/moe_ep/kernel_src/sm90/push_style_megamoe/src/fp8_gemm/fp8_moe_launcher.cuh",
        "flashinfer/moe_ep/kernel_src/sm90/push_style_megamoe/src/fp8_gemm/fp8_moe_scheduler.cuh",
