...
- GEMM:
    ...
    - `mm_mxfp8` - Dense MXFP8 matrix multiplication. See [MXFP8 dense GEMM benchmark](MXFP8_dense_gemm_benchmark.md) for the cuDNN vs CuTe DSL vs TensorRT-LLM Gen comparison contract and results.
