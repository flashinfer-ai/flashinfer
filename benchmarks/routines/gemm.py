...
def parse_gemm_args(line, parser):
    ...
    parser.add_argument(
        ...
        nargs="+",
        default=["cudnn"],
        choices=["cudnn", "cublas", "trtllm", "cutlass", "cute_dsl", "auto"],
...
def testMmFp4(args):
    ...
    autotune_supported_backends = ["cudnn", "cutlass", "trtllm", "cute_dsl", "auto"]
    res = []
    ...
    def run_backend(
        ...
        if backend in ["cudnn", "trtllm", "cutlass", "cute_dsl", "auto"]:
