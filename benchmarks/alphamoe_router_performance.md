...
The sealed [full historical shape table](https://github.com/yyihuang/flashinfer/blob/fec4f2904151b3d411f9b68c2e15098457f27827/benchmarks/alphamoe_router_history.csv) now has **742 rows** and the [full historical below-one table](https://github.com/yyihuang/flashinfer/blob/fec4f2904151b3d411f9b68c2e15098457f27827/benchmarks/alphamoe_router_below_one.csv) has **5,615 rows**. They represent history125: **125 matrices, 32,746 arm records, 86,584 ratios and 4,422 rounds**. Every original row and surviving field is preserved; only the internal summary-path column is removed. The precision matrix adds six below-one round values and zero negative medians. History124 remains intact with 124 matrices, 736 shape rows, 32,536 arm records, 86,164 ratios, 5,609 below-one values and 4,386 rounds. Its original grouped matrix added 21 below-one values: 18 rounds and three medians across all comparisons. Equal ratios remain in the complete ratio records and each matrix's separate disclosure evidence.
