...
class Mxfp8CuteGemmSm120RunnerInterface {
 public:
  ...
  virtual void batch_gemm_mxfp8_nt_groupwise(void* A, int ld_a, int stride_a, void* B, int ld_b,
                                             ...
                                             float* SFA, float* SFB, int num_groups, int shape_m,
  ...
  virtual void group_gemm_mxfp8_nt_groupwise_masked(void* D, void const* A, void const* B,
                                                    ...
                                                    float const* SFA = nullptr,
                                                    float const* SFB = nullptr,
                                                    int granK = 128) = 0;
  ...
  virtual void group_gemm_mxfp8_nt_groupwise_zero_padding(
      ...
      int max_shape_m, int shape_n, int shape_k, cudaStream_t stream, float const* SFA = nullptr,
      float const* SFB = nullptr, int granK = 128) = 0;
  ...
  virtual void group_gemm_mxfp8_nt_groupwise_contiguous(
      ...
      int shape_n, int shape_k, cudaStream_t stream, float const* SFA = nullptr,
      float const* SFB = nullptr, int granK = 128, bool use_psum_layout = true) = 0;
};

template <typename ElementType, typename OutElementType, typename AccumElementType,
          typename BlockScaleElementType>
class Mxfp8CuteGemmSm120Runner : public Mxfp8CuteGemmSm120RunnerInterface {
 public:
  ...
  void batch_gemm_mxfp8_nt_groupwise(void* A, int ld_a, int stride_a, void* B, int ld_b,
                                     int stride_b, void* D, int ld_d, int stride_d, float* SFA,
                                     float* SFB, int num_groups, int shape_m, int shape_n,
  ...
  void group_gemm_mxfp8_nt_groupwise_masked(void* D, void const* A, void const* B,
                                            ...
                                            int k, cudaStream_t stream, float const* SFA = nullptr,
                                            float const* SFB = nullptr, int granK = 128) override;
  ...
  void group_gemm_mxfp8_nt_groupwise_zero_padding(void* D, void const* A, void const* B,
                                                  ...
                                                  cudaStream_t stream, float const* SFA = nullptr,
                                                  float const* SFB = nullptr,
  ...
  void group_gemm_mxfp8_nt_groupwise_contiguous(void* D, void const* A, void const* B,
                                                ...
                                                int shape_n, int shape_k, cudaStream_t stream,
                                                float const* SFA = nullptr,
                                                float const* SFB = nullptr, int granK = 128,
