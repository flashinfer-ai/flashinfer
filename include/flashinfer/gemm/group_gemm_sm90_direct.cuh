...
cudaError_t CutlassSegmentGEMMSM90DirectRun(void* float_buffer, size_t float_buffer_size_in_bytes,
  ...
  if constexpr (std::is_same_v<cutlass::layout::RowMajor, cutlass::layout::RowMajor> &&
    ...
    typename Gemm::Arguments arguments{
        ...
        {int(batch_size), reinterpret_cast<ProblemShape::UnderlyingProblemShape*>(all_problems),
         nullptr},
        {static_cast<const DTypeIn**>(x), static_cast<StrideA*>(x_stride),
         static_cast<const DTypeIn**>(w), static_cast<StrideB*>(w_stride)},
        {params, static_cast<const DTypeOut**>(y), static_cast<StrideC*>(y_stride),
         static_cast<DTypeOut**>(y), static_cast<StrideD*>(y_stride)},
        hw_info};
  ...
  return cudaErrorUnknown;  // Should not reach here
}
