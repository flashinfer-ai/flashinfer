...
static auto
make_tma_descriptors(
    typename KT::ElementA* ptr_A, typename KT::ABLoadConfig::StrideA dA,
    typename KT::ElementB* ptr_B, typename KT::ABLoadConfig::StrideB dB,
    typename KT::SFConfig::ElementSFLoad* ptr_SFA,
    typename KT::SFConfig::ElementSFLoad* ptr_SFB,
    int M, int N, int K, int num_experts)
{
  constexpr bool kPerBatchAB = KT::kGemmType == GemmType::Batched ||
                               KT::kGemmType == GemmType::MGroupedMasked;
