  ...
  switch (gemmConfig.tile_config_sm120) {
    ...
    case CutlassTileConfigSM120::ChooseWithHeuristic:
      throw std::runtime_error(
          "[Error][FP4][dispatch_gemm_cta_shape] Gemm config should have already been set by heuristic.");
      break;
    default:
...
std::vector<CutlassGemmConfig> CutlassFp4GemmRunner<T, fp4GemmType>::getConfigs() const {
  ...
  CutlassGemmConfig config(CutlassTileConfigSM120::CtaShape128x128x128B, 
