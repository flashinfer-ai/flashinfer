...
__device__ __forceinline__ __nv_bfloat162 decode_e2m1_or_e4m3_pair_bf16(uint32_t raw,
                                                                        bool is_e2m1) {
  uint32_t half_pair;
  if (is_e2m1) {
...
__device__ __forceinline__ __nv_bfloat162 decode_e4m3_or_ue8m0_scale_bf16(uint8_t code,
                                                                          bool is_e4m3) {
