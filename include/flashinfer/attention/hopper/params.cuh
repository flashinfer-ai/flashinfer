...
struct Flash_fwd_params : public Qkv_params {
  ...
  // Otherwise it's cu_seqlens_k[bidb], i.e., we use cu_seqlens_k to store the sequence lengths of
  // K.
  ...
  bool unpadded_lse;  // For varlen paths: LSE is in [nheads, total_seqlen_q] format instead of [b,
                      // nheads, seqlen_q].
