 ...
 */
#ifndef FLASHINFER_ATTENTION_HOPPER_SM90_PIPELINE_NO_CLUSTER_CUH_
#define FLASHINFER_ATTENTION_HOPPER_SM90_PIPELINE_NO_CLUSTER_CUH_
...
class PipelineTmaAsyncNoCluster : public Base {
 public:
  ...
  static CUTLASS_DEVICE void init_barriers(SharedStorage& storage, Params params) {
    ...
    if (is_initializing_warp) {
      ...
      uint32_t const num_consumer_warpgroups_per_cluster =
          (params.num_consumers + cutlass::NumThreadsPerWarpGroup - 1) /
  ...
  CUTLASS_DEVICE PipelineTmaAsyncNoCluster(SharedStorage& storage, Params params,
                                           ClusterShape cluster_shape, InitBarriers = {},
                                           InitMasks = {})
      : Base(storage, params, make_shape(_1{}, _1{}, _1{}) /*cluster_shape*/,
             cute::false_type{} /*init_barriers*/, cute::false_type{} /*init_masks*/),
  ...
  CUTLASS_DEVICE PipelineTmaAsyncNoCluster(SharedStorage& storage, Params params,
      ...
      : PipelineTmaAsyncNoCluster(storage, params, cluster_shape, cute::true_type{},
                                  cute::true_type{}) {}

  template <class ClusterShape, class InitBarriers>
  CUTLASS_DEVICE PipelineTmaAsyncNoCluster(SharedStorage& storage, Params params,
                                           ClusterShape cluster_shape, InitBarriers = {})
      : PipelineTmaAsyncNoCluster(storage, params, cluster_shape, InitBarriers{},
                                  cute::true_type{}) {}
 ...
 private:
  ...
  void consumer_release(uint32_t stage, uint32_t skip = false) {
    empty_barrier_ptr_[stage].arrive(0 /*dst_blockid_*/,
...
#endif  // FLASHINFER_ATTENTION_HOPPER_SM90_PIPELINE_NO_CLUSTER_CUH_
