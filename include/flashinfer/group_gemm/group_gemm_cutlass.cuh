...
template <typename T>
__global__ void compute_cutlass_group_gemm_args(cutlass::gemm::GemmCoord* all_problems, T** ptr_y,
                                                T** ptr_x, T** ptr_w, int64_t* ld_y, int64_t* ld_x,
                                                int64_t* ld_w, T* y, T* x, T* w, int64_t* xy_indptr,
