...
struct tensor_info_t {
  ...
  size_t num_heads;
  size_t head_dim;
  __host__ __device__ __forceinline__ tensor_info_t(size_t q_len, size_t kv_len, size_t num_heads,
                                                    size_t head_dim)
  ...
  __host__ __device__ __forceinline__ size_t get_qo_elem_offset(size_t query_idx, size_t head_idx,
    ...
    return get_elem_offset_impl<layout>(query_idx, head_idx, feat_idx, q_len, num_heads, head_dim);
  }
