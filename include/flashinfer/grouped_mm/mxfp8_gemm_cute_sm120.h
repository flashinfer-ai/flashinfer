...
class Mxfp8GemmCuteSm120RunnerInterface {
 public:
  Mxfp8GemmCuteSm120RunnerInterface() {}

  virtual ~Mxfp8GemmCuteSm120RunnerInterface() {}
  ...
  virtual void group_gemm_mxfp8_nt_groupwise_zero_padding(
      ...
      int max_shape_m, int shape_n, int shape_k, cudaStream_t stream, int32_t const* SFA = nullptr,
...
class Mxfp8GemmCuteSm120Runner : public Mxfp8GemmCuteSm120RunnerInterface {
 public:
  Mxfp8GemmCuteSm120Runner();
  ~Mxfp8GemmCuteSm120Runner();
  ...
  void group_gemm_mxfp8_nt_groupwise_zero_padding(void* D, void const* A, void const* B,
 ...
 private:
  ...
  template <int GranK>
  void group_gemm_mxfp8_nt_groupwise_zero_padding_impl(void* D, void const* A, void const* B,
                                                       int32_t const* token_offset, int num_groups,
                                                       int max_shape_m, int shape_n, int shape_k,
...
void quantize_mxfp8_zero_padding(
    ...
    int64_t size_k, cudaStream_t stream, int granK = 128);
