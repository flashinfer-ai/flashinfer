...
| `FLASHINFER_SM90_PUSH_NVFP4_RS_WGMMA_GROUP` | `1` | `flashinfer/moe_ep/kernel_src/sm90/push_style_megamoe/shim/nvfp4_rs_gemm.py` | Experimental direct-RS WGMMA group size (`1`, `2`, or `4`). The production runner ignores this override. |
| `FLASHINFER_SM90_PUSH_NVFP4_RS_STATIC_SCHED` | `0` | `flashinfer/moe_ep/kernel_src/sm90/push_style_megamoe/shim/nvfp4_rs_gemm.py` | `1` enables the experimental direct-RS static scheduler. The production runner ignores this override. |
| `FLASHINFER_SM90_PUSH_NVFP4_RS_NO_UNION` | `0` | `flashinfer/moe_ep/kernel_src/sm90/push_style_megamoe/shim/nvfp4_rs_gemm.py` | `1` disables the experimental direct-RS union layout. The production runner ignores this override. |
