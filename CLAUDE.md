...
| `FLASHINFER_SM90_PUSH_NVFP4_RS_WGMMA_GROUP` | `1` | `flashinfer/moe_ep/kernel_src/sm90/push_style_megamoe/shim/nvfp4_rs_gemm.py` | Selects the internal WGMMA commit-group size (`1`, `2`, or `4`) for the SM90 push NVFP4 RS runtime-JIT kernel. Internal/experimental — leave at the default unless investigating that kernel. |
| `FLASHINFER_SM90_PUSH_NVFP4_RS_STATIC_SCHED` | `0` | `flashinfer/moe_ep/kernel_src/sm90/push_style_megamoe/shim/nvfp4_rs_gemm.py` | `1` enables the internal static-schedule variant of the SM90 push NVFP4 RS runtime-JIT kernel. Internal/experimental — leave at the default unless investigating that kernel. |
| `FLASHINFER_SM90_PUSH_NVFP4_RS_NO_UNION` | `0` | `flashinfer/moe_ep/kernel_src/sm90/push_style_megamoe/shim/nvfp4_rs_gemm.py` | `1` disables the internal shared-memory union variant of the SM90 push NVFP4 RS runtime-JIT kernel. Internal/experimental — leave at the default unless investigating that kernel. |
