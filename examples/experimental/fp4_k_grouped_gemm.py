...
plan=prepare_fp4_k_grouped_gemm(a,b,sfa,sfb,m=m,group_ks=group_ks,k_alignment=alignment,
    use_psum_layout=False,output_dtype='fp32',accumulate=True,out=out)
