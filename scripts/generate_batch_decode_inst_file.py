...
template cudaError_t BatchDecodeWithPagedKVCacheWrapperDispatched<page_storage, {kv_layout}, {group_size}, {head_dim}, {pos_encoding_mode}, {dtype_in}, {dtype_out}, {idtype}>(
  BatchDecodeHandler* handler, {dtype_in}* q, {idtype}* q_offset,
