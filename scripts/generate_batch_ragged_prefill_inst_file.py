...
template cudaError_t BatchPrefillWithRaggedKVCacheWrapperDispatched<{group_size}, {head_dim}, {kv_layout}, {pos_encoding_mode}, {allow_fp16_qk_reduction}, {causal}, {dtype_in}, {dtype_out}, {idtype}>(
  BatchPrefillHandler* handler, {dtype_in}* q, {idtype}* qo_indptr,
