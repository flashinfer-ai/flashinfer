...
[`flashinfer/experimental/AGENTS.md`](flashinfer/experimental/AGENTS.md); the
...
- Important infrastructure changes (e.g., `@flashinfer_api`, `@backend_requirement`, TVM-FFI macros) → Update examples in `AGENTS.md` and relevant skill files
