...
// Provenance: generated Loom schedule 'flashinfer_tinygemm2_stage4' (USE_PDL=1); an exact
// port of the TensorRT-LLM tinygemm2 kernel (csrc/tinygemm2.cu) with
// bit-identical outputs. Included by tinygemm2_sm100_stage4_pdl_binding.cu.
