...
#define kernel_flashinfer_tinygemm2 tinygemm2_sm100_stage4_pdl_kernel
#include "tinygemm2_sm100_stage4_pdl.cu"
...
void RunStage4Pdl(TensorView input, TensorView weight, TensorView bias, TensorView out) {
  ...
  LaunchVariant(&tinygemm2_sm100_stage4_pdl_kernel, SMEM_TOTAL, /*pdl=*/true, weight_map,
