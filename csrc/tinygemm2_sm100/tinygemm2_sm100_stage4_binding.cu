...
#define kernel_flashinfer_tinygemm2 tinygemm2_sm100_stage4_kernel
#include "tinygemm2_sm100_stage4.cu"
...
static_assert(SMEM_TOTAL == 52352, "generated variant disagrees on dynamic smem footprint");
...
void RunStage4(TensorView input, TensorView weight, TensorView bias, TensorView out) {
  ...
  LaunchVariant(&tinygemm2_sm100_stage4_kernel, SMEM_TOTAL, /*pdl=*/false, weight_map,
