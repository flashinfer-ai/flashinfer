...
#define kernel_flashinfer_tinygemm2 tinygemm2_sm100_stage8_pdl_kernel
#include "tinygemm2_sm100_stage8_pdl.cu"
...
static_assert(USE_PDL == 1, "binding paired with the wrong PDL flavor of the generated TU");
...
void RunStage8Pdl(TensorView input, TensorView weight, TensorView bias, TensorView out) {
  ...
  LaunchVariant(&tinygemm2_sm100_stage8_pdl_kernel, SMEM_TOTAL, /*pdl=*/true, weight_map,
