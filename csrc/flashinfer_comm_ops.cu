...
public:
    ...
    std::vector<at::Tensor> run(at::Tensor const& input, at::optional<at::Tensor> const& residual,
        ...
        at::optional<at::Tensor> const& bias, at::optional<at::Tensor> workspace) noexcept
    {
...
private:
    std::vector<at::Tensor> runUBAllReduce(at::Tensor const& input,
        at::optional<at::Tensor> const& residual, at::optional<at::Tensor> const& norm_weight,
        at::optional<at::Tensor> const& scale, at::optional<at::Tensor> const& bias) noexcept
    {
    ...
    std::vector<at::Tensor> runFusionAllReduce(at::Tensor const& input,
        at::optional<at::Tensor> const& residual, at::optional<at::Tensor> const& norm_weight,
        at::optional<at::Tensor> const& scale, at::optional<at::Tensor> const& bias,
        at::optional<at::Tensor> workspace, AllReduceStrategyType strategy) noexcept
    {
    ...
    std::vector<at::Tensor> fallbackRunSubsequentOps(at::Tensor const& input,
        torch::optional<at::Tensor> const& residual, torch::optional<at::Tensor> const& norm_weight,
        torch::optional<at::Tensor> const& scale, torch::optional<at::Tensor> const& bias,
...
std::vector<at::Tensor> allreduce(at::Tensor const& input, at::optional<at::Tensor> const& residual,
    ...
    at::List<int64_t> const& group_, int64_t const strategy_, int64_t const fusion_op_, double const eps_)
{
#if ENABLE_MULTI_DEVICE
...
std::vector<at::Tensor> moe_allreduce(at::Tensor const& residual, at::Tensor const& norm_weight,
    at::Tensor const& device_num_experts, at::Tensor const& scale_input,
    at::Tensor const& active_experts_token_input, at::Tensor const& token_input, at::Tensor workspace,
...
TORCH_LIBRARY_FRAGMENT(TORCH_EXTENSION_NAME, m) {
  ...
  m.def(
        "allreduce", &torch_ext::allreduce);
    m.def(
        "moe_allreduce", &torch_ext::moe_allreduce);
}
