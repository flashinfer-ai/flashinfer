    ...
    // ---- Role: load_b ----
        ...
        { // load_b_main
            ...
            for (int base = 0; base < entries; base += 32) {
                ...
                expert_10 = _shfl_54;
                pcounts[0] = pcounts[0] + (unsigned int)(expert_10 == lane);
                pcounts[1] = pcounts[1] + (unsigned int)(expert_10 == 32 + lane);
                pcounts[2] = pcounts[2] + (unsigned int)(expert_10 == 64 + lane);
                pcounts[3] = pcounts[3] + (unsigned int)(expert_10 == 96 + lane);
                pcounts[4] = pcounts[4] + (unsigned int)(expert_10 == 128 + lane);
                pcounts[5] = pcounts[5] + (unsigned int)(expert_10 == 160 + lane);
                pcounts[6] = pcounts[6] + (unsigned int)(expert_10 == 192 + lane);
                pcounts[7] = pcounts[7] + (unsigned int)(expert_10 == 224 + lane);
                pcounts[8] = pcounts[8] + (unsigned int)(expert_10 == 256 + lane);
                pcounts[9] = pcounts[9] + (unsigned int)(expert_10 == 288 + lane);
                pcounts[10] = pcounts[10] + (unsigned int)(expert_10 == 320 + lane);
                pcounts[11] = pcounts[11] + (unsigned int)(expert_10 == 352 + lane);
            ...
            if (first_task < pool_blocks * 18) {
                ...
                unsigned int _vote_12 = __ballot_sync(0xFFFFFFFF, expert_0 < 384 && (pool_block_2 >= lane_offset && pool_block_2 < lane_offset + blocks_1));
                ...
                if (owner_mask != 0) {
                    ...
                    unsigned int _shfl_86 = __shfl_sync(0xFFFFFFFF, expert_0, owner_lane);
                    ptask[1] = _shfl_86;
                ...
                unsigned int expert_16 = 64 + lane;
                ...
                unsigned int _vote_14 = __ballot_sync(0xFFFFFFFF, expert_16 < 384 && (pool_block_2 >= lane_offset_25 && pool_block_2 < lane_offset_25 + blocks_18));
                ...
                if (owner_mask_26 != 0) {
                    ...
                    unsigned int _shfl_94 = __shfl_sync(0xFFFFFFFF, expert_16, owner_lane_2);
                    ptask[1] = _shfl_94;
    ...
    // ---- Role: schedule ----
        ...
        { // schedule_main
            ...
            if (cta_rank == 0) {
                ...
                unsigned int expert_12 = lane_read_0_1;
                unsigned long long received_1 = 0;
                if (expert_12 < 384) {
                    while (1) {
                        received_1 = reinterpret_cast<volatile unsigned long long*>(RecvSum)[(unsigned int)expert_12];
                ...
                unsigned int expert_5_2 = 96 + lane_read_0_1;
                unsigned long long received_6_1 = 0;
                if (expert_5_2 < 384) {
                    while (1) {
                        received_6_1 = reinterpret_cast<volatile unsigned long long*>(RecvSum)[(unsigned int)expert_5_2];
                ...
                for (int iteration_2 = 0; iteration_2 < 250801; iteration_2++) {
                    ...
                    if (phase_1 != 0) {
                        ...
                        if (owner_mask_1 != 0) {
                            ...
                            unsigned int _shfl_5 = __shfl_sync(0xFFFFFFFF, expert_0_1, owner_lane_12);
                            task_3[1] = _shfl_5;
                        ...
                        unsigned int previous_10_1 = _shfl_up_5;
                        if (lane >= 1) {
                            inclusive_9 += previous_10_1;
                        }
                        unsigned int _shfl_up_6 = __shfl_up_sync(0xFFFFFFFF, inclusive_9, 2, 32);
                        unsigned int previous_11_1 = _shfl_up_6;
                        if (lane >= 2) {
                            inclusive_9 += previous_11_1;
                        }
                        unsigned int _shfl_up_7 = __shfl_up_sync(0xFFFFFFFF, inclusive_9, 4, 32);
                        unsigned int previous_12_1 = _shfl_up_7;
                        if (lane >= 4) {
                            inclusive_9 += previous_12_1;
                        }
                        unsigned int _shfl_up_8 = __shfl_up_sync(0xFFFFFFFF, inclusive_9, 8, 32);
                        unsigned int previous_13_1 = _shfl_up_8;
                        if (lane >= 8) {
                            inclusive_9 += previous_13_1;
                        }
                        ...
                        unsigned int lane_offset_15 = block_offset_1 + inclusive_9 - blocks_8;
                        unsigned int _vote_1 = __ballot_sync(0xFFFFFFFF, expert_6_1 < 384 && (pool_block_3 >= lane_offset_15 && pool_block_3 < lane_offset_15 + blocks_8));
                        unsigned int owner_mask_16 = _vote_1;
                        if (owner_mask_16 != 0) {
                            int _ffs_1 = __ffs(owner_mask_16);
                            unsigned int owner_lane_13 = _ffs_1 - 1;
                            unsigned int local_block_13 = pool_block_3 - lane_offset_15;
                            unsigned int _min_5 = ((tokens_7 - local_block_13 * 16) < (16) ? (tokens_7 - local_block_13 * 16) : (16));
                            unsigned int valid_13 = _min_5;
                            unsigned int _shfl_9 = __shfl_sync(0xFFFFFFFF, expert_6_1, owner_lane_13);
                            task_3[1] = _shfl_9;
                        ...
                        unsigned int previous_22_1 = _shfl_up_10;
                        if (lane >= 1) {
                            inclusive_21 += previous_22_1;
                        }
                        unsigned int _shfl_up_11 = __shfl_up_sync(0xFFFFFFFF, inclusive_21, 2, 32);
                        unsigned int previous_23_1 = _shfl_up_11;
                        if (lane >= 2) {
                            inclusive_21 += previous_23_1;
                        }
                        unsigned int _shfl_up_12 = __shfl_up_sync(0xFFFFFFFF, inclusive_21, 4, 32);
                        unsigned int previous_24_1 = _shfl_up_12;
                        if (lane >= 4) {
                            inclusive_21 += previous_24_1;
                        }
                        ...
                        unsigned int lane_offset_27 = block_offset_1 + inclusive_21 - blocks_20;
                        unsigned int _vote_2 = __ballot_sync(0xFFFFFFFF, expert_18 < 384 && (pool_block_3 >= lane_offset_27 && pool_block_3 < lane_offset_27 + blocks_20));
                        unsigned int owner_mask_28 = _vote_2;
                        if (owner_mask_28 != 0) {
                            int _ffs_2 = __ffs(owner_mask_28);
                            unsigned int owner_lane_14 = _ffs_2 - 1;
                            unsigned int local_block_14 = pool_block_3 - lane_offset_27;
                            unsigned int _min_6 = ((tokens_19 - local_block_14 * 16) < (16) ? (tokens_19 - local_block_14 * 16) : (16));
                            unsigned int valid_14 = _min_6;
                            unsigned int _shfl_13 = __shfl_sync(0xFFFFFFFF, expert_18, owner_lane_14);
                            task_3[1] = _shfl_13;
                        ...
                        unsigned int previous_33_1 = _shfl_up_15;
                        if (lane >= 1) {
                            inclusive_32 += previous_33_1;
                        }
                        unsigned int _shfl_up_16 = __shfl_up_sync(0xFFFFFFFF, inclusive_32, 2, 32);
                        unsigned int previous_34_1 = _shfl_up_16;
                        if (lane >= 2) {
                            inclusive_32 += previous_34_1;
                        }
                        unsigned int _shfl_up_17 = __shfl_up_sync(0xFFFFFFFF, inclusive_32, 4, 32);
                        unsigned int previous_35_1 = _shfl_up_17;
                        if (lane >= 4) {
                            inclusive_32 += previous_35_1;
                        }
                        ...
                        unsigned int lane_offset_38 = block_offset_1 + inclusive_32 - blocks_31;
                        unsigned int _vote_3 = __ballot_sync(0xFFFFFFFF, expert_29 < 384 && (pool_block_3 >= lane_offset_38 && pool_block_3 < lane_offset_38 + blocks_31));
                        unsigned int owner_mask_39 = _vote_3;
                        if (owner_mask_39 != 0) {
                            int _ffs_3 = __ffs(owner_mask_39);
                            unsigned int owner_lane_15 = _ffs_3 - 1;
                            unsigned int local_block_15 = pool_block_3 - lane_offset_38;
                            unsigned int _min_7 = ((tokens_30 - local_block_15 * 16) < (16) ? (tokens_30 - local_block_15 * 16) : (16));
                            unsigned int valid_15 = _min_7;
                            unsigned int _shfl_17 = __shfl_sync(0xFFFFFFFF, expert_29, owner_lane_15);
                            task_3[1] = _shfl_17;
                        ...
                        unsigned int previous_44_1 = _shfl_up_20;
                        if (lane >= 1) {
                            inclusive_43 += previous_44_1;
                        }
                        unsigned int _shfl_up_21 = __shfl_up_sync(0xFFFFFFFF, inclusive_43, 2, 32);
                        unsigned int previous_45_1 = _shfl_up_21;
                        if (lane >= 2) {
                            inclusive_43 += previous_45_1;
                        }
                        unsigned int _shfl_up_22 = __shfl_up_sync(0xFFFFFFFF, inclusive_43, 4, 32);
                        unsigned int previous_46_1 = _shfl_up_22;
                        if (lane >= 4) {
                            inclusive_43 += previous_46_1;
                        }
                        ...
                        unsigned int lane_offset_49 = block_offset_1 + inclusive_43 - blocks_42;
                        unsigned int _vote_4 = __ballot_sync(0xFFFFFFFF, expert_40 < 384 && (pool_block_3 >= lane_offset_49 && pool_block_3 < lane_offset_49 + blocks_42));
                        unsigned int owner_mask_50 = _vote_4;
                        if (owner_mask_50 != 0) {
                            int _ffs_4 = __ffs(owner_mask_50);
                            unsigned int owner_lane_16 = _ffs_4 - 1;
                            unsigned int local_block_16 = pool_block_3 - lane_offset_49;
                            unsigned int _min_8 = ((tokens_41 - local_block_16 * 16) < (16) ? (tokens_41 - local_block_16 * 16) : (16));
                            unsigned int valid_16 = _min_8;
                            unsigned int _shfl_21 = __shfl_sync(0xFFFFFFFF, expert_40, owner_lane_16);
                            task_3[1] = _shfl_21;
                        ...
                        unsigned int previous_55_1 = _shfl_up_25;
                        if (lane >= 1) {
                            inclusive_54 += previous_55_1;
                        }
                        unsigned int _shfl_up_26 = __shfl_up_sync(0xFFFFFFFF, inclusive_54, 2, 32);
                        unsigned int previous_56_1 = _shfl_up_26;
                        if (lane >= 2) {
                            inclusive_54 += previous_56_1;
                        }
                        unsigned int _shfl_up_27 = __shfl_up_sync(0xFFFFFFFF, inclusive_54, 4, 32);
                        unsigned int previous_57_1 = _shfl_up_27;
                        if (lane >= 4) {
                            inclusive_54 += previous_57_1;
                        }
                        ...
                        unsigned int lane_offset_60 = block_offset_1 + inclusive_54 - blocks_53;
                        unsigned int _vote_5 = __ballot_sync(0xFFFFFFFF, expert_51 < 384 && (pool_block_3 >= lane_offset_60 && pool_block_3 < lane_offset_60 + blocks_53));
                        unsigned int owner_mask_61 = _vote_5;
                        if (owner_mask_61 != 0) {
                            int _ffs_5 = __ffs(owner_mask_61);
                            unsigned int owner_lane_17 = _ffs_5 - 1;
                            unsigned int local_block_17 = pool_block_3 - lane_offset_60;
                            unsigned int _min_9 = ((tokens_52 - local_block_17 * 16) < (16) ? (tokens_52 - local_block_17 * 16) : (16));
                            unsigned int valid_17 = _min_9;
                            unsigned int _shfl_25 = __shfl_sync(0xFFFFFFFF, expert_51, owner_lane_17);
                            task_3[1] = _shfl_25;
                        ...
                        unsigned int previous_66_1 = _shfl_up_30;
                        if (lane >= 1) {
                            inclusive_65 += previous_66_1;
                        }
                        unsigned int _shfl_up_31 = __shfl_up_sync(0xFFFFFFFF, inclusive_65, 2, 32);
                        unsigned int previous_67_1 = _shfl_up_31;
                        if (lane >= 2) {
                            inclusive_65 += previous_67_1;
                        }
                        unsigned int _shfl_up_32 = __shfl_up_sync(0xFFFFFFFF, inclusive_65, 4, 32);
                        unsigned int previous_68_1 = _shfl_up_32;
                        if (lane >= 4) {
                            inclusive_65 += previous_68_1;
                        }
                        ...
                        unsigned int lane_offset_71 = block_offset_1 + inclusive_65 - blocks_64;
                        unsigned int _vote_6 = __ballot_sync(0xFFFFFFFF, expert_62 < 384 && (pool_block_3 >= lane_offset_71 && pool_block_3 < lane_offset_71 + blocks_64));
                        unsigned int owner_mask_72 = _vote_6;
                        if (owner_mask_72 != 0) {
                            int _ffs_6 = __ffs(owner_mask_72);
                            unsigned int owner_lane_18 = _ffs_6 - 1;
                            unsigned int local_block_18 = pool_block_3 - lane_offset_71;
                            unsigned int _min_10 = ((tokens_63 - local_block_18 * 16) < (16) ? (tokens_63 - local_block_18 * 16) : (16));
                            unsigned int valid_18 = _min_10;
                            unsigned int _shfl_29 = __shfl_sync(0xFFFFFFFF, expert_62, owner_lane_18);
                            task_3[1] = _shfl_29;
                        ...
                        unsigned int previous_77_1 = _shfl_up_35;
                        if (lane >= 1) {
                            inclusive_76 += previous_77_1;
                        }
                        unsigned int _shfl_up_36 = __shfl_up_sync(0xFFFFFFFF, inclusive_76, 2, 32);
                        unsigned int previous_78_1 = _shfl_up_36;
                        if (lane >= 2) {
                            inclusive_76 += previous_78_1;
                        }
                        unsigned int _shfl_up_37 = __shfl_up_sync(0xFFFFFFFF, inclusive_76, 4, 32);
                        unsigned int previous_79_1 = _shfl_up_37;
                        if (lane >= 4) {
                            inclusive_76 += previous_79_1;
                        }
                        ...
                        unsigned int lane_offset_82 = block_offset_1 + inclusive_76 - blocks_75;
                        unsigned int _vote_7 = __ballot_sync(0xFFFFFFFF, expert_73 < 384 && (pool_block_3 >= lane_offset_82 && pool_block_3 < lane_offset_82 + blocks_75));
                        unsigned int owner_mask_83 = _vote_7;
                        if (owner_mask_83 != 0) {
                            int _ffs_7 = __ffs(owner_mask_83);
                            unsigned int owner_lane_19 = _ffs_7 - 1;
                            unsigned int local_block_19 = pool_block_3 - lane_offset_82;
                            unsigned int _min_11 = ((tokens_74 - local_block_19 * 16) < (16) ? (tokens_74 - local_block_19 * 16) : (16));
                            unsigned int valid_19 = _min_11;
                            unsigned int _shfl_33 = __shfl_sync(0xFFFFFFFF, expert_73, owner_lane_19);
                            task_3[1] = _shfl_33;
                        ...
                        unsigned int previous_88_1 = _shfl_up_40;
                        if (lane >= 1) {
                            inclusive_87 += previous_88_1;
                        }
                        unsigned int _shfl_up_41 = __shfl_up_sync(0xFFFFFFFF, inclusive_87, 2, 32);
                        unsigned int previous_89_1 = _shfl_up_41;
                        if (lane >= 2) {
                            inclusive_87 += previous_89_1;
                        }
                        unsigned int _shfl_up_42 = __shfl_up_sync(0xFFFFFFFF, inclusive_87, 4, 32);
                        unsigned int previous_90_1 = _shfl_up_42;
                        if (lane >= 4) {
                            inclusive_87 += previous_90_1;
                        }
                        ...
                        unsigned int lane_offset_93 = block_offset_1 + inclusive_87 - blocks_86;
                        unsigned int _vote_8 = __ballot_sync(0xFFFFFFFF, expert_84 < 384 && (pool_block_3 >= lane_offset_93 && pool_block_3 < lane_offset_93 + blocks_86));
                        unsigned int owner_mask_94 = _vote_8;
                        if (owner_mask_94 != 0) {
                            int _ffs_8 = __ffs(owner_mask_94);
                            unsigned int owner_lane_20 = _ffs_8 - 1;
                            unsigned int local_block_20 = pool_block_3 - lane_offset_93;
                            unsigned int _min_12 = ((tokens_85 - local_block_20 * 16) < (16) ? (tokens_85 - local_block_20 * 16) : (16));
                            unsigned int valid_20 = _min_12;
                            unsigned int _shfl_37 = __shfl_sync(0xFFFFFFFF, expert_84, owner_lane_20);
                            task_3[1] = _shfl_37;
                        ...
                        unsigned int previous_99_1 = _shfl_up_45;
                        if (lane >= 1) {
                            inclusive_98 += previous_99_1;
                        }
                        unsigned int _shfl_up_46 = __shfl_up_sync(0xFFFFFFFF, inclusive_98, 2, 32);
                        unsigned int previous_100_1 = _shfl_up_46;
                        if (lane >= 2) {
                            inclusive_98 += previous_100_1;
                        }
                        unsigned int _shfl_up_47 = __shfl_up_sync(0xFFFFFFFF, inclusive_98, 4, 32);
                        unsigned int previous_101_1 = _shfl_up_47;
                        if (lane >= 4) {
                            inclusive_98 += previous_101_1;
                        }
                        ...
                        unsigned int lane_offset_104 = block_offset_1 + inclusive_98 - blocks_97;
                        unsigned int _vote_9 = __ballot_sync(0xFFFFFFFF, expert_95 < 384 && (pool_block_3 >= lane_offset_104 && pool_block_3 < lane_offset_104 + blocks_97));
                        unsigned int owner_mask_105 = _vote_9;
                        if (owner_mask_105 != 0) {
                            int _ffs_9 = __ffs(owner_mask_105);
                            unsigned int owner_lane_21 = _ffs_9 - 1;
                            unsigned int local_block_21 = pool_block_3 - lane_offset_104;
                            unsigned int _min_13 = ((tokens_96 - local_block_21 * 16) < (16) ? (tokens_96 - local_block_21 * 16) : (16));
                            unsigned int valid_21 = _min_13;
                            unsigned int _shfl_41 = __shfl_sync(0xFFFFFFFF, expert_95, owner_lane_21);
                            task_3[1] = _shfl_41;
                        ...
                        unsigned int previous_110_1 = _shfl_up_50;
                        if (lane >= 1) {
                            inclusive_109 += previous_110_1;
                        }
                        unsigned int _shfl_up_51 = __shfl_up_sync(0xFFFFFFFF, inclusive_109, 2, 32);
                        unsigned int previous_111_1 = _shfl_up_51;
                        if (lane >= 2) {
                            inclusive_109 += previous_111_1;
                        }
                        unsigned int _shfl_up_52 = __shfl_up_sync(0xFFFFFFFF, inclusive_109, 4, 32);
                        unsigned int previous_112_1 = _shfl_up_52;
                        if (lane >= 4) {
                            inclusive_109 += previous_112_1;
                        }
                        ...
                        unsigned int lane_offset_115 = block_offset_1 + inclusive_109 - blocks_108;
                        unsigned int _vote_10 = __ballot_sync(0xFFFFFFFF, expert_106 < 384 && (pool_block_3 >= lane_offset_115 && pool_block_3 < lane_offset_115 + blocks_108));
                        unsigned int owner_mask_116 = _vote_10;
                        if (owner_mask_116 != 0) {
                            int _ffs_10 = __ffs(owner_mask_116);
                            unsigned int owner_lane_22 = _ffs_10 - 1;
                            unsigned int local_block_22 = pool_block_3 - lane_offset_115;
                            unsigned int _min_14 = ((tokens_107 - local_block_22 * 16) < (16) ? (tokens_107 - local_block_22 * 16) : (16));
                            unsigned int valid_22 = _min_14;
                            unsigned int _shfl_45 = __shfl_sync(0xFFFFFFFF, expert_106, owner_lane_22);
                            task_3[1] = _shfl_45;
                        ...
                        unsigned int previous_121_1 = _shfl_up_55;
                        if (lane >= 1) {
                            inclusive_120 += previous_121_1;
                        }
                        unsigned int _shfl_up_56 = __shfl_up_sync(0xFFFFFFFF, inclusive_120, 2, 32);
                        unsigned int previous_122_1 = _shfl_up_56;
                        if (lane >= 2) {
                            inclusive_120 += previous_122_1;
                        }
                        unsigned int _shfl_up_57 = __shfl_up_sync(0xFFFFFFFF, inclusive_120, 4, 32);
                        unsigned int previous_123_1 = _shfl_up_57;
                        if (lane >= 4) {
                            inclusive_120 += previous_123_1;
                        }
                        ...
                        unsigned int lane_offset_126 = block_offset_1 + inclusive_120 - blocks_119;
                        unsigned int _vote_11 = __ballot_sync(0xFFFFFFFF, expert_117 < 384 && (pool_block_3 >= lane_offset_126 && pool_block_3 < lane_offset_126 + blocks_119));
                        unsigned int owner_mask_127 = _vote_11;
                        if (owner_mask_127 != 0) {
                            int _ffs_11 = __ffs(owner_mask_127);
                            unsigned int owner_lane_23 = _ffs_11 - 1;
                            unsigned int local_block_23 = pool_block_3 - lane_offset_126;
                            unsigned int _min_15 = ((tokens_118 - local_block_23 * 16) < (16) ? (tokens_118 - local_block_23 * 16) : (16));
                            unsigned int valid_23 = _min_15;
                            unsigned int _shfl_49 = __shfl_sync(0xFFFFFFFF, expert_117, owner_lane_23);
                            task_3[1] = _shfl_49;
    ...
    // ---- Role: epilogue ----
        ...
        { // epilogue_main
                ...
                if (task_4[0] == 1 || task_4[0] == 3) {
                    ...
                    for (int s = 0; s < 1; s++) {
                        ...
                        for (int i = 0; i < 1; i++) {
                            ...
                            float _shfl_135;
                            asm volatile("shfl.sync.idx.b32 %0, %1, %2, 0x1f, 0xffffffff;" : "=f"(_shfl_135) : "f"(cached_weight), "r"(j * 8 % 32 + lane_read_0_2 % 4 * 2));
                            float first_weight = _shfl_135;
                            float _shfl_136;
                            asm volatile("shfl.sync.idx.b32 %0, %1, %2, 0x1f, 0xffffffff;" : "=f"(_shfl_136) : "f"(cached_weight), "r"(j * 8 % 32 + lane_read_0_2 % 4 * 2 + 1));
            ...
            for (unsigned int token_chunk = epi_warp_2 * 152 + (unsigned int)bid; token_chunk < num_tokens * 4; token_chunk += 1216) {
                ...
                int expert_14 = -1;
                if (lane < 6) {
                    expert_14 = (int)TopK[token_1 * 6 + lane];
                }
                if (lane == 6) {
                    expert_14 = 6;
                }
                unsigned int _vote_24 = __ballot_sync(0xFFFFFFFF, expert_14 >= 0);
