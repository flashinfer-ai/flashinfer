...
kernel_deepgemm_source_mega_moe_sm103a_eb6404f694082ca049d4(DeepgemmTensorMap const* A1, DeepgemmTensorMap const* A2, DeepgemmTensorMap const* SA1, DeepgemmTensorMap const* SA2, DeepgemmTensorMap const* B1, DeepgemmTensorMap const* B2, DeepgemmTensorMap const* SB1, DeepgemmTensorMap const* SB2, DeepgemmTensorMap const* SFA1, DeepgemmTensorMap const* SFA2, DeepgemmTensorMap const* SSFA1, DeepgemmTensorMap const* SSFA2, DeepgemmTensorMap const* SFB1, DeepgemmTensorMap const* SFB2, DeepgemmTensorMap const* SSFB1, DeepgemmTensorMap const* SSFB2, DeepgemmTensorMap const* L1Output, DeepgemmTensorMap const* SharedL1Output, uint8_t* __restrict__ X, unsigned int* __restrict__ XSF, long long* __restrict__ TopK, float* __restrict__ Weights, uint8_t* __restrict__ L1Acts, unsigned int* __restrict__ L1SF, float* __restrict__ L1Weights, uint8_t* __restrict__ L2SF, uint8_t* __restrict__ SharedL2SF, unsigned int* __restrict__ SourceIndices, unsigned int* __restrict__ TokenMetadata, unsigned int* __restrict__ GridCounters, unsigned int* __restrict__ NvlCounter, unsigned int* __restrict__ NvlSignals, unsigned long long* __restrict__ PeerGrid, unsigned long long* __restrict__ ReadyGrid, unsigned long long* __restrict__ SendCounts, unsigned long long* __restrict__ RecvCounts, unsigned long long* __restrict__ RecvSum, unsigned int* __restrict__ L1Full, unsigned int* __restrict__ L1Empty, unsigned long long* __restrict__ L2Mask, unsigned int* __restrict__ L2Empty, unsigned int* __restrict__ SharedFull, unsigned int* __restrict__ L1Counter, unsigned int* __restrict__ L2Counter, unsigned int* __restrict__ SharedL1Counter, unsigned int* __restrict__ SharedL2Counter, unsigned int* __restrict__ Combine, uint8_t* __restrict__ CombineBytes, uint8_t* __restrict__ Y, unsigned int num_tokens)
{
    ...
    #define task_full_addr (mbar_base + 368)
    #define task_empty_addr (mbar_base + 384)
    ...
    // Mbarriers at smem_raw[229696..230096)
    ...
    if (warp == 2) {
        ...
        if (leader) {
            ...
            mbarrier_init(smem + 230080, 512);
            mbarrier_init(smem + 230088, 512);
            asm volatile("fence.mbarrier_init.release.cluster;" ::: "memory");
        }
    }
    ...
    volatile int* tmem_addr_storage = (volatile int*)(smem_raw + 230096);
    if (warp == 3) {
        int _tmem_hold = smem + 230096;
                ...
                for (int iteration_2 = 0; iteration_2 < 250801; iteration_2++) {
                    ...
                    if (phase_2 != 0) {
                        ...
                        if (owner_mask_17 != 0) {
                            ...
                            unsigned int _min_5 = ((tokens_8 - local_block_1 * 16) < (16) ? (tokens_8 - local_block_1 * 16) : (16));
                        ...
                        if (owner_mask_29 != 0) {
                            ...
                            unsigned int _min_6 = ((tokens_20 - local_block_2 * 16) < (16) ? (tokens_20 - local_block_2 * 16) : (16));
                        ...
                        if (owner_mask_40 != 0) {
                            ...
                            unsigned int _min_7 = ((tokens_31 - local_block_3 * 16) < (16) ? (tokens_31 - local_block_3 * 16) : (16));
                        ...
                        if (owner_mask_51 != 0) {
                            ...
                            unsigned int _min_8 = ((tokens_42 - local_block_4 * 16) < (16) ? (tokens_42 - local_block_4 * 16) : (16));
                        ...
                        if (owner_mask_62 != 0) {
                            ...
                            unsigned int _min_9 = ((tokens_53 - local_block_5 * 16) < (16) ? (tokens_53 - local_block_5 * 16) : (16));
                        ...
                        if (owner_mask_73 != 0) {
                            ...
                            unsigned int _min_10 = ((tokens_64 - local_block_6 * 16) < (16) ? (tokens_64 - local_block_6 * 16) : (16));
                        ...
                        if (owner_mask_84 != 0) {
                            ...
                            unsigned int _min_11 = ((tokens_75 - local_block_7 * 16) < (16) ? (tokens_75 - local_block_7 * 16) : (16));
                        ...
                        if (owner_mask_95 != 0) {
                            ...
                            unsigned int _min_12 = ((tokens_86 - local_block_8 * 16) < (16) ? (tokens_86 - local_block_8 * 16) : (16));
                        ...
                        if (owner_mask_106 != 0) {
                            ...
                            unsigned int _min_13 = ((tokens_97 - local_block_9 * 16) < (16) ? (tokens_97 - local_block_9 * 16) : (16));
                        ...
                        if (owner_mask_117 != 0) {
                            ...
                            unsigned int _min_14 = ((tokens_108 - local_block_10 * 16) < (16) ? (tokens_108 - local_block_10 * 16) : (16));
                        ...
                        if (owner_mask_128 != 0) {
                            ...
                            unsigned int _min_15 = ((tokens_119 - local_block_11 * 16) < (16) ? (tokens_119 - local_block_11 * 16) : (16));
        ...
        { // epilogue_main
                ...
                if (task_4[0] == 1 || task_4[0] == 3) {
                    ...
                    for (int s = 0; s < 1; s++) {
                        ...
                        for (int i = 0; i < 1; i++) {
                            ...
                            if (task_4[0] == 1 && j * 8 % 32 == 0) {
                                if (j * 8 + lane_read_0 < 8) {
                                    cached_weight = L1Weights[ring_block_2 * 16 + epi_wg * 8 + j * 8 + lane_read_0];
                                }
                            }
                            float _shfl_55;
                            ...
                            if (lane_read_0 < 4) {
                                amax_reduction[epi_warp * 8 + (unsigned int)(i * 8) + lane_read_0 * 2] = first_max;
                                amax_reduction[epi_warp * 8 + (unsigned int)(i * 8) + lane_read_0 * 2 + 1] = second_max;
                            }
                            __syncwarp();
                        }
                        ...
                        for (int i_1 = 0; i_1 < 1; i_1++) {
                            unsigned int paired_index = (epi_warp ^ 1) * 8 + (unsigned int)(i_1 * 8) + lane_read_0 % 4 * 2;
                    ...
                    for (int s_1 = 0; s_1 < 1; s_1++) {
                        ...
                        for (int j_1 = 0; j_1 < 1; j_1++) {
                            unsigned int row = epi_wg_1 * 8 + (unsigned int)(s_1 * 8) + (unsigned int)(j_1 * 8) + warp_in_wg_1 * 2 + lane_read_0 / 16;
                            if (row < valid_m_1) {
                                if (task_4[0] == 4) {
                        ...
                        for (int j_2 = 0; j_2 < 1; j_2++) {
                            ...
                            unsigned int read_address = output_base + lane_read_0 % 16 / 8 * 8 * 128 + row_in_store * 128 + (lane_read_0 % 8 ^ row_in_atom) * 16;
                            asm volatile("ld.shared.v4.b32 {%0,%1,%2,%3}, [%4];"
                                ...
                                : "r"(read_address));
                            unsigned long long dst_index = ((unsigned long long)cached_topk[j_2] * 1920 + (unsigned long long)cached_token[j_2]) * 2560 + (unsigned long long)(n_offset_1 / 2) + (unsigned long long)(lane_read_0 % 16 * 4);
            ...
            for (unsigned int token_chunk = epi_warp_2 * 152 + (unsigned int)bid; token_chunk < num_tokens * 2; token_chunk += 1216) {
                ...
                if (mask != 0) {
                    ...
                    if (elect_sync()) {
                        cp_async_bulk_gmem2smem(reusable_addr + (epi_warp_2 + stage * 8) * 5120, reinterpret_cast<const void*>(reinterpret_cast<const uint8_t*>(CombineBytes) + ((unsigned long long)(((unsigned long long)slot_1 * 1920 + (unsigned long long)token_1) * 5120 * 2 + (unsigned long long)(chunk_1 * 5120)) * (unsigned long long)1)), 5120, combine_barriers_addr + (epi_warp_2 * 2 + stage) * 8);
                ...
                if (total_mask != 0) {
                    ...
                    for (unsigned int selection = 0; selection < 7; selection++) {
                        ...
                        if (has_next != 0) {
                            ...
                            if (elect_sync()) {
                                cp_async_bulk_gmem2smem(reusable_addr + (epi_warp_2 + (stage ^ 1) * 8) * 5120, reinterpret_cast<const void*>(reinterpret_cast<const uint8_t*>(CombineBytes) + ((unsigned long long)(((unsigned long long)slot_2 * 1920 + (unsigned long long)token_1) * 5120 * 2 + (unsigned long long)(chunk_1 * 5120)) * (unsigned long long)1)), 5120, combine_barriers_addr + (epi_warp_2 * 2 + (stage ^ 1)) * 8);
