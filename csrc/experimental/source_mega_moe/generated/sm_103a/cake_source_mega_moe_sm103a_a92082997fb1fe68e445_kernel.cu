    ...
    if (warp <= 3) {
        { // dispatch_main
            ...
            if (tid == 0) {
                ...
                asm volatile("atom.release.gpu.global.add.u32 %0, [%1], %2;"
                    : "=r"(_atomic_old_3) : "l"(&GridCounters[0]), "r"(static_cast<uint32_t>(increment_2)) : "memory");
                unsigned int old_3 = _atomic_old_3;
    ...
    // ---- Role: epilogue ----
        ...
        { // epilogue_main
            ...
            if (epi_thread == 0) {
                ...
                asm volatile("atom.release.gpu.global.add.u32 %0, [%1], %2;"
                    : "=r"(_atomic_old_9) : "l"(&GridCounters[1]), "r"(static_cast<uint32_t>(increment_3)) : "memory");
                unsigned int old_4 = _atomic_old_9;
