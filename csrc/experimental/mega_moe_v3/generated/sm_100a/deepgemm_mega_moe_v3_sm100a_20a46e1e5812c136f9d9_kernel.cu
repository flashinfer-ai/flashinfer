...
kernel_deepgemm_mega_moe_v3_sm100a_20a46e1e5812c136f9d9(DeepgemmTensorMap const* A, DeepgemmTensorMap const* B, DeepgemmTensorMap const* SFA, DeepgemmTensorMap const* SFB, __nv_bfloat16* __restrict__ Out, int* __restrict__ tile_expert, int* __restrict__ tile_m_local, int* __restrict__ expert_row_offsets, int M_total, int N, int K, int grid_n, int K_tiles, int total_m_tiles)
{
