                ...
                if (task_4[0] == 1) {
                    ...
                    for (int s = 0; s < 1; s++) {
                        ...
                        for (int i_4 = 0; i_4 < 1; i_4++) {
                            ...
                            float2 _f2_5 = make_float2(activation[i_4 * 4], activation[i_4 * 4 + 1]);
                            float2 _mul_f32x2_6;
                            ...
                            float2 _f2_6 = make_float2(activation[i_4 * 4 + 2], activation[i_4 * 4 + 3]);
                            float2 _mul_f32x2_7;
