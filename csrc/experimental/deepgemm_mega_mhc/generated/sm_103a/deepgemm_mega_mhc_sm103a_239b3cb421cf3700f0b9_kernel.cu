        ...
        if (task_6 < pairs * partitions) {
            ...
            while (1) {
                ...
                if (task_6 < pairs * partitions) {
                    ...
                    unsigned long long target_1 = (launch_epochs[bid] + 1) * 128 + 40;
                    {
                    unsigned long long _acquire_observed;
                    do {
