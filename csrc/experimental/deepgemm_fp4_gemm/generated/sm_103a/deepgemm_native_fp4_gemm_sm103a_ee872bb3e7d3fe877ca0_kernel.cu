    ...
    if (warp == 0) {
        { // load_main
            ...
            for (unsigned int this_bid = bid; this_bid < num_tiles; this_bid += num_bids) {
                ...
                int off_n = bid_n * 224;
                #pragma unroll 1
                for (int iter_k = 0; iter_k < 9; iter_k++) {
        ...
        { // mma_main
            ...
            if (cta_rank == 0) {
                ...
                for (unsigned int this_bid_1 = bid; this_bid_1 < num_tiles_1; this_bid_1 += num_bids) {
                    ...
                    #pragma unroll 1
                    for (int iter_k_1 = 0; iter_k_1 < 9; iter_k_1++) {
