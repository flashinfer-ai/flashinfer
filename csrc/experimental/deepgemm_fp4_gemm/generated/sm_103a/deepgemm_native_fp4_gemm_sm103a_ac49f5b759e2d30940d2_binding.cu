...
// tvm-ffi direct-source launcher for Deepgemm kernel 'kernel_deepgemm_native_fp4_gemm_sm103a_ac49f5b759e2d30940d2'.
#include <cuda.h>
#include <cuda_bf16.h>
#include <cuda_fp16.h>
...
extern "C" __global__ void kernel_deepgemm_native_fp4_gemm_sm103a_ac49f5b759e2d30940d2(const __grid_constant__ CUtensorMap SFA, const __grid_constant__ CUtensorMap SFB, const __grid_constant__ CUtensorMap A, const __grid_constant__ CUtensorMap B, const __grid_constant__ CUtensorMap C_tma, int M, int N, int K, int grid_m, int grid_n, int K_tiles, float alpha);


namespace deepgemm_host_shim_932062f94788f87f {
...
void Run(TensorView arg_SFA, TensorView arg_SFB, TensorView arg_A, TensorView arg_B, TensorView arg_C_tma, int64_t arg_M, int64_t arg_N, int64_t arg_K, int64_t arg_grid_m, int64_t arg_grid_n, int64_t arg_K_tiles, double arg_alpha, int64_t grid_x, int64_t grid_y, int64_t grid_z) {
    ...
    if (it == smem_status_by_device->end()) {
      ...
      if (smem_status == cudaSuccess) {
        smem_status = cudaFuncSetAttribute(
            reinterpret_cast<const void*>(kernel_deepgemm_native_fp4_gemm_sm103a_ac49f5b759e2d30940d2),
  ...
  TVM_FFI_CHECK(smem_status == cudaSuccess, RuntimeError)
      << "cudaFuncSetAttribute for kernel_deepgemm_native_fp4_gemm_sm103a_ac49f5b759e2d30940d2 failed: "
  ...
  cudaError_t launch_status = cudaLaunchKernelExC(
      &config, reinterpret_cast<const void*>(kernel_deepgemm_native_fp4_gemm_sm103a_ac49f5b759e2d30940d2), kargs);
  TVM_FFI_CHECK(launch_status == cudaSuccess, RuntimeError)
      << "cudaLaunchKernelExC for kernel_deepgemm_native_fp4_gemm_sm103a_ac49f5b759e2d30940d2 failed: "
      << cudaGetErrorString(launch_status);
}

}  // namespace deepgemm_host_shim_932062f94788f87f

TVM_FFI_DLL_EXPORT_TYPED_FUNC(run, deepgemm_host_shim_932062f94788f87f::Run);
