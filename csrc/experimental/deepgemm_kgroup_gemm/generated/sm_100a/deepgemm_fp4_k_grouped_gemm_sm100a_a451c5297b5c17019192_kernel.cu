    ...
    if (warp == 0) {
        { // load_main
            ...
            for (unsigned int this_bid = bid; this_bid < num_tiles; this_bid += num_bids) {
                while (this_bid >= (unsigned int)((current_group + 1) * 360)) {
                ...
                int block_idx = this_bid - (unsigned int)(current_group * 360);
        ...
        { // mma_main
            ...
            if (cta_rank == 0) {
                ...
                for (unsigned int this_bid_1 = bid; this_bid_1 < num_tiles_1; this_bid_1 += num_bids) {
                    while (this_bid_1 >= (unsigned int)((current_group_1 + 1) * 360)) {
    ...
    if (warp >= 2 && warp <= 3) {
        { // transpose_main
            ...
            for (unsigned int this_bid_2 = bid; this_bid_2 < num_tiles_2; this_bid_2 += num_bids) {
                while (this_bid_2 >= (unsigned int)((current_group_2 + 1) * 360)) {
    ...
    if (warp >= 4 && warp <= 7) {
        { // epilogue_main
            ...
            for (unsigned int this_bid_3 = bid; this_bid_3 < num_tiles_3; this_bid_3 += num_bids) {
                while (this_bid_3 >= (unsigned int)((current_group_3 + 1) * 360)) {
                ...
                int block_idx_1 = this_bid_3 - (unsigned int)(current_group_3 * 360);
