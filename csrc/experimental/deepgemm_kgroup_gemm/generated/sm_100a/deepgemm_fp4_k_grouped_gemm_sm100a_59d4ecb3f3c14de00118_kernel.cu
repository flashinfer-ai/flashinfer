    ...
    if (warp == 0) {
        { // load_main
            ...
            for (unsigned int this_bid = bid; this_bid < num_tiles; this_bid += num_bids) {
                ...
                int block_idx = this_bid % 360;
                int swizzle_group = block_idx / 144;
                int first_m = swizzle_group * 16;
                int in_group = block_idx % 144;
                int _min_0 = ((16) < (40 - first_m) ? (16) : (40 - first_m));
                int m_blocks = _min_0;
        ...
        { // mma_main
            ...
            if (cta_rank == 0) {
                ...
                for (unsigned int this_bid_1 = bid; this_bid_1 < num_tiles_1; this_bid_1 += num_bids) {
                    int target_group_1 = this_bid_1 / 360;
    ...
    if (warp >= 2 && warp <= 3) {
        { // transpose_main
            ...
            for (unsigned int this_bid_2 = bid; this_bid_2 < num_tiles_2; this_bid_2 += num_bids) {
                int target_group_2 = this_bid_2 / 360;
    ...
    if (warp >= 4 && warp <= 7) {
        { // epilogue_main
            ...
            for (unsigned int this_bid_3 = bid; this_bid_3 < num_tiles_3; this_bid_3 += num_bids) {
                int target_group_3 = this_bid_3 / 360;
                ...
                int block_idx_1 = this_bid_3 % 360;
                int swizzle_group_1 = block_idx_1 / 144;
                int first_m_1 = swizzle_group_1 * 16;
                int in_group_1 = block_idx_1 % 144;
                int _min_1 = ((16) < (40 - first_m_1) ? (16) : (40 - first_m_1));
