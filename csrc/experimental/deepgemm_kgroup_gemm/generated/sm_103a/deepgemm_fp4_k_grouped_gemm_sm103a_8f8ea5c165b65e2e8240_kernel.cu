...
kernel_deepgemm_fp4_k_grouped_gemm_sm103a_8f8ea5c165b65e2e8240(const __grid_constant__ CUtensorMap A, const __grid_constant__ CUtensorMap B, const __grid_constant__ CUtensorMap SFA, const __grid_constant__ CUtensorMap SFB, const __grid_constant__ CUtensorMap C_tma, int* __restrict__ grouped_layout, int M, int N, int K, int grid_m, int grid_n, int num_groups)
{
        ...
        { // epilogue_main
            ...
            for (unsigned int bid_4 = bid; bid_4 < 48; bid_4 += 152) {
                ...
                for (int s = 0; s < 1; s++) {
                    ...
                    if (warp == 4) {
                        if (elect_sync()) {
                            tma_store_3d((&C_tma), off_n_1 + (unsigned int)(s * 16), off_m_1, current_group_3, stage_base);
