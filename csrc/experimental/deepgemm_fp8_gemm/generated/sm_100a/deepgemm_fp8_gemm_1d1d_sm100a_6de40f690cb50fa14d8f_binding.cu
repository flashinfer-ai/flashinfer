...
// tvm-ffi host launcher for Deepgemm kernel 'kernel_deepgemm_fp8_gemm_1d1d_sm100a_6de40f690cb50fa14d8f'.
#include <cuda.h>
...
TVM_FFI_EMBED_CUBIN(deepgemm_fp8_gemm_1d1d_sm100a_6de40f690cb50fa14d8f_sm_100a);
...
void Run(TensorView arg_A, TensorView arg_B, TensorView arg_SFA, TensorView arg_SFB, TensorView arg_C_tma, int64_t arg_M, int64_t arg_N, int64_t arg_K, int64_t arg_grid_m, int64_t arg_grid_n, int64_t arg_K_tiles, int64_t grid_x, int64_t grid_y, int64_t grid_z) {
  ...
  static auto kernel = EmbedCubinModule_deepgemm_fp8_gemm_1d1d_sm100a_6de40f690cb50fa14d8f_sm_100a::Global()->mod.GetKernel("kernel_deepgemm_fp8_gemm_1d1d_sm100a_6de40f690cb50fa14d8f");
