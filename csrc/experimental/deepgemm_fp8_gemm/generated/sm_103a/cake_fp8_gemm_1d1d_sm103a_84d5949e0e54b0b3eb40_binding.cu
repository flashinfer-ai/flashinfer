...
// tvm-ffi host launcher for Cake kernel 'kernel_cake_fp8_gemm_1d1d_sm103a_84d5949e0e54b0b3eb40'.
#include <cuda.h>
...
TVM_FFI_EMBED_CUBIN(cake_fp8_gemm_1d1d_sm103a_84d5949e0e54b0b3eb40_sm_103a);

namespace cake_host_shim_b411527fad58d60c {
...
void Run(TensorView arg_A, TensorView arg_B, TensorView arg_SFA, TensorView arg_SFB, TensorView arg_C_tma, int64_t arg_M, int64_t arg_N, int64_t arg_K, int64_t arg_grid_m, int64_t arg_grid_n, int64_t arg_K_tiles, int64_t grid_x, int64_t grid_y, int64_t grid_z) {
  ...
  static auto kernel = EmbedCubinModule_cake_fp8_gemm_1d1d_sm103a_84d5949e0e54b0b3eb40_sm_103a::Global()->mod.GetKernel("kernel_cake_fp8_gemm_1d1d_sm103a_84d5949e0e54b0b3eb40");
...
TVM_FFI_DLL_EXPORT_TYPED_FUNC(run, cake_host_shim_b411527fad58d60c::Run);
