...
// tvm-ffi host launcher for Deepgemm kernel 'kernel_deepgemm_fp8_gemm_1d1d_sm103a_5bd9da5e12b93a4341c4'.
#include <cuda.h>
...
TVM_FFI_EMBED_CUBIN(deepgemm_fp8_gemm_1d1d_sm103a_5bd9da5e12b93a4341c4_sm_103a);

namespace deepgemm_host_shim_2c72426ae1a3a8f9 {
...
void Run(TensorView arg_A, TensorView arg_B, TensorView arg_SFA, TensorView arg_SFB, TensorView arg_C_tma, int64_t arg_M, int64_t arg_N, int64_t arg_K, int64_t arg_grid_m, int64_t arg_grid_n, int64_t arg_K_tiles, int64_t grid_x, int64_t grid_y, int64_t grid_z) {
  ...
  static auto kernel = EmbedCubinModule_deepgemm_fp8_gemm_1d1d_sm103a_5bd9da5e12b93a4341c4_sm_103a::Global()->mod.GetKernel("kernel_deepgemm_fp8_gemm_1d1d_sm103a_5bd9da5e12b93a4341c4");
...
TVM_FFI_DLL_EXPORT_TYPED_FUNC(run, deepgemm_host_shim_2c72426ae1a3a8f9::Run);
