...
kernel_deepgemm_mixed_fp8_fp4_gemm_sm100a_df4a1220b73a9d9348a3(DeepgemmTensorMap const* SFA, DeepgemmTensorMap const* SFB, DeepgemmTensorMap const* A, DeepgemmTensorMap const* B, DeepgemmTensorMap const* C_tma, int M, int N, int K, int grid_m, int grid_n, int K_tiles)
{
