...
kernel_deepgemm_mixed_fp8_fp4_gemm_sm103a_07ec48f1688bd9f30664(unsigned int* __restrict__ SFA, unsigned int* __restrict__ SFB, DeepgemmTensorMap const* A, DeepgemmTensorMap const* B, DeepgemmTensorMap const* C_tma, int M, int N, int K, int grid_m, int grid_n, int K_tiles)
{
