...
kernel_cake_mixed_fp8_fp4_gemm_sm103a_f7a8370f9078e4614fc7(CakeTensorMap const* SFA, CakeTensorMap const* SFB, CakeTensorMap const* A, CakeTensorMap const* B, CakeTensorMap const* C_tma, int M, int N, int K, int grid_m, int grid_n, int K_tiles)
{
