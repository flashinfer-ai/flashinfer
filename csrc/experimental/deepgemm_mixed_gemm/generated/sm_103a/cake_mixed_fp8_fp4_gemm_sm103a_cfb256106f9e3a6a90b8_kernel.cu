...
kernel_cake_mixed_fp8_fp4_gemm_sm103a_cfb256106f9e3a6a90b8(unsigned int* __restrict__ SFA, unsigned int* __restrict__ SFB, CakeTensorMap const* A, CakeTensorMap const* B, CakeTensorMap const* C_tma, int M, int N, int K, int grid_m, int grid_n, int K_tiles)
{
