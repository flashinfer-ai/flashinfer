...
// tvm-ffi direct-source launcher for Cake kernel 'kernel_cake_mixed_fp8_fp4_gemm_sm103a_f329a333df92b18f38d0'.
#include <cuda.h>
#include <cuda_bf16.h>
#include <cuda_fp16.h>
...
extern "C" __global__ void kernel_cake_mixed_fp8_fp4_gemm_sm103a_f329a333df92b18f38d0(const __grid_constant__ CUtensorMap SFA, const __grid_constant__ CUtensorMap SFB, const __grid_constant__ CUtensorMap A, const __grid_constant__ CUtensorMap B, const __grid_constant__ CUtensorMap C_tma, int M, int N, int K, int grid_m, int grid_n, int K_tiles);


namespace cake_host_shim_e08429169280b799 {
...
void Run(TensorView arg_SFA, TensorView arg_SFB, TensorView arg_A, TensorView arg_B, TensorView arg_C_tma, int64_t arg_M, int64_t arg_N, int64_t arg_K, int64_t arg_grid_m, int64_t arg_grid_n, int64_t arg_K_tiles, int64_t grid_x, int64_t grid_y, int64_t grid_z) {
    ...
    if (it == smem_status_by_device->end()) {
      ...
      if (smem_status == cudaSuccess) {
        smem_status = cudaFuncSetAttribute(
            reinterpret_cast<const void*>(kernel_cake_mixed_fp8_fp4_gemm_sm103a_f329a333df92b18f38d0),
  ...
  TVM_FFI_CHECK(smem_status == cudaSuccess, RuntimeError)
      << "cudaFuncSetAttribute for kernel_cake_mixed_fp8_fp4_gemm_sm103a_f329a333df92b18f38d0 failed: "
  ...
  cudaError_t launch_status = cudaLaunchKernelExC(
      &config, reinterpret_cast<const void*>(kernel_cake_mixed_fp8_fp4_gemm_sm103a_f329a333df92b18f38d0), kargs);
  TVM_FFI_CHECK(launch_status == cudaSuccess, RuntimeError)
      << "cudaLaunchKernelExC for kernel_cake_mixed_fp8_fp4_gemm_sm103a_f329a333df92b18f38d0 failed: "
      << cudaGetErrorString(launch_status);
}

}  // namespace cake_host_shim_e08429169280b799

TVM_FFI_DLL_EXPORT_TYPED_FUNC(run, cake_host_shim_e08429169280b799::Run);
