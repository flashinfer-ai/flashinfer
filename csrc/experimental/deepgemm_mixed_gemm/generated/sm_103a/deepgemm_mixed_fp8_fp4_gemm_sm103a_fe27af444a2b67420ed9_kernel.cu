...
kernel_deepgemm_mixed_fp8_fp4_gemm_sm103a_fe27af444a2b67420ed9(DeepgemmTensorMap const* SFA, DeepgemmTensorMap const* SFB, DeepgemmTensorMap const* A, DeepgemmTensorMap const* B, DeepgemmTensorMap const* C_tma, int M, int N, int K, int grid_m, int grid_n, int K_tiles)
{
