...
// tvm-ffi direct-source launcher for Weave kernel 'kernel_cake_fmha_dcp_spec_bf16_fp8_d256'.
#include <cuda.h>
...
void Run(TensorView arg_Qt, TensorView arg_K, TensorView arg_V, TensorView arg_partial_O_ptr,
  ...
  std::call_once(smem_once, [] {
    smem_status =
        cudaFuncSetAttribute(reinterpret_cast<const void*>(kernel_cake_fmha_dcp_spec_bf16_fp8_d256),
