...
// tvm-ffi direct-source launcher for Cake kernel 'kernel_cake_fmha_dcp_spec_bf16_v4'.
#include <cuda.h>
...
void Run(TensorView arg_Qt, TensorView arg_K, TensorView arg_V, TensorView arg_partial_O_ptr,
  ...
  cudaError_t launch_status =
      cudaLaunchKernel(reinterpret_cast<const void*>(kernel_cake_fmha_dcp_spec_bf16_v4), grid,
