...
__global__ __launch_bounds__(512, 1) void kernel_cake_fmha_dcp_spec_bf16_fp8(
    ...
    int* __restrict__ seq_lens_kv, int* __restrict__ causal_seqlens_kv_global,
...
#pragma unroll 1
        for (int pair_3 = 0; pair_3 < cta_n_blocks_4 / 2 - 1; pair_3++) {
          ...
          {
            const char* _src_ptr =
                smem_raw + (smem_kv_fp8_addr + (unsigned int)(s0_2 * 16384) - smem);
...
#pragma unroll
          ...
          {
            const char* _src_ptr =
                smem_raw + (smem_kv_fp8_addr + (unsigned int)(s0_next_1 * 16384) - smem);
...
#pragma unroll
          ...
          {
            const char* _src_ptr =
                smem_raw + (smem_kv_fp8_addr + (unsigned int)(s1_2 * 16384) - smem);
...
#pragma unroll
          ...
          {
            const char* _src_ptr =
                smem_raw + (smem_kv_fp8_addr + (unsigned int)(s1_next_1 * 16384) - smem);
...
#pragma unroll
        ...
        {
          const char* _src_ptr =
              smem_raw + (smem_kv_fp8_addr + (unsigned int)(s0_last_t * 16384) - smem);
...
#pragma unroll
        ...
        {
          const char* _src_ptr =
              smem_raw + (smem_kv_fp8_addr + (unsigned int)(s1_last_t * 16384) - smem);
