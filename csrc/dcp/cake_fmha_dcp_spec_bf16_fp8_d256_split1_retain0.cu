...
#pragma unroll
          for (int head_lane = 0; head_lane < 8; head_lane++) {
            ...
            if (h_8 < group_ratio_rt) {
              ...
              {
                int o_idx =
                    ((batch_idx_1 * Q_LEN + q_row_idx_1) * NUM_Q_HEADS + q_head_2) * HEAD_DIM +
                    d_idx;
...
#pragma unroll
          for (int head_lane_1 = 0; head_lane_1 < 8; head_lane_1++) {
            ...
            if (h_9 < group_ratio_rt) {
              ...
              {
                int o_idx_1 =
                    ((batch_idx_1 * Q_LEN + q_row_idx_1) * NUM_Q_HEADS + q_head_3) * HEAD_DIM +
                    HEAD_DIM_HALF + d_idx;
                *(reinterpret_cast<__nv_bfloat16*>(O_ptr + o_idx_1) + (0)) =
