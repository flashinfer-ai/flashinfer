                                ...
                                {
                                    {
                                        ...
                                        uint32_t _f16x2_0;
                                        asm volatile("cvt.rn.f16x2.e5m2x2 %0, %1;" : "=r"(_f16x2_0) : "h"(_fp8x2_0));
                                    ...
                                    }
                                    {
                                        ...
                                        uint32_t _f16x2_1;
                                        asm volatile("cvt.rn.f16x2.e5m2x2 %0, %1;" : "=r"(_f16x2_1) : "h"(_fp8x2_1));
                                ...
                                {
                                    {
                                        ...
                                        asm("cvt.rn.satfinite.e5m2x2.f32 %0, 0f00000000, %1;" : "=h"(_fp8_pair) : "f"(_tmem_load_17[state_reg_base_cg1]));
                                    ...
                                    {
                                        unsigned short _fp8_pair;
                                        asm("cvt.rn.satfinite.e5m2x2.f32 %0, 0f00000000, %1;" : "=h"(_fp8_pair) : "f"(_tmem_load_17[state_reg_base_cg1 + 1]));
                                    ...
                                    {
                                        unsigned short _fp8_pair;
                                        asm("cvt.rn.satfinite.e5m2x2.f32 %0, 0f00000000, %1;" : "=h"(_fp8_pair) : "f"(_tmem_load_17[state_reg_base_cg1 + 2]));
                                    ...
                                    {
                                        unsigned short _fp8_pair;
                                        asm("cvt.rn.satfinite.e5m2x2.f32 %0, 0f00000000, %1;" : "=h"(_fp8_pair) : "f"(_tmem_load_17[state_reg_base_cg1 + 3]));
                    ...
                    if (empty_state_warp < 4) {
                        ...
                        for (int empty_col_group = 0; empty_col_group < 8; empty_col_group++) {
                            ...
                            for (int empty_pair = 0; empty_pair < 2; empty_pair++) {
                                {
                                    ...
                                    uint32_t _f16x2_10;
                                    asm volatile("cvt.rn.f16x2.e5m2x2 %0, %1;" : "=r"(_f16x2_10) : "h"(_fp8x2_10));
                                ...
                                }
                                {
                                    ...
                                    uint32_t _f16x2_11;
                                    asm volatile("cvt.rn.f16x2.e5m2x2 %0, %1;" : "=r"(_f16x2_11) : "h"(_fp8x2_11));
                            ...
                            for (int empty_element = 0; empty_element < 4; empty_element++) {
                                {
                                    unsigned short _fp8_pair;
                                    asm("cvt.rn.satfinite.e5m2x2.f32 %0, 0f00000000, %1;" : "=h"(_fp8_pair) : "f"(empty_top_vec[empty_element]));
                                ...
                                {
                                    unsigned short _fp8_pair;
                                    asm("cvt.rn.satfinite.e5m2x2.f32 %0, 0f00000000, %1;" : "=h"(_fp8_pair) : "f"(empty_bot_vec[empty_element]));
