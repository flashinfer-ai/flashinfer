...
// tvm-ffi host launcher for Weave kernel 'kernel_flashinfer_blackwell_gdn_prefill_dvsplit'.
#include <cuda.h>
...
TVM_FFI_DLL_EXPORT_TYPED_FUNC(run_prefill_flashinfer_blackwell_gdn_prefill_dvsplit_8944e8b63ed0, loom_host_shim::Run);
// clang-format on
