...
// tvm-ffi host launcher for Weave kernel 'kernel_flashinfer_blackwell_gdn_prefill_dvsplit_single_chunk'.
#include <cuda.h>
...
TVM_FFI_DLL_EXPORT_TYPED_FUNC(run_prefill_flashinfer_blackwell_gdn_prefill_dvsplit_single_chunk_abf6bf9d1b0a, loom_host_shim::Run);
// clang-format on
