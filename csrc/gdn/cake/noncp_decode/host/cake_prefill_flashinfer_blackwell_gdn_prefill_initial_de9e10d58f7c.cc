...
// tvm-ffi host launcher for Weave kernel 'kernel_flashinfer_blackwell_gdn_prefill_initial'.
#include <cuda.h>
...
TVM_FFI_DLL_EXPORT_TYPED_FUNC(run_prefill_flashinfer_blackwell_gdn_prefill_initial_de9e10d58f7c, loom_host_shim::Run);
// clang-format on
