...
namespace cake_gdn_host_shim_c0e4dc05369302f9 {
...
TVM_FFI_DLL_EXPORT_TYPED_FUNC(run_prefill_flashinfer_blackwell_gdn_prefill_68e76b274180, cake_gdn_host_shim_c0e4dc05369302f9::Run);
// clang-format on
