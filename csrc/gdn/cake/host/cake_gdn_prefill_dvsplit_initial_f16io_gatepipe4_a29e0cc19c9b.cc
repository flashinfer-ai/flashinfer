...
namespace cake_gdn_host_shim_f81b01d52b021777 {
...
TVM_FFI_DLL_EXPORT_TYPED_FUNC(run_prefill_flashinfer_blackwell_gdn_prefill_dvsplit_initial_f16io_gatepipe4_a29e0cc19c9b, cake_gdn_host_shim_f81b01d52b021777::Run);
// clang-format on
