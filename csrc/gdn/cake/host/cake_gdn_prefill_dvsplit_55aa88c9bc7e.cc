...
namespace cake_gdn_host_shim_efb050a12dfcc313 {
...
TVM_FFI_DLL_EXPORT_TYPED_FUNC(run_prefill_flashinfer_blackwell_gdn_prefill_dvsplit_55aa88c9bc7e, cake_gdn_host_shim_efb050a12dfcc313::Run);
// clang-format on
