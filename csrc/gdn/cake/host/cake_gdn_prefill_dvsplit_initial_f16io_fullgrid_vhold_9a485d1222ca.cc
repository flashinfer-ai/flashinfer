...
namespace cake_gdn_host_shim_8d9e8be45734e4c2 {
...
TVM_FFI_DLL_EXPORT_TYPED_FUNC(run_prefill_flashinfer_blackwell_gdn_prefill_dvsplit_initial_f16io_fullgrid_vhold_9a485d1222ca, cake_gdn_host_shim_8d9e8be45734e4c2::Run);
// clang-format on
