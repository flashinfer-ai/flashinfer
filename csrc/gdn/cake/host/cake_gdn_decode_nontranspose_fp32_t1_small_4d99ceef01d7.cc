...
namespace cake_gdn_host_shim_fd89a7b164684101 {
...
TVM_FFI_DLL_EXPORT_TYPED_FUNC(run_decode_gdn_decode_nontranspose_fp32_t1_small_4d99ceef01d7, cake_gdn_host_shim_fd89a7b164684101::Run);
// clang-format on
