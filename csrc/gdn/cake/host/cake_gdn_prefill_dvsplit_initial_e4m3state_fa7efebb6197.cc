...
namespace cake_gdn_host_shim_7bd982240b1b7043 {
...
TVM_FFI_DLL_EXPORT_TYPED_FUNC(run_prefill_flashinfer_blackwell_gdn_prefill_dvsplit_initial_e4m3state_fa7efebb6197, cake_gdn_host_shim_7bd982240b1b7043::Run);
// clang-format on
