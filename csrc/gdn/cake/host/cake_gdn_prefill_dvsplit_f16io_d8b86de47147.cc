...
namespace cake_gdn_host_shim_47d8f2ea58a532da {
...
TVM_FFI_DLL_EXPORT_TYPED_FUNC(run_prefill_flashinfer_blackwell_gdn_prefill_dvsplit_f16io_d8b86de47147, cake_gdn_host_shim_47d8f2ea58a532da::Run);
// clang-format on
