...
namespace cake_gdn_host_shim_80dd163dc0023e4d {
...
TVM_FFI_DLL_EXPORT_TYPED_FUNC(run_prefill_flashinfer_blackwell_gdn_prefill_initial_f16io_72bcb63ae70f, cake_gdn_host_shim_80dd163dc0023e4d::Run);
// clang-format on
