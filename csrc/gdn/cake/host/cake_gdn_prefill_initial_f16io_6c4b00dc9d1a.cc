...
namespace cake_gdn_host_shim_6db93649602cd057 {
...
TVM_FFI_DLL_EXPORT_TYPED_FUNC(run_prefill_flashinfer_blackwell_gdn_prefill_initial_f16io_6c4b00dc9d1a, cake_gdn_host_shim_6db93649602cd057::Run);
// clang-format on
