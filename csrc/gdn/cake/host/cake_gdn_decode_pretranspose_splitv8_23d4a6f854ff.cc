...
namespace cake_gdn_host_shim_8df241250bd78f2e {
...
TVM_FFI_DLL_EXPORT_TYPED_FUNC(run_decode_gdn_decode_pretranspose_splitv8_23d4a6f854ff, cake_gdn_host_shim_8df241250bd78f2e::Run);
// clang-format on
