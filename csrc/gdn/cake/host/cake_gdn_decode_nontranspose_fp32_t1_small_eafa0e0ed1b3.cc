...
namespace cake_gdn_host_shim_cd3a59049547a208 {
...
TVM_FFI_DLL_EXPORT_TYPED_FUNC(run_decode_gdn_decode_nontranspose_fp32_t1_small_eafa0e0ed1b3, cake_gdn_host_shim_cd3a59049547a208::Run);
// clang-format on
