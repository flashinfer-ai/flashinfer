...
kernel_flashinfer_blackwell_gdn_cp_prefill_state_scatter_bf16_v1(float* __restrict__ packed, int* __restrict__ state_indices, __nv_bfloat16* __restrict__ output, long long pool_stride0, long long pool_stride1, long long pool_stride2, long long pool_stride3, int num_heads, long long total_values, int use_indices)
{
