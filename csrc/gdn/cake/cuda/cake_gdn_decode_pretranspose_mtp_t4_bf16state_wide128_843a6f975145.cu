...
#define CACHE_INTERMEDIATE_STATES 0
#define INTERMEDIATE_BATCH_STRIDE 16384
#define INTERMEDIATE_TOKEN_STRIDE 16384
...
kernel_gdn_decode_pretranspose_mtp_t4_bf16state_wide128(__nv_bfloat16* __restrict__ q, __nv_bfloat16* __restrict__ k, __nv_bfloat16* __restrict__ v, __nv_bfloat16* __restrict__ state, float* __restrict__ A_log, __nv_bfloat16* __restrict__ a, float* __restrict__ dt_bias, __nv_bfloat16* __restrict__ b, __nv_bfloat16* __restrict__ out, __nv_bfloat16* __restrict__ intermediate_state, int* __restrict__ initial_state_indices, int* __restrict__ output_state_indices, long long state_size_p0, long long state_stride_p0, long long q_stride_p0, long long q_stride_p1, long long q_stride_p2, long long k_stride_p0, long long k_stride_p1, long long k_stride_p2, long long a_stride_p0, long long a_stride_p1, long long a_stride_p2, long long b_stride_p0, long long b_stride_p1, long long b_stride_p2, long long v_stride_p0, long long v_stride_p1, long long v_stride_p2)
{
    ...
    int t_pre = t_pre_raw;
    {
        t_pre = ((t_pre_raw < T_STEPS) ? t_pre_raw : 0);
    }
    {
    ...
    for (int iter_idx = 0; iter_idx < iters_per_group; iter_idx++) {
        ...
        for (int t = 0; t < T_STEPS; t++) {
            ...
            float2 _mul_f32x2_9;
            asm("mul.rn.ftz.f32x2 %0, %1, %2;" : "=l"(*(unsigned long long*)&_mul_f32x2_9) : "l"(*(const unsigned long long*)&h_a_pair1), "l"(*(const unsigned long long*)&decay_pair));
            h_a_pair1 = _mul_f32x2_9;
            float2 _mul_f32x2_10;
            asm("mul.rn.ftz.f32x2 %0, %1, %2;" : "=l"(*(unsigned long long*)&_mul_f32x2_10) : "l"(*(const unsigned long long*)&h_a_pair2), "l"(*(const unsigned long long*)&decay_pair));
            h_a_pair2 = _mul_f32x2_10;
            float2 _mul_f32x2_11;
            asm("mul.rn.ftz.f32x2 %0, %1, %2;" : "=l"(*(unsigned long long*)&_mul_f32x2_11) : "l"(*(const unsigned long long*)&h_a_pair3), "l"(*(const unsigned long long*)&decay_pair));
            h_a_pair3 = _mul_f32x2_11;
            float2 _mul_f32x2_12;
            asm("mul.rn.ftz.f32x2 %0, %1, %2;" : "=l"(*(unsigned long long*)&_mul_f32x2_12) : "l"(*(const unsigned long long*)&h_b_pair0), "l"(*(const unsigned long long*)&decay_pair));
            h_b_pair0 = _mul_f32x2_12;
            float2 _mul_f32x2_13;
            asm("mul.rn.ftz.f32x2 %0, %1, %2;" : "=l"(*(unsigned long long*)&_mul_f32x2_13) : "l"(*(const unsigned long long*)&h_b_pair1), "l"(*(const unsigned long long*)&decay_pair));
            h_b_pair1 = _mul_f32x2_13;
            float2 _mul_f32x2_14;
            asm("mul.rn.ftz.f32x2 %0, %1, %2;" : "=l"(*(unsigned long long*)&_mul_f32x2_14) : "l"(*(const unsigned long long*)&h_b_pair2), "l"(*(const unsigned long long*)&decay_pair));
            h_b_pair2 = _mul_f32x2_14;
            float2 _mul_f32x2_15;
            asm("mul.rn.ftz.f32x2 %0, %1, %2;" : "=l"(*(unsigned long long*)&_mul_f32x2_15) : "l"(*(const unsigned long long*)&h_b_pair3), "l"(*(const unsigned long long*)&decay_pair));
            h_b_pair3 = _mul_f32x2_15;
            float2 _mul_f32x2_16;
            asm("mul.rn.ftz.f32x2 %0, %1, %2;" : "=l"(*(unsigned long long*)&_mul_f32x2_16) : "l"(*(const unsigned long long*)&h_c_pair0), "l"(*(const unsigned long long*)&decay_pair));
            h_c_pair0 = _mul_f32x2_16;
            float2 _mul_f32x2_17;
            asm("mul.rn.ftz.f32x2 %0, %1, %2;" : "=l"(*(unsigned long long*)&_mul_f32x2_17) : "l"(*(const unsigned long long*)&h_c_pair1), "l"(*(const unsigned long long*)&decay_pair));
            h_c_pair1 = _mul_f32x2_17;
            float2 _mul_f32x2_18;
            asm("mul.rn.ftz.f32x2 %0, %1, %2;" : "=l"(*(unsigned long long*)&_mul_f32x2_18) : "l"(*(const unsigned long long*)&h_c_pair2), "l"(*(const unsigned long long*)&decay_pair));
            h_c_pair2 = _mul_f32x2_18;
            float2 _mul_f32x2_19;
            asm("mul.rn.ftz.f32x2 %0, %1, %2;" : "=l"(*(unsigned long long*)&_mul_f32x2_19) : "l"(*(const unsigned long long*)&h_c_pair3), "l"(*(const unsigned long long*)&decay_pair));
            h_c_pair3 = _mul_f32x2_19;
            float2 _mul_f32x2_20;
            asm("mul.rn.ftz.f32x2 %0, %1, %2;" : "=l"(*(unsigned long long*)&_mul_f32x2_20) : "l"(*(const unsigned long long*)&h_d_pair0), "l"(*(const unsigned long long*)&decay_pair));
            h_d_pair0 = _mul_f32x2_20;
            float2 _mul_f32x2_21;
            asm("mul.rn.ftz.f32x2 %0, %1, %2;" : "=l"(*(unsigned long long*)&_mul_f32x2_21) : "l"(*(const unsigned long long*)&h_d_pair1), "l"(*(const unsigned long long*)&decay_pair));
            h_d_pair1 = _mul_f32x2_21;
            float2 _mul_f32x2_22;
            asm("mul.rn.ftz.f32x2 %0, %1, %2;" : "=l"(*(unsigned long long*)&_mul_f32x2_22) : "l"(*(const unsigned long long*)&h_d_pair2), "l"(*(const unsigned long long*)&decay_pair));
            ...
            float2 sum_hk_a_pair = fma_f32x2_rn_ftz(h_a_pair0, k_pair0_4, _f2_37);
            sum_hk_a_pair = fma_f32x2_rn_ftz(h_a_pair1, k_pair1_5, sum_hk_a_pair);
            sum_hk_a_pair = fma_f32x2_rn_ftz(h_a_pair2, k_pair2_6, sum_hk_a_pair);
            sum_hk_a_pair = fma_f32x2_rn_ftz(h_a_pair3, k_pair3_7, sum_hk_a_pair);
            float2 _f2_38 = make_float2(0.0f, 0.0f);
            float2 sum_hk_b_pair = fma_f32x2_rn_ftz(h_b_pair0, k_pair0_4, _f2_38);
            sum_hk_b_pair = fma_f32x2_rn_ftz(h_b_pair1, k_pair1_5, sum_hk_b_pair);
            sum_hk_b_pair = fma_f32x2_rn_ftz(h_b_pair2, k_pair2_6, sum_hk_b_pair);
            sum_hk_b_pair = fma_f32x2_rn_ftz(h_b_pair3, k_pair3_7, sum_hk_b_pair);
            float2 _f2_39 = make_float2(0.0f, 0.0f);
            float2 sum_hk_c_pair = fma_f32x2_rn_ftz(h_c_pair0, k_pair0_4, _f2_39);
            sum_hk_c_pair = fma_f32x2_rn_ftz(h_c_pair1, k_pair1_5, sum_hk_c_pair);
            sum_hk_c_pair = fma_f32x2_rn_ftz(h_c_pair2, k_pair2_6, sum_hk_c_pair);
            sum_hk_c_pair = fma_f32x2_rn_ftz(h_c_pair3, k_pair3_7, sum_hk_c_pair);
            float2 _f2_40 = make_float2(0.0f, 0.0f);
            float2 sum_hk_d_pair = fma_f32x2_rn_ftz(h_d_pair0, k_pair0_4, _f2_40);
            sum_hk_d_pair = fma_f32x2_rn_ftz(h_d_pair1, k_pair1_5, sum_hk_d_pair);
            sum_hk_d_pair = fma_f32x2_rn_ftz(h_d_pair2, k_pair2_6, sum_hk_d_pair);
            sum_hk_d_pair = fma_f32x2_rn_ftz(h_d_pair3, k_pair3_7, sum_hk_d_pair);
            ...
            h_a_pair0 = fma_f32x2_rn_ftz(k_pair0_4, v_new_a_pair, h_a_pair0);
            h_a_pair1 = fma_f32x2_rn_ftz(k_pair1_5, v_new_a_pair, h_a_pair1);
            h_a_pair2 = fma_f32x2_rn_ftz(k_pair2_6, v_new_a_pair, h_a_pair2);
            h_a_pair3 = fma_f32x2_rn_ftz(k_pair3_7, v_new_a_pair, h_a_pair3);
            h_b_pair0 = fma_f32x2_rn_ftz(k_pair0_4, v_new_b_pair, h_b_pair0);
            h_b_pair1 = fma_f32x2_rn_ftz(k_pair1_5, v_new_b_pair, h_b_pair1);
            h_b_pair2 = fma_f32x2_rn_ftz(k_pair2_6, v_new_b_pair, h_b_pair2);
            h_b_pair3 = fma_f32x2_rn_ftz(k_pair3_7, v_new_b_pair, h_b_pair3);
            h_c_pair0 = fma_f32x2_rn_ftz(k_pair0_4, v_new_c_pair, h_c_pair0);
            h_c_pair1 = fma_f32x2_rn_ftz(k_pair1_5, v_new_c_pair, h_c_pair1);
            h_c_pair2 = fma_f32x2_rn_ftz(k_pair2_6, v_new_c_pair, h_c_pair2);
            h_c_pair3 = fma_f32x2_rn_ftz(k_pair3_7, v_new_c_pair, h_c_pair3);
            h_d_pair0 = fma_f32x2_rn_ftz(k_pair0_4, v_new_d_pair, h_d_pair0);
            h_d_pair1 = fma_f32x2_rn_ftz(k_pair1_5, v_new_d_pair, h_d_pair1);
            h_d_pair2 = fma_f32x2_rn_ftz(k_pair2_6, v_new_d_pair, h_d_pair2);
            h_d_pair3 = fma_f32x2_rn_ftz(k_pair3_7, v_new_d_pair, h_d_pair3);
            float2 _f2_45 = make_float2(0.0f, 0.0f);
            float2 sum_hq_a_pair = fma_f32x2_rn_ftz(h_a_pair0, q_pair0_0, _f2_45);
            sum_hq_a_pair = fma_f32x2_rn_ftz(h_a_pair1, q_pair1_1, sum_hq_a_pair);
            sum_hq_a_pair = fma_f32x2_rn_ftz(h_a_pair2, q_pair2_2, sum_hq_a_pair);
            sum_hq_a_pair = fma_f32x2_rn_ftz(h_a_pair3, q_pair3_3, sum_hq_a_pair);
            float2 _f2_46 = make_float2(0.0f, 0.0f);
            float2 sum_hq_b_pair = fma_f32x2_rn_ftz(h_b_pair0, q_pair0_0, _f2_46);
            sum_hq_b_pair = fma_f32x2_rn_ftz(h_b_pair1, q_pair1_1, sum_hq_b_pair);
            sum_hq_b_pair = fma_f32x2_rn_ftz(h_b_pair2, q_pair2_2, sum_hq_b_pair);
            sum_hq_b_pair = fma_f32x2_rn_ftz(h_b_pair3, q_pair3_3, sum_hq_b_pair);
            float2 _f2_47 = make_float2(0.0f, 0.0f);
            float2 sum_hq_c_pair = fma_f32x2_rn_ftz(h_c_pair0, q_pair0_0, _f2_47);
            sum_hq_c_pair = fma_f32x2_rn_ftz(h_c_pair1, q_pair1_1, sum_hq_c_pair);
            sum_hq_c_pair = fma_f32x2_rn_ftz(h_c_pair2, q_pair2_2, sum_hq_c_pair);
            sum_hq_c_pair = fma_f32x2_rn_ftz(h_c_pair3, q_pair3_3, sum_hq_c_pair);
            float2 _f2_48 = make_float2(0.0f, 0.0f);
            float2 sum_hq_d_pair = fma_f32x2_rn_ftz(h_d_pair0, q_pair0_0, _f2_48);
            sum_hq_d_pair = fma_f32x2_rn_ftz(h_d_pair1, q_pair1_1, sum_hq_d_pair);
            sum_hq_d_pair = fma_f32x2_rn_ftz(h_d_pair2, q_pair2_2, sum_hq_d_pair);
            sum_hq_d_pair = fma_f32x2_rn_ftz(h_d_pair3, q_pair3_3, sum_hq_d_pair);
            ...
            if (read_state_slot_valid != 0 && write_state_slot_valid != 0) {
                {
                    ...
                    *reinterpret_cast<uint4*>(&((__nv_bfloat16*)(state))[write_state_head_base + (long long)(v_row_a * 128) + (long long)k_start + 0]) = *reinterpret_cast<uint4*>(&_pk[0]);
                }
            }
            r_h[0] = h_b_pair0.x;
            r_h[1] = h_b_pair0.y;
            ...
            if (read_state_slot_valid != 0 && write_state_slot_valid != 0) {
                {
                    ...
                    _pk[2] = __floats2bfloat162_rn(r_h[0 + 4], r_h[0 + 5]);
                    _pk[3] = __floats2bfloat162_rn(r_h[0 + 6], r_h[0 + 7]);
                    *reinterpret_cast<uint4*>(&((__nv_bfloat16*)(state))[write_state_head_base + (long long)(v_row_b * 128) + (long long)k_start + 0]) = *reinterpret_cast<uint4*>(&_pk[0]);
                }
            }
            r_h[0] = h_c_pair0.x;
            r_h[1] = h_c_pair0.y;
            ...
            if (read_state_slot_valid != 0 && write_state_slot_valid != 0) {
                {
                    ...
                    _pk[2] = __floats2bfloat162_rn(r_h[0 + 4], r_h[0 + 5]);
                    _pk[3] = __floats2bfloat162_rn(r_h[0 + 6], r_h[0 + 7]);
                    *reinterpret_cast<uint4*>(&((__nv_bfloat16*)(state))[write_state_head_base + (long long)(v_row_c * 128) + (long long)k_start + 0]) = *reinterpret_cast<uint4*>(&_pk[0]);
                }
            }
            r_h[0] = h_d_pair0.x;
            r_h[1] = h_d_pair0.y;
            ...
            if (read_state_slot_valid != 0 && write_state_slot_valid != 0) {
                {
                    ...
                    _pk[2] = __floats2bfloat162_rn(r_h[0 + 4], r_h[0 + 5]);
                    _pk[3] = __floats2bfloat162_rn(r_h[0 + 6], r_h[0 + 7]);
                    *reinterpret_cast<uint4*>(&((__nv_bfloat16*)(state))[write_state_head_base + (long long)(v_row_d * 128) + (long long)k_start + 0]) = *reinterpret_cast<uint4*>(&_pk[0]);
                }
            }
        }
    }
