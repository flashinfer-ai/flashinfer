...
#define SMEM_SQ_STRIDE 4352
#define SMEM_SK_OFF 4352
#define SMEM_SK_STAGE_BYTES 4352
#define SMEM_SK_STRIDE 4352
...
#define HV 16
#define T_STEPS 7
#define INTERMEDIATE_BATCH_STRIDE 1835008
...
kernel_gdn_decode_pretranspose_t4_bf16state_tile16(__nv_bfloat16* __restrict__ q, __nv_bfloat16* __restrict__ k, __nv_bfloat16* __restrict__ v, __nv_bfloat16* __restrict__ state, float* __restrict__ A_log, __nv_bfloat16* __restrict__ a, float* __restrict__ dt_bias, __nv_bfloat16* __restrict__ b, __nv_bfloat16* __restrict__ out, __nv_bfloat16* __restrict__ intermediate_state, int* __restrict__ initial_state_indices, int* __restrict__ output_state_indices, long long state_size_p0, long long state_stride_p0, long long q_stride_p0, long long q_stride_p1, long long q_stride_p2, long long k_stride_p0, long long k_stride_p1, long long k_stride_p2, long long a_stride_p0, long long a_stride_p1, long long a_stride_p2, long long b_stride_p0, long long b_stride_p1, long long b_stride_p2, long long v_stride_p0, long long v_stride_p1, long long v_stride_p2)
{
    ...
    for (int t_round = 0; t_round < T_STEPS; t_round += 4) {
        ...
        float2 _mul_f32x2_0;
        asm("mul.rn.ftz.f32x2 %0, %1, %2;" : "=l"(*(unsigned long long*)&_mul_f32x2_0) : "l"(*(const unsigned long long*)&q_raw_pair0), "l"(*(const unsigned long long*)&_f2_6));
        float2 q_pair0 = _mul_f32x2_0;
        float2 _f2_7 = make_float2(q_norm, q_norm);
        float2 _mul_f32x2_1;
        asm("mul.rn.ftz.f32x2 %0, %1, %2;" : "=l"(*(unsigned long long*)&_mul_f32x2_1) : "l"(*(const unsigned long long*)&q_raw_pair1), "l"(*(const unsigned long long*)&_f2_7));
        float2 q_pair1 = _mul_f32x2_1;
        float2 _f2_8 = make_float2(k_norm, k_norm);
        float2 _mul_f32x2_2;
        asm("mul.rn.ftz.f32x2 %0, %1, %2;" : "=l"(*(unsigned long long*)&_mul_f32x2_2) : "l"(*(const unsigned long long*)&k_raw_pair0), "l"(*(const unsigned long long*)&_f2_8));
        float2 k_pair0 = _mul_f32x2_2;
        float2 _f2_9 = make_float2(k_norm, k_norm);
        float2 _mul_f32x2_3;
        asm("mul.rn.ftz.f32x2 %0, %1, %2;" : "=l"(*(unsigned long long*)&_mul_f32x2_3) : "l"(*(const unsigned long long*)&k_raw_pair1), "l"(*(const unsigned long long*)&_f2_9));
        float2 k_pair1 = _mul_f32x2_3;
        sQ[t_pre_raw * 136 + qk_smem_col] = q_pair0.x;
        sQ[t_pre_raw * 136 + qk_smem_col + 1] = q_pair0.y;
        sQ[t_pre_raw * 136 + qk_smem_col + 2] = q_pair1.x;
        sQ[t_pre_raw * 136 + qk_smem_col + 3] = q_pair1.y;
        sK[t_pre_raw * 136 + qk_smem_col] = k_pair0.x;
        sK[t_pre_raw * 136 + qk_smem_col + 1] = k_pair0.y;
        sK[t_pre_raw * 136 + qk_smem_col + 2] = k_pair1.x;
        sK[t_pre_raw * 136 + qk_smem_col + 3] = k_pair1.y;
        float x = 0.0f;
    ...
    for (int t = 0; t < T_STEPS; t++) {
        ...
        float2 _mul_f32x2_4;
        asm("mul.rn.ftz.f32x2 %0, %1, %2;" : "=l"(*(unsigned long long*)&_mul_f32x2_4) : "l"(*(const unsigned long long*)&h_a_pair0), "l"(*(const unsigned long long*)&decay_pair));
        h_a_pair0 = _mul_f32x2_4;
        float2 _mul_f32x2_5;
        asm("mul.rn.ftz.f32x2 %0, %1, %2;" : "=l"(*(unsigned long long*)&_mul_f32x2_5) : "l"(*(const unsigned long long*)&h_a_pair1), "l"(*(const unsigned long long*)&decay_pair));
        h_a_pair1 = _mul_f32x2_5;
        float2 _mul_f32x2_6;
        asm("mul.rn.ftz.f32x2 %0, %1, %2;" : "=l"(*(unsigned long long*)&_mul_f32x2_6) : "l"(*(const unsigned long long*)&h_b_pair0), "l"(*(const unsigned long long*)&decay_pair));
        h_b_pair0 = _mul_f32x2_6;
        float2 _mul_f32x2_7;
        asm("mul.rn.ftz.f32x2 %0, %1, %2;" : "=l"(*(unsigned long long*)&_mul_f32x2_7) : "l"(*(const unsigned long long*)&h_b_pair1), "l"(*(const unsigned long long*)&decay_pair));
        h_b_pair1 = _mul_f32x2_7;
        float2 _mul_f32x2_8;
        asm("mul.rn.ftz.f32x2 %0, %1, %2;" : "=l"(*(unsigned long long*)&_mul_f32x2_8) : "l"(*(const unsigned long long*)&h_c_pair0), "l"(*(const unsigned long long*)&decay_pair));
        h_c_pair0 = _mul_f32x2_8;
        float2 _mul_f32x2_9;
        asm("mul.rn.ftz.f32x2 %0, %1, %2;" : "=l"(*(unsigned long long*)&_mul_f32x2_9) : "l"(*(const unsigned long long*)&h_c_pair1), "l"(*(const unsigned long long*)&decay_pair));
        h_c_pair1 = _mul_f32x2_9;
        float2 _mul_f32x2_10;
        asm("mul.rn.ftz.f32x2 %0, %1, %2;" : "=l"(*(unsigned long long*)&_mul_f32x2_10) : "l"(*(const unsigned long long*)&h_d_pair0), "l"(*(const unsigned long long*)&decay_pair));
        h_d_pair0 = _mul_f32x2_10;
        float2 _mul_f32x2_11;
        asm("mul.rn.ftz.f32x2 %0, %1, %2;" : "=l"(*(unsigned long long*)&_mul_f32x2_11) : "l"(*(const unsigned long long*)&h_d_pair1), "l"(*(const unsigned long long*)&decay_pair));
        h_d_pair1 = _mul_f32x2_11;
        float2 _f2_23 = make_float2(0.0f, 0.0f);
        float2 sum_hk_a_pair = fma_f32x2_rn_ftz(h_a_pair0, _f2_20, _f2_23);
        sum_hk_a_pair = fma_f32x2_rn_ftz(h_a_pair1, _f2_21, sum_hk_a_pair);
        float2 _f2_24 = make_float2(0.0f, 0.0f);
        float2 sum_hk_b_pair = fma_f32x2_rn_ftz(h_b_pair0, _f2_20, _f2_24);
        sum_hk_b_pair = fma_f32x2_rn_ftz(h_b_pair1, _f2_21, sum_hk_b_pair);
        float2 _f2_25 = make_float2(0.0f, 0.0f);
        float2 sum_hk_c_pair = fma_f32x2_rn_ftz(h_c_pair0, _f2_20, _f2_25);
        sum_hk_c_pair = fma_f32x2_rn_ftz(h_c_pair1, _f2_21, sum_hk_c_pair);
        float2 _f2_26 = make_float2(0.0f, 0.0f);
        float2 sum_hk_d_pair = fma_f32x2_rn_ftz(h_d_pair0, _f2_20, _f2_26);
        sum_hk_d_pair = fma_f32x2_rn_ftz(h_d_pair1, _f2_21, sum_hk_d_pair);
        ...
        h_a_pair0 = fma_f32x2_rn_ftz(_f2_20, _f2_27, h_a_pair0);
        float2 _f2_28 = make_float2(v_new_a, v_new_a);
        h_a_pair1 = fma_f32x2_rn_ftz(_f2_21, _f2_28, h_a_pair1);
        float2 _f2_29 = make_float2(v_new_b, v_new_b);
        h_b_pair0 = fma_f32x2_rn_ftz(_f2_20, _f2_29, h_b_pair0);
        float2 _f2_30 = make_float2(v_new_b, v_new_b);
        h_b_pair1 = fma_f32x2_rn_ftz(_f2_21, _f2_30, h_b_pair1);
        float2 _f2_31 = make_float2(v_new_c, v_new_c);
        h_c_pair0 = fma_f32x2_rn_ftz(_f2_20, _f2_31, h_c_pair0);
        float2 _f2_32 = make_float2(v_new_c, v_new_c);
        h_c_pair1 = fma_f32x2_rn_ftz(_f2_21, _f2_32, h_c_pair1);
        float2 _f2_33 = make_float2(v_new_d, v_new_d);
        h_d_pair0 = fma_f32x2_rn_ftz(_f2_20, _f2_33, h_d_pair0);
        float2 _f2_34 = make_float2(v_new_d, v_new_d);
        h_d_pair1 = fma_f32x2_rn_ftz(_f2_21, _f2_34, h_d_pair1);
        ...
        float2 sum_hq_a_pair = fma_f32x2_rn_ftz(h_a_pair0, _f2_18, _f2_35);
        sum_hq_a_pair = fma_f32x2_rn_ftz(h_a_pair1, _f2_19, sum_hq_a_pair);
        float2 _f2_36 = make_float2(0.0f, 0.0f);
        float2 sum_hq_b_pair = fma_f32x2_rn_ftz(h_b_pair0, _f2_18, _f2_36);
        sum_hq_b_pair = fma_f32x2_rn_ftz(h_b_pair1, _f2_19, sum_hq_b_pair);
        float2 _f2_37 = make_float2(0.0f, 0.0f);
        float2 sum_hq_c_pair = fma_f32x2_rn_ftz(h_c_pair0, _f2_18, _f2_37);
        sum_hq_c_pair = fma_f32x2_rn_ftz(h_c_pair1, _f2_19, sum_hq_c_pair);
        float2 _f2_38 = make_float2(0.0f, 0.0f);
        float2 sum_hq_d_pair = fma_f32x2_rn_ftz(h_d_pair0, _f2_18, _f2_38);
        sum_hq_d_pair = fma_f32x2_rn_ftz(h_d_pair1, _f2_19, sum_hq_d_pair);
        ...
        if (lane_local == 0) {
            if (read_state_slot_valid != 0) {
                ...
                r_o[3] = sum_hq_d;
                {
                    ...
                    *reinterpret_cast<uint2*>(&((__nv_bfloat16*)(out))[((n * T_STEPS + t) * HV + h) * 128 + v_row_a]) = _pk2;
                }
            }
        }
    }
