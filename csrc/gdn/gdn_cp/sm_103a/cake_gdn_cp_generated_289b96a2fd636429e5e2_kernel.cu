...
kernel_cake_gdn_cp_289b96a2fd636429e5e2(CakeTensorMap const* local_transfer, CakeTensorMap const* local_state, float* __restrict__ initial_state, float* __restrict__ initial_state_workspace, float* __restrict__ fixed_state, float* __restrict__ output_state, long long* __restrict__ cu_seqlens, int chunk_len, int total_cp_chunks, int num_seqs, int num_heads)
{
    ...
    // Mbarrier init (8 pipeline groups, 0 ordered-sequence groups, 10 barriers)
    ...
    if (warp <= 3) {
        ...
        { // compute_main
            ...
            if (active) {
                ...
                int local_row = (unsigned int)(warp_in_wg * 16) + (lane & 15);
                ...
                int local_row_1 = (unsigned int)(warp_in_wg * 16) + (lane & 15);
                ...
                for (int chunk_idx = 0; chunk_idx < num_chunks; chunk_idx++) {
                    ...
                    int local_row_2 = (unsigned int)(warp_in_wg * 16) + (lane & 15);
                    ...
                    if (chunk_idx == num_chunks - 1) {
                        ...
                        int local_row_3 = (unsigned int)(warp_in_wg * 16) + (lane & 15);
                        ...
                        int local_row_3_1 = (unsigned int)(warp_in_wg * 16) + (lane & 15);
