...
// tvm-ffi direct-source launcher for Cake kernel 'kernel_cake_gdn_cp_d469dc884c6b59ee6287'.
#include <cuda.h>
#include <cuda_bf16.h>
#include <cuda_fp16.h>
...
extern "C" __global__ void kernel_cake_gdn_cp_d469dc884c6b59ee6287(const __grid_constant__ CUtensorMap K, float* __restrict__ beta, __half* __restrict__ t, long long* __restrict__ cu_seqlens, int num_k_heads, int num_sab_heads, int total_t_blocks, int num_seqs);


namespace cake_host_shim_5968d22ddb46b862 {
...
void Run(TensorView arg_K, TensorView arg_beta, TensorView arg_t, TensorView arg_cu_seqlens, int64_t arg_num_k_heads, int64_t arg_num_sab_heads, int64_t arg_total_t_blocks, int64_t arg_num_seqs, int64_t grid_x, int64_t grid_y, int64_t grid_z) {
  ...
  __half* p_t = static_cast<__half*>(arg_t.data_ptr());
  ...
  cudaError_t launch_status = cudaLaunchKernelExC(
      &config, reinterpret_cast<const void*>(kernel_cake_gdn_cp_d469dc884c6b59ee6287), kargs);
  TVM_FFI_CHECK(launch_status == cudaSuccess, RuntimeError)
      << "cudaLaunchKernelExC for kernel_cake_gdn_cp_d469dc884c6b59ee6287 failed: "
      << cudaGetErrorString(launch_status);
}

}  // namespace cake_host_shim_5968d22ddb46b862

TVM_FFI_DLL_EXPORT_TYPED_FUNC(run, cake_host_shim_5968d22ddb46b862::Run);
