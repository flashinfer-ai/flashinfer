...
kernel_flashinfer_blackwell_gdn_cp_prefill_t_precompute_v1_gb300_hv48_min6(const __grid_constant__ CUtensorMap K, float* __restrict__ beta, __half* __restrict__ t, long long* __restrict__ cu_seqlens, int num_k_heads, int num_sab_heads, int total_t_blocks, int num_seqs)
{
