...
kernel_flashinfer_blackwell_gdn_cp_prefill_state_scatter_fp32_int64_v1(float* __restrict__ packed, long long* __restrict__ state_indices, float* __restrict__ output, long long pool_stride0, long long pool_stride1, long long pool_stride2, long long pool_stride3, int num_heads, long long total_values, int use_indices)
{
