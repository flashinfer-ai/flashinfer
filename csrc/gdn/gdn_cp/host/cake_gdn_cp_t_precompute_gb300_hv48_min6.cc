...
TVM_FFI_EMBED_CUBIN(flashinfer_blackwell_gdn_cp_prefill_t_precompute_v1_gb300_hv48_min6_6ea8bfdf97);

namespace gdn_cp_host_shim_6a9bc049715825a1 {
...
void Run(TensorView arg_K, TensorView arg_beta, TensorView arg_t, TensorView arg_cu_seqlens, int64_t arg_num_k_heads, int64_t arg_num_sab_heads, int64_t arg_total_t_blocks, int64_t arg_num_seqs, int64_t grid_x, int64_t grid_y, int64_t grid_z) {
  ...
  static auto kernel = TVM_FFI_EMBED_CUBIN_GET_KERNEL(flashinfer_blackwell_gdn_cp_prefill_t_precompute_v1_gb300_hv48_min6_6ea8bfdf97, "kernel_flashinfer_blackwell_gdn_cp_prefill_t_precompute_v1_gb300_hv48_min6");
...
TVM_FFI_DLL_EXPORT_TYPED_FUNC(run_t_precompute_gb300_hv48_min6, gdn_cp_host_shim_6a9bc049715825a1::Run);
// clang-format on
