...
// tvm-ffi host launcher for GDN CP-prefill kernel 'kernel_flashinfer_blackwell_gdn_cp_prefill_qk_norm_bf16_v1'.
#include <cuda.h>
...
TVM_FFI_EMBED_CUBIN(flashinfer_blackwell_gdn_cp_prefill_qk_norm_bf16_v1_8342e61030);

namespace gdn_cp_host_shim_d92ec59ea0dd9b0f {
...
void Run(TensorView arg_q, TensorView arg_k, TensorView arg_q_normalized, TensorView arg_k_normalized, int64_t arg_num_q_heads, int64_t arg_num_k_heads, int64_t grid_x, int64_t grid_y, int64_t grid_z) {
  ...
  CheckDtype(arg_q_normalized, "q_normalized", 4, 16, 1);
  CheckContiguous(arg_q_normalized, "q_normalized");
  CheckCudaTensor(arg_k_normalized, "k_normalized");
  CheckDtype(arg_k_normalized, "k_normalized", 4, 16, 1);
  ...
  static auto kernel = TVM_FFI_EMBED_CUBIN_GET_KERNEL(flashinfer_blackwell_gdn_cp_prefill_qk_norm_bf16_v1_8342e61030, "kernel_flashinfer_blackwell_gdn_cp_prefill_qk_norm_bf16_v1");
...
TVM_FFI_DLL_EXPORT_TYPED_FUNC(run_qk_norm_bf16, gdn_cp_host_shim_d92ec59ea0dd9b0f::Run);
// clang-format on
