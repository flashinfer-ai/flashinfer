...
TVM_FFI_EMBED_CUBIN(flashinfer_blackwell_gdn_cp_prefill_state_gather_fp16_v1_86932d768d);

namespace gdn_cp_host_shim_95d3845314792ff8 {
...
void Run(TensorView arg_source, TensorView arg_state_indices, TensorView arg_packed, int64_t arg_pool_stride0, int64_t arg_pool_stride1, int64_t arg_pool_stride2, int64_t arg_pool_stride3, int64_t arg_num_heads, int64_t arg_total_values, int64_t arg_use_indices, int64_t grid_x, int64_t grid_y, int64_t grid_z) {
  ...
  static auto kernel = TVM_FFI_EMBED_CUBIN_GET_KERNEL(flashinfer_blackwell_gdn_cp_prefill_state_gather_fp16_v1_86932d768d, "kernel_flashinfer_blackwell_gdn_cp_prefill_state_gather_fp16_v1");
...
TVM_FFI_DLL_EXPORT_TYPED_FUNC(run_state_gather_fp16, gdn_cp_host_shim_95d3845314792ff8::Run);
// clang-format on
