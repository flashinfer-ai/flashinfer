...
TVM_FFI_EMBED_CUBIN(flashinfer_blackwell_gdn_cp_prefill_fixup_v1_0191fade82);

namespace gdn_cp_host_shim_d406d9849179ce3b {
...
void Run(TensorView arg_local_transfer, TensorView arg_local_state, TensorView arg_initial_state, TensorView arg_initial_state_workspace, TensorView arg_fixed_state, TensorView arg_output_state, TensorView arg_cu_seqlens, int64_t arg_chunk_len, int64_t arg_total_cp_chunks, int64_t arg_num_seqs, int64_t arg_num_heads, int64_t grid_x, int64_t grid_y, int64_t grid_z) {
  ...
  static auto kernel = TVM_FFI_EMBED_CUBIN_GET_KERNEL(flashinfer_blackwell_gdn_cp_prefill_fixup_v1_0191fade82, "kernel_flashinfer_blackwell_gdn_cp_prefill_fixup_v1");
...
TVM_FFI_DLL_EXPORT_TYPED_FUNC(run_state_fixup_simt_row4, gdn_cp_host_shim_d406d9849179ce3b::Run);
// clang-format on
