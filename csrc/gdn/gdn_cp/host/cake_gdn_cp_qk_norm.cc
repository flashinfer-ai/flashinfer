...
TVM_FFI_EMBED_CUBIN(flashinfer_blackwell_gdn_cp_prefill_qk_norm_f16_v1_ce46676b6e);

namespace gdn_cp_host_shim_6169f1f83244a49c {
...
void Run(TensorView arg_q, TensorView arg_k, TensorView arg_q_normalized, TensorView arg_k_normalized, int64_t arg_num_q_heads, int64_t arg_num_k_heads, int64_t grid_x, int64_t grid_y, int64_t grid_z) {
  ...
  static auto kernel = TVM_FFI_EMBED_CUBIN_GET_KERNEL(flashinfer_blackwell_gdn_cp_prefill_qk_norm_f16_v1_ce46676b6e, "kernel_flashinfer_blackwell_gdn_cp_prefill_qk_norm_f16_v1");
...
TVM_FFI_DLL_EXPORT_TYPED_FUNC(run_qk_norm, gdn_cp_host_shim_6169f1f83244a49c::Run);
// clang-format on
