...
kernel_gdn_decode_pretranspose_t1_bf16state_tile16(__nv_bfloat16* __restrict__ q, __nv_bfloat16* __restrict__ k, __nv_bfloat16* __restrict__ v, __nv_bfloat16* __restrict__ state, float* __restrict__ A_log, __nv_bfloat16* __restrict__ a, float* __restrict__ dt_bias, __nv_bfloat16* __restrict__ b, __nv_bfloat16* __restrict__ out, __nv_bfloat16* __restrict__ intermediate_state, int* __restrict__ initial_state_indices, int* __restrict__ output_state_indices, long long state_size_p0, long long state_stride_p0, long long q_stride_p0, long long q_stride_p2, long long k_stride_p0, long long k_stride_p2, long long a_stride_p0, long long a_stride_p2, long long b_stride_p0, long long b_stride_p2, long long v_stride_p0, long long v_stride_p2)
{
    ...
    float2 _mul_f32x2_4;
    asm("mul.rn.ftz.f32x2 %0, %1, %2;" : "=l"(*(unsigned long long*)&_mul_f32x2_4) : "l"(*(const unsigned long long*)&_f2_9), "l"(*(const unsigned long long*)&decay_pair));
    float2 h_a_pair0 = _mul_f32x2_4;
    float2 _f2_10 = make_float2(r_h_a[2], r_h_a[3]);
    float2 _mul_f32x2_5;
    asm("mul.rn.ftz.f32x2 %0, %1, %2;" : "=l"(*(unsigned long long*)&_mul_f32x2_5) : "l"(*(const unsigned long long*)&_f2_10), "l"(*(const unsigned long long*)&decay_pair));
    float2 h_a_pair1 = _mul_f32x2_5;
    float2 _f2_11 = make_float2(r_h_b[0], r_h_b[1]);
    float2 _mul_f32x2_6;
    asm("mul.rn.ftz.f32x2 %0, %1, %2;" : "=l"(*(unsigned long long*)&_mul_f32x2_6) : "l"(*(const unsigned long long*)&_f2_11), "l"(*(const unsigned long long*)&decay_pair));
    float2 h_b_pair0 = _mul_f32x2_6;
    float2 _f2_12 = make_float2(r_h_b[2], r_h_b[3]);
    float2 _mul_f32x2_7;
    asm("mul.rn.ftz.f32x2 %0, %1, %2;" : "=l"(*(unsigned long long*)&_mul_f32x2_7) : "l"(*(const unsigned long long*)&_f2_12), "l"(*(const unsigned long long*)&decay_pair));
    float2 h_b_pair1 = _mul_f32x2_7;
    ...
    float2 h_d_pair0 = _mul_f32x2_10;
    ...
    float2 h_d_pair1 = _mul_f32x2_11;
    ...
    h_a_pair0 = fma_f32x2_rn_ftz(k_pair0, _f2_21, h_a_pair0);
    float2 _f2_22 = make_float2(v_new_a, v_new_a);
    h_a_pair1 = fma_f32x2_rn_ftz(k_pair1, _f2_22, h_a_pair1);
    float2 _f2_23 = make_float2(v_new_b, v_new_b);
    h_b_pair0 = fma_f32x2_rn_ftz(k_pair0, _f2_23, h_b_pair0);
    float2 _f2_24 = make_float2(v_new_b, v_new_b);
    h_b_pair1 = fma_f32x2_rn_ftz(k_pair1, _f2_24, h_b_pair1);
    float2 _f2_25 = make_float2(v_new_c, v_new_c);
    h_c_pair0 = fma_f32x2_rn_ftz(k_pair0, _f2_25, h_c_pair0);
    float2 _f2_26 = make_float2(v_new_c, v_new_c);
    h_c_pair1 = fma_f32x2_rn_ftz(k_pair1, _f2_26, h_c_pair1);
    float2 _f2_27 = make_float2(v_new_d, v_new_d);
    h_d_pair0 = fma_f32x2_rn_ftz(k_pair0, _f2_27, h_d_pair0);
    float2 _f2_28 = make_float2(v_new_d, v_new_d);
    h_d_pair1 = fma_f32x2_rn_ftz(k_pair1, _f2_28, h_d_pair1);
    float2 _f2_29 = make_float2(0.0f, 0.0f);
    float2 sum_hq_a_pair = fma_f32x2_rn_ftz(h_a_pair0, q_pair0, _f2_29);
    sum_hq_a_pair = fma_f32x2_rn_ftz(h_a_pair1, q_pair1, sum_hq_a_pair);
    float2 _f2_30 = make_float2(0.0f, 0.0f);
    float2 sum_hq_b_pair = fma_f32x2_rn_ftz(h_b_pair0, q_pair0, _f2_30);
    sum_hq_b_pair = fma_f32x2_rn_ftz(h_b_pair1, q_pair1, sum_hq_b_pair);
    float2 _f2_31 = make_float2(0.0f, 0.0f);
    float2 sum_hq_c_pair = fma_f32x2_rn_ftz(h_c_pair0, q_pair0, _f2_31);
    sum_hq_c_pair = fma_f32x2_rn_ftz(h_c_pair1, q_pair1, sum_hq_c_pair);
    float2 _f2_32 = make_float2(0.0f, 0.0f);
    float2 sum_hq_d_pair = fma_f32x2_rn_ftz(h_d_pair0, q_pair0, _f2_32);
