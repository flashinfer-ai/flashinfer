        ...
        { // compute_group_1_main
            ...
            for (unsigned int tile_1 = bid; tile_1 < total_tiles; tile_1 += num_bids) {
                        ...
                        if (ENABLE_CHECKPOINTS != 0 && ((state_slot_raw_cg1 >= 0 && (long long)state_slot_raw_cg1 < initial_state_size_p0 && (long long)state_slot_raw_cg1 < output_state_size_p0) ? 1 : 0) != 0) {
                            {
                                ...
                                if (checkpoint_token_cg1 <= batch_end_1 - batch_start_1 && checkpoint_token_cg1 % checkpoint_every_n_tokens == 0) {
                                    ...
                                    int checkpoint_row_cg1 = (unsigned int)(warp_id_in_role_4 * 32) + lane;
                                    ...
                                    for (int checkpoint_vec_idx_cg1 = 0; checkpoint_vec_idx_cg1 < 8; checkpoint_vec_idx_cg1++) {
                                        {
                                            ...
                                            _pk[0] = __floats2bfloat162_rn(_tmem_load_24[checkpoint_vec_idx_cg1 * 4 + 0], _tmem_load_24[checkpoint_vec_idx_cg1 * 4 + 1]);
                                            _pk[1] = __floats2bfloat162_rn(_tmem_load_24[checkpoint_vec_idx_cg1 * 4 + 2], _tmem_load_24[checkpoint_vec_idx_cg1 * 4 + 3]);
                                    ...
                                    for (int checkpoint_vec_idx_cg1_1 = 0; checkpoint_vec_idx_cg1_1 < 8; checkpoint_vec_idx_cg1_1++) {
                                        {
                                            uint2 _pk2;
                                            __nv_bfloat162* _pk = reinterpret_cast<__nv_bfloat162*>(&_pk2);
                                            _pk[0] = __floats2bfloat162_rn(_tmem_load_25[checkpoint_vec_idx_cg1_1 * 4 + 0], _tmem_load_25[checkpoint_vec_idx_cg1_1 * 4 + 1]);
                                            _pk[1] = __floats2bfloat162_rn(_tmem_load_25[checkpoint_vec_idx_cg1_1 * 4 + 2], _tmem_load_25[checkpoint_vec_idx_cg1_1 * 4 + 3]);
                                    ...
                                    for (int checkpoint_vec_idx_cg1_2 = 0; checkpoint_vec_idx_cg1_2 < 8; checkpoint_vec_idx_cg1_2++) {
                                        {
                                            uint2 _pk2;
                                            __nv_bfloat162* _pk = reinterpret_cast<__nv_bfloat162*>(&_pk2);
                                            _pk[0] = __floats2bfloat162_rn(_tmem_load_26[checkpoint_vec_idx_cg1_2 * 4 + 0], _tmem_load_26[checkpoint_vec_idx_cg1_2 * 4 + 1]);
                                            _pk[1] = __floats2bfloat162_rn(_tmem_load_26[checkpoint_vec_idx_cg1_2 * 4 + 2], _tmem_load_26[checkpoint_vec_idx_cg1_2 * 4 + 3]);
                                    ...
                                    for (int checkpoint_vec_idx_cg1_3 = 0; checkpoint_vec_idx_cg1_3 < 8; checkpoint_vec_idx_cg1_3++) {
                                        {
                                            uint2 _pk2;
                                            __nv_bfloat162* _pk = reinterpret_cast<__nv_bfloat162*>(&_pk2);
                                            _pk[0] = __floats2bfloat162_rn(_tmem_load_27[checkpoint_vec_idx_cg1_3 * 4 + 0], _tmem_load_27[checkpoint_vec_idx_cg1_3 * 4 + 1]);
                                            _pk[1] = __floats2bfloat162_rn(_tmem_load_27[checkpoint_vec_idx_cg1_3 * 4 + 2], _tmem_load_27[checkpoint_vec_idx_cg1_3 * 4 + 3]);
                ...
                if ((STORE_FINAL_STATE != 0 || ENABLE_CHECKPOINTS != 0) && num_chunks_b_1 > 0) {
                    ...
                    int state_row_cg1 = (unsigned int)(warp_id_in_role_7 * 32) + lane;
                                    ...
                                    if (output_state_head_base_cg1 % 4 == 0) {
                                        {
                                            uint2 _pk2;
                                            __nv_bfloat162* _pk = reinterpret_cast<__nv_bfloat162*>(&_pk2);
                                            _pk[0] = __floats2bfloat162_rn(_tmem_load_34[state_vec_idx_cg1 * 4 + 0], _tmem_load_34[state_vec_idx_cg1 * 4 + 1]);
                                            _pk[1] = __floats2bfloat162_rn(_tmem_load_34[state_vec_idx_cg1 * 4 + 2], _tmem_load_34[state_vec_idx_cg1 * 4 + 3]);
                                        ...
                                        for (int final_state_element_cg1 = 0; final_state_element_cg1 < 4; final_state_element_cg1++) {
                                            *(reinterpret_cast<__nv_bfloat16*>(output_state + (final_state_vec_index_cg1 + (long long)final_state_element_cg1)) + (0)) = __float2bfloat16_rn(_tmem_load_34[state_vec_idx_cg1 * 4 + final_state_element_cg1]);
                                        }
                                    }
                                }
                            }
                ...
                if (STORE_FINAL_STATE != 0 && USE_INITIAL_STATE != 0 && num_chunks_b_1 == 0 && ((state_slot_raw_cg1 >= 0 && (long long)state_slot_raw_cg1 < initial_state_size_p0 && (long long)state_slot_raw_cg1 < output_state_size_p0) ? 1 : 0) != 0) {
                    ...
                    int empty_state_row = (unsigned int)(warp_id_in_role_8 * 32) + lane;
