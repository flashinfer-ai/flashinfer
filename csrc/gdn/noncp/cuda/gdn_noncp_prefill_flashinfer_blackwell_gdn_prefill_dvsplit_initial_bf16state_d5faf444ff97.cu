            ...
            for (unsigned int tile = bid; tile < total_tiles; tile += num_bids) {
                ...
                for (int chunk_idx = 0; chunk_idx < num_chunks_b; chunk_idx += 2) {
                    ...
                    for (int qk_repeat_cg0_4 = 0; qk_repeat_cg0_4 < 4; qk_repeat_cg0_4++) {
                        ...
                        #pragma unroll
                        for (int _lp = 0; _lp < 4; _lp++) {
                            __nv_bfloat162 _bf2 = __float22bfloat162_rn(make_float2(_t6[_lp*2 + 0], _t6[_lp*2+1 + 0]));
                            _t6_bf16[_lp] = *(uint32_t*)&_bf2;
                        }
                        ...
                        asm volatile("stmatrix.sync.aligned.m8n8.x4.shared.b16 [%0], {%1, %2, %3, %4};\n"
                            :: "r"(_stmatrix_addr_26), "r"(*reinterpret_cast<const uint32_t*>(&_t6_bf16[0])), "r"(*reinterpret_cast<const uint32_t*>(&_t6_bf16[1])), "r"(*reinterpret_cast<const uint32_t*>(&_t6_bf16[2])), "r"(*reinterpret_cast<const uint32_t*>(&_t6_bf16[3]))
                            : "memory");
                    }
                    asm volatile("fence.proxy.async.shared::cta;" ::: "memory");
                    mbarrier_arrive(cg0_shared_acc_empty_addr);
                    mbarrier_arrive(qk_ready_addr + (qk0_stage) * 8);
                    {
                        ...
                        for (int qk_repeat_cg0_5 = 0; qk_repeat_cg0_5 < 4; qk_repeat_cg0_5++) {
                            ...
                            asm volatile("stmatrix.sync.aligned.m8n8.x4.shared.b16 [%0], {%1, %2, %3, %4};\n"
                                :: "r"(_stmatrix_addr_28), "r"(*reinterpret_cast<const uint32_t*>(&_t7_bf16[0])), "r"(*reinterpret_cast<const uint32_t*>(&_t7_bf16[1])), "r"(*reinterpret_cast<const uint32_t*>(&_t7_bf16[2])), "r"(*reinterpret_cast<const uint32_t*>(&_t7_bf16[3]))
                                : "memory");
                        }
                        asm volatile("fence.proxy.async.shared::cta;" ::: "memory");
                        mbarrier_arrive(cg0_shared_acc_empty_addr + 8);
                            ...
                            if (ENABLE_CHECKPOINTS != 0 && ((state_slot_raw_cg1 >= 0 && (long long)state_slot_raw_cg1 < initial_state_size_p0 && (long long)state_slot_raw_cg1 < output_state_size_p0) ? 1 : 0) != 0) {
                                {
                                    ...
                                    if (checkpoint_token_cg1 <= batch_end_1 - batch_start_1 && checkpoint_token_cg1 % checkpoint_every_n_tokens == 0) {
                                        ...
                                        int checkpoint_row_top_cg1 = state_warp_cg1_1 * 16 + lane / 4;
                                        ...
                                        for (int checkpoint_col_group_cg1 = 0; checkpoint_col_group_cg1 < 8; checkpoint_col_group_cg1++) {
                                            ...
                                            *(reinterpret_cast<__nv_bfloat16*>(checkpoint_state + (checkpoint_base_top_cg1 + (long long)checkpoint_col_pair_cg1)) + (0)) = __float2bfloat16_rn(_tmem_load_13[checkpoint_reg_base_cg1]);
                                            *(reinterpret_cast<__nv_bfloat16*>(checkpoint_state + (checkpoint_base_top_cg1 + (long long)checkpoint_col_pair_cg1 + 1)) + (0)) = __float2bfloat16_rn(_tmem_load_13[checkpoint_reg_base_cg1 + 1]);
                                            *(reinterpret_cast<__nv_bfloat16*>(checkpoint_state + (checkpoint_base_bot_cg1 + (long long)checkpoint_col_pair_cg1)) + (0)) = __float2bfloat16_rn(_tmem_load_13[checkpoint_reg_base_cg1 + 2]);
                                            *(reinterpret_cast<__nv_bfloat16*>(checkpoint_state + (checkpoint_base_bot_cg1 + (long long)checkpoint_col_pair_cg1 + 1)) + (0)) = __float2bfloat16_rn(_tmem_load_13[checkpoint_reg_base_cg1 + 3]);
                                        }
                                        #pragma unroll
                                        for (int checkpoint_col_group_cg1_1 = 0; checkpoint_col_group_cg1_1 < 8; checkpoint_col_group_cg1_1++) {
                                            ...
                                            *(reinterpret_cast<__nv_bfloat16*>(checkpoint_state + (checkpoint_base_top_cg1 + (long long)checkpoint_col_pair_cg1_1)) + (0)) = __float2bfloat16_rn(_tmem_load_14[checkpoint_reg_base_cg1_1]);
                                            *(reinterpret_cast<__nv_bfloat16*>(checkpoint_state + (checkpoint_base_top_cg1 + (long long)checkpoint_col_pair_cg1_1 + 1)) + (0)) = __float2bfloat16_rn(_tmem_load_14[checkpoint_reg_base_cg1_1 + 1]);
                                            *(reinterpret_cast<__nv_bfloat16*>(checkpoint_state + (checkpoint_base_bot_cg1 + (long long)checkpoint_col_pair_cg1_1)) + (0)) = __float2bfloat16_rn(_tmem_load_14[checkpoint_reg_base_cg1_1 + 2]);
                                            *(reinterpret_cast<__nv_bfloat16*>(checkpoint_state + (checkpoint_base_bot_cg1 + (long long)checkpoint_col_pair_cg1_1 + 1)) + (0)) = __float2bfloat16_rn(_tmem_load_14[checkpoint_reg_base_cg1_1 + 3]);
                                        }
                                    }
                                }
                            }
                            ...
                            for (int state_col_group_cg1 = 0; state_col_group_cg1 < 8; state_col_group_cg1++) {
                                ...
                                if (ENABLE_CHECKPOINTS != 0 && ((state_slot_raw_cg1 >= 0 && (long long)state_slot_raw_cg1 < initial_state_size_p0 && (long long)state_slot_raw_cg1 < output_state_size_p0) ? 1 : 0) != 0) {
                                    ...
                                    if (final_checkpoint_token_cg1 % checkpoint_every_n_tokens == 0 && (final_checkpoint_token_cg1 + 64 - 1) / 64 % 2 == 0) {
                                        ...
                                        *(reinterpret_cast<__nv_bfloat16*>(checkpoint_state + (final_checkpoint_base_top_cg1 + (long long)state_col_pair_cg1)) + (0)) = __float2bfloat16_rn(_tmem_load_17[state_reg_base_cg1]);
                                        *(reinterpret_cast<__nv_bfloat16*>(checkpoint_state + (final_checkpoint_base_top_cg1 + (long long)state_col_pair_cg1 + 1)) + (0)) = __float2bfloat16_rn(_tmem_load_17[state_reg_base_cg1 + 1]);
                                        *(reinterpret_cast<__nv_bfloat16*>(checkpoint_state + (final_checkpoint_base_bot_cg1 + (long long)state_col_pair_cg1)) + (0)) = __float2bfloat16_rn(_tmem_load_17[state_reg_base_cg1 + 2]);
                                        *(reinterpret_cast<__nv_bfloat16*>(checkpoint_state + (final_checkpoint_base_bot_cg1 + (long long)state_col_pair_cg1 + 1)) + (0)) = __float2bfloat16_rn(_tmem_load_17[state_reg_base_cg1 + 3]);
                                    }
                                }
                            }
                        }
