...
kernel_gdn_decode_pretranspose_mtp_t4_splitv2_tile64(__nv_bfloat16* __restrict__ q, __nv_bfloat16* __restrict__ k, __nv_bfloat16* __restrict__ v, float* __restrict__ state, float* __restrict__ A_log, __nv_bfloat16* __restrict__ a, float* __restrict__ dt_bias, __nv_bfloat16* __restrict__ b, __nv_bfloat16* __restrict__ out, float* __restrict__ intermediate_state, int* __restrict__ initial_state_indices, int* __restrict__ output_state_indices, long long state_size_p0, long long state_stride_p0, long long state_stride_p1, long long state_stride_p2, long long q_stride_p0, long long q_stride_p1, long long q_stride_p2, long long k_stride_p0, long long k_stride_p1, long long k_stride_p2, long long v_stride_p0, long long v_stride_p1, long long v_stride_p2, long long a_stride_p0, long long a_stride_p1, long long a_stride_p2, long long b_stride_p0, long long b_stride_p1, long long b_stride_p2)
{
    ...
    for (int row_quad = 0; row_quad < 4; row_quad++) {
        ...
        for (int t = 0; t < T_STEPS; t++) {
            ...
            float2 sum_hk_a_pair = fma_f32x2_rn_ftz(h_a_pair0, k_pair0_2, _f2_21);
            sum_hk_a_pair = fma_f32x2_rn_ftz(h_a_pair1, k_pair1_3, sum_hk_a_pair);
            float2 _f2_22 = make_float2(0.0f, 0.0f);
            float2 sum_hk_b_pair = fma_f32x2_rn_ftz(h_b_pair0, k_pair0_2, _f2_22);
            sum_hk_b_pair = fma_f32x2_rn_ftz(h_b_pair1, k_pair1_3, sum_hk_b_pair);
            float2 _f2_23 = make_float2(0.0f, 0.0f);
            float2 sum_hk_c_pair = fma_f32x2_rn_ftz(h_c_pair0, k_pair0_2, _f2_23);
            sum_hk_c_pair = fma_f32x2_rn_ftz(h_c_pair1, k_pair1_3, sum_hk_c_pair);
            float2 _f2_24 = make_float2(0.0f, 0.0f);
            float2 sum_hk_d_pair = fma_f32x2_rn_ftz(h_d_pair0, k_pair0_2, _f2_24);
            sum_hk_d_pair = fma_f32x2_rn_ftz(h_d_pair1, k_pair1_3, sum_hk_d_pair);
            ...
            h_a_pair0 = fma_f32x2_rn_ftz(k_pair0_2, v_new_a_pair, h_a_pair0);
            h_a_pair1 = fma_f32x2_rn_ftz(k_pair1_3, v_new_a_pair, h_a_pair1);
            h_b_pair0 = fma_f32x2_rn_ftz(k_pair0_2, v_new_b_pair, h_b_pair0);
            h_b_pair1 = fma_f32x2_rn_ftz(k_pair1_3, v_new_b_pair, h_b_pair1);
            h_c_pair0 = fma_f32x2_rn_ftz(k_pair0_2, v_new_c_pair, h_c_pair0);
            h_c_pair1 = fma_f32x2_rn_ftz(k_pair1_3, v_new_c_pair, h_c_pair1);
            h_d_pair0 = fma_f32x2_rn_ftz(k_pair0_2, v_new_d_pair, h_d_pair0);
            h_d_pair1 = fma_f32x2_rn_ftz(k_pair1_3, v_new_d_pair, h_d_pair1);
            {
