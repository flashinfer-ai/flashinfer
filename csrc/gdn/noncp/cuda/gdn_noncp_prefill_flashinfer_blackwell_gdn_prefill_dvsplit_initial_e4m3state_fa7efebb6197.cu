                                ...
                                {
                                    {
                                        ...
                                        asm("cvt.rn.satfinite.e4m3x2.f32 %0, 0f00000000, %1;" : "=h"(_fp8_pair) : "f"(_tmem_load_17[state_reg_base_cg1]));
                                    ...
                                    {
                                        unsigned short _fp8_pair;
                                        asm("cvt.rn.satfinite.e4m3x2.f32 %0, 0f00000000, %1;" : "=h"(_fp8_pair) : "f"(_tmem_load_17[state_reg_base_cg1 + 1]));
                                    ...
                                    {
                                        unsigned short _fp8_pair;
                                        asm("cvt.rn.satfinite.e4m3x2.f32 %0, 0f00000000, %1;" : "=h"(_fp8_pair) : "f"(_tmem_load_17[state_reg_base_cg1 + 2]));
                                    ...
                                    {
                                        unsigned short _fp8_pair;
                                        asm("cvt.rn.satfinite.e4m3x2.f32 %0, 0f00000000, %1;" : "=h"(_fp8_pair) : "f"(_tmem_load_17[state_reg_base_cg1 + 3]));
