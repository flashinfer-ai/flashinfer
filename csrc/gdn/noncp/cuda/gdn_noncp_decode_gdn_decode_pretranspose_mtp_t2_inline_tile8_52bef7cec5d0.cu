...
kernel_gdn_decode_pretranspose_mtp_t2_inline_tile8(__nv_bfloat16* __restrict__ q, __nv_bfloat16* __restrict__ k, __nv_bfloat16* __restrict__ v, float* __restrict__ state, float* __restrict__ A_log, __nv_bfloat16* __restrict__ a, float* __restrict__ dt_bias, __nv_bfloat16* __restrict__ b, __nv_bfloat16* __restrict__ out, float* __restrict__ intermediate_state, int* __restrict__ initial_state_indices, long long state_size_p0, long long state_stride_p0, long long state_stride_p1, long long state_stride_p2, long long q_stride_p0, long long q_stride_p1, long long q_stride_p2, long long k_stride_p0, long long k_stride_p1, long long k_stride_p2, long long v_stride_p0, long long v_stride_p1, long long v_stride_p2, long long a_stride_p0, long long a_stride_p1, long long a_stride_p2, long long b_stride_p0, long long b_stride_p1, long long b_stride_p2)
{
    ...
    for (int t = 0; t < 2; t++) {
        ...
        float2 sum_q_pair = fma_f32x2_rn_ftz(q_pair0, q_pair0, _f2_8);
        sum_q_pair = fma_f32x2_rn_ftz(q_pair1, q_pair1, sum_q_pair);
        float2 _f2_9 = make_float2(0.0f, 0.0f);
        float2 sum_k_pair = fma_f32x2_rn_ftz(k_pair0, k_pair0, _f2_9);
        sum_k_pair = fma_f32x2_rn_ftz(k_pair1, k_pair1, sum_k_pair);
        ...
        float2 _mul_f32x2_0;
        asm("mul.rn.ftz.f32x2 %0, %1, %2;" : "=l"(*(unsigned long long*)&_mul_f32x2_0) : "l"(*(const unsigned long long*)&h_a_pair0), "l"(*(const unsigned long long*)&decay_pair));
        h_a_pair0 = _mul_f32x2_0;
        float2 _mul_f32x2_1;
        asm("mul.rn.ftz.f32x2 %0, %1, %2;" : "=l"(*(unsigned long long*)&_mul_f32x2_1) : "l"(*(const unsigned long long*)&h_a_pair1), "l"(*(const unsigned long long*)&decay_pair));
        h_a_pair1 = _mul_f32x2_1;
        float2 _mul_f32x2_2;
        asm("mul.rn.ftz.f32x2 %0, %1, %2;" : "=l"(*(unsigned long long*)&_mul_f32x2_2) : "l"(*(const unsigned long long*)&h_b_pair0), "l"(*(const unsigned long long*)&decay_pair));
        h_b_pair0 = _mul_f32x2_2;
        float2 _mul_f32x2_3;
        asm("mul.rn.ftz.f32x2 %0, %1, %2;" : "=l"(*(unsigned long long*)&_mul_f32x2_3) : "l"(*(const unsigned long long*)&h_b_pair1), "l"(*(const unsigned long long*)&decay_pair));
        h_b_pair1 = _mul_f32x2_3;
        float2 _f2_11 = make_float2(0.0f, 0.0f);
        float2 sum_hk_a_pair = fma_f32x2_rn_ftz(h_a_pair0, k_pair0, _f2_11);
        sum_hk_a_pair = fma_f32x2_rn_ftz(h_a_pair1, k_pair1, sum_hk_a_pair);
        float2 _f2_12 = make_float2(0.0f, 0.0f);
        float2 sum_hk_b_pair = fma_f32x2_rn_ftz(h_b_pair0, k_pair0, _f2_12);
        ...
        h_a_pair0 = fma_f32x2_rn_ftz(k_pair0, k_scale_a, h_a_pair0);
        h_a_pair1 = fma_f32x2_rn_ftz(k_pair1, k_scale_a, h_a_pair1);
        h_b_pair0 = fma_f32x2_rn_ftz(k_pair0, k_scale_b, h_b_pair0);
        h_b_pair1 = fma_f32x2_rn_ftz(k_pair1, k_scale_b, h_b_pair1);
        ...
        float2 sum_hq_a_pair = fma_f32x2_rn_ftz(h_a_pair0, q_pair0, _f2_15);
        sum_hq_a_pair = fma_f32x2_rn_ftz(h_a_pair1, q_pair1, sum_hq_a_pair);
        float2 _f2_16 = make_float2(0.0f, 0.0f);
        float2 sum_hq_b_pair = fma_f32x2_rn_ftz(h_b_pair0, q_pair0, _f2_16);
