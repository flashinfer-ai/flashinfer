...
namespace gdn_noncp_host_shim_97f67c6a8ac538fe {
...
TVM_FFI_DLL_EXPORT_TYPED_FUNC(run_prefill_flashinfer_blackwell_gdn_prefill_dvsplit_initial_f16io_gatepipe4_ebd3d17eac82, gdn_noncp_host_shim_97f67c6a8ac538fe::Run);
// clang-format on
