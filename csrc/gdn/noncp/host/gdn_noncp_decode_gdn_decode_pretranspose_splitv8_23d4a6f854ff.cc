...
// tvm-ffi host launcher for GDN non-CP kernel 'kernel_gdn_decode_pretranspose_splitv8'.
#include <cuda.h>
...
TVM_FFI_EMBED_CUBIN(gdn_decode_pretranspose_splitv8_93888dda37);

namespace gdn_noncp_host_shim_9aa7022cd09cda7a {
...
void Run(TensorView arg_q, TensorView arg_k, TensorView arg_v, TensorView arg_state, TensorView arg_A_log, TensorView arg_a, TensorView arg_dt_bias, TensorView arg_b, TensorView arg_out, TensorView arg_initial_state_indices, TensorView arg_output_state_indices, int64_t grid_x, int64_t grid_y, int64_t grid_z) {
  ...
  void* kargs[] = {&p_q, &p_k, &p_v, &p_state, &p_A_log, &p_a, &p_dt_bias, &p_b, &p_out, &p_initial_state_indices, &p_output_state_indices, &v_state_size_p0};

  static auto kernel = TVM_FFI_EMBED_CUBIN_GET_KERNEL(gdn_decode_pretranspose_splitv8_93888dda37, "kernel_gdn_decode_pretranspose_splitv8");
...
TVM_FFI_DLL_EXPORT_TYPED_FUNC(run_decode_gdn_decode_pretranspose_splitv8_23d4a6f854ff, gdn_noncp_host_shim_9aa7022cd09cda7a::Run);
// clang-format on
