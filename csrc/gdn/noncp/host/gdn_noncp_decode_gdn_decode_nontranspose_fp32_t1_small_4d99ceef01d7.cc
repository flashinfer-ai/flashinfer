...
TVM_FFI_EMBED_CUBIN(gdn_decode_nontranspose_fp32_t1_small_bfaa32c11b);

namespace gdn_noncp_host_shim_fd89a7b164684101 {
...
void Run(TensorView arg_q, TensorView arg_k, TensorView arg_v, TensorView arg_state, TensorView arg_A_log, TensorView arg_a, TensorView arg_dt_bias, TensorView arg_b, TensorView arg_out, int64_t grid_x, int64_t grid_y, int64_t grid_z) {
  ...
  static auto kernel = TVM_FFI_EMBED_CUBIN_GET_KERNEL(gdn_decode_nontranspose_fp32_t1_small_bfaa32c11b, "kernel_gdn_decode_nontranspose_fp32_t1_small");
...
TVM_FFI_DLL_EXPORT_TYPED_FUNC(run_decode_gdn_decode_nontranspose_fp32_t1_small_4d99ceef01d7, gdn_noncp_host_shim_fd89a7b164684101::Run);
// clang-format on
