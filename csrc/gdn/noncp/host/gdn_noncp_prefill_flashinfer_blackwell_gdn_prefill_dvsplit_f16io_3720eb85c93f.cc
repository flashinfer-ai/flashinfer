...
namespace gdn_noncp_host_shim_cacf0e81c00b7dbe {
...
TVM_FFI_DLL_EXPORT_TYPED_FUNC(run_prefill_flashinfer_blackwell_gdn_prefill_dvsplit_f16io_3720eb85c93f, gdn_noncp_host_shim_cacf0e81c00b7dbe::Run);
// clang-format on
