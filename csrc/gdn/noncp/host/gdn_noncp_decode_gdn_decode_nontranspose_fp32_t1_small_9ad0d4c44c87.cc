...
TVM_FFI_EMBED_CUBIN(gdn_decode_nontranspose_fp32_t1_small_2e105cc41e);

namespace gdn_noncp_host_shim_6408f269d9f38496 {
...
void Run(TensorView arg_q, TensorView arg_k, TensorView arg_v, TensorView arg_state, TensorView arg_A_log, TensorView arg_a, TensorView arg_dt_bias, TensorView arg_b, TensorView arg_out, int64_t grid_x, int64_t grid_y, int64_t grid_z) {
  ...
  static auto kernel = TVM_FFI_EMBED_CUBIN_GET_KERNEL(gdn_decode_nontranspose_fp32_t1_small_2e105cc41e, "kernel_gdn_decode_nontranspose_fp32_t1_small");
...
TVM_FFI_DLL_EXPORT_TYPED_FUNC(run_decode_gdn_decode_nontranspose_fp32_t1_small_9ad0d4c44c87, gdn_noncp_host_shim_6408f269d9f38496::Run);
// clang-format on
