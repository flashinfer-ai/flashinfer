        ...
        { // softmax_main
            ...
            for (unsigned int _tile_iter_s = 0; _tile_iter_s < total_tiles; _tile_iter_s++) {
                ...
                if (corr_prod_stage == 2) { corr_prod_stage = 0; corr_prod_phase ^= 1; }
                {
                    ...
                    {
                        kv_head_idx_0 = (int)default_part;
                        {
                            if (has_local != 0) {
                                kv_head_idx_0 = kv_head_idx_s;
        ...
        { // correction_main
            ...
            for (unsigned int _tile_iter_c = 0; _tile_iter_c < total_tiles; _tile_iter_c++) {
                ...
                }
                {
                    ...
                    {
                        kv_head_idx_0_1 = (int)default_part_1;
                        {
                            if (has_local_1 != 0) {
                                kv_head_idx_0_1 = kv_head_idx_c;
    ...
    if (warp == 8) {
        ...
        { // mma_warp_main
            ...
            for (unsigned int _tile_iter_m = 0; _tile_iter_m < total_tiles; _tile_iter_m++) {
                ...
                {
                    kv_head_idx_0_2 = (int)default_part_2;
                    {
                        if (has_local_2 != 0) {
                            kv_head_idx_0_2 = kv_head_idx_m;
    ...
    if (warp == 9) {
        ...
        { // page_offsets_main
            ...
            for (unsigned int _tile_iter_p = 0; _tile_iter_p < total_tiles; _tile_iter_p++) {
                ...
                {
                    kv_head_idx_0_3 = (int)default_part_3;
                    {
                        if (has_local_3 != 0) {
                            kv_head_idx_0_3 = kv_head_idx_p;
    ...
    if (warp == 11) {
        ...
        { // load_warp_main
            ...
            for (unsigned int _tile_iter_l = 0; _tile_iter_l < total_tiles; _tile_iter_l++) {
                ...
                {
                    kv_head_idx_0_4 = (int)default_part_4;
                    {
                        if (has_local_5 != 0) {
                            kv_head_idx_0_4 = kv_head_idx_2_1;
    ...
    if (warp >= 12 && warp <= 15) {
        ...
        { // transform_main
            ...
            for (unsigned int _tile_iter_t = 0; _tile_iter_t < total_tiles; _tile_iter_t++) {
                ...
                {
                    kv_head_idx_0_5 = (int)default_part_5;
                    {
                        if (has_local_6 != 0) {
                            kv_head_idx_0_5 = kv_head_idx_t;
