    ...
    if (warp <= 3) {
        ...
        { // softmax_main
            ...
            for (unsigned int _tile_iter_s = 0; _tile_iter_s < total_tiles; _tile_iter_s++) {
                ...
                int base_pairs = 0;
                int extra_pairs = 0;
                base_pairs = total_pairs / 4;
                extra_pairs = total_pairs % 4;
    ...
    if (warp >= 4 && warp <= 7) {
        ...
        { // correction_main
            ...
            for (unsigned int _tile_iter_c = 0; _tile_iter_c < total_tiles; _tile_iter_c++) {
                ...
                int base_pairs_1 = 0;
                int extra_pairs_1 = 0;
                base_pairs_1 = total_pairs_1 / 4;
                extra_pairs_1 = total_pairs_1 % 4;
                ...
                for (int cga_pair = 0; cga_pair < TILE_Q / 2; cga_pair++) {
                    if (corr_tid == cga_pair) {
                        ...
                        int cga_active_o_bytes = 16 * HEAD_DIM * 2;
                ...
                if (cta_rank < 2) {
                    if (warp == 4) {
                        if (elect_sync()) {
                            asm volatile(
                                ...
                                :: "r"(low_q1_cga_reduction_addr), "r"((uint32_t)(24960)) : "memory");
                        }
                    }
                    ...
                    for (int cga_local_head = 0; cga_local_head < 4; cga_local_head++) {
                        ...
                        #pragma unroll
                        for (int cga_source = 0; cga_source < 4; cga_source++) {
                        ...
                        #pragma unroll
                        for (int cga_source_1 = 0; cga_source_1 < 4; cga_source_1++) {
    ...
    if (warp == 8) {
        ...
        { // mma_warp_main
            ...
            for (unsigned int _tile_iter_m = 0; _tile_iter_m < total_tiles; _tile_iter_m++) {
                ...
                int base_pairs_2 = 0;
                int extra_pairs_2 = 0;
                base_pairs_2 = total_pairs_2 / 4;
                extra_pairs_2 = total_pairs_2 % 4;
    ...
    if (warp == 9) {
        ...
        { // page_offsets_main
            ...
            for (unsigned int _tile_iter_p = 0; _tile_iter_p < total_tiles; _tile_iter_p++) {
                ...
                int base_pairs_3 = 0;
                int extra_pairs_3 = 0;
                base_pairs_3 = total_pairs_3 / 4;
                extra_pairs_3 = total_pairs_3 % 4;
    ...
    if (warp == 11) {
        ...
        { // load_warp_main
            ...
            for (unsigned int _tile_iter_l = 0; _tile_iter_l < total_tiles; _tile_iter_l++) {
                ...
                int base_pairs_4 = 0;
                int extra_pairs_4 = 0;
                base_pairs_4 = total_pairs_4 / 4;
                extra_pairs_4 = total_pairs_4 % 4;
    ...
    if (warp >= 12 && warp <= 15) {
        ...
        { // transform_main
            ...
            for (unsigned int _tile_iter_t = 0; _tile_iter_t < total_tiles; _tile_iter_t++) {
                ...
                int base_pairs_5 = 0;
                int extra_pairs_5 = 0;
                base_pairs_5 = total_pairs_5 / 4;
                extra_pairs_5 = total_pairs_5 % 4;
