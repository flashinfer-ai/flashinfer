            ...
            for (unsigned int _tile_iter_s = 0; _tile_iter_s < total_tiles; _tile_iter_s++) {
                ...
                if (corr_prod_stage == 2) { corr_prod_stage = 0; corr_prod_phase ^= 1; }
                {
                    ...
                    int next_bundle_item_idx = 0;
                    {
                        ...
                        next_part = default_part;
                        schedule_batch = default_batch;
                    }
                    ...
                    {
                        int head_split_idx_1 = (int)next_part;
                        kv_head_idx_0 = head_split_idx_1 / NUM_SPLIT;
    ...
    if (warp >= 4 && warp <= 7) {
        ...
        { // correction_main
            ...
            int bundle_item_idx_1 = 0;
            {
                ...
                kv_head_idx_1 = head_split_idx_2 / NUM_SPLIT;
            ...
            for (unsigned int _tile_iter_c = 0; _tile_iter_c < total_tiles; _tile_iter_c++) {
                ...
                }
                {
                    ...
                    int next_bundle_item_idx_1 = 0;
                    {
                        ...
                        next_part_1 = default_part_1;
                        schedule_batch_1 = default_batch_1;
                    }
                    ...
                    {
                        int head_split_idx_3 = (int)next_part_1;
                        kv_head_idx_0_1 = head_split_idx_3 / NUM_SPLIT;
                        split_idx_1_1 = head_split_idx_3 % NUM_SPLIT;
                    }
    ...
    if (warp == 8) {
        ...
        { // mma_warp_main
            ...
            int bundle_item_idx_2 = 0;
            {
                ...
                kv_head_idx_2 = head_split_idx_4 / NUM_SPLIT;
                split_idx_3 = head_split_idx_4 % NUM_SPLIT;
            ...
            int split_idx_m = split_idx_3;
            int part_count_m = part_count_3;
            ...
            for (unsigned int _tile_iter_m = 0; _tile_iter_m < total_tiles; _tile_iter_m++) {
                ...
                }
                {
                    ...
                    int next_bundle_item_idx_2 = 0;
                    {
                        ...
                        next_part_2 = default_part_2;
                        schedule_batch_2 = default_batch_2;
                    }
                    ...
                    {
                        int head_split_idx_5 = (int)next_part_2;
                        kv_head_idx_0_2 = head_split_idx_5 / NUM_SPLIT;
                        split_idx_1_2 = head_split_idx_5 % NUM_SPLIT;
                    }
    ...
    if (warp == 9) {
        ...
        { // page_offsets_main
            ...
            int bundle_item_idx_3 = 0;
            {
                ...
                int head_split_idx_6 = blockIdx.y;
                kv_head_idx_3 = head_split_idx_6 / NUM_SPLIT;
                split_idx_4 = head_split_idx_6 % NUM_SPLIT;
            ...
            int split_idx_p = split_idx_4;
            int part_count_p = part_count_4;
            ...
            for (unsigned int _tile_iter_p = 0; _tile_iter_p < total_tiles; _tile_iter_p++) {
                ...
                }
                {
                    ...
                    int next_bundle_item_idx_3 = 0;
                    {
                        ...
                        next_part_3 = default_part_3;
                        schedule_batch_3 = default_batch_3;
                    }
                    ...
                    {
                        int head_split_idx_7 = (int)next_part_3;
                        kv_head_idx_0_3 = head_split_idx_7 / NUM_SPLIT;
                        split_idx_1_3 = head_split_idx_7 % NUM_SPLIT;
                    }
        ...
        { // scheduler_main
            ...
            unsigned int _phase_work_full_4 = 0;
            {
                ...
                int bundle_item_idx_4 = 0;
                {
                    ...
                    int head_split_idx_8 = blockIdx.y;
                    kv_head_idx_4 = head_split_idx_8 / NUM_SPLIT;
                    split_idx_5 = head_split_idx_8 % NUM_SPLIT;
                ...
                int split_idx_sched = split_idx_5;
                int part_count_sched = part_count_5;
    ...
    if (warp == 11) {
        ...
        { // load_warp_main
            ...
            int bundle_item_idx_5 = 0;
            {
                ...
                int head_split_idx_9 = blockIdx.y;
                kv_head_idx_5 = head_split_idx_9 / NUM_SPLIT;
                split_idx_6 = head_split_idx_9 % NUM_SPLIT;
            ...
            int split_idx_l = split_idx_6;
            int part_count_l = part_count_6;
            ...
            for (unsigned int _tile_iter_l = 0; _tile_iter_l < total_tiles; _tile_iter_l++) {
                ...
                }
                {
                    ...
                    int next_bundle_item_idx_5 = 0;
                    {
                        ...
                        next_part_4 = default_part_4;
                        schedule_batch_4 = default_batch_5;
                    }
                    ...
                    {
                        int head_split_idx_10 = (int)next_part_4;
                        kv_head_idx_0_4 = head_split_idx_10 / NUM_SPLIT;
                        split_idx_1_4 = head_split_idx_10 % NUM_SPLIT;
                    }
    ...
    if (warp >= 12 && warp <= 15) {
        ...
        { // transform_main
            ...
            int bundle_item_idx_6 = 0;
            {
                ...
                int head_split_idx_11 = blockIdx.y;
                kv_head_idx_6 = head_split_idx_11 / NUM_SPLIT;
                split_idx_7 = head_split_idx_11 % NUM_SPLIT;
                int schedule_batch_idx_6 = blockIdx.z;
                batch_idx_6 = schedule_batch_idx_6;
                {
                    batch_idx_6 = request_order[schedule_batch_idx_6];
                }
            }
            int batch_idx_t = batch_idx_6;
            int q_row_idx_t = q_row_idx_6;
            int kv_head_idx_t = kv_head_idx_6;
            int split_idx_t = split_idx_7;
            int part_count_t = part_count_7;
            ...
            for (unsigned int _tile_iter_t = 0; _tile_iter_t < total_tiles; _tile_iter_t++) {
                ...
                }
                {
                    ...
                    int next_bundle_item_idx_6 = 0;
                    {
                        ...
                        next_part_5 = default_part_5;
                        schedule_batch_5 = default_batch_6;
                    }
                    ...
                    {
                        int head_split_idx_12 = (int)next_part_5;
                        kv_head_idx_0_5 = head_split_idx_12 / NUM_SPLIT;
                        split_idx_1_5 = head_split_idx_12 % NUM_SPLIT;
                    }
