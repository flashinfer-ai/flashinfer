...
kernel_cake_fmha_context_nvfp4(CakeFmhaTensorMap const* Q, CakeFmhaTensorMap const* Kp, CakeFmhaTensorMap const* Vp, CakeFmhaTensorMap const* Ksf, CakeFmhaTensorMap const* Vsf, uint8_t* __restrict__ O_ptr, float* __restrict__ LSE_ptr, float* __restrict__ sinks, int* __restrict__ page_table_k, int* __restrict__ page_table_v, int* __restrict__ seq_lens_q, int* __restrict__ seq_lens_kv, int* __restrict__ cu_seq_lens_q, float softmax_scale_log2, float output_scale, int total_bh, int page_row_stride, int num_ctas, unsigned int* __restrict__ dynamic_counter)
{
    ...
    // Mbarrier init (18 pipeline groups, 0 ordered-sequence groups, 41 barriers)
                    ...
                    int tail_valid_1 = seqlen_kv_bh - n_block_1 * BLOCK_N;
                    {
                        if (tail_valid_1 < BLOCK_N) {
                            uint32_t _slice_lo_mask_12;
                            {
                                ...
                                if (_lim_14 <= 0) { _slice_lo_mask_12 = 0u; }
                                else if (_lim_14 >= 32) { _slice_lo_mask_12 = 0xFFFFFFFFu; }
                                else {
                                    asm volatile("{"
                                        ".reg .u32 t;\n\t"
                                        "shl.b32 t, 1, %1;\n\t"
                                        "add.u32 %0, t, -1;\n\t"
                                        "}" : "=r"(_slice_lo_mask_12) : "r"(_lim_14));
                                }
                            }
                            ...
                            uint32_t _slice_lo_mask_14;
                            {
                                ...
                                if (_lim_16 <= 0) { _slice_lo_mask_14 = 0u; }
                                else if (_lim_16 >= 32) { _slice_lo_mask_14 = 0xFFFFFFFFu; }
                                else {
                                    asm volatile("{"
                                        ".reg .u32 t;\n\t"
                                        "shl.b32 t, 1, %1;\n\t"
                                        "add.u32 %0, t, -1;\n\t"
                                        "}" : "=r"(_slice_lo_mask_14) : "r"(_lim_16));
                                }
                            }
                            ...
                            uint32_t _slice_lo_mask_15;
                            {
                                ...
                                if (_lim_17 <= 0) { _slice_lo_mask_15 = 0u; }
                                else if (_lim_17 >= 32) { _slice_lo_mask_15 = 0xFFFFFFFFu; }
                                else {
                                    asm volatile("{"
                                        ".reg .u32 t;\n\t"
                                        "shl.b32 t, 1, %1;\n\t"
                                        "add.u32 %0, t, -1;\n\t"
                                        "}" : "=r"(_slice_lo_mask_15) : "r"(_lim_17));
                                }
                            }
    ...
    // ---- Role: correction ----
        ...
        { // correction_main
            ...
            int dq_tok = (unsigned int)dq_warp_base + lane;
                    ...
                    if (n_iter_2 < num_n_blocks_1 - 1) {
                        ...
                        for (int chunk_wave_4 = 0; chunk_wave_4 < 4; chunk_wave_4++) {
                            ...
                            for (int in_pair_4 = 0; in_pair_4 < 2; in_pair_4++) {
                                ...
                                {
                                    encoded_4[2] = cake_fmha_qmul4_portable<5>(packed_words_4[packed_idx_4 + 1], sf_4);
                                }
                                {
                                    encoded_4[3] = cake_fmha_qmul4_portable<6>(packed_words_4[packed_idx_4 + 1], sf_4);
                                }
                    ...
                    if (n_iter_2 < num_n_blocks_1 - 1) {
                        ...
                        for (int chunk_wave_5 = 0; chunk_wave_5 < 4; chunk_wave_5++) {
                            ...
                            for (int in_pair_5 = 0; in_pair_5 < 2; in_pair_5++) {
                                ...
                                {
                                    encoded_5[2] = cake_fmha_qmul4_portable<5>(packed_words_5[packed_idx_5 + 1], sf_5);
                                }
                                {
                                    encoded_5[3] = cake_fmha_qmul4_portable<6>(packed_words_5[packed_idx_5 + 1], sf_5);
                                }
