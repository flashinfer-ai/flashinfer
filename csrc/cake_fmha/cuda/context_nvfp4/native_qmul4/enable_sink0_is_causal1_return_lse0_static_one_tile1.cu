...
#pragma unroll
          for (int in_pair = 0; in_pair < 2; in_pair++) {
            ...
            unsigned int encoded[4];
            {
              ...
              asm volatile("fma.rn.f32 %0, %1, 0f51A7E005, %2;"
                           : "=r"(_qmul4_marker_0)
                           : "r"(packed_words[packed_idx]), "r"(sf));
              encoded[0] = _qmul4_marker_0;
            }
            {
              uint32_t _qmul4_marker_1;
              // qmul4 patch marker 0x51A7E006
              asm volatile("fma.rn.f32 %0, %1, 0f51A7E006, %2;"
                           : "=r"(_qmul4_marker_1)
                           : "r"(packed_words[packed_idx]), "r"(sf));
            ...
            }
            {
              ...
              asm volatile("fma.rn.f32 %0, %1, 0f51A7E005, %2;"
                           : "=r"(_qmul4_marker_2)
                           : "r"(packed_words[packed_idx + 1]), "r"(sf));
...
#pragma unroll
          for (int in_pair_1 = 0; in_pair_1 < 2; in_pair_1++) {
            ...
            unsigned int encoded_1[4];
            {
              ...
              asm volatile("fma.rn.f32 %0, %1, 0f51A7E005, %2;"
                           : "=r"(_qmul4_marker_4)
                           : "r"(packed_words_1[packed_idx_1]), "r"(sf_1));
            ...
            }
            {
              ...
              asm volatile("fma.rn.f32 %0, %1, 0f51A7E005, %2;"
                           : "=r"(_qmul4_marker_6)
                           : "r"(packed_words_1[packed_idx_1 + 1]), "r"(sf_1));
...
#pragma unroll
            for (int in_pair_2 = 0; in_pair_2 < 2; in_pair_2++) {
              ...
              unsigned int encoded_2[4];
              {
                ...
                asm volatile("fma.rn.f32 %0, %1, 0f51A7E005, %2;"
                             : "=r"(_qmul4_marker_8)
                             : "r"(packed_words_2[packed_idx_2]), "r"(sf_2));
              ...
              }
              {
                ...
                asm volatile("fma.rn.f32 %0, %1, 0f51A7E005, %2;"
                             : "=r"(_qmul4_marker_10)
                             : "r"(packed_words_2[packed_idx_2 + 1]), "r"(sf_2));
...
#pragma unroll
            for (int in_pair_3 = 0; in_pair_3 < 2; in_pair_3++) {
              ...
              unsigned int encoded_3[4];
              {
                ...
                asm volatile("fma.rn.f32 %0, %1, 0f51A7E005, %2;"
                             : "=r"(_qmul4_marker_12)
                             : "r"(packed_words_3[packed_idx_3]), "r"(sf_3));
              ...
              }
              {
                ...
                asm volatile("fma.rn.f32 %0, %1, 0f51A7E005, %2;"
                             : "=r"(_qmul4_marker_14)
                             : "r"(packed_words_3[packed_idx_3 + 1]), "r"(sf_3));
...
#pragma unroll
              for (int in_pair_4 = 0; in_pair_4 < 2; in_pair_4++) {
                ...
                unsigned int encoded_4[4];
                {
                  ...
                  asm volatile("fma.rn.f32 %0, %1, 0f51A7E005, %2;"
                               : "=r"(_qmul4_marker_17)
                               : "r"(packed_words_4[packed_idx_4]), "r"(sf_4));
                ...
                }
                {
                  ...
                  asm volatile("fma.rn.f32 %0, %1, 0f51A7E005, %2;"
                               : "=r"(_qmul4_marker_19)
                               : "r"(packed_words_4[packed_idx_4 + 1]), "r"(sf_4));
...
#pragma unroll
              for (int in_pair_5 = 0; in_pair_5 < 2; in_pair_5++) {
                ...
                unsigned int encoded_5[4];
                {
                  ...
                  asm volatile("fma.rn.f32 %0, %1, 0f51A7E005, %2;"
                               : "=r"(_qmul4_marker_22)
                               : "r"(packed_words_5[packed_idx_5]), "r"(sf_5));
                ...
                }
                {
                  ...
                  asm volatile("fma.rn.f32 %0, %1, 0f51A7E005, %2;"
                               : "=r"(_qmul4_marker_24)
                               : "r"(packed_words_5[packed_idx_5 + 1]), "r"(sf_5));
