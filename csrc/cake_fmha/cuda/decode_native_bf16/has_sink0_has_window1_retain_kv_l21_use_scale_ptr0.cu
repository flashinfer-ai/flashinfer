              ...
              for (int hg_la_3 = 0; hg_la_3 < 2; hg_la_3++) {
                int tvtoff_la = hg_la_3 * 16384 + pg_half_la_3 * 2048;
                {
                  asm volatile(
                      "cp.async.bulk.tensor.5d.shared::cta.global.mbarrier::complete_tx::bytes.L2::"
                      "cache_hint"
                      " [%0], [%1, {%2, %3, %4, %5, %6}], [%7], %8;" ::"r"(tvdst_la + tvtoff_la),
                      "l"(V), "r"(0), "r"(0), "r"(hg_la_3), "r"(kv_head_idx_3), "r"(tvpg0_la),
                      "r"(kv_full_addr + (tstage_la) * 8), "l"(0x14F0000000000000ULL)
                      : "memory");
                }
              }
            }
              ...
              for (int hg_3 = 0; hg_3 < 2; hg_3++) {
                int tvtoff = hg_3 * 16384 + pg_i_3 * 2048;
                {
                  asm volatile(
                      "cp.async.bulk.tensor.5d.shared::cta.global.mbarrier::complete_tx::bytes.L2::"
                      "cache_hint"
                      " [%0], [%1, {%2, %3, %4, %5, %6}], [%7], %8;" ::"r"(tvdst + tvtoff),
                      "l"(V), "r"(0), "r"(0), "r"(hg_3), "r"(kv_head_idx_4), "r"(tvpg0),
                      "r"(kv_full_addr + (tstage) * 8), "l"(0x14F0000000000000ULL)
                      : "memory");
                }
              }
            }
