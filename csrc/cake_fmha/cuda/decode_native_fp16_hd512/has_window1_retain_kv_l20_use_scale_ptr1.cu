...
#pragma unroll 1
          for (int ni_la = 0; ni_la < prefill_la; ni_la++) {
            ...
            {
              tma_5d_gmem2smem(smem_kv_addr + 16384, K, 0, 0, 1, kv_head_idx_3, pg_k_la,
                               kv_full_addr);
            }
            mbarrier_wait(kv_empty_addr + 8, ph_la);
            mbarrier_arrive_expect_tx(kv_full_addr + 8, 16384);
            {
              tma_5d_gmem2smem(smem_kv_addr + 32768, K, 0, 0, 2, kv_head_idx_3, pg_k_la,
                               kv_full_addr + 8);
            }
            {
              tma_5d_gmem2smem(smem_kv_addr + 32768 + 16384, K, 0, 0, 3, kv_head_idx_3, pg_k_la,
                               kv_full_addr + 8);
            }
            mbarrier_wait(kv_empty_addr + 16, ph_la);
            mbarrier_arrive_expect_tx(kv_full_addr + 16, 16384);
            {
              tma_5d_gmem2smem(smem_kv_addr + 65536, K, 0, 0, 4, kv_head_idx_3, pg_k_la,
                               kv_full_addr + 16);
            }
            {
              tma_5d_gmem2smem(smem_kv_addr + 65536 + 16384, K, 0, 0, 5, kv_head_idx_3, pg_k_la,
                               kv_full_addr + 16);
            }
            mbarrier_wait(kv_empty_addr + 24, ph_la);
            mbarrier_arrive_expect_tx(kv_full_addr + 24, 16384);
            {
              tma_5d_gmem2smem(smem_kv_addr + 98304, K, 0, 0, 6, kv_head_idx_3, pg_k_la,
                               kv_full_addr + 24);
            }
            {
              tma_5d_gmem2smem(smem_kv_addr + 98304 + 16384, K, 0, 0, 7, kv_head_idx_3, pg_k_la,
                               kv_full_addr + 24);
            }
          }
...
#pragma unroll 1
          for (int ni_la_1 = 0; ni_la_1 < main_ni_la; ni_la_1++) {
            ...
            {
              tma_5d_gmem2smem(smem_kv_addr + 16384, V, 0, 0, 1, kv_head_idx_3, pg_v_la,
                               kv_full_addr);
            }
            mbarrier_wait(kv_empty_addr + 8, 1);
            mbarrier_arrive_expect_tx(kv_full_addr + 8, 16384);
            {
              tma_5d_gmem2smem(smem_kv_addr + 32768, V, 0, 0, 2, kv_head_idx_3, pg_v_la,
                               kv_full_addr + 8);
            }
            {
              tma_5d_gmem2smem(smem_kv_addr + 32768 + 16384, V, 0, 0, 3, kv_head_idx_3, pg_v_la,
                               kv_full_addr + 8);
            }
            mbarrier_wait(kv_empty_addr + 16, 1);
            mbarrier_arrive_expect_tx(kv_full_addr + 16, 16384);
            {
              tma_5d_gmem2smem(smem_kv_addr + 65536, V, 0, 0, 4, kv_head_idx_3, pg_v_la,
                               kv_full_addr + 16);
            }
            {
              tma_5d_gmem2smem(smem_kv_addr + 65536 + 16384, V, 0, 0, 5, kv_head_idx_3, pg_v_la,
                               kv_full_addr + 16);
            }
            mbarrier_wait(kv_empty_addr + 24, 1);
            mbarrier_arrive_expect_tx(kv_full_addr + 24, 16384);
            {
              tma_5d_gmem2smem(smem_kv_addr + 98304, V, 0, 0, 6, kv_head_idx_3, pg_v_la,
                               kv_full_addr + 24);
            }
            {
              tma_5d_gmem2smem(smem_kv_addr + 98304 + 16384, V, 0, 0, 7, kv_head_idx_3, pg_v_la,
                               kv_full_addr + 24);
            }
            ...
            {
              tma_5d_gmem2smem(smem_kv_addr + 16384, K, 0, 0, 1, kv_head_idx_3, pg_nk_la,
                               kv_full_addr);
            }
            mbarrier_wait(kv_empty_addr + 8, 0);
            mbarrier_arrive_expect_tx(kv_full_addr + 8, 16384);
            {
              tma_5d_gmem2smem(smem_kv_addr + 32768, K, 0, 0, 2, kv_head_idx_3, pg_nk_la,
                               kv_full_addr + 8);
            }
            {
              tma_5d_gmem2smem(smem_kv_addr + 32768 + 16384, K, 0, 0, 3, kv_head_idx_3, pg_nk_la,
                               kv_full_addr + 8);
            }
            mbarrier_wait(kv_empty_addr + 16, 0);
            mbarrier_arrive_expect_tx(kv_full_addr + 16, 16384);
            {
              tma_5d_gmem2smem(smem_kv_addr + 65536, K, 0, 0, 4, kv_head_idx_3, pg_nk_la,
                               kv_full_addr + 16);
            }
            {
              tma_5d_gmem2smem(smem_kv_addr + 65536 + 16384, K, 0, 0, 5, kv_head_idx_3, pg_nk_la,
                               kv_full_addr + 16);
            }
            mbarrier_wait(kv_empty_addr + 24, 0);
            mbarrier_arrive_expect_tx(kv_full_addr + 24, 16384);
            {
              tma_5d_gmem2smem(smem_kv_addr + 98304, K, 0, 0, 6, kv_head_idx_3, pg_nk_la,
                               kv_full_addr + 24);
            }
            {
              tma_5d_gmem2smem(smem_kv_addr + 98304 + 16384, K, 0, 0, 7, kv_head_idx_3, pg_nk_la,
                               kv_full_addr + 24);
            }
          }
#pragma unroll 1
          for (int tail_ni_la = main_ni_la; tail_ni_la < cta_n_blocks_3; tail_ni_la++) {
            ...
            {
              tma_5d_gmem2smem(smem_kv_addr + 16384, V, 0, 0, 1, kv_head_idx_3, tpg_v_la,
                               kv_full_addr);
            }
            mbarrier_wait(kv_empty_addr + 8, tph_la);
            mbarrier_arrive_expect_tx(kv_full_addr + 8, 16384);
            {
              tma_5d_gmem2smem(smem_kv_addr + 32768, V, 0, 0, 2, kv_head_idx_3, tpg_v_la,
                               kv_full_addr + 8);
            }
            {
              tma_5d_gmem2smem(smem_kv_addr + 32768 + 16384, V, 0, 0, 3, kv_head_idx_3, tpg_v_la,
                               kv_full_addr + 8);
            }
            mbarrier_wait(kv_empty_addr + 16, tph_la);
            mbarrier_arrive_expect_tx(kv_full_addr + 16, 16384);
            {
              tma_5d_gmem2smem(smem_kv_addr + 65536, V, 0, 0, 4, kv_head_idx_3, tpg_v_la,
                               kv_full_addr + 16);
            }
            {
              tma_5d_gmem2smem(smem_kv_addr + 65536 + 16384, V, 0, 0, 5, kv_head_idx_3, tpg_v_la,
                               kv_full_addr + 16);
            }
            mbarrier_wait(kv_empty_addr + 24, tph_la);
            mbarrier_arrive_expect_tx(kv_full_addr + 24, 16384);
            {
              tma_5d_gmem2smem(smem_kv_addr + 98304, V, 0, 0, 6, kv_head_idx_3, tpg_v_la,
                               kv_full_addr + 24);
            }
            {
              tma_5d_gmem2smem(smem_kv_addr + 98304 + 16384, V, 0, 0, 7, kv_head_idx_3, tpg_v_la,
                               kv_full_addr + 24);
            }
          }
        }
...
#pragma unroll 1
          for (int ni = 0; ni < prefill; ni++) {
            ...
            {
              tma_5d_gmem2smem(smem_kv_addr + 16384 + 8192, K, 0, 0, 1, kv_head_idx_4, pg_k,
                               kv_full_addr);
            }
            mbarrier_wait(kv_empty_addr + 8, ph);
            mbarrier_arrive_expect_tx(kv_full_addr + 8, 16384);
            {
              tma_5d_gmem2smem(smem_kv_addr + 32768 + 8192, K, 0, 0, 2, kv_head_idx_4, pg_k,
                               kv_full_addr + 8);
            }
            {
              tma_5d_gmem2smem(smem_kv_addr + 32768 + 16384 + 8192, K, 0, 0, 3, kv_head_idx_4, pg_k,
                               kv_full_addr + 8);
            }
            mbarrier_wait(kv_empty_addr + 16, ph);
            mbarrier_arrive_expect_tx(kv_full_addr + 16, 16384);
            {
              tma_5d_gmem2smem(smem_kv_addr + 65536 + 8192, K, 0, 0, 4, kv_head_idx_4, pg_k,
                               kv_full_addr + 16);
            }
            {
              tma_5d_gmem2smem(smem_kv_addr + 65536 + 16384 + 8192, K, 0, 0, 5, kv_head_idx_4, pg_k,
                               kv_full_addr + 16);
            }
            mbarrier_wait(kv_empty_addr + 24, ph);
            mbarrier_arrive_expect_tx(kv_full_addr + 24, 16384);
            {
              tma_5d_gmem2smem(smem_kv_addr + 98304 + 8192, K, 0, 0, 6, kv_head_idx_4, pg_k,
                               kv_full_addr + 24);
            }
            {
              tma_5d_gmem2smem(smem_kv_addr + 98304 + 16384 + 8192, K, 0, 0, 7, kv_head_idx_4, pg_k,
                               kv_full_addr + 24);
            }
          }
...
#pragma unroll 1
          for (int ni_1 = 0; ni_1 < main_ni; ni_1++) {
            ...
            {
              tma_5d_gmem2smem(smem_kv_addr + 16384 + 8192, V, 0, 0, 1, kv_head_idx_4, pg_v,
                               kv_full_addr);
            }
            mbarrier_wait(kv_empty_addr + 8, 1);
            mbarrier_arrive_expect_tx(kv_full_addr + 8, 16384);
            {
              tma_5d_gmem2smem(smem_kv_addr + 32768 + 8192, V, 0, 0, 2, kv_head_idx_4, pg_v,
                               kv_full_addr + 8);
            }
            {
              tma_5d_gmem2smem(smem_kv_addr + 32768 + 16384 + 8192, V, 0, 0, 3, kv_head_idx_4, pg_v,
                               kv_full_addr + 8);
            }
            mbarrier_wait(kv_empty_addr + 16, 1);
            mbarrier_arrive_expect_tx(kv_full_addr + 16, 16384);
            {
              tma_5d_gmem2smem(smem_kv_addr + 65536 + 8192, V, 0, 0, 4, kv_head_idx_4, pg_v,
                               kv_full_addr + 16);
            }
            {
              tma_5d_gmem2smem(smem_kv_addr + 65536 + 16384 + 8192, V, 0, 0, 5, kv_head_idx_4, pg_v,
                               kv_full_addr + 16);
            }
            mbarrier_wait(kv_empty_addr + 24, 1);
            mbarrier_arrive_expect_tx(kv_full_addr + 24, 16384);
            {
              tma_5d_gmem2smem(smem_kv_addr + 98304 + 8192, V, 0, 0, 6, kv_head_idx_4, pg_v,
                               kv_full_addr + 24);
            }
            {
              tma_5d_gmem2smem(smem_kv_addr + 98304 + 16384 + 8192, V, 0, 0, 7, kv_head_idx_4, pg_v,
                               kv_full_addr + 24);
            }
            int next_ni = ni_1 + 2;
            ...
            {
              tma_5d_gmem2smem(smem_kv_addr + 16384 + 8192, K, 0, 0, 1, kv_head_idx_4, pg_nk,
                               kv_full_addr);
            }
            mbarrier_wait(kv_empty_addr + 8, 0);
            mbarrier_arrive_expect_tx(kv_full_addr + 8, 16384);
            {
              tma_5d_gmem2smem(smem_kv_addr + 32768 + 8192, K, 0, 0, 2, kv_head_idx_4, pg_nk,
                               kv_full_addr + 8);
            }
            {
              tma_5d_gmem2smem(smem_kv_addr + 32768 + 16384 + 8192, K, 0, 0, 3, kv_head_idx_4,
                               pg_nk, kv_full_addr + 8);
            }
            mbarrier_wait(kv_empty_addr + 16, 0);
            mbarrier_arrive_expect_tx(kv_full_addr + 16, 16384);
            {
              tma_5d_gmem2smem(smem_kv_addr + 65536 + 8192, K, 0, 0, 4, kv_head_idx_4, pg_nk,
                               kv_full_addr + 16);
            }
            {
              tma_5d_gmem2smem(smem_kv_addr + 65536 + 16384 + 8192, K, 0, 0, 5, kv_head_idx_4,
                               pg_nk, kv_full_addr + 16);
            }
            mbarrier_wait(kv_empty_addr + 24, 0);
            mbarrier_arrive_expect_tx(kv_full_addr + 24, 16384);
            {
              tma_5d_gmem2smem(smem_kv_addr + 98304 + 8192, K, 0, 0, 6, kv_head_idx_4, pg_nk,
                               kv_full_addr + 24);
            }
            {
              tma_5d_gmem2smem(smem_kv_addr + 98304 + 16384 + 8192, K, 0, 0, 7, kv_head_idx_4,
                               pg_nk, kv_full_addr + 24);
            }
          }
#pragma unroll 1
          for (int tail_ni = main_ni; tail_ni < cta_n_blocks_4; tail_ni++) {
            ...
            {
              tma_5d_gmem2smem(smem_kv_addr + 16384 + 8192, V, 0, 0, 1, kv_head_idx_4, tpg_v,
                               kv_full_addr);
            }
            mbarrier_wait(kv_empty_addr + 8, tph);
            mbarrier_arrive_expect_tx(kv_full_addr + 8, 16384);
            {
              tma_5d_gmem2smem(smem_kv_addr + 32768 + 8192, V, 0, 0, 2, kv_head_idx_4, tpg_v,
                               kv_full_addr + 8);
            }
            {
              tma_5d_gmem2smem(smem_kv_addr + 32768 + 16384 + 8192, V, 0, 0, 3, kv_head_idx_4,
                               tpg_v, kv_full_addr + 8);
            }
            mbarrier_wait(kv_empty_addr + 16, tph);
            mbarrier_arrive_expect_tx(kv_full_addr + 16, 16384);
            {
              tma_5d_gmem2smem(smem_kv_addr + 65536 + 8192, V, 0, 0, 4, kv_head_idx_4, tpg_v,
                               kv_full_addr + 16);
            }
            {
              tma_5d_gmem2smem(smem_kv_addr + 65536 + 16384 + 8192, V, 0, 0, 5, kv_head_idx_4,
                               tpg_v, kv_full_addr + 16);
            }
            mbarrier_wait(kv_empty_addr + 24, tph);
            mbarrier_arrive_expect_tx(kv_full_addr + 24, 16384);
            {
              tma_5d_gmem2smem(smem_kv_addr + 98304 + 8192, V, 0, 0, 6, kv_head_idx_4, tpg_v,
                               kv_full_addr + 24);
            }
            {
              tma_5d_gmem2smem(smem_kv_addr + 98304 + 16384 + 8192, V, 0, 0, 7, kv_head_idx_4,
                               tpg_v, kv_full_addr + 24);
            }
          }
        }
      }
