...
__global__ __launch_bounds__(512) void kernel_cake_fmha_decode_native_fp16_nhd(
...
#pragma unroll
              for (int hg_la_3 = 0; hg_la_3 < 2; hg_la_3++) {
                ...
                {
                  tma_5d_gmem2smem(tvdst_la + tvtoff_la, V, 0, 0, hg_la_3, kv_head_idx_3, tvpg0_la,
                                   kv_full_addr + (tstage_la) * 8);
                }
              }
            }
          }
...
#pragma unroll
              for (int hg_3 = 0; hg_3 < 2; hg_3++) {
                ...
                {
                  tma_5d_gmem2smem(tvdst + tvtoff, V, 0, 0, hg_3, kv_head_idx_4, tvpg0,
