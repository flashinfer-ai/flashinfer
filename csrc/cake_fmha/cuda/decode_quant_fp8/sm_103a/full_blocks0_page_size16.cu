...
#pragma unroll 1
          for (int ni = 0; ni < prefill; ni++) {
            ...
            {
              asm volatile("ld.shared.v4.b32 {%0,%1,%2,%3}, [%4];"
                           : "=r"(*reinterpret_cast<uint32_t*>(&pg_k[4])),
                             "=r"(*reinterpret_cast<uint32_t*>(&pg_k[(4) + 1])),
                             "=r"(*reinterpret_cast<uint32_t*>(&pg_k[(4) + 2])),
                             "=r"(*reinterpret_cast<uint32_t*>(&pg_k[(4) + 3]))
                           : "r"(pg_k_base + 16));
            }
#pragma unroll
...
#pragma unroll 1
          for (int ni_1 = 0; ni_1 < cta_n_blocks_3; ni_1++) {
            ...
            if (next_ni < cta_n_blocks_3) {
              ...
              {
                asm volatile("ld.shared.v4.b32 {%0,%1,%2,%3}, [%4];"
                             : "=r"(*reinterpret_cast<uint32_t*>(&pg_nk[4])),
                               "=r"(*reinterpret_cast<uint32_t*>(&pg_nk[(4) + 1])),
                               "=r"(*reinterpret_cast<uint32_t*>(&pg_nk[(4) + 2])),
                               "=r"(*reinterpret_cast<uint32_t*>(&pg_nk[(4) + 3]))
                             : "r"(pg_nk_base + 16));
              }
#pragma unroll
            ...
            {
              asm volatile("ld.shared.v4.b32 {%0,%1,%2,%3}, [%4];"
                           : "=r"(*reinterpret_cast<uint32_t*>(&pg_v[4])),
                             "=r"(*reinterpret_cast<uint32_t*>(&pg_v[(4) + 1])),
                             "=r"(*reinterpret_cast<uint32_t*>(&pg_v[(4) + 2])),
                             "=r"(*reinterpret_cast<uint32_t*>(&pg_v[(4) + 3]))
                           : "r"(pg_v_base + 16));
            }
