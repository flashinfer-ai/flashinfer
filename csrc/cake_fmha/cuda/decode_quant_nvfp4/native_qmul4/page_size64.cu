                  ...
                  if (ldsm_stage_1 % 4 == 0) {
                    {
                      ...
                      asm volatile("fma.rn.f32 %0, %1, 0f51A7E001, %2;"
                                   : "=r"(_qmul4_marker_0)
                                   : "r"(k_src_word0[slot_1]), "r"(ksf_words0[scale_slot]));
                    ...
                    }
                    {
                      ...
                      asm volatile("fma.rn.f32 %0, %1, 0f51A7E001, %2;"
                                   : "=r"(_qmul4_marker_1)
                                   : "r"(k_src_word1[slot_1]), "r"(ksf_words1[scale_slot]));
                  ...
                  } else if (ldsm_stage_1 % 4 == 1) {
                    {
                      ...
                      asm volatile("fma.rn.f32 %0, %1, 0f51A7E002, %2;"
                                   : "=r"(_qmul4_marker_2)
                                   : "r"(k_src_word0[slot_1]), "r"(ksf_words0[scale_slot]));
                    ...
                    if (ldsm_stage_1 % 4 == 2) {
                      {
                        ...
                        asm volatile("fma.rn.f32 %0, %1, 0f51A7E003, %2;"
                                     : "=r"(_qmul4_marker_4)
                                     : "r"(k_src_word0[slot_1]), "r"(ksf_words0[scale_slot]));
                    ...
                    } else {
                      {
                        ...
                        asm volatile("fma.rn.f32 %0, %1, 0f51A7E004, %2;"
                                     : "=r"(_qmul4_marker_6)
                                     : "r"(k_src_word0[slot_1]), "r"(ksf_words0[scale_slot]));
...
#pragma unroll
                for (int ldsm_stage_3 = 0; ldsm_stage_3 < 8; ldsm_stage_3++) {
                  ...
                  unsigned int dst_word1_1 = 0;
                  {
                    ...
                    asm volatile("fma.rn.f32 %0, %1, 0f51A7E000, %2;"
                                 : "=r"(_qmul4_marker_8)
                                 : "r"(v_src_word0[slot_3]), "r"(vsf_words[scale_slot_1]));
                  ...
                  }
                  {
                    ...
                    asm volatile("fma.rn.f32 %0, %1, 0f51A7E000, %2;"
                                 : "=r"(_qmul4_marker_9)
                                 : "r"(v_src_word1[slot_3]), "r"(vsf_words[scale_slot_1]));
