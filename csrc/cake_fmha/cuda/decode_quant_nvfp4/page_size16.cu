                        ...
                        if (work_is_v == 0) {
                            ...
                            for (int atom_i_1 = 0; atom_i_1 < 2; atom_i_1++) {
                                ...
                                for (int ldsm_stage_1 = 0; ldsm_stage_1 < 8; ldsm_stage_1++) {
                                    ...
                                    if (ldsm_stage_1 % 4 == 0) {
                                        {
                                            dst_word0 = cake_fmha_qmul4_portable<1>(src_word0[slot_1], ksf_words0[scale_slot]);
                                        }
                                        {
                                            dst_word1 = cake_fmha_qmul4_portable<1>(src_word1[slot_1], ksf_words1[scale_slot]);
                                        }
                                    } else if (ldsm_stage_1 % 4 == 1) {
                                        {
                                            dst_word0 = cake_fmha_qmul4_portable<2>(src_word0[slot_1], ksf_words0[scale_slot]);
                                        }
                                        {
                                            dst_word1 = cake_fmha_qmul4_portable<2>(src_word1[slot_1], ksf_words1[scale_slot]);
                                        }
                                    } else {
                                        if (ldsm_stage_1 % 4 == 2) {
                                            {
                                                dst_word0 = cake_fmha_qmul4_portable<3>(src_word0[slot_1], ksf_words0[scale_slot]);
                                            }
                                            {
                                                dst_word1 = cake_fmha_qmul4_portable<3>(src_word1[slot_1], ksf_words1[scale_slot]);
                                            }
                                        } else {
                                            {
                                                dst_word0 = cake_fmha_qmul4_portable<4>(src_word0[slot_1], ksf_words0[scale_slot]);
                                            }
                                            {
                                                dst_word1 = cake_fmha_qmul4_portable<4>(src_word1[slot_1], ksf_words1[scale_slot]);
                                            }
                                        }
                                    }
                            ...
                            for (int atom_i_3 = 0; atom_i_3 < 2; atom_i_3++) {
                                ...
                                for (int ldsm_stage_3 = 0; ldsm_stage_3 < 8; ldsm_stage_3++) {
                                    ...
                                    {
                                        dst_word0_1 = cake_fmha_qmul4_portable<0>(src_word0[slot_3], vsf_words[scale_slot_1]);
                                    }
                                    {
                                        dst_word1_1 = cake_fmha_qmul4_portable<0>(src_word1[slot_3], vsf_words[scale_slot_1]);
                                    }
