...
namespace cake_host_shim_09fa0daa84d9a5ee {
...
TVM_FFI_DLL_EXPORT_TYPED_FUNC(run, cake_host_shim_09fa0daa84d9a5ee::Run);
TVM_FFI_DLL_EXPORT_TYPED_FUNC(begin_tma_capture, cake_host_shim_09fa0daa84d9a5ee::BeginTmaCapture);
TVM_FFI_DLL_EXPORT_TYPED_FUNC(run_tma_capture, cake_host_shim_09fa0daa84d9a5ee::RunTmaCapture);
TVM_FFI_DLL_EXPORT_TYPED_FUNC(finalize_tma_capture, cake_host_shim_09fa0daa84d9a5ee::FinalizeTmaCapture);
TVM_FFI_DLL_EXPORT_TYPED_FUNC(discard_tma_capture, cake_host_shim_09fa0daa84d9a5ee::DiscardTmaCapture);
