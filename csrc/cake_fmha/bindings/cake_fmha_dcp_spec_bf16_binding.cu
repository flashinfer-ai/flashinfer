...
extern "C" cudaError_t cake_fmha_launch_dcp_spec_bf16(
  ...
  cudaError_t status =
      cudaFuncSetAttribute(reinterpret_cast<const void*>(kernel_cake_fmha_dcp_spec_bf16),
  ...
  return cudaLaunchKernel(reinterpret_cast<const void*>(kernel_cake_fmha_dcp_spec_bf16),
                          dim3(grid_x, grid_y, grid_z), dim3(512, 1, 1), kernel_args, 145408,
                          stream);
}
