...
extern "C" __global__ void kernel_cake_fmha_decode_native_bf16_hd256_smallm_n32_p32(CakeFmhaTensorMap const* Q, CakeFmhaTensorMap const* K, CakeFmhaTensorMap const* V, __nv_bfloat16* partial_O_ptr, float* partial_LSE_ptr, __nv_bfloat16* O_ptr, float* LSE_ptr, uint32_t* counters, int* page_table, int* seq_lens, int max_pages_per_seq, float softmax_scale_log2, int num_q_heads, int num_kv_heads);
...
extern "C" cudaError_t cake_fmha_launch_decode_native_bf16_hd256_smallm_n32_p32(
    ...
    cudaError_t status = cudaFuncSetAttribute(
        reinterpret_cast<const void*>(kernel_cake_fmha_decode_native_bf16_hd256_smallm_n32_p32),
