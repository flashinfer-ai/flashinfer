...
extern "C" __global__ void kernel_cake_fmha_decode_native_fp16_nhd(
...
extern "C" cudaError_t cake_fmha_launch_decode_native_fp16_nhd(
  ...
  cudaError_t status =
      cudaFuncSetAttribute(reinterpret_cast<const void*>(kernel_cake_fmha_decode_native_fp16_nhd),
  ...
  return cudaLaunchKernel(reinterpret_cast<const void*>(kernel_cake_fmha_decode_native_fp16_nhd),
