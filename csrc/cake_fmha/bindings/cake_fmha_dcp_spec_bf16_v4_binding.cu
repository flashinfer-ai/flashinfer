...
extern "C" cudaError_t cake_fmha_launch_dcp_spec_bf16_v4(
    ...
    cudaStream_t stream) {
  cudaError_t status =
      cudaFuncSetAttribute(reinterpret_cast<const void*>(kernel_cake_fmha_dcp_spec_bf16_v4),
  ...
  return cudaLaunchKernel(reinterpret_cast<const void*>(kernel_cake_fmha_dcp_spec_bf16_v4),
