...
// tvm-ffi host launcher for Cake kernel 'kernel_cake_fmha_request_ordered_paged_decode_runtime_lengths_one_page_a6838733ac6f3b24b18d'.
#include <cuda.h>
...
TVM_FFI_EMBED_CUBIN(cake_fmha_request_ordered_paged_decode_runtime_lengths_one_page_a6838733ac6f3b24b18d_sm_103a);

namespace cake_host_shim_c8d75785d5b77c41 {
...
void Run(TensorView arg_Qt, TensorView arg_K, TensorView arg_V, TensorView arg_partial_O, TensorView arg_partial_LSE, TensorView arg_split_completion, TensorView arg_O, TensorView arg_LSE, TensorView arg_page_table, TensorView arg_seq_lens_kv, TensorView arg_request_order, int64_t arg_max_pages_per_seq, int64_t arg_page_table_v_offset, double arg_softmax_scale_log2, double arg_output_scale, TensorView arg_bmm1_scale_ptr, TensorView arg_bmm2_scale_ptr, int64_t arg_bmm1_is_log2, int64_t arg_num_q_heads, int64_t arg_num_kv_heads, int64_t arg_batch_size, int64_t arg_total_tiles, TensorView arg_tma_descriptor_workspace, int64_t grid_x, int64_t grid_y, int64_t grid_z) {
  ...
  static auto kernel = EmbedCubinModule_cake_fmha_request_ordered_paged_decode_runtime_lengths_one_page_a6838733ac6f3b24b18d_sm_103a::Global()->mod.GetKernel("kernel_cake_fmha_request_ordered_paged_decode_runtime_lengths_one_page_a6838733ac6f3b24b18d");
  static signed char cake_smem_mode_cache[64] = {0};
  const bool use_oversized_smem = CakeConfigureDynamicSmem(
      kernel, (int)arg_Qt.device().device_id, 146076,
  ...
  config.dynamicSmemBytes = 146076u;
...
static bool PrepareTmaCaptureKernel(DLDevice dev) {
  ...
  static signed char cake_smem_mode_cache[64] = {0};
  const bool use_oversized_smem = CakeConfigureDynamicSmem(
      kernel, (int)dev.device_id, 146076,
      cake_smem_mode_cache, 64);
...
static int64_t BeginTmaCapture() {
  ...
  CUresult result = cuLibraryGetModule(
      &module, reinterpret_cast<CUlibrary>(EmbedCubinModule_cake_fmha_request_ordered_paged_decode_runtime_lengths_one_page_a6838733ac6f3b24b18d_sm_103a::Global()->mod.GetHandle()));
  TVM_FFI_CHECK(result == CUDA_SUCCESS, RuntimeError)
      << "cuLibraryGetModule preparing TMA capture failed: CUresult=" << static_cast<int>(result);
  result = cuModuleGetFunction(&function, module, "kernel_cake_fmha_request_ordered_paged_decode_runtime_lengths_one_page_a6838733ac6f3b24b18d");
  TVM_FFI_CHECK(result == CUDA_SUCCESS, RuntimeError)
...
TVM_FFI_DLL_EXPORT_TYPED_FUNC(run, cake_host_shim_c8d75785d5b77c41::Run);
TVM_FFI_DLL_EXPORT_TYPED_FUNC(begin_tma_capture, cake_host_shim_c8d75785d5b77c41::BeginTmaCapture);
TVM_FFI_DLL_EXPORT_TYPED_FUNC(run_tma_capture, cake_host_shim_c8d75785d5b77c41::RunTmaCapture);
TVM_FFI_DLL_EXPORT_TYPED_FUNC(finalize_tma_capture, cake_host_shim_c8d75785d5b77c41::FinalizeTmaCapture);
TVM_FFI_DLL_EXPORT_TYPED_FUNC(discard_tma_capture, cake_host_shim_c8d75785d5b77c41::DiscardTmaCapture);
