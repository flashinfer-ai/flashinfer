...
__global__ __launch_bounds__(512, 1) void kernel_mamba_ssd_q_tmem_alias_f16_batched(
    ...
    __half* __restrict__ initial_states, __half* __restrict__ final_states,
    __half* __restrict__ checkpoint_states, int* __restrict__ checkpoint_token_indices,
