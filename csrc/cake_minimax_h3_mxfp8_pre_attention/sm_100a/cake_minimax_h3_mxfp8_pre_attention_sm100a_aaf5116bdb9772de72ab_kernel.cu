...
#define ROWS_PER_DESTINATION 779520
#define SCALE_STRIDE 3118080
...
kernel_cake_minimax_h3_mxfp8_pre_attention_sm100a_aaf5116bdb9772de72ab(__nv_bfloat16* __restrict__ qkv_bf16, __nv_bfloat16* __restrict__ q_norm_weight, __nv_bfloat16* __restrict__ k_norm_weight, __nv_bfloat16* __restrict__ rope_cos_sin, uint8_t* __restrict__ out_q, uint8_t* __restrict__ out_sf, __nv_bfloat16* __restrict__ debug_q_bf16, __nv_bfloat16* __restrict__ debug_k_bf16, int write_debug, float eps)
{
