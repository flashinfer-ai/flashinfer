...
#define ROWS_PER_DESTINATION 1620864
#define SCALE_STRIDE 6483456
...
kernel_cake_minimax_h3_mxfp8_pre_attention_sm100a_35ff85b4237a155d2f39(__nv_bfloat16* __restrict__ qkv_bf16, __nv_bfloat16* __restrict__ q_norm_weight, __nv_bfloat16* __restrict__ k_norm_weight, __nv_bfloat16* __restrict__ rope_cos_sin, uint8_t* __restrict__ out_q, uint8_t* __restrict__ out_sf, __nv_bfloat16* __restrict__ debug_q_bf16, __nv_bfloat16* __restrict__ debug_k_bf16, int write_debug, float eps)
{
