...
kernel_cake_msa_decode_m16_bf16_flat(const __grid_constant__ CakeMsaTensorMap Q_value, const __grid_constant__ CakeMsaTensorMap Q_prefill_value, __nv_bfloat16* __restrict__ Q_prefill_raw, const __grid_constant__ CakeMsaTensorMap K_value, const __grid_constant__ CakeMsaTensorMap K_prefill_pair_value, const __grid_constant__ CakeMsaTensorMap V_value, const __grid_constant__ CakeMsaTensorMap V_prefill_pair_value, const __grid_constant__ CakeMsaTensorMap KV_value, __nv_bfloat16* __restrict__ O, float* __restrict__ partial_O, float* __restrict__ partial_M, float* __restrict__ partial_D, int* __restrict__ split_completion, float* __restrict__ msa_lse, int* __restrict__ kv_indices, int* __restrict__ qo_indptr, int* __restrict__ kv_indptr, int* __restrict__ kv_len_arr, int* __restrict__ task_kind, int* __restrict__ task_request, int* __restrict__ task_kv_head, int* __restrict__ task_q_tile, int* __restrict__ task_split, int* __restrict__ task_kv_tile_begin, int* __restrict__ task_kv_tile_end, int* __restrict__ task_qo_begin, int* __restrict__ task_qo_end, int* __restrict__ task_page_begin, int* __restrict__ task_page_end, int* __restrict__ status, int num_requests, int num_q_heads, int num_kv_heads, int max_kv_tiles, int max_splits, int max_task_claims, float softmax_scale_log2, int attention_mode, int is_causal, int derive_q_offset, int record_tasks, int msa_max_pages, int msa_split_policy)
{
                                ...
                                for (int row_group = 0; row_group < 2; row_group++) {
                                    ...
                                    if (reduce_row < valid_rows) {
                                        ...
                                        for (int reduce_split_2 = 0; reduce_split_2 < max_splits; reduce_split_2++) {
                                            ...
                                            float split_scale_1 = ((split_m_2 == -CAKE_MSA_INF) ? 0.0f : _exp2_10);
