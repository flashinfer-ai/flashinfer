            ...
            for (int n_iter = 0; n_iter < num_n_blocks; n_iter++) {
                ...
                if (tail_valid > 0 && tail_valid < 64) {
                    ...
                    for (int _i_6 = 0; _i_6 < 32; _i_6++) {
                        if (!(_slice_lo_mask_2 & (1u << _i_6))) _tmem_load_1[0 + _i_6] = -CAKE_MSA_INF;
                    }
                    ...
                    for (int _i_8 = 0; _i_8 < 32; _i_8++) {
                        if (!(_slice_lo_mask_3 & (1u << _i_8))) _tmem_load_1[32 + _i_8] = -CAKE_MSA_INF;
                    }
                }
                ...
                if (return_temperature_lse != 0) {
                    ...
                    if (tail_valid > 0 && tail_valid < 64) {
                        ...
                        for (int _i_17 = 0; _i_17 < 32; _i_17++) {
                            if (!(_slice_lo_mask_4 & (1u << _i_17))) _tmem_load_2[0 + _i_17] = -CAKE_MSA_INF;
                        }
                        ...
                        for (int _i_19 = 0; _i_19 < 32; _i_19++) {
                            if (!(_slice_lo_mask_5 & (1u << _i_19))) _tmem_load_2[32 + _i_19] = -CAKE_MSA_INF;
                        }
                    }
                    ...
                    if (body_valid > 0 && body_valid < 64) {
                        ...
                        for (int _i_23 = 0; _i_23 < 32; _i_23++) {
                            if (!(_slice_lo_mask_6 & (1u << _i_23))) _tmem_load_3[0 + _i_23] = -CAKE_MSA_INF;
                        }
                        ...
                        for (int _i_25 = 0; _i_25 < 32; _i_25++) {
                            if (!(_slice_lo_mask_7 & (1u << _i_25))) _tmem_load_3[32 + _i_25] = -CAKE_MSA_INF;
                        }
                    }
