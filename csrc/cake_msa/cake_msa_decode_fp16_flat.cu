...
kernel_cake_msa_decode_fp16_flat(const __grid_constant__ CakeMsaTensorMap Q_value, const __grid_constant__ CakeMsaTensorMap Q_prefill_value, __half* __restrict__ Q_prefill_raw, const __grid_constant__ CakeMsaTensorMap K_value, const __grid_constant__ CakeMsaTensorMap K_prefill_pair_value, const __grid_constant__ CakeMsaTensorMap V_value, const __grid_constant__ CakeMsaTensorMap V_prefill_pair_value, const __grid_constant__ CakeMsaTensorMap KV_value, __half* __restrict__ O, float* __restrict__ partial_O, float* __restrict__ partial_M, float* __restrict__ partial_D, int* __restrict__ split_completion, float* __restrict__ msa_lse, int* __restrict__ kv_indices, int* __restrict__ qo_indptr, int* __restrict__ kv_indptr, int* __restrict__ kv_len_arr, int* __restrict__ task_kind, int* __restrict__ task_request, int* __restrict__ task_kv_head, int* __restrict__ task_q_tile, int* __restrict__ task_split, int* __restrict__ task_kv_tile_begin, int* __restrict__ task_kv_tile_end, int* __restrict__ task_qo_begin, int* __restrict__ task_qo_end, int* __restrict__ task_page_begin, int* __restrict__ task_page_end, int* __restrict__ status, int num_requests, int num_q_heads, int num_kv_heads, int max_kv_tiles, int max_splits, int max_task_claims, float softmax_scale_log2, int attention_mode, int is_causal, int derive_q_offset, int record_tasks, int msa_max_pages, int msa_split_policy)
{
        ...
        { // softmax_main
            ...
            for (int task_iter = 0; task_iter < max_task_claims + 1; task_iter++) {
                ...
                if (kind == 1) {
                    ...
                    #pragma unroll
                    for (int c = 0; c < 16; c++) {
                        decode_row_max[row_state_base + c] = -CAKE_MSA_INF;
                    ...
                    for (int pair = 0; pair < max_decode_pairs; pair++) {
                        ...
                        for (int c_5 = 0; c_5 < 16; c_5++) {
                            ...
                            acc_scale[c_5] = ((old_max > -CAKE_MSA_INF) ? _exp2_0 : 1.0f);
                        }
                        ...
                        for (int c_6 = 0; c_6 < 16; c_6++) {
                            ...
                            float safe_max = ((new_max_1 == -CAKE_MSA_INF) ? 0.0f : new_max_1);
                    ...
                    if (is_wg1 == 0 || q_stages == 2) {
                        ...
                        float row_max_val = -CAKE_MSA_INF;
                        ...
                        for (int n_iter = 0; n_iter < num_n_blocks; n_iter++) {
                            ...
                            if (body_valid < 64) {
                                ...
                                for (int _i_1 = 0; _i_1 < 32; _i_1++) {
                                    if (!(_slice_lo_mask_0 & (1u << _i_1))) _tmem_load_1[0 + _i_1] = -CAKE_MSA_INF;
                                }
                                ...
                                for (int _i_3 = 0; _i_3 < 32; _i_3++) {
                                    if (!(_slice_lo_mask_1 & (1u << _i_3))) _tmem_load_1[32 + _i_3] = -CAKE_MSA_INF;
                                }
                            }
                            ...
                            if (tail_valid < 64) {
                                ...
                                for (int _i_6 = 0; _i_6 < 32; _i_6++) {
                                    if (!(_slice_lo_mask_2 & (1u << _i_6))) _tmem_load_2[0 + _i_6] = -CAKE_MSA_INF;
                                }
                                ...
                                for (int _i_8 = 0; _i_8 < 32; _i_8++) {
                                    if (!(_slice_lo_mask_3 & (1u << _i_8))) _tmem_load_2[32 + _i_8] = -CAKE_MSA_INF;
                                }
                            }
                            ...
                            float safe_max_1 = ((new_max_2 == -CAKE_MSA_INF) ? 0.0f : new_max_2);
                            ...
                            if (body_valid < 64) {
                                ...
                                for (int _i_14 = 0; _i_14 < 32; _i_14++) {
                                    if (!(_slice_lo_mask_4 & (1u << _i_14))) _tmem_load_3[0 + _i_14] = -CAKE_MSA_INF;
                                }
                                ...
                                for (int _i_16 = 0; _i_16 < 32; _i_16++) {
                                    if (!(_slice_lo_mask_5 & (1u << _i_16))) _tmem_load_3[32 + _i_16] = -CAKE_MSA_INF;
                                }
                            }
            ...
            for (int task_iter_1 = 0; task_iter_1 < max_task_claims + 1; task_iter_1++) {
                ...
                if (kind_1 == 1) {
                    ...
                    for (int c_10 = 0; c_10 < 16; c_10++) {
                        ...
                        float fm = _max_6;
                        final_max[c_10] = fm;
                        float d0 = ((_shfl_1 == -CAKE_MSA_INF) ? 0.0f : softmax_scale_log2 * (_shfl_1 - fm));
                        float d1 = ((_shfl_2 == -CAKE_MSA_INF) ? 0.0f : softmax_scale_log2 * (_shfl_2 - fm));
                    ...
                    for (int h_4 = 0; h_4 < 16; h_4++) {
                        if (group_size_1 > h_4) {
                            ...
                            if (splits == 1) {
                                {
                                    if (d_idx == 0) {
                                        float natural_lse = -CAKE_MSA_INF;
                    ...
                    if (splits > 1) {
                        ...
                        if (d_idx < group_size_1) {
                            ...
                            float stat_scale0 = ((stat_m0 == -CAKE_MSA_INF) ? 0.0f : _exp2_5);
                            float _exp2_6 = approx_exp2(softmax_scale_log2 * (stat_m1 - stat_m));
                            float stat_scale1 = ((stat_m1 == -CAKE_MSA_INF) ? 0.0f : _exp2_6);
                            ...
                            for (int h_5 = 0; h_5 < 16; h_5++) {
                                if (group_size_1 > h_5) {
                                    ...
                                    for (int reduce_split = 0; reduce_split < max_splits; reduce_split++) {
                                        ...
                                        float old_scale = ((reduce_m == -CAKE_MSA_INF) ? 0.0f : _exp2_7);
                                        float _exp2_8 = approx_exp2(softmax_scale_log2 * (split_m - new_m));
                                        float split_scale = ((split_m == -CAKE_MSA_INF) ? 0.0f : _exp2_8);
                                    ...
                                    {
                                        if (d_idx == 0) {
                                            float natural_lse_1 = -CAKE_MSA_INF;
                                            if (reduce_d > 0.0f) {
                                                float _log2_1;
                            ...
                            for (int row_group_3 = 0; row_group_3 < 2; row_group_3++) {
                                ...
                                if (reduce_row < valid_rows) {
                                    ...
                                    for (int reduce_split_2 = 0; reduce_split_2 < max_splits; reduce_split_2++) {
                                        ...
                                        float split_scale_1 = ((split_m_2 == -CAKE_MSA_INF) ? 0.0f : _exp2_9);
                                ...
                                for (int row_group_4 = 0; row_group_4 < 2; row_group_4++) {
                                    ...
                                    if (reduce_row_2 < valid_rows_1) {
                                        ...
                                        for (int reduce_split_5 = 0; reduce_split_5 < max_splits; reduce_split_5++) {
                                            ...
                                            float split_scale_3 = ((split_m_4 == -CAKE_MSA_INF) ? 0.0f : _exp2_10);
