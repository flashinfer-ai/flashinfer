...
void BatchDecodeWithPagedKVCacheRunMLA(
    ...
    Tensor q_nope, Tensor q_pe, Tensor paged_ckv_cache, Tensor paged_kpe_cache,
    Tensor paged_kv_indptr, Tensor paged_kv_indices, Tensor paged_kv_last_page_len, Tensor o,
    double sm_scale, int64_t window_left, double logits_soft_cap, double rope_scale,
    double rope_theta, Optional<Tensor> maybe_lse,
