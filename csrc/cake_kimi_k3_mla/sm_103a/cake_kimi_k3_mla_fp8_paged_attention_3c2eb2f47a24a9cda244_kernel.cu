    ...
    if (warp >= 4 && warp <= 7) {
        ...
        { // softmax_wg1_main
            ...
            if (is_reducer_1 != 0) {
                ...
                smem_stats[336 + red_col_1] = csum_1;
    ...
    if (warp >= 8 && warp <= 11) {
        ...
        { // softmax_wg2_main
            ...
            for (int tile_2 = 0; tile_2 < my_n_tiles_2; tile_2++) {
                ...
                for (int k_20 = 0; k_20 < 8; k_20 += 4) {
                    ...
                    for (int e_20 = 0; e_20 < 4; e_20++) {
                        ...
                        float _max_32 = max_noftz(pm_3, _tmem_load_12[k_20 + e_20]);
                        pm_3 = _max_32;
                    }
                }
                ...
                for (int k_21 = 0; k_21 < 8; k_21 += 4) {
                    ...
                    for (int e_21 = 0; e_21 < 4; e_21++) {
                        ...
                        float _max_33 = max_noftz(pm_0_2, _tmem_load_13[k_21 + e_21]);
                        pm_0_2 = _max_33;
                    }
                }
                float _max_34 = max_noftz(pm_3, pm_0_2);
                float pm_1_2 = _max_34;
                ...
                if (wg_exceed_2 != 0) {
                    ...
                    for (int j_39 = 0; j_39 < 4; j_39++) {
                        ...
                        float _max_35 = max_noftz(keep_12, recv_12);
                        red_2[j_39] = _max_35;
                    }
                    ...
                    for (int j_40 = 0; j_40 < 2; j_40++) {
                        ...
                        float _max_36 = max_noftz(keep_13, recv_13);
                        red_2[j_40] = _max_36;
                    }
                    ...
                    for (int j_43 = 0; j_43 < 4; j_43++) {
                        ...
                        float _max_40 = max_noftz(keep_15, recv_15);
                        red_3_2[j_43] = _max_40;
                    }
                    ...
                    for (int j_44 = 0; j_44 < 2; j_44++) {
                        ...
                        float _max_41 = max_noftz(keep_16, recv_16);
                        red_3_2[j_44] = _max_41;
                    }
            ...
            if (is_reducer_2 != 0) {
                ...
                smem_stats[336 + red_col_2] = csum_2;
