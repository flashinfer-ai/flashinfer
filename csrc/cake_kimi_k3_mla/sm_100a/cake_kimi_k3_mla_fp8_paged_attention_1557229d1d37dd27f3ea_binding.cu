...
// tvm-ffi direct-source launcher for Cake kernel 'kernel_cake_kimi_k3_mla_fp8_paged_attention_1557229d1d37dd27f3ea'.
#include <cuda.h>
#include <cuda_bf16.h>
#include <cuda_fp16.h>
...
void Run(TensorView arg_partial_O, TensorView arg_partial_max, TensorView arg_partial_sum, TensorView arg_O, TensorView arg_cum_seq_lens_q, int64_t arg_batch, int64_t arg_num_heads, int64_t arg_num_split, double arg_bmm2_scale, int64_t grid_x, int64_t grid_y, int64_t grid_z) {
  ...
  cudaError_t launch_status = cudaLaunchKernelExC(
      &config, reinterpret_cast<const void*>(kernel_cake_kimi_k3_mla_fp8_paged_attention_1557229d1d37dd27f3ea), kargs);
  TVM_FFI_CHECK(launch_status == cudaSuccess, RuntimeError)
      << "cudaLaunchKernelExC for kernel_cake_kimi_k3_mla_fp8_paged_attention_1557229d1d37dd27f3ea failed: "
      << cudaGetErrorString(launch_status);
}

}  // namespace cake_host_shim_7395883cfd393494

TVM_FFI_DLL_EXPORT_TYPED_FUNC(run, cake_host_shim_7395883cfd393494::Run);
