...
Array<int64_t> BatchPrefillWithKVCachePlan(
    ...
    int64_t head_dim_vo, bool causal, int64_t window_left, int64_t window_right,
  ...
  cudaError_t status = PrefillPlan<IdType>(
      ...
      /*sizeof_dtype_o=*/2, window_left, window_right, fixed_split_size, disable_split_kv,
...
Array<int64_t> BatchPrefillWithKVCacheWorkspaceSize(
    ...
    bool causal, int64_t window_left, int64_t window_right, int64_t fixed_split_size,
  ...
  cudaError_t status = PrefillPlanWorkspaceSize<IdType>(
      ...
      enable_cuda_graph, /*sizeof_dtype_o=*/2, window_left, window_right, fixed_split_size,
      disable_split_kv, num_colocated_ctas, uniform_q_len, stream, /*kv_dtype_bytes=*/sizeof(DTypeKV));
