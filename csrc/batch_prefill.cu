...
Array<int64_t> BatchPrefillWithKVCachePlan(
    ...
    bool disable_split_kv, int64_t num_colocated_ctas = 0, int64_t sizeof_dtype_kv = 2) {
  ...
  cudaError_t status = PrefillPlan<IdType>(
      ...
      /*sizeof_dtype_o=*/2, static_cast<uint32_t>(sizeof_dtype_kv), window_left, fixed_split_size,
