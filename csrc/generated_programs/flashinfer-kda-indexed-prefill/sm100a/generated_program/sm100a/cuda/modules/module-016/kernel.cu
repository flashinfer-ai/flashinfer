...
kernel_flashkda_bf16_persistent_m128(__nv_bfloat16* __restrict__ q, CudaTensorMap const* q_tma, __nv_bfloat16* __restrict__ k, CudaTensorMap const* k_tma, __nv_bfloat16* __restrict__ v, CudaTensorMap const* v_tma, __nv_bfloat16* __restrict__ g, CudaTensorMap const* g_tma, __nv_bfloat16* __restrict__ beta, CudaTensorMap const* beta_tma, float* __restrict__ A_log, float* __restrict__ dt_bias, long long* __restrict__ cu_seqlens, int* __restrict__ seq_order, int* __restrict__ task_ids, int* __restrict__ task_offsets, int* __restrict__ task_token_starts, int* __restrict__ task_token_counts, int* __restrict__ task_state_sources, int* __restrict__ task_state_destinations, __nv_bfloat16* __restrict__ mid_state, unsigned int* __restrict__ mid_state_ready, __nv_bfloat16* __restrict__ initial_state, __nv_bfloat16* __restrict__ out, CudaTensorMap const* out_tma, __nv_bfloat16* __restrict__ final_state, unsigned long long state_indices_addr, long long state_slot_stride, int use_state_indices, float* __restrict__ initial_state_f32, float* __restrict__ final_state_f32, int num_heads, int use_initial_state, int store_final_state, float scale, float lower_bound)
{
                            ...
                            for (int state_col_block_3 = 0; state_col_block_3 < 4; state_col_block_3++) {
                                    ...
                                    : "r"(taddr + 64 + (unsigned int)tmem_row_base + (unsigned int)(state_col_block_3 * 32)));
                                {
                                    ...
                                    for (int state_quarter_1 = 0; state_quarter_1 < 4; state_quarter_1++) {
                                        {
                                            unsigned _stv8_3_0 = __float_as_uint(_tmem_load_4[state_quarter_1 * 8 + 0]);
                                            unsigned _stv8_3_1 = __float_as_uint(_tmem_load_4[state_quarter_1 * 8 + 1]);
                                            unsigned _stv8_3_2 = __float_as_uint(_tmem_load_4[state_quarter_1 * 8 + 2]);
                                            unsigned _stv8_3_3 = __float_as_uint(_tmem_load_4[state_quarter_1 * 8 + 3]);
                                            unsigned _stv8_3_4 = __float_as_uint(_tmem_load_4[state_quarter_1 * 8 + 4]);
                                            unsigned _stv8_3_5 = __float_as_uint(_tmem_load_4[state_quarter_1 * 8 + 5]);
                                            unsigned _stv8_3_6 = __float_as_uint(_tmem_load_4[state_quarter_1 * 8 + 6]);
                                            unsigned _stv8_3_7 = __float_as_uint(_tmem_load_4[state_quarter_1 * 8 + 7]);
                                            asm volatile(
                                                "st.global.v8.b32 [%0], {%1, %2, %3, %4, %5, %6, %7, %8};"
                                                :: "l"((void*)(final_state_f32 + (state_base + (long long)(state_col_block_3 * 32) + (long long)(state_quarter_1 * 8)) + (0))), "r"(_stv8_3_0), "r"(_stv8_3_1), "r"(_stv8_3_2), "r"(_stv8_3_3), "r"(_stv8_3_4), "r"(_stv8_3_5), "r"(_stv8_3_6), "r"(_stv8_3_7) : "memory");
                                        }
                                    }
                                }
                            }
