...
kernel_flashkda_bf16_fused_m128_vtile(__nv_bfloat16* __restrict__ q, CudaTensorMap const* q_tma, __nv_bfloat16* __restrict__ k, CudaTensorMap const* k_tma, __nv_bfloat16* __restrict__ v, CudaTensorMap const* v_tma, __nv_bfloat16* __restrict__ g, CudaTensorMap const* g_tma, __nv_bfloat16* __restrict__ beta, CudaTensorMap const* beta_tma, float* __restrict__ A_log, float* __restrict__ dt_bias, long long* __restrict__ cu_seqlens, int* __restrict__ seq_order, __nv_bfloat16* __restrict__ initial_state, __nv_bfloat16* __restrict__ out, CudaTensorMap const* out_tma, __nv_bfloat16* __restrict__ final_state, unsigned long long state_indices_addr, long long state_slot_stride, int use_state_indices, float* __restrict__ initial_state_f32, float* __restrict__ final_state_f32, int uniform_seq_len, int persistent_tasks, int persistent_stride, int num_heads, int use_initial_state, int store_final_state, float scale, float lower_bound)
{
