...
kernel_cake_bf16_bmm_706b766a7aedb03057b4(__nv_bfloat16* __restrict__ A, __nv_bfloat16* __restrict__ B_storage, uint8_t* __restrict__ out_bytes, int M, int N, int a_stride_b, int a_stride_m, int a_stride_k, int b_stride_b, int b_stride_n, int b_stride_k, int out_type)
{
    ...
    int effective_m = 48;
    int effective_n = 80;
    int effective_a_stride_b = 12288;
    int effective_a_stride_m = 256;
    int effective_a_stride_k = 1;
    int effective_b_stride_b = 20480;
