...
__global__ __launch_bounds__(256) void kernel_flashinfer_mnnvl_moe_alltoall_dispatch(
    int* __restrict__ token_selected_experts, uint8_t* __restrict__ payload_0,
    uint8_t* __restrict__ payload_1, uint8_t* __restrict__ payload_2,
    uint8_t* __restrict__ payload_3, uint8_t* __restrict__ payload_4,
    uint8_t* __restrict__ payload_5, uint8_t* __restrict__ workspace,
    ...
    unsigned long long payload_4_offset, unsigned long long payload_5_offset, int payload_0_bytes,
    int payload_1_bytes, int payload_2_bytes, int payload_3_bytes, int payload_4_bytes,
    int payload_5_bytes, int num_payloads, int max_tokens_per_rank, int local_num_tokens,
    int ep_rank, int ep_size, int num_experts, int top_k, int eplb_stats_num_experts,
    bool enable_pdl, bool enable_eplb, bool enable_rank_mask, unsigned long long active_rank_mask) {
  ...
  if (local_num_tokens > 0) {
    if (tid == 0) {
      ...
      unsigned long long topk_workspace_base =
          ...
          (unsigned long long)local_token_idx * (unsigned long long)top_k;
...
#pragma unroll 1
      for (int k = 0; k < top_k; k++) {
        ...
        if (first_for_rank != 0 && rank_is_active != 0) {
          unsigned long long send_counter_index =
              (local_workspace_base + send_counters_offset) / 4 + (unsigned long long)target_rank;
    ...
    __syncthreads();
    if (num_payloads > 0) {
      unsigned long long source_base_0 =
          (unsigned long long)local_token_idx * (unsigned long long)payload_0_bytes;
#pragma unroll 1
...
#pragma unroll 1
        for (int k_0 = 0; k_0 < top_k; k_0++) {
          ...
          if (send_index_0 >= 0) {
            unsigned long long destination_0 =
                (unsigned long long)target_rank_0 * workspace_stride_bytes + payload_0_offset +
                ((unsigned long long)ep_rank * (unsigned long long)max_tokens_per_rank +
                 (unsigned long long)send_index_0) *
                    (unsigned long long)payload_0_bytes +
                (unsigned long long)byte_0;
    ...
    if (num_payloads > 1) {
      unsigned long long source_base_1 =
          (unsigned long long)local_token_idx * (unsigned long long)payload_1_bytes;
#pragma unroll 1
...
#pragma unroll 1
        for (int k_1 = 0; k_1 < top_k; k_1++) {
          ...
          if (send_index_1 >= 0) {
            unsigned long long destination_1 =
                (unsigned long long)target_rank_1 * workspace_stride_bytes + payload_1_offset +
                ((unsigned long long)ep_rank * (unsigned long long)max_tokens_per_rank +
                 (unsigned long long)send_index_1) *
                    (unsigned long long)payload_1_bytes +
    ...
    if (num_payloads > 2) {
      unsigned long long source_base_2 =
          (unsigned long long)local_token_idx * (unsigned long long)payload_2_bytes;
#pragma unroll 1
...
#pragma unroll 1
        for (int k_2 = 0; k_2 < top_k; k_2++) {
          ...
          if (send_index_2 >= 0) {
            unsigned long long destination_2 =
                (unsigned long long)target_rank_2 * workspace_stride_bytes + payload_2_offset +
                ((unsigned long long)ep_rank * (unsigned long long)max_tokens_per_rank +
                 (unsigned long long)send_index_2) *
                    (unsigned long long)payload_2_bytes +
    ...
    if (num_payloads > 3) {
      unsigned long long source_base_3 =
          (unsigned long long)local_token_idx * (unsigned long long)payload_3_bytes;
#pragma unroll 1
...
#pragma unroll 1
        for (int k_3 = 0; k_3 < top_k; k_3++) {
          ...
          if (send_index_3 >= 0) {
            unsigned long long destination_3 =
                (unsigned long long)target_rank_3 * workspace_stride_bytes + payload_3_offset +
                ((unsigned long long)ep_rank * (unsigned long long)max_tokens_per_rank +
                 (unsigned long long)send_index_3) *
                    (unsigned long long)payload_3_bytes +
    ...
    if (num_payloads > 4) {
      unsigned long long source_base_4 =
          (unsigned long long)local_token_idx * (unsigned long long)payload_4_bytes;
#pragma unroll 1
...
#pragma unroll 1
        for (int k_4 = 0; k_4 < top_k; k_4++) {
          ...
          if (send_index_4 >= 0) {
            unsigned long long destination_4 =
                (unsigned long long)target_rank_4 * workspace_stride_bytes + payload_4_offset +
                ((unsigned long long)ep_rank * (unsigned long long)max_tokens_per_rank +
                 (unsigned long long)send_index_4) *
                    (unsigned long long)payload_4_bytes +
    ...
    if (num_payloads > 5) {
      unsigned long long source_base_5 =
          (unsigned long long)local_token_idx * (unsigned long long)payload_5_bytes;
#pragma unroll 1
...
#pragma unroll 1
        for (int k_5 = 0; k_5 < top_k; k_5++) {
          ...
          if (send_index_5 >= 0) {
            unsigned long long destination_5 =
                (unsigned long long)target_rank_5 * workspace_stride_bytes + payload_5_offset +
                ((unsigned long long)ep_rank * (unsigned long long)max_tokens_per_rank +
                 (unsigned long long)send_index_5) *
                    (unsigned long long)payload_5_bytes +
                (unsigned long long)byte_5;
  ...
  if (warp == 0) {
    ...
    if (lane == 0) {
      if (local_num_tokens == 0) {
        ...
        unsigned long long local_counter_index =
            (local_workspace_base + local_token_counter_offset) / 4;
...
#pragma unroll 1
      for (int target_rank_6 = lane; target_rank_6 < ep_size; target_rank_6 += 32) {
        ...
        if (rank_is_active_1 != 0) {
          unsigned long long send_counter_index_1 =
              (local_workspace_base + send_counters_offset) / 4 + (unsigned long long)target_rank_6;
          unsigned long long recv_counter_index =
              ((unsigned long long)target_rank_6 * workspace_stride_bytes + recv_counters_offset) /
                  4 +
...
#pragma unroll 1
        for (int target_rank_eplb = 0; target_rank_eplb < ep_size; target_rank_eplb++) {
          ...
          if (rank_is_active_eplb != 0) {
            unsigned long long gathered_base =
                ((unsigned long long)target_rank_eplb * workspace_stride_bytes +
                 eplb_gathered_stats_offset) /
                    4 +
                (unsigned long long)ep_rank * (unsigned long long)eplb_stats_num_experts;
#pragma unroll 1
            for (int expert_stat = lane; expert_stat < eplb_stats_num_experts; expert_stat += 32) {
              workspace_i32[gathered_base + (unsigned long long)expert_stat] =
                  eplb_local_stats[expert_stat];
            }
          }
        }
      }
      ...
      for (int target_rank_flag = lane; target_rank_flag < ep_size; target_rank_flag += 32) {
        ...
        if (rank_is_active_flag != 0) {
          unsigned long long remote_flag_index =
              ((unsigned long long)target_rank_flag * workspace_stride_bytes +
