...
__global__ __launch_bounds__(64) void kernel_flashinfer_mnnvl_moe_alltoall_publish_combine(
    ...
    unsigned long long flag_val_offset, unsigned long long completion_flags_offset, int ep_rank,
    int ep_size, bool enable_pdl, bool enable_rank_mask, unsigned long long active_rank_mask) {
