...
std::vector<CutlassGemmConfig> get_candidate_configs_sm120(
  ...
  // All candidate tiles for SM120 block-scaled (FP4 / MXFP8). Tiles that can never dispatch are
  // pruned below; anything else invalid is still skipped gracefully by the try-catch in
