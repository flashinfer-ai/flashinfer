...
namespace cutlass_kernels
{
        ...
        INSTANTIATE_TMA_WARP_SPECIALIZED_MOE_GEMM(Sm100, SafeFP4, SafeFP4, half,
                EpilogueOpDefault, NONE, 128, 64, 256, 1, 1, 1, false, false);
        ...
        INSTANTIATE_TMA_WARP_SPECIALIZED_MOE_GEMM(Sm100, SafeFP4, SafeFP4, half,
                EpilogueOpDefault, NONE, 128, 128, 256, 1, 2, 1, false, false);
        ...
        INSTANTIATE_TMA_WARP_SPECIALIZED_MOE_GEMM(Sm100, SafeFP4, SafeFP4, half,
                EpilogueOpDefault, NONE, 128, 128, 256, 1, 1, 1, false, false);
        ...
        INSTANTIATE_TMA_WARP_SPECIALIZED_MOE_GEMM(Sm100, SafeFP4, SafeFP4, half,
                EpilogueOpDefault, NONE, 128, 256, 256, 1, 2, 1, false, false);
        ...
        INSTANTIATE_TMA_WARP_SPECIALIZED_MOE_GEMM(Sm100, __nv_fp8_e4m3, SafeFP4, half,
                EpilogueOpDefault, NONE, 128, 64, 128, 1, 1, 1, true, false);
        ...
        INSTANTIATE_TMA_WARP_SPECIALIZED_MOE_GEMM(Sm100, __nv_fp8_e4m3, SafeFP4, half,
                EpilogueOpDefault, NONE, 128, 128, 128, 1, 2, 1, true, false);
        ...
        INSTANTIATE_TMA_WARP_SPECIALIZED_MOE_GEMM(Sm100, __nv_fp8_e4m3, SafeFP4, half,
                EpilogueOpDefault, NONE, 128, 128, 128, 1, 1, 1, true, false);
        ...
        INSTANTIATE_TMA_WARP_SPECIALIZED_MOE_GEMM(Sm100, __nv_fp8_e4m3, SafeFP4, half,
                EpilogueOpDefault, NONE, 128, 256, 128, 1, 2, 1, true, false);
