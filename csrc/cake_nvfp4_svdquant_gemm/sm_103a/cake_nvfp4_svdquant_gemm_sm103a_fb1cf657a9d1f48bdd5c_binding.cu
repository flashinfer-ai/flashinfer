...
// tvm-ffi direct-source launcher for Cake kernel 'kernel_cake_nvfp4_svdquant_gemm_sm103a_fb1cf657a9d1f48bdd5c'.
#include <cuda.h>
#include <cuda_bf16.h>
#include <cuda_fp16.h>
...
extern "C" __global__ void kernel_cake_nvfp4_svdquant_gemm_sm103a_fb1cf657a9d1f48bdd5c(const __grid_constant__ CUtensorMap A, const __grid_constant__ CUtensorMap B, const __grid_constant__ CUtensorMap SFA, const __grid_constant__ CUtensorMap SFB, const __grid_constant__ CUtensorMap D, const __grid_constant__ CUtensorMap L1, float* __restrict__ alpha, const __grid_constant__ CUtensorMap out, int K_tiles);


namespace cake_host_shim_10157c954af5484b {
...
void Run(TensorView arg_A, TensorView arg_B, TensorView arg_SFA, TensorView arg_SFB, TensorView arg_D, TensorView arg_L1, TensorView arg_alpha, TensorView arg_out, int64_t arg_K_tiles, int64_t grid_x, int64_t grid_y, int64_t grid_z) {
    ...
    if (it == smem_status_by_device->end()) {
      ...
      if (smem_status == cudaSuccess) {
        smem_status = cudaFuncSetAttribute(
            reinterpret_cast<const void*>(kernel_cake_nvfp4_svdquant_gemm_sm103a_fb1cf657a9d1f48bdd5c),
  ...
  TVM_FFI_CHECK(smem_status == cudaSuccess, RuntimeError)
      << "cudaFuncSetAttribute for kernel_cake_nvfp4_svdquant_gemm_sm103a_fb1cf657a9d1f48bdd5c failed: "
  ...
  cudaError_t launch_status = cudaLaunchKernelExC(
      &config, reinterpret_cast<const void*>(kernel_cake_nvfp4_svdquant_gemm_sm103a_fb1cf657a9d1f48bdd5c), kargs);
  TVM_FFI_CHECK(launch_status == cudaSuccess, RuntimeError)
      << "cudaLaunchKernelExC for kernel_cake_nvfp4_svdquant_gemm_sm103a_fb1cf657a9d1f48bdd5c failed: "
      << cudaGetErrorString(launch_status);
}

}  // namespace cake_host_shim_10157c954af5484b

TVM_FFI_DLL_EXPORT_TYPED_FUNC(run, cake_host_shim_10157c954af5484b::Run);
