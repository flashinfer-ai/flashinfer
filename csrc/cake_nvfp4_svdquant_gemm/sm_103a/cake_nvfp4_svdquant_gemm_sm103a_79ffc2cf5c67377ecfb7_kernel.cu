...
kernel_cake_nvfp4_svdquant_gemm_sm103a_79ffc2cf5c67377ecfb7(CakeTensorMap const* A, CakeTensorMap const* B, CakeTensorMap const* SFA, CakeTensorMap const* SFB, CakeTensorMap const* D, CakeTensorMap const* L1, float* __restrict__ alpha, __nv_bfloat16* __restrict__ bias, CakeTensorMap const* out, int M, int N, int K_tiles, int rank_tiles, int grid_n, int has_bias)
{
