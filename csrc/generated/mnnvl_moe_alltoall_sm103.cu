...
template <int N>
struct __align__(128) FlashInferTensorMapPack {
  FlashInferTensorMap maps[N];
};
...
__global__ __launch_bounds__(64) void kernel_flashinfer_mnnvl_moe_alltoall_prepare_dispatch(
    int* __restrict__ send_counters, int* __restrict__ local_token_counter, int ep_size,
    unsigned int* __restrict__ flag_val, bool enable_pdl) {
...
#pragma unroll 1
    ...
    __syncthreads();
    if (num_payloads > 0) {
      unsigned long long source_base =
...
#pragma unroll 1
        for (int byte_offset = tid * 16; byte_offset < payload_0_bytes; byte_offset += 4096) {
          int _vec_load_0[4];
          {
            int4 _iv4 = *reinterpret_cast<const int4*>(
                payload_i32 + (source_base + (unsigned long long)byte_offset) / 4);
          ...
          for (int k_1 = 0; k_1 < top_k; k_1++) {
            ...
            if (send_index_1 >= 0) {
              unsigned long long destination =
                  (unsigned long long)target_rank_1 * workspace_stride_bytes + payload_0_offset +
              ...
              {
                int4 _iv4 = make_int4(_vec_load_0[0 + 0], _vec_load_0[0 + 1], _vec_load_0[0 + 2],
                                      _vec_load_0[0 + 3]);
          ...
          for (int k_2 = 0; k_2 < top_k; k_2++) {
            ...
            if (send_index_2 >= 0) {
              unsigned long long destination_1 =
                  (unsigned long long)target_rank_2 * workspace_stride_bytes + payload_0_offset +
                  ((unsigned long long)ep_rank * (unsigned long long)max_tokens_per_rank +
                   (unsigned long long)send_index_2) *
                      (unsigned long long)payload_0_bytes +
                  (unsigned long long)byte_offset_1;
...
#pragma unroll 1
        for (int byte_offset_2 = tid * 16; byte_offset_2 < payload_1_bytes; byte_offset_2 += 4096) {
          ...
          {
            int4 _iv4 = *reinterpret_cast<const int4*>(
                payload_i32_1 + (source_base_1 + (unsigned long long)byte_offset_2) / 4);
          ...
          for (int k_3 = 0; k_3 < top_k; k_3++) {
            ...
            if (send_index_3 >= 0) {
              unsigned long long destination_2 =
                  (unsigned long long)target_rank_3 * workspace_stride_bytes + payload_1_offset +
                  ((unsigned long long)ep_rank * (unsigned long long)max_tokens_per_rank +
                   (unsigned long long)send_index_3) *
                      (unsigned long long)payload_1_bytes +
                  (unsigned long long)byte_offset_2;
              {
                int4 _iv4 = make_int4(_vec_load_1[0 + 0], _vec_load_1[0 + 1], _vec_load_1[0 + 2],
                                      _vec_load_1[0 + 3]);
          ...
          for (int k_4 = 0; k_4 < top_k; k_4++) {
            ...
            if (send_index_4 >= 0) {
              unsigned long long destination_3 =
                  (unsigned long long)target_rank_4 * workspace_stride_bytes + payload_1_offset +
                  ((unsigned long long)ep_rank * (unsigned long long)max_tokens_per_rank +
                   (unsigned long long)send_index_4) *
                      (unsigned long long)payload_1_bytes +
                  (unsigned long long)byte_offset_3;
...
#pragma unroll 1
        for (int byte_offset_4 = tid * 16; byte_offset_4 < payload_2_bytes; byte_offset_4 += 4096) {
          ...
          {
            int4 _iv4 = *reinterpret_cast<const int4*>(
                payload_i32_2 + (source_base_2 + (unsigned long long)byte_offset_4) / 4);
          ...
          for (int k_5 = 0; k_5 < top_k; k_5++) {
            ...
            if (send_index_5 >= 0) {
              unsigned long long destination_4 =
                  (unsigned long long)target_rank_5 * workspace_stride_bytes + payload_2_offset +
                  ((unsigned long long)ep_rank * (unsigned long long)max_tokens_per_rank +
                   (unsigned long long)send_index_5) *
                      (unsigned long long)payload_2_bytes +
                  (unsigned long long)byte_offset_4;
              {
                int4 _iv4 = make_int4(_vec_load_2[0 + 0], _vec_load_2[0 + 1], _vec_load_2[0 + 2],
                                      _vec_load_2[0 + 3]);
          ...
          for (int k_6 = 0; k_6 < top_k; k_6++) {
            ...
            if (send_index_6 >= 0) {
              unsigned long long destination_5 =
                  (unsigned long long)target_rank_6 * workspace_stride_bytes + payload_2_offset +
                  ((unsigned long long)ep_rank * (unsigned long long)max_tokens_per_rank +
                   (unsigned long long)send_index_6) *
                      (unsigned long long)payload_2_bytes +
                  (unsigned long long)byte_offset_5;
...
#pragma unroll 1
        for (int byte_offset_6 = tid * 16; byte_offset_6 < payload_3_bytes; byte_offset_6 += 4096) {
          ...
          {
            int4 _iv4 = *reinterpret_cast<const int4*>(
                payload_i32_3 + (source_base_3 + (unsigned long long)byte_offset_6) / 4);
...
#pragma unroll 1
          for (int k_7 = 0; k_7 < top_k; k_7++) {
            ...
            if (send_index_7 >= 0) {
              unsigned long long destination_6 =
                  (unsigned long long)target_rank_7 * workspace_stride_bytes + payload_3_offset +
                  ((unsigned long long)ep_rank * (unsigned long long)max_tokens_per_rank +
                   (unsigned long long)send_index_7) *
                      (unsigned long long)payload_3_bytes +
                  (unsigned long long)byte_offset_6;
              {
                int4 _iv4 = make_int4(_vec_load_3[0 + 0], _vec_load_3[0 + 1], _vec_load_3[0 + 2],
                                      _vec_load_3[0 + 3]);
...
#pragma unroll 1
          for (int k_8 = 0; k_8 < top_k; k_8++) {
            ...
            if (send_index_8 >= 0) {
              unsigned long long destination_7 =
                  (unsigned long long)target_rank_8 * workspace_stride_bytes + payload_3_offset +
                  ((unsigned long long)ep_rank * (unsigned long long)max_tokens_per_rank +
                   (unsigned long long)send_index_8) *
                      (unsigned long long)payload_3_bytes +
                  (unsigned long long)byte_offset_7;
...
#pragma unroll 1
        for (int byte_offset_8 = tid * 16; byte_offset_8 < payload_4_bytes; byte_offset_8 += 4096) {
          ...
          {
            int4 _iv4 = *reinterpret_cast<const int4*>(
                payload_i32_4 + (source_base_4 + (unsigned long long)byte_offset_8) / 4);
...
#pragma unroll 1
          for (int k_9 = 0; k_9 < top_k; k_9++) {
            ...
            if (send_index_9 >= 0) {
              unsigned long long destination_8 =
                  (unsigned long long)target_rank_9 * workspace_stride_bytes + payload_4_offset +
                  ((unsigned long long)ep_rank * (unsigned long long)max_tokens_per_rank +
                   (unsigned long long)send_index_9) *
                      (unsigned long long)payload_4_bytes +
                  (unsigned long long)byte_offset_8;
              {
                int4 _iv4 = make_int4(_vec_load_4[0 + 0], _vec_load_4[0 + 1], _vec_load_4[0 + 2],
                                      _vec_load_4[0 + 3]);
...
#pragma unroll 1
          for (int k_10 = 0; k_10 < top_k; k_10++) {
            ...
            if (send_index_10 >= 0) {
              unsigned long long destination_9 =
                  (unsigned long long)target_rank_10 * workspace_stride_bytes + payload_4_offset +
                  ((unsigned long long)ep_rank * (unsigned long long)max_tokens_per_rank +
                   (unsigned long long)send_index_10) *
                      (unsigned long long)payload_4_bytes +
                  (unsigned long long)byte_offset_9;
...
#pragma unroll 1
        for (int byte_offset_10 = tid * 16; byte_offset_10 < payload_5_bytes;
             byte_offset_10 += 4096) {
          int _vec_load_5[4];
          {
            int4 _iv4 = *reinterpret_cast<const int4*>(
                payload_i32_5 + (source_base_5 + (unsigned long long)byte_offset_10) / 4);
...
#pragma unroll 1
          for (int k_11 = 0; k_11 < top_k; k_11++) {
            ...
            if (send_index_11 >= 0) {
              unsigned long long destination_10 =
                  (unsigned long long)target_rank_11 * workspace_stride_bytes + payload_5_offset +
                  ((unsigned long long)ep_rank * (unsigned long long)max_tokens_per_rank +
                   (unsigned long long)send_index_11) *
                      (unsigned long long)payload_5_bytes +
                  (unsigned long long)byte_offset_10;
              {
                int4 _iv4 = make_int4(_vec_load_5[0 + 0], _vec_load_5[0 + 1], _vec_load_5[0 + 2],
                                      _vec_load_5[0 + 3]);
...
#pragma unroll 1
          for (int k_12 = 0; k_12 < top_k; k_12++) {
            ...
            if (send_index_12 >= 0) {
              unsigned long long destination_11 =
                  (unsigned long long)target_rank_12 * workspace_stride_bytes + payload_5_offset +
                  ((unsigned long long)ep_rank * (unsigned long long)max_tokens_per_rank +
                   (unsigned long long)send_index_12) *
                      (unsigned long long)payload_5_bytes +
                  (unsigned long long)byte_offset_11;
...
#pragma unroll 1
      for (int target_rank_13 = lane; target_rank_13 < ep_size; target_rank_13 += 32) {
        ...
        if (enable_rank_mask) {
          ...
          unsigned long long target_bit_1 = completion_bit_one
                                            << (unsigned long long)target_rank_13;
        ...
        if (rank_is_active_1 != 0) {
          ...
          unsigned long long recv_counter_index =
              ((unsigned long long)target_rank_13 * workspace_stride_bytes + recv_counters_offset) /
                  4 +
...
__global__ __launch_bounds__(256) void kernel_flashinfer_mnnvl_moe_alltoall_stage_combine(
    ...
    unsigned long long destination_offset, unsigned long long payload_bytes,
    bool advance_generation, int ep_rank, bool enable_pdl) {
  const int tid = threadIdx.x;
  const int warp = make_warp_uniform(tid / 32);
  const int lane = tid % 32;
  ...
  int* workspace_i32 = reinterpret_cast<int*>(workspace);
#pragma unroll 1
  for (unsigned long long byte_index = linear_thread * 16; byte_index < vector_bytes;
       byte_index += thread_stride * 16) {
    int _vec_load_0[4];
    {
    ...
    {
      int4 _iv4 =
          make_int4(_vec_load_0[0 + 0], _vec_load_0[0 + 1], _vec_load_0[0 + 2], _vec_load_0[0 + 3]);
      *reinterpret_cast<int4*>(workspace_i32 + (destination_offset + byte_index) / 4) = _iv4;
    }
  }
#pragma unroll 1
  for (unsigned long long byte_index_1 = vector_bytes + linear_thread; byte_index_1 < payload_bytes;
       byte_index_1 += thread_stride) {
...
__global__ __launch_bounds__(64) void kernel_flashinfer_mnnvl_moe_alltoall_publish_combine(
    uint8_t* __restrict__ workspace, unsigned long long workspace_stride_bytes,
    unsigned long long flag_val_offset, unsigned long long completion_flags_offset,
    bool advance_generation, int ep_rank, int ep_size, bool enable_pdl, bool enable_rank_mask,
  ...
  if (tid < ep_size) {
    ...
    if (target_is_active != 0) {
      unsigned long long remote_flag_index =
          ((unsigned long long)target_rank * workspace_stride_bytes + completion_flags_offset) / 4 +
          (unsigned long long)ep_rank;
      asm volatile("st.relaxed.sys.u32 [%0], %1;" ::"l"(
                       (reinterpret_cast<unsigned int*>(workspace_u32) + (remote_flag_index))),
                   "r"(static_cast<unsigned int>(expected_value))
                   : "memory");
      unsigned long long local_flag_index =
          (local_workspace_base + completion_flags_offset) / 4 + (unsigned long long)target_rank;
      {
        unsigned int* _sre_ptr_0 =
            (reinterpret_cast<unsigned int*>(workspace_u32) + (local_flag_index));
        const unsigned int _sre_expected_0 = static_cast<unsigned int>(expected_value);
...
__global__ __launch_bounds__(256) void kernel_flashinfer_mnnvl_moe_alltoall_combine_top_k_1(
...
__global__ __launch_bounds__(256) void kernel_flashinfer_mnnvl_moe_alltoall_combine_top_k_2(
    uint8_t* __restrict__ workspace, uint8_t* __restrict__ output,
    unsigned long long workspace_stride_bytes, unsigned long long topk_target_ranks_offset,
    unsigned long long topk_send_indices_offset, unsigned long long combine_payload_offset,
    int max_tokens_per_rank, int local_num_tokens, int elements_per_token,
...
__global__ __launch_bounds__(256) void kernel_flashinfer_mnnvl_moe_alltoall_combine_top_k_4(
    uint8_t* __restrict__ workspace, uint8_t* __restrict__ output,
    unsigned long long workspace_stride_bytes, unsigned long long topk_target_ranks_offset,
    unsigned long long topk_send_indices_offset, unsigned long long combine_payload_offset,
    int max_tokens_per_rank, int local_num_tokens, int elements_per_token,
...
__global__ __launch_bounds__(256) void kernel_flashinfer_mnnvl_moe_alltoall_combine_top_k_6(
    uint8_t* __restrict__ workspace, uint8_t* __restrict__ output,
    unsigned long long workspace_stride_bytes, unsigned long long topk_target_ranks_offset,
    unsigned long long topk_send_indices_offset, unsigned long long combine_payload_offset,
    int max_tokens_per_rank, int local_num_tokens, int elements_per_token,
...
__global__ __launch_bounds__(256) void kernel_flashinfer_mnnvl_moe_alltoall_combine_top_k_8(
    uint8_t* __restrict__ workspace, uint8_t* __restrict__ output,
    unsigned long long workspace_stride_bytes, unsigned long long topk_target_ranks_offset,
    unsigned long long topk_send_indices_offset, unsigned long long combine_payload_offset,
    int max_tokens_per_rank, int local_num_tokens, int elements_per_token,
...
__global__ __launch_bounds__(256) void kernel_flashinfer_mnnvl_moe_alltoall_combine_top_k_10(
    uint8_t* __restrict__ workspace, uint8_t* __restrict__ output,
    unsigned long long workspace_stride_bytes, unsigned long long topk_target_ranks_offset,
    unsigned long long topk_send_indices_offset, unsigned long long combine_payload_offset,
    int max_tokens_per_rank, int local_num_tokens, int elements_per_token,
...
__global__ __launch_bounds__(256) void kernel_flashinfer_mnnvl_moe_alltoall_combine_top_k_12(
    uint8_t* __restrict__ workspace, uint8_t* __restrict__ output,
    unsigned long long workspace_stride_bytes, unsigned long long topk_target_ranks_offset,
    unsigned long long topk_send_indices_offset, unsigned long long combine_payload_offset,
    int max_tokens_per_rank, int local_num_tokens, int elements_per_token,
...
__global__ __launch_bounds__(256) void kernel_flashinfer_mnnvl_moe_alltoall_combine_top_k_14(
    uint8_t* __restrict__ workspace, uint8_t* __restrict__ output,
    unsigned long long workspace_stride_bytes, unsigned long long topk_target_ranks_offset,
    unsigned long long topk_send_indices_offset, unsigned long long combine_payload_offset,
    int max_tokens_per_rank, int local_num_tokens, int elements_per_token,
...
__global__ __launch_bounds__(256) void kernel_flashinfer_mnnvl_moe_alltoall_combine_top_k_16(
    uint8_t* __restrict__ workspace, uint8_t* __restrict__ output,
    unsigned long long workspace_stride_bytes, unsigned long long topk_target_ranks_offset,
    unsigned long long topk_send_indices_offset, unsigned long long combine_payload_offset,
    int max_tokens_per_rank, int local_num_tokens, int elements_per_token,
...
__global__ __launch_bounds__(256) void kernel_flashinfer_mnnvl_moe_alltoall_combine_top_k_18(
    uint8_t* __restrict__ workspace, uint8_t* __restrict__ output,
    unsigned long long workspace_stride_bytes, unsigned long long topk_target_ranks_offset,
    unsigned long long topk_send_indices_offset, unsigned long long combine_payload_offset,
    int max_tokens_per_rank, int local_num_tokens, int elements_per_token,
...
__global__ __launch_bounds__(256) void kernel_flashinfer_mnnvl_moe_alltoall_combine_top_k_22(
    uint8_t* __restrict__ workspace, uint8_t* __restrict__ output,
    unsigned long long workspace_stride_bytes, unsigned long long topk_target_ranks_offset,
    unsigned long long topk_send_indices_offset, unsigned long long combine_payload_offset,
    int max_tokens_per_rank, int local_num_tokens, int elements_per_token,
...
__global__ __launch_bounds__(256) void kernel_flashinfer_mnnvl_moe_alltoall_combine_bf16_topk8(
    uint8_t* __restrict__ workspace, uint8_t* __restrict__ output,
    unsigned long long workspace_stride_bytes, unsigned long long topk_target_ranks_offset,
    unsigned long long topk_send_indices_offset, unsigned long long combine_payload_offset,
    int max_tokens_per_rank, int local_num_tokens, int elements_per_token,
  ...
  if (token < local_num_tokens) {
    unsigned long long target_base =
        (local_workspace_base + topk_target_ranks_offset) / 4 + (unsigned long long)token * 8;
    unsigned long long send_base =
        (local_workspace_base + topk_send_indices_offset) / 4 + (unsigned long long)token * 8;
#pragma unroll 1
...
#pragma unroll
      for (int element_1 = 0; element_1 < 8; element_1++) {
        ...
        contributions[48 + element_1] =
            contributions[48 + element_1] + contributions[56 + element_1];
        contributions[element_1] = contributions[element_1] + contributions[16 + element_1];
        contributions[32 + element_1] =
            contributions[32 + element_1] + contributions[48 + element_1];
...
__global__ __launch_bounds__(32) void kernel_flashinfer_mnnvl_moe_alltoall_quantize_combine(
    uint8_t* __restrict__ accumulated, uint8_t* __restrict__ quantized_fp8,
    uint8_t* __restrict__ quantized_packed, uint8_t* __restrict__ scales_u8,
    uint8_t* __restrict__ scales_fp8, int elements_per_token, int payload_element_bytes,
    int payload_dtype_code, int quant_mode, int scale_layout, float output_scalar_scale,
    int blocks_per_row, int padded_scale_cols, bool enable_pdl) {
  const int tid = threadIdx.x;
  const int warp = make_warp_uniform(tid / 32);
  const int lane = tid % 32;
  ...
  lane_value[0] = 0.0f;
  if (active_lane != 0) {
    unsigned long long accumulated_item =
        (unsigned long long)token * (unsigned long long)elements_per_token +
        (unsigned long long)column;
    float value = 0.0f;
    if (payload_dtype_code == 0) {
    ...
    if (payload_dtype_code == 2) {
      ...
      float _vec_load_0[1];
      {
        uint8_t _fp8_byte_0 = *reinterpret_cast<const uint8_t*>(
            source_fp8 + accumulated_item * (unsigned long long)payload_element_bytes);
        uint16_t _e4m3x2_0 = (uint16_t)_fp8_byte_0;
        uint32_t _f16x2_0;
        asm volatile("cvt.rn.f16x2.e4m3x2 %0, %1;" : "=r"(_f16x2_0) : "h"(_e4m3x2_0));
        uint16_t _h0_0 = (uint16_t)(_f16x2_0 & 0xFFFFu);
  ...
  if (scale_layout == 0) {
    scale_index = block_column % 4 + block_column / 4 * 512 + token % 32 * 16 +
                  token % 128 / 32 * 4 + token / 128 * (128 * padded_scale_cols);
  }
  if (scale_layout == 1) {
    int tiles = padded_scale_cols / 4;
    scale_index =
        token / 8 * (tiles * 32) + block_column / 4 * 32 + token % 8 * 4 + block_column % 4;
  }
  if (lane == 0) {
    if (quant_mode == 3) {
      {
        ...
        *(reinterpret_cast<unsigned char*>(scales_fp8 + scale_index) + (0)) =
            (unsigned char)(_fp8_pair & 0xFF);
      }
    } else {
    ...
    if (active_lane != 0) {
      {
        ...
        *(reinterpret_cast<unsigned char*>(quantized_fp8 + (token * elements_per_token + column)) +
          (0)) = (unsigned char)(_fp8_pair & 0xFF);
      }
    }
  } else {
...
__global__ __launch_bounds__(256) void kernel_flashinfer_mnnvl_moe_alltoall_sanitize_expert_ids(
    int* __restrict__ expert_ids, int* __restrict__ recv_counters, int ep_size,
    int max_tokens_per_rank, int top_k, int invalid_id, int enable_pdl) {
  const int tid = threadIdx.x;
  const int warp = make_warp_uniform(tid / 32);
  const int lane = tid % 32;
