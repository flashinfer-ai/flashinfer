...
TVM_FFI_EMBED_CUBIN(flashinfer_blackwell_vsa_longseq_warp_specialized_sm100_0a17c589f0);
...
void Run(TensorView arg_q, TensorView arg_k, TensorView arg_v, TensorView arg_out, TensorView arg_lse, TensorView arg_temperature_lse, TensorView arg_block_mask, int64_t arg_mb, int64_t arg_nb, int64_t arg_selected_blocks, int64_t arg_num_q_heads, int64_t arg_num_kv_heads, double arg_softmax_scale_log2, double arg_lse_temperature_scale, int64_t arg_return_softmax_lse, int64_t arg_return_temperature_lse, int64_t grid_x, int64_t grid_y, int64_t grid_z) {
  ...
  static auto kernel = EmbedCubinModule_flashinfer_blackwell_vsa_longseq_warp_specialized_sm100_0a17c589f0::Global()->mod.GetKernel("kernel_flashinfer_blackwell_vsa_longseq_warp_specialized_sm100");
  static std::atomic<signed char> cake_smem_mode_cache[64]{};
  const bool use_oversized_smem = CakeConfigureDynamicSmem(
      kernel, (int)arg_q.device().device_id, 201344,
