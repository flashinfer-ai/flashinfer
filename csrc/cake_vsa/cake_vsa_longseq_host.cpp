...
void Run(TensorView arg_q, TensorView arg_k, TensorView arg_v, TensorView arg_out,
         ...
         int64_t arg_mb, int64_t arg_nb, int64_t arg_selected_blocks, int64_t arg_num_q_heads,
         int64_t arg_num_kv_heads, double arg_softmax_scale_log2, double arg_lse_temperature_scale,
  ...
  static auto kernel =
      EmbedCubinModule_flashinfer_blackwell_vsa_longseq_warp_specialized_sm100_15e30f005b::Global()
          ->mod.GetKernelWithMaxDynamicSharedMemory(
              "kernel_flashinfer_blackwell_vsa_longseq_warp_specialized_sm100", 201344);
