...
// tvm-ffi host launcher for Cake kernel 'kernel_flashinfer_vsa_blk64_persistent_per_head_m64n256_ws_sm100'.
#include <cuda.h>
...
TVM_FFI_EMBED_CUBIN(flashinfer_vsa_blk64_persistent_per_head_m64n256_ws_sm100_63c998b85a);
...
inline CUtensorMap EncodeTma_out(const TensorView& t) {
  ...
  TVM_FFI_CHECK(32u <= global_dim[0] && 64u <= global_dim[1] && 1u <= global_dim[2], ValueError)
      << "TMA box (32, 64, 1) exceeds resolved global dims for 'out'";
...
void Run(TensorView arg_q, TensorView arg_k, TensorView arg_v, TensorView arg_out, TensorView arg_lse, TensorView arg_q2k_indices, TensorView arg_q2k_num, TensorView arg_kv_block_lens, int64_t arg_max_kv_blocks, int64_t arg_sequence_q, int64_t arg_query_blocks, int64_t arg_total_tiles, int64_t arg_tiles_per_cta, int64_t arg_num_heads, double arg_softmax_scale_log2, int64_t arg_return_lse, int64_t grid_x, int64_t grid_y, int64_t grid_z) {
  ...
  static auto kernel = EmbedCubinModule_flashinfer_vsa_blk64_persistent_per_head_m64n256_ws_sm100_63c998b85a::Global()->mod.GetKernel("kernel_flashinfer_vsa_blk64_persistent_per_head_m64n256_ws_sm100");
