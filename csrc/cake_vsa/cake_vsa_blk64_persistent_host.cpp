...
TVM_FFI_EMBED_CUBIN(flashinfer_vsa_blk64_persistent_m64_sm100_a09aff8a73);
...
void Run(TensorView arg_q, TensorView arg_k, TensorView arg_v, TensorView arg_out, TensorView arg_lse, TensorView arg_q2k_indices, TensorView arg_q2k_num, TensorView arg_kv_block_lens, int64_t arg_max_kv_blocks, int64_t arg_sequence_q, int64_t arg_query_blocks, int64_t arg_total_tiles, int64_t arg_tiles_per_cta, int64_t arg_num_heads, double arg_softmax_scale_log2, int64_t arg_return_lse, int64_t grid_x, int64_t grid_y, int64_t grid_z) {
  ...
  static auto kernel = EmbedCubinModule_flashinfer_vsa_blk64_persistent_m64_sm100_a09aff8a73::Global()->mod.GetKernel("kernel_flashinfer_vsa_blk64_persistent_m64_sm100");
  static std::atomic<signed char> cake_smem_mode_cache[64]{};
  const bool use_oversized_smem = CakeConfigureDynamicSmem(
      kernel, (int)arg_q.device().device_id, 150016,
  ...
  TVM_FFI_CHECK_CUBIN_LAUNCHER_CUDA_ERROR(kernel.Launch(kargs, grid, block, stream, 150016u));
}
