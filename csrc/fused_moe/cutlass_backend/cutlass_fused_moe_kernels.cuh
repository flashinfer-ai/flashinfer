...
struct AbsMaxOp {
  ...
  __device__ static Accum abs(T value) {
    return fabsf(static_cast<float>(value));
  }

  __device__ static Accum update(Accum current, T value) {
    return fmaxf(current, abs(value));
  }
...
struct AbsMaxOp<half> {
  ...
  __device__ static Accum update(Accum current, half value) {
...
__global__ void expandInputRowsKernel(
    ...
    float* fp8_token_dequant_scale = nullptr, float const* fp8_token_residual_scale = nullptr,
    ...
    if constexpr (is_nvfp4 || is_mxfp8) {
      ...
      if (threadIdx.x == 0) {
        ...
        float const residual =
            fp8_token_residual_scale ? fp8_token_residual_scale[permuted_row] : 1.0f;
...
void expandInputRowsKernelLauncher(
    ...
    float const* fp8_token_residual_scale, float const** fp8_token_scale_ptr_array,
    bool enable_pdl, cudaStream_t stream) {
#ifdef ENABLE_FP4
  ...
  auto func = [&]() {
    ...
    if constexpr (std::is_same_v<ExpandedActivationsType, __nv_fp8_e4m3> &&
      ...
      TLLM_CHECK_WITH_INFO(quant_params.mxfp8_mxfp4.fc1.weight_block_scale ||
                               ...
                               prequant_scales || use_per_token_fp8_quant,
  ...
  cudaLaunchKernelEx(&config, func, unpermuted_input, permuted_output, unpermuted_scales,
                     ...
                     fp8_token_dequant_scale, fp8_token_residual_scale,
                     fp8_token_scale_ptr_array);
}
...
__global__ __launch_bounds__(ACTIVATION_THREADS_PER_BLOCK) void doActivationKernel(
  ...
  for (int64_t token = blockIdx.x; token < num_valid_tokens; token += gridDim.x) {
    ...
    if (use_per_token_fp8_quant) {
      ...
      for (int64_t elem_index = start_offset; elem_index < num_elems_in_col;
           elem_index += stride) {
      ...
      if (tid == 0) {
        float const quant = row_amax > 0.0f ? (448.0f / row_amax) : 1.0f;
        float const residual = fp8_token_residual_scale ? fp8_token_residual_scale[token] : 1.0f;
        shared_token_quant_scale = quant;
...
void doActivation(T* output, GemmOutputType const* gemm_result, float const* fp8_quant,
  ...
  cudaLaunchKernelEx(&config, fn, output, gemm_result, fp8_quant, bias, bias_is_broadcast,
                     ...
                     fc2_act_sf_flat, fp8_token_dequant_scale, fp8_token_residual_scale,
                     activation_type);
}
...
makeDeepSeekBlockScaleGemmRunnerIfSupported() {
  ...
  if constexpr (std::is_same_v<T, __nv_bfloat16> &&
    ...
    return std::make_unique<
        kernels::fp8_blockscale_gemm::CutlassFp8BlockScaleGemmRunner<
...
template <class T, class WeightType, class OutputType, class InputType, class BackBoneType,
          bool IsMXFPX, Wfp4Afp8ScaleMode Wfp4Afp8Mode, class Enable>
...
#define ADD(name) ADD_NAME(name, name##_size)
  ...
  ADD_NAME(alpha_scale_ptr_array_fc2,
           (use_wfp4afp8 && Wfp4Afp8Mode == Wfp4Afp8ScaleMode::kHummingPreMmaE8M0)
               ? 0
...
template <class T, class WeightType, class OutputType, class InputType, class BackBoneType,
          bool IsMXFPX, Wfp4Afp8ScaleMode Wfp4Afp8Mode, class Enable>
size_t CutlassMoeFCRunner<T, WeightType, OutputType, InputType, BackBoneType, IsMXFPX, Wfp4Afp8Mode,
...
template <class T, class WeightType, class OutputType, class InputType, class BackBoneType,
          bool IsMXFPX, Wfp4Afp8ScaleMode Wfp4Afp8Mode, class Enable>
void CutlassMoeFCRunner<T, WeightType, OutputType, InputType, BackBoneType, IsMXFPX, Wfp4Afp8Mode,
...
CutlassMoeFCRunner<T, WeightType, OutputType, InputType, ScaleBiasType, IsMXFPX, Wfp4Afp8Mode,
...
template <class T, class WeightType, class OutputType, class InputType, class ScaleBiasType,
          bool IsMXFPX, Wfp4Afp8ScaleMode Wfp4Afp8Mode, class Enable>
void CutlassMoeFCRunner<T, WeightType, OutputType, InputType, ScaleBiasType, IsMXFPX, Wfp4Afp8Mode, Enable>::
  ...
  doActivation<T, UnfusedGemmOutputType>(
      ...
      nullptr, nullptr, nullptr, enable_pdl, stream);
...
template <class T, class WeightType, class OutputType, class InputType, class ScaleBiasType,
          bool IsMXFPX, Wfp4Afp8ScaleMode Wfp4Afp8Mode, class Enable>
T const* CutlassMoeFCRunner<T, WeightType, OutputType, InputType, ScaleBiasType, IsMXFPX, Wfp4Afp8Mode,
...
template <class T, class WeightType, class OutputType, class InputType, class BackBoneType,
          bool IsMXFPX, Wfp4Afp8ScaleMode Wfp4Afp8Mode, class Enable>
void CutlassMoeFCRunner<T, WeightType, OutputType, InputType, BackBoneType, IsMXFPX, Wfp4Afp8Mode, Enable>::gemm1(
  ...
  if (using_tma_ws_gemm1) {
    ...
    float const* fp8_token_residual_scale = nullptr;
    if constexpr (use_wfp4afp8 && Wfp4Afp8Mode == Wfp4Afp8ScaleMode::kHummingPreMmaE8M0) {
      TLLM_CHECK(quant_params.fp8_mxfp4.fc2.global_scale != nullptr);
      fp8_token_dequant_scale = act_fp8_token_scale;
      fp8_token_residual_scale = quant_params.fp8_mxfp4.fc2.global_scale;
    }
    ...
    doActivation<GatedActOutputType, UnfusedGemmOutputType>(
        ...
        fc2_fp4_act_flat, fp8_token_dequant_scale, fp8_token_residual_scale, enable_pdl, stream);
...
template <class T, class WeightType, class OutputType, class InputType, class BackBoneType,
          bool IsMXFPX, Wfp4Afp8ScaleMode Wfp4Afp8Mode, class Enable>
void CutlassMoeFCRunner<T, WeightType, OutputType, InputType, BackBoneType, IsMXFPX, Wfp4Afp8Mode, Enable>::gemm2(
    MoeGemmRunner<T, WeightType, OutputType, ScaleBiasType, IsMXFPX, Wfp4Afp8Mode>& gemm_runner,
  ...
  if (use_lora && !fuse_lora_bias) {
    ...
    loraBiasApplyFunc(static_cast<UnfusedGemmOutputType*>(gemm_output),
                      ...
                      ActivationParams(ActivationType::Identity), {}, false, nullptr, nullptr,
...
template <class T, class WeightType, class OutputType, class InputType, class BackBoneType,
          bool IsMXFPX, Wfp4Afp8ScaleMode Wfp4Afp8Mode, class Enable>
bool CutlassMoeFCRunner<T, WeightType, OutputType, InputType, BackBoneType, IsMXFPX, Wfp4Afp8Mode,
...
template <class T, class WeightType, class OutputType, class InputType, class BackBoneType,
          bool IsMXFPX, Wfp4Afp8ScaleMode Wfp4Afp8Mode, class Enable>
auto CutlassMoeFCRunner<T, WeightType, OutputType, InputType, BackBoneType, IsMXFPX, Wfp4Afp8Mode,
...
template <class T, class WeightType, class OutputType, class InputType, class BackBoneType,
          bool IsMXFPX, Wfp4Afp8ScaleMode Wfp4Afp8Mode, class Enable>
void CutlassMoeFCRunner<T, WeightType, OutputType, InputType, BackBoneType, IsMXFPX, Wfp4Afp8Mode, Enable>::
  ...
  if (min_latency_mode) {
    ...
    Self::gemm1(moe_gemm_runner_, blockscale_gemm_runner,
                ...
                act_fp8_token_scale_, input_sf /*input fp4 scale or expanded fp4 scale*/, fc2_fp4_act_scale_,
    ...
    if constexpr (use_wfp4afp8 && Wfp4Afp8Mode == Wfp4Afp8ScaleMode::kHummingPreMmaE8M0) {
      ...
      fp8_token_residual_scale = quant_params.fp8_mxfp4.fc1.global_scale;
    ...
    expandInputRowsKernelLauncher(
        ...
        fp8_token_dequant_scale, fp8_token_residual_scale, act_fp8_token_scale_ptr_array,
        enable_pdl, stream);
    ...
    Self::gemm1(moe_gemm_runner_, blockscale_gemm_runner, gemm1_input, fc1_result_,
                ...
                act_fp8_token_scale_, fc1_fp4_act_scale_, fc2_fp4_act_scale_, quant_params, num_rows,
...
CutlassMoeFCRunner<T, WeightType, OutputType, InputType, BackBoneType, IsMXFPX, Wfp4Afp8Mode, Enable>::
  ...
  auto alpha_scale_flat1 = use_fp4 ? quant_params.fp4.fc1.global_scale
                           : (use_wfp4afp8 && !use_humming_pre_mma) ? quant_params.fp8_mxfp4.fc1.global_scale
                           : use_fp8 ? fp8_dequant1
                           : nullptr;
  auto alpha_scale_flat2 = use_fp4 ? quant_params.fp4.fc2.global_scale
                           : (use_wfp4afp8 && !use_humming_pre_mma) ? quant_params.fp8_mxfp4.fc2.global_scale
...
CutlassMoeFCRunner<T, WeightType, OutputType, InputType, BackBoneType, IsMXFPX, Wfp4Afp8Mode, Enable>::
  ...
  if (min_latency_mode) {
    ...
    bool gemm2_using_finalize_fusion =
        ...
        cutlass_extensions::CutlassGemmConfig::EpilogueFusionType::FINALIZE;
    bool using_fused_finalize =
        use_fused_finalize_ && gemm2_using_finalize_fusion && !use_sm90_mixed_input_gemm && !use_lora;
    TLLM_CHECK_WITH_INFO(
...
std::map<std::string, std::pair<size_t, size_t>> GemmProfilerBackend::getProfilerWorkspaces(
  ...
  // This predicate identifies the shared FP8 activation x packed-MXFP4 storage
  // family.  Wfp4Afp8ScaleMode selects Humming/pre-MMA vs future post-MMA
  // semantics; do not infer the semantic path from dtype/layout alone.
  bool const is_wfp4afp8_family = isWfp4Afp8Family();
  checkWfp4Afp8ScaleMode();
  bool is_w4afp8_quant = is_int_groupwise_w_quant && is_fp8_act_quant && !is_wfp4afp8_family;
  ...
  } else if ((is_int_groupwise_w_quant && !is_wfp4afp8_family) || is_wfp4a16_quant) {
