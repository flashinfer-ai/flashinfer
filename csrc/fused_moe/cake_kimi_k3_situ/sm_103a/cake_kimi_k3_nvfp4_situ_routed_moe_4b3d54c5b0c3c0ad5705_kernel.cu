...
kernel_cake_kimi_k3_nvfp4_situ_routed_moe_4b3d54c5b0c3c0ad5705(int* __restrict__ expert_counts, int* __restrict__ expert_tile_offsets, int* __restrict__ expert_scatter_offsets, int* __restrict__ total_tiles, int num_experts, int tile_n, int tile_n_shift)
{
