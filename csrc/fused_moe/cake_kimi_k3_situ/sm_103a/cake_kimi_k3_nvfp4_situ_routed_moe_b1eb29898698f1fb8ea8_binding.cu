...
// tvm-ffi direct-source launcher for Cake kernel 'kernel_cake_kimi_k3_nvfp4_situ_routed_moe_b1eb29898698f1fb8ea8'.
#include <cuda.h>
#include <cuda_bf16.h>
#include <cuda_fp16.h>
...
namespace cake_host_shim_1cfd36d25a0d3d5f {
...
TVM_FFI_DLL_EXPORT_TYPED_FUNC(run, cake_host_shim_1cfd36d25a0d3d5f::Run);
