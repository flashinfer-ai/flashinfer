...
kernel_cake_kimi_k3_nvfp4_situ_routed_moe_7f90af8af9dda88666ef(__nv_bfloat16* __restrict__ x, float* __restrict__ qx, uint8_t* __restrict__ packed, uint8_t* __restrict__ scales, int M)
{
