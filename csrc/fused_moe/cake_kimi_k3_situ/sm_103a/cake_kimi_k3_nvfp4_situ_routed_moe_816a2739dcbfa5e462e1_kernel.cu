...
kernel_cake_kimi_k3_nvfp4_situ_routed_moe_816a2739dcbfa5e462e1(__nv_bfloat16* __restrict__ expert_output, __nv_bfloat16* __restrict__ route_weights, int* __restrict__ token_to_permuted, __nv_bfloat16* __restrict__ out, int M)
{
