...
kernel_cake_kimi_k3_nvfp4_situ_routed_moe_3097d2db1a7718f39cab(int* __restrict__ topk_ids, int* __restrict__ expert_counts, int* __restrict__ expert_tile_offsets, int* __restrict__ expert_scatter_offsets, int* __restrict__ route_map, int* __restrict__ token_to_permuted, int* __restrict__ tile_expert, int* __restrict__ tile_mn_limit, int* __restrict__ total_tiles, int total_pairs, int num_experts, int max_tiles, int top_k, int tile_n, int* __restrict__ fc2_work_counter, int fc2_pool_ctas)
{
