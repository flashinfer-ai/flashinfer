            ...
            for (unsigned int _tile_iter = 0; _tile_iter < grid_m * grid_n; _tile_iter++) {
                ...
                asm volatile("tcgen05.fence::after_thread_sync;");
                {
                    ...
                    if (wide_feature < 64) {
                        ...
                        epi_staging_u64[(1024 + token * 64 + wide_feature - 64) / 4] = wide_word;
                    }
                    ...
                    if (wide_feature < 64) {
                        ...
                        epi_staging_u64[(1024 + token_0 * 64 + wide_feature - 64) / 4] = wide_word;
                    }
                    ...
                    if (wide_feature < 64) {
                        ...
                        epi_staging_u64[(1024 + token_1 * 64 + wide_feature - 64) / 4] = wide_word;
                    }
                    ...
                    if (wide_feature < 64) {
                        ...
                        epi_staging_u64[(1024 + token_2 * 64 + wide_feature - 64) / 4] = wide_word;
                    }
                }
                asm volatile("fence.proxy.async.shared::cta;" ::: "memory");
                asm volatile("barrier.sync 8, 128;" ::: "memory");
