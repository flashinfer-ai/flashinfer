...
kernel_cake_kimi_k3_nvfp4_situ_routed_moe_c4eb7c7ce6c387b9d304(__nv_bfloat16* __restrict__ x, float* __restrict__ qx, uint8_t* __restrict__ packed, uint8_t* __restrict__ scales, int M)
{
