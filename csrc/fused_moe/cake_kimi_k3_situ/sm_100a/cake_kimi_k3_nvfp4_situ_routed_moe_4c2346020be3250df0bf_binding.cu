...
// tvm-ffi direct-source launcher for Cake kernel 'kernel_cake_kimi_k3_nvfp4_situ_routed_moe_4c2346020be3250df0bf'.
#include <cuda.h>
#include <cuda_bf16.h>
#include <cuda_fp16.h>
...
namespace cake_host_shim_e01fb60a8cbc5882 {
...
TVM_FFI_DLL_EXPORT_TYPED_FUNC(run, cake_host_shim_e01fb60a8cbc5882::Run);
