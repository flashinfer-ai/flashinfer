    ...
    if (warp <= 3) {
        ...
        { // epilogue_main
            ...
            for (unsigned int _tile_iter = 0; _tile_iter < grid_m * grid_n; _tile_iter++) {
                ...
                {
                    int wide_swizzled = wide_feature ^ token % 8 * 8;
                    if (wide_feature < 64) {
                        epi_staging_u64[(token * 64 + wide_swizzled) / 4] = wide_word;
                    } else {
                        epi_staging_u64[(8192 + token * 64 + wide_swizzled - 64) / 4] = wide_word;
                    }
                }
                ...
                wide_word = (unsigned long long)wide_packed[0] | (unsigned long long)wide_packed[1] << 32;
                {
                    int wide_swizzled_1 = wide_feature ^ token_0 % 8 * 8;
                    if (wide_feature < 64) {
                        epi_staging_u64[(token_0 * 64 + wide_swizzled_1) / 4] = wide_word;
                    } else {
                        epi_staging_u64[(8192 + token_0 * 64 + wide_swizzled_1 - 64) / 4] = wide_word;
                    }
                }
                ...
                wide_word = (unsigned long long)wide_packed[0] | (unsigned long long)wide_packed[1] << 32;
                {
                    int wide_swizzled_2 = wide_feature ^ token_1 % 8 * 8;
                    if (wide_feature < 64) {
                        epi_staging_u64[(token_1 * 64 + wide_swizzled_2) / 4] = wide_word;
                    } else {
                        epi_staging_u64[(8192 + token_1 * 64 + wide_swizzled_2 - 64) / 4] = wide_word;
                    }
                }
                ...
                wide_word = (unsigned long long)wide_packed[0] | (unsigned long long)wide_packed[1] << 32;
                {
                    int wide_swizzled_3 = wide_feature ^ token_2 % 8 * 8;
                    if (wide_feature < 64) {
                        epi_staging_u64[(token_2 * 64 + wide_swizzled_3) / 4] = wide_word;
                    } else {
                        epi_staging_u64[(8192 + token_2 * 64 + wide_swizzled_3 - 64) / 4] = wide_word;
                    }
                }
                ...
                wide_word = (unsigned long long)wide_packed[0] | (unsigned long long)wide_packed[1] << 32;
                {
                    int wide_swizzled_4 = wide_feature ^ token_3 % 8 * 8;
                    if (wide_feature < 64) {
                        epi_staging_u64[(token_3 * 64 + wide_swizzled_4) / 4] = wide_word;
                    } else {
                        epi_staging_u64[(8192 + token_3 * 64 + wide_swizzled_4 - 64) / 4] = wide_word;
                    }
                }
                ...
                wide_word = (unsigned long long)wide_packed[0] | (unsigned long long)wide_packed[1] << 32;
                {
                    int wide_swizzled_5 = wide_feature ^ token_4 % 8 * 8;
                    if (wide_feature < 64) {
                        epi_staging_u64[(token_4 * 64 + wide_swizzled_5) / 4] = wide_word;
                    } else {
                        epi_staging_u64[(8192 + token_4 * 64 + wide_swizzled_5 - 64) / 4] = wide_word;
                    }
                }
                ...
                wide_word = (unsigned long long)wide_packed[0] | (unsigned long long)wide_packed[1] << 32;
                {
                    int wide_swizzled_6 = wide_feature ^ token_5 % 8 * 8;
                    if (wide_feature < 64) {
                        epi_staging_u64[(token_5 * 64 + wide_swizzled_6) / 4] = wide_word;
                    } else {
                        epi_staging_u64[(8192 + token_5 * 64 + wide_swizzled_6 - 64) / 4] = wide_word;
                    }
                }
                ...
                wide_word = (unsigned long long)wide_packed[0] | (unsigned long long)wide_packed[1] << 32;
                {
                    int wide_swizzled_7 = wide_feature ^ token_6 % 8 * 8;
                    if (wide_feature < 64) {
                        epi_staging_u64[(token_6 * 64 + wide_swizzled_7) / 4] = wide_word;
                    } else {
                        epi_staging_u64[(8192 + token_6 * 64 + wide_swizzled_7 - 64) / 4] = wide_word;
                    }
                }
                ...
                wide_word = (unsigned long long)wide_packed[0] | (unsigned long long)wide_packed[1] << 32;
                {
                    int wide_swizzled_8 = wide_feature ^ token_7 % 8 * 8;
                    if (wide_feature < 64) {
                        epi_staging_u64[(token_7 * 64 + wide_swizzled_8) / 4] = wide_word;
                    } else {
                        epi_staging_u64[(8192 + token_7 * 64 + wide_swizzled_8 - 64) / 4] = wide_word;
                    }
                }
                ...
                wide_word = (unsigned long long)wide_packed[0] | (unsigned long long)wide_packed[1] << 32;
                {
                    int wide_swizzled_9 = wide_feature ^ token_8 % 8 * 8;
                    if (wide_feature < 64) {
                        epi_staging_u64[(token_8 * 64 + wide_swizzled_9) / 4] = wide_word;
                    } else {
                        epi_staging_u64[(8192 + token_8 * 64 + wide_swizzled_9 - 64) / 4] = wide_word;
                    }
                }
                ...
                wide_word = (unsigned long long)wide_packed[0] | (unsigned long long)wide_packed[1] << 32;
                {
                    int wide_swizzled_10 = wide_feature ^ token_9 % 8 * 8;
                    if (wide_feature < 64) {
                        epi_staging_u64[(token_9 * 64 + wide_swizzled_10) / 4] = wide_word;
                    } else {
                        epi_staging_u64[(8192 + token_9 * 64 + wide_swizzled_10 - 64) / 4] = wide_word;
                    }
                }
                ...
                wide_word = (unsigned long long)wide_packed[0] | (unsigned long long)wide_packed[1] << 32;
                {
                    int wide_swizzled_11 = wide_feature ^ token_10 % 8 * 8;
                    if (wide_feature < 64) {
                        epi_staging_u64[(token_10 * 64 + wide_swizzled_11) / 4] = wide_word;
                    } else {
                        epi_staging_u64[(8192 + token_10 * 64 + wide_swizzled_11 - 64) / 4] = wide_word;
                    }
                }
                ...
                wide_word = (unsigned long long)wide_packed[0] | (unsigned long long)wide_packed[1] << 32;
                {
                    int wide_swizzled_12 = wide_feature ^ token_11 % 8 * 8;
                    if (wide_feature < 64) {
                        epi_staging_u64[(token_11 * 64 + wide_swizzled_12) / 4] = wide_word;
                    } else {
                        epi_staging_u64[(8192 + token_11 * 64 + wide_swizzled_12 - 64) / 4] = wide_word;
                    }
                }
                ...
                wide_word = (unsigned long long)wide_packed[0] | (unsigned long long)wide_packed[1] << 32;
                {
                    int wide_swizzled_13 = wide_feature ^ token_12 % 8 * 8;
                    if (wide_feature < 64) {
                        epi_staging_u64[(token_12 * 64 + wide_swizzled_13) / 4] = wide_word;
                    } else {
                        epi_staging_u64[(8192 + token_12 * 64 + wide_swizzled_13 - 64) / 4] = wide_word;
                    }
                }
                ...
                wide_word = (unsigned long long)wide_packed[0] | (unsigned long long)wide_packed[1] << 32;
                {
                    int wide_swizzled_14 = wide_feature ^ token_13 % 8 * 8;
                    if (wide_feature < 64) {
                        epi_staging_u64[(token_13 * 64 + wide_swizzled_14) / 4] = wide_word;
                    } else {
                        epi_staging_u64[(8192 + token_13 * 64 + wide_swizzled_14 - 64) / 4] = wide_word;
                    }
                }
                ...
                wide_word = (unsigned long long)wide_packed[0] | (unsigned long long)wide_packed[1] << 32;
                {
                    int wide_swizzled_15 = wide_feature ^ token_14 % 8 * 8;
                    if (wide_feature < 64) {
                        epi_staging_u64[(token_14 * 64 + wide_swizzled_15) / 4] = wide_word;
                    } else {
                        epi_staging_u64[(8192 + token_14 * 64 + wide_swizzled_15 - 64) / 4] = wide_word;
                    }
                }
                ...
                wide_word = (unsigned long long)wide_packed[0] | (unsigned long long)wide_packed[1] << 32;
                {
                    int wide_swizzled_16 = wide_feature ^ token_15 % 8 * 8;
                    if (wide_feature < 64) {
                        epi_staging_u64[(token_15 * 64 + wide_swizzled_16) / 4] = wide_word;
                    } else {
                        epi_staging_u64[(8192 + token_15 * 64 + wide_swizzled_16 - 64) / 4] = wide_word;
                    }
                }
                ...
                wide_word = (unsigned long long)wide_packed[0] | (unsigned long long)wide_packed[1] << 32;
                {
                    int wide_swizzled_17 = wide_feature ^ token_16 % 8 * 8;
                    if (wide_feature < 64) {
                        epi_staging_u64[(token_16 * 64 + wide_swizzled_17) / 4] = wide_word;
                    } else {
                        epi_staging_u64[(8192 + token_16 * 64 + wide_swizzled_17 - 64) / 4] = wide_word;
                    }
                }
                ...
                wide_word = (unsigned long long)wide_packed[0] | (unsigned long long)wide_packed[1] << 32;
                {
                    int wide_swizzled_18 = wide_feature ^ token_17 % 8 * 8;
                    if (wide_feature < 64) {
                        epi_staging_u64[(token_17 * 64 + wide_swizzled_18) / 4] = wide_word;
                    } else {
                        epi_staging_u64[(8192 + token_17 * 64 + wide_swizzled_18 - 64) / 4] = wide_word;
                    }
                }
                ...
                wide_word = (unsigned long long)wide_packed[0] | (unsigned long long)wide_packed[1] << 32;
                {
                    int wide_swizzled_19 = wide_feature ^ token_18 % 8 * 8;
                    if (wide_feature < 64) {
                        epi_staging_u64[(token_18 * 64 + wide_swizzled_19) / 4] = wide_word;
                    } else {
                        epi_staging_u64[(8192 + token_18 * 64 + wide_swizzled_19 - 64) / 4] = wide_word;
                    }
                }
                ...
                wide_word = (unsigned long long)wide_packed[0] | (unsigned long long)wide_packed[1] << 32;
                {
                    int wide_swizzled_20 = wide_feature ^ token_19 % 8 * 8;
                    if (wide_feature < 64) {
                        epi_staging_u64[(token_19 * 64 + wide_swizzled_20) / 4] = wide_word;
                    } else {
                        epi_staging_u64[(8192 + token_19 * 64 + wide_swizzled_20 - 64) / 4] = wide_word;
                    }
                }
                ...
                wide_word = (unsigned long long)wide_packed[0] | (unsigned long long)wide_packed[1] << 32;
                {
                    int wide_swizzled_21 = wide_feature ^ token_20 % 8 * 8;
                    if (wide_feature < 64) {
                        epi_staging_u64[(token_20 * 64 + wide_swizzled_21) / 4] = wide_word;
                    } else {
                        epi_staging_u64[(8192 + token_20 * 64 + wide_swizzled_21 - 64) / 4] = wide_word;
                    }
                }
                ...
                wide_word = (unsigned long long)wide_packed[0] | (unsigned long long)wide_packed[1] << 32;
                {
                    int wide_swizzled_22 = wide_feature ^ token_21 % 8 * 8;
                    if (wide_feature < 64) {
                        epi_staging_u64[(token_21 * 64 + wide_swizzled_22) / 4] = wide_word;
                    } else {
                        epi_staging_u64[(8192 + token_21 * 64 + wide_swizzled_22 - 64) / 4] = wide_word;
                    }
                }
                ...
                wide_word = (unsigned long long)wide_packed[0] | (unsigned long long)wide_packed[1] << 32;
                {
                    int wide_swizzled_23 = wide_feature ^ token_22 % 8 * 8;
                    if (wide_feature < 64) {
                        epi_staging_u64[(token_22 * 64 + wide_swizzled_23) / 4] = wide_word;
                    } else {
                        epi_staging_u64[(8192 + token_22 * 64 + wide_swizzled_23 - 64) / 4] = wide_word;
                    }
                }
                ...
                wide_word = (unsigned long long)wide_packed[0] | (unsigned long long)wide_packed[1] << 32;
                {
                    int wide_swizzled_24 = wide_feature ^ token_23 % 8 * 8;
                    if (wide_feature < 64) {
                        epi_staging_u64[(token_23 * 64 + wide_swizzled_24) / 4] = wide_word;
                    } else {
                        epi_staging_u64[(8192 + token_23 * 64 + wide_swizzled_24 - 64) / 4] = wide_word;
                    }
                }
                ...
                wide_word = (unsigned long long)wide_packed[0] | (unsigned long long)wide_packed[1] << 32;
                {
                    int wide_swizzled_25 = wide_feature ^ token_24 % 8 * 8;
                    if (wide_feature < 64) {
                        epi_staging_u64[(token_24 * 64 + wide_swizzled_25) / 4] = wide_word;
                    } else {
                        epi_staging_u64[(8192 + token_24 * 64 + wide_swizzled_25 - 64) / 4] = wide_word;
                    }
                }
                ...
                wide_word = (unsigned long long)wide_packed[0] | (unsigned long long)wide_packed[1] << 32;
                {
                    int wide_swizzled_26 = wide_feature ^ token_25 % 8 * 8;
                    if (wide_feature < 64) {
                        epi_staging_u64[(token_25 * 64 + wide_swizzled_26) / 4] = wide_word;
                    } else {
                        epi_staging_u64[(8192 + token_25 * 64 + wide_swizzled_26 - 64) / 4] = wide_word;
                    }
                }
                ...
                wide_word = (unsigned long long)wide_packed[0] | (unsigned long long)wide_packed[1] << 32;
                {
                    int wide_swizzled_27 = wide_feature ^ token_26 % 8 * 8;
                    if (wide_feature < 64) {
                        epi_staging_u64[(token_26 * 64 + wide_swizzled_27) / 4] = wide_word;
                    } else {
                        epi_staging_u64[(8192 + token_26 * 64 + wide_swizzled_27 - 64) / 4] = wide_word;
                    }
                }
                ...
                wide_word = (unsigned long long)wide_packed[0] | (unsigned long long)wide_packed[1] << 32;
                {
                    int wide_swizzled_28 = wide_feature ^ token_27 % 8 * 8;
                    if (wide_feature < 64) {
                        epi_staging_u64[(token_27 * 64 + wide_swizzled_28) / 4] = wide_word;
                    } else {
                        epi_staging_u64[(8192 + token_27 * 64 + wide_swizzled_28 - 64) / 4] = wide_word;
                    }
                }
                ...
                wide_word = (unsigned long long)wide_packed[0] | (unsigned long long)wide_packed[1] << 32;
                {
                    int wide_swizzled_29 = wide_feature ^ token_28 % 8 * 8;
                    if (wide_feature < 64) {
                        epi_staging_u64[(token_28 * 64 + wide_swizzled_29) / 4] = wide_word;
                    } else {
                        epi_staging_u64[(8192 + token_28 * 64 + wide_swizzled_29 - 64) / 4] = wide_word;
                    }
                }
                ...
                wide_word = (unsigned long long)wide_packed[0] | (unsigned long long)wide_packed[1] << 32;
                {
                    int wide_swizzled_30 = wide_feature ^ token_29 % 8 * 8;
                    if (wide_feature < 64) {
                        epi_staging_u64[(token_29 * 64 + wide_swizzled_30) / 4] = wide_word;
                    } else {
                        epi_staging_u64[(8192 + token_29 * 64 + wide_swizzled_30 - 64) / 4] = wide_word;
                    }
                }
                ...
                wide_word = (unsigned long long)wide_packed[0] | (unsigned long long)wide_packed[1] << 32;
                {
                    int wide_swizzled_31 = wide_feature ^ token_30 % 8 * 8;
                    if (wide_feature < 64) {
                        epi_staging_u64[(token_30 * 64 + wide_swizzled_31) / 4] = wide_word;
                    } else {
                        epi_staging_u64[(8192 + token_30 * 64 + wide_swizzled_31 - 64) / 4] = wide_word;
                    }
                }
                asm volatile("fence.proxy.async.shared::cta;" ::: "memory");
                asm volatile("barrier.sync 8, 128;" ::: "memory");
