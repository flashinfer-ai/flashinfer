    ...
    if (warp <= 3) {
        ...
        { // epilogue_main
            ...
            for (int token_group = 0; token_group < 1; token_group++) {
                ...
                {
                    float2 _f2_26 = make_float2(value00, value10);
                    float2 _f2_27 = make_float2(inv_scale0, inv_scale0);
                    float2 _mul_f32x2_18;
                    asm("mul.rn.ftz.f32x2 %0, %1, %2;" : "=l"(*(unsigned long long*)&_mul_f32x2_18) : "l"(*(const unsigned long long*)&_f2_26), "l"(*(const unsigned long long*)&_f2_27));
                    quant0 = _mul_f32x2_18;
                    float2 _f2_28 = make_float2(value01, value11);
                    float2 _f2_29 = make_float2(inv_scale1, inv_scale1);
                    float2 _mul_f32x2_19;
                    asm("mul.rn.ftz.f32x2 %0, %1, %2;" : "=l"(*(unsigned long long*)&_mul_f32x2_19) : "l"(*(const unsigned long long*)&_f2_28), "l"(*(const unsigned long long*)&_f2_29));
                    quant1 = _mul_f32x2_19;
                    float2 _f2_30 = make_float2(sc, sc);
                    float2 scale_c2 = _f2_30;
                    float2 _mul_f32x2_20;
                    asm("mul.rn.ftz.f32x2 %0, %1, %2;" : "=l"(*(unsigned long long*)&_mul_f32x2_20) : "l"(*(const unsigned long long*)&quant0), "l"(*(const unsigned long long*)&scale_c2));
                    quant0 = _mul_f32x2_20;
                    float2 _mul_f32x2_21;
                    asm("mul.rn.ftz.f32x2 %0, %1, %2;" : "=l"(*(unsigned long long*)&_mul_f32x2_21) : "l"(*(const unsigned long long*)&quant1), "l"(*(const unsigned long long*)&scale_c2));
                    quant1 = _mul_f32x2_21;
