...
kernel_cake_warp_decode_52cd5e51ce562b853b51(const __grid_constant__ CUtensorMap A, const __grid_constant__ CUtensorMap B, const __grid_constant__ CUtensorMap SFA, const __grid_constant__ CUtensorMap SFB, const __grid_constant__ CUtensorMap C_tma, __nv_bfloat16* __restrict__ C, float* __restrict__ scale_c, int* __restrict__ tile_expert, int* __restrict__ tile_mn_limit, int* __restrict__ num_non_exiting_ctas, int* __restrict__ work_counter, int M, int K, int grid_m, int grid_n, int K_tiles)
{
    ...
    // Partial post-allocation TMEM rendezvous (384 threads on named barrier 10)
    if (warp == 0 || warp == 1 || warp == 2 || warp == 3 || warp == 4 || warp == 5 || warp == 6 || warp == 7 || warp == 12 || warp == 13 || warp == 14 || warp == 15) {
        asm volatile("barrier.sync.aligned %0, %1;" :: "r"(10), "r"(384) : "memory");
    }
            ...
            for (unsigned int _tile_iter_7 = 0; _tile_iter_7 < grid_m * grid_n; _tile_iter_7++) {
                ...
                for (int route_k_4 = 0; route_k_4 < route_k_extent_6; route_k_4++) {
                    ...
                    asm volatile("tcgen05.fence::after_thread_sync;");
                    {
                        int sfa_base_col = 0;
                        int sfb_base_col = 0;
                        int _mma_a_lo_1 = make_warp_uniform((((smem_a_mma0_addr) >> 4) & 0x3FFF) + (k_stage) * 1024);
                        int _mma_b_lo_1 = make_warp_uniform((((smem_b_mma0_addr) >> 4) & 0x3FFF) + (k_stage) * 64);
                        if (elect_sync()) {
                            {
                        ...
                        int _mma_a_lo_2 = make_warp_uniform((((smem_a_mma1_addr) >> 4) & 0x3FFF) + (k_stage) * 1024);
                        int _mma_b_lo_2 = make_warp_uniform((((smem_b_mma1_addr) >> 4) & 0x3FFF) + (k_stage) * 64);
                        if (elect_sync()) {
                            {
                                ...
                                tcgen05_mma_mxf4nvf4_bs((tmem_accum + ((acc_stage_1 + (unsigned int)route_slot) * 8)), a_desc + 0, b_desc + 0,
                                    0x8020480U, (unsigned int)tmem_sfa + (k_stage * 16 + (unsigned int)sfa_base_col_0) + 0, (unsigned int)tmem_sfb + (k_stage * 8 + (unsigned int)sfb_base_col_1) + 0, ((((0) ? ((0) ? ((route_k_4 % K_tiles == 0) ? 1 : 0) : ((route_k_4 == 0) ? 1 : 0)) : 0)) ? 0 : 1));
                            }
                        }
                        int sfa_base_col_2 = 8;
                        int sfb_base_col_3 = 4;
                        int _mma_a_lo_3 = make_warp_uniform((((smem_a_mma2_addr) >> 4) & 0x3FFF) + (k_stage) * 1024);
                        int _mma_b_lo_3 = make_warp_uniform((((smem_b_mma2_addr) >> 4) & 0x3FFF) + (k_stage) * 64);
                        if (elect_sync()) {
                            {
                                ...
                                tcgen05_mma_mxf4nvf4_bs((tmem_accum + ((acc_stage_1 + (unsigned int)route_slot) * 8)), a_desc + 0, b_desc + 0,
                                    0x8020480U, (unsigned int)tmem_sfa + (k_stage * 16 + (unsigned int)sfa_base_col_2) + 0, (unsigned int)tmem_sfb + (k_stage * 8 + (unsigned int)sfb_base_col_3) + 0, ((((0) ? ((0) ? ((route_k_4 % K_tiles == 0) ? 1 : 0) : ((route_k_4 == 0) ? 1 : 0)) : 0)) ? 0 : 1));
                            }
                        }
                        int sfa_base_col_4 = 12;
                        int sfb_base_col_5 = 6;
                        int _mma_a_lo_4 = make_warp_uniform((((smem_a_mma3_addr) >> 4) & 0x3FFF) + (k_stage) * 1024);
                        int _mma_b_lo_4 = make_warp_uniform((((smem_b_mma3_addr) >> 4) & 0x3FFF) + (k_stage) * 64);
                        if (elect_sync()) {
                            {
                                ...
                                tcgen05_mma_mxf4nvf4_bs((tmem_accum + ((acc_stage_1 + (unsigned int)route_slot) * 8)), a_desc + 0, b_desc + 0,
                                    0x8020480U, (unsigned int)tmem_sfa + (k_stage * 16 + (unsigned int)sfa_base_col_4) + 0, (unsigned int)tmem_sfb + (k_stage * 8 + (unsigned int)sfb_base_col_5) + 0, ((((0) ? ((0) ? ((route_k_4 % K_tiles == 0) ? 1 : 0) : ((route_k_4 == 0) ? 1 : 0)) : 0)) ? 0 : 1));
                            }
                        }
                    }
                    {
