...
// tvm-ffi direct-source launcher for Cake kernel 'kernel_cake_warp_decode_fc0aed4e58408740ce2a'.
#include <cuda.h>
#include <cuda_bf16.h>
#include <cuda_fp16.h>
...
void Run(TensorView arg_A, TensorView arg_B, TensorView arg_SFA, TensorView arg_SFB, TensorView arg_C_tma, TensorView arg_C, TensorView arg_scale_c, TensorView arg_tile_expert, TensorView arg_tile_mn_limit, TensorView arg_num_non_exiting_ctas, TensorView arg_work_counter, int64_t arg_M, int64_t arg_K, int64_t arg_grid_m, int64_t arg_grid_n, int64_t arg_K_tiles, TensorView arg_pack_ready, TensorView arg_done_counter, int64_t arg_initial_work, int64_t arg_launch_ctas, int64_t grid_x, int64_t grid_y, int64_t grid_z) {
  ...
  void* kargs[] = {&p_A, &p_B, &p_SFA, &p_SFB, &p_C_tma, &p_C, &p_scale_c, &p_tile_expert, &p_tile_mn_limit, &p_num_non_exiting_ctas, &p_work_counter, &v_M, &v_K, &v_grid_m, &v_grid_n, &v_K_tiles, &p_pack_ready, &p_done_counter, &v_initial_work, &v_launch_ctas};
  ...
  TVM_FFI_CHECK(smem_status == cudaSuccess, RuntimeError)
      << "cudaFuncSetAttribute for kernel_cake_warp_decode_fc0aed4e58408740ce2a failed: "
  ...
  cudaError_t launch_status = cudaLaunchKernelExC(
      &config, reinterpret_cast<const void*>(kernel_cake_warp_decode_fc0aed4e58408740ce2a), kargs);
  TVM_FFI_CHECK(launch_status == cudaSuccess, RuntimeError)
      << "cudaLaunchKernelExC for kernel_cake_warp_decode_fc0aed4e58408740ce2a failed: "
      << cudaGetErrorString(launch_status);
}

}  // namespace cake_host_shim_4aa84057922b477d

TVM_FFI_DLL_EXPORT_TYPED_FUNC(run, cake_host_shim_4aa84057922b477d::Run);
