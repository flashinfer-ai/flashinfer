        ...
        { // epilogue_main
            ...
            for (unsigned int _tile_iter = 0; _tile_iter < grid_m * grid_n; _tile_iter++) {
                ...
                for (int token_group = 0; token_group < 1; token_group++) {
                    ...
                    float value11 = 0.0f;
                    {
                        float _max_0 = max_noftz(_tmem_load_0[token_group * 4] * sg, neg_cl);
                        float _min_0 = fminf(_max_0, cl);
                        float oa_up00 = _min_0;
                        float _max_1 = max_noftz(_tmem_load_0[token_group * 4 + 1] * sg, neg_cl);
                        float _min_1 = fminf(_max_1, cl);
                        float oa_up01 = _min_1;
                        float _max_2 = max_noftz(_tmem_load_1[token_group * 4] * sg, neg_cl);
                        float _min_2 = fminf(_max_2, cl);
                        float oa_up10 = _min_2;
                        float _max_3 = max_noftz(_tmem_load_1[token_group * 4 + 1] * sg, neg_cl);
                        float _min_3 = fminf(_max_3, cl);
                        float oa_up11 = _min_3;
                        float _min_4 = fminf(_tmem_load_0[token_group * 4 + 2] * sg, cl);
                        float oa_gate00 = _min_4;
                        float _min_5 = fminf(_tmem_load_0[token_group * 4 + 3] * sg, cl);
                        float oa_gate01 = _min_5;
                        float _min_6 = fminf(_tmem_load_1[token_group * 4 + 2] * sg, cl);
                        float oa_gate10 = _min_6;
                        float _min_7 = fminf(_tmem_load_1[token_group * 4 + 3] * sg, cl);
                    ...
                    float scale1 = 0.0f;
                    {
                        float oa_quant_scale_max = sc / sg;
                        float2 _f2_0 = make_float2(block_max0, block_max1);
                        float2 _f2_1 = make_float2(oa_quant_scale_max, oa_quant_scale_max);
                        float2 _mul_f32x2_0;
                        ...
                        float2 oa_scaled_max = _mul_f32x2_0;
                        float2 _f2_2 = make_float2(0.16666666666666666f, 0.16666666666666666f);
                        float2 _mul_f32x2_1;
                        asm("mul.rn.ftz.f32x2 %0, %1, %2;" : "=l"(*(unsigned long long*)&_mul_f32x2_1) : "l"(*(const unsigned long long*)&oa_scaled_max), "l"(*(const unsigned long long*)&_f2_2));
                        oa_scaled_max = _mul_f32x2_1;
                        float _fp8_rt_0;
                        uint16_t _e4m3x2_0;
                        uint32_t _f16x2_0;
                        asm volatile("cvt.rn.satfinite.e4m3x2.f32 %0, %1, %2;" : "=h"(_e4m3x2_0) : "f"(0.0f), "f"(oa_scaled_max.x));
                    ...
                    {
                        float2 _f2_5 = make_float2(value00, value10);
                        float2 _f2_6 = make_float2(inv_scale0, inv_scale0);
                        float2 _mul_f32x2_2;
                        asm("mul.rn.ftz.f32x2 %0, %1, %2;" : "=l"(*(unsigned long long*)&_mul_f32x2_2) : "l"(*(const unsigned long long*)&_f2_5), "l"(*(const unsigned long long*)&_f2_6));
                        oa_quant0 = _mul_f32x2_2;
                        float2 _f2_7 = make_float2(value01, value11);
                        float2 _f2_8 = make_float2(inv_scale1, inv_scale1);
                        float2 _mul_f32x2_3;
                        asm("mul.rn.ftz.f32x2 %0, %1, %2;" : "=l"(*(unsigned long long*)&_mul_f32x2_3) : "l"(*(const unsigned long long*)&_f2_7), "l"(*(const unsigned long long*)&_f2_8));
                        oa_quant1 = _mul_f32x2_3;
                        float oa_quant_scale_values = sc / sg;
                        float2 _f2_9 = make_float2(oa_quant_scale_values, oa_quant_scale_values);
                        float2 oa_quant_scale2 = _f2_9;
                        float2 _mul_f32x2_4;
                        asm("mul.rn.ftz.f32x2 %0, %1, %2;" : "=l"(*(unsigned long long*)&_mul_f32x2_4) : "l"(*(const unsigned long long*)&oa_quant0), "l"(*(const unsigned long long*)&oa_quant_scale2));
                        oa_quant0 = _mul_f32x2_4;
                        float2 _mul_f32x2_5;
                        asm("mul.rn.ftz.f32x2 %0, %1, %2;" : "=l"(*(unsigned long long*)&_mul_f32x2_5) : "l"(*(const unsigned long long*)&oa_quant1), "l"(*(const unsigned long long*)&oa_quant_scale2));
                        oa_quant1 = _mul_f32x2_5;
                        quant_pair[0] = oa_quant0.x;
                        quant_pair[1] = oa_quant0.y;
                    }
                    ...
                    {
                        quant_pair[0] = oa_quant1.x;
                        quant_pair[1] = oa_quant1.y;
                    }
                    uint32_t _fp4_1[1];
