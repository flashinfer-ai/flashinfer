    ...
    if (warp <= 3) {
        ...
        { // epilogue_main
            ...
            for (int token_group = 0; token_group < 1; token_group++) {
                ...
                {
                    {
                        float oa_cl = clamp_limit[expert];
                        float oa_neg_cl = -oa_cl;
                ...
                {
                    {
                        ...
                        float2 _f2_21 = make_float2(block_max0, block_max1);
                        float2 _f2_22 = make_float2(oa_quant_scale_max, oa_quant_scale_max);
                        float2 _mul_f32x2_16;
                        asm("mul.rn.ftz.f32x2 %0, %1, %2;" : "=l"(*(unsigned long long*)&_mul_f32x2_16) : "l"(*(const unsigned long long*)&_f2_21), "l"(*(const unsigned long long*)&_f2_22));
                        float2 oa_scaled_max = _mul_f32x2_16;
                        float2 _f2_23 = make_float2(0.16666666666666666f, 0.16666666666666666f);
                        float2 _mul_f32x2_17;
                        asm("mul.rn.ftz.f32x2 %0, %1, %2;" : "=l"(*(unsigned long long*)&_mul_f32x2_17) : "l"(*(const unsigned long long*)&oa_scaled_max), "l"(*(const unsigned long long*)&_f2_23));
                        oa_scaled_max = _mul_f32x2_17;
                        float _fp8_rt_2;
                        uint16_t _e4m3x2_0;
                        uint32_t _f16x2_0;
                ...
                {
                    {
                        float2 _f2_31 = make_float2(value00, value10);
                        float2 _f2_32 = make_float2(inv_scale0, inv_scale0);
