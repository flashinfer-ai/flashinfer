...
// tvm-ffi direct-source launcher for Cake kernel 'kernel_cake_warp_decode_d83b7ea65ec15e68f94c'.
#include <cuda.h>
#include <cuda_bf16.h>
#include <cuda_fp16.h>
...
extern "C" __global__ void kernel_cake_warp_decode_d83b7ea65ec15e68f94c(int* __restrict__ route_experts, int* __restrict__ route_map, int* __restrict__ tile_expert, int* __restrict__ tile_mn_limit, int* __restrict__ route_slots, int* __restrict__ num_non_exiting_ctas, int* __restrict__ fc1_work_counter, int* __restrict__ fc2_work_counter, int route_count, int top_k, int local_expert_offset, int num_experts, int fc1_initial_work, int fc2_initial_work);


namespace cake_host_shim_9f651fd8e3764dac {
...
void Run(TensorView arg_route_experts, TensorView arg_route_map, TensorView arg_tile_expert, TensorView arg_tile_mn_limit, TensorView arg_route_slots, TensorView arg_num_non_exiting_ctas, TensorView arg_fc1_work_counter, TensorView arg_fc2_work_counter, int64_t arg_route_count, int64_t arg_top_k, int64_t arg_local_expert_offset, int64_t arg_num_experts, int64_t arg_fc1_initial_work, int64_t arg_fc2_initial_work, int64_t grid_x, int64_t grid_y, int64_t grid_z) {
  ...
  cudaError_t launch_status = cudaLaunchKernelExC(
      &config, reinterpret_cast<const void*>(kernel_cake_warp_decode_d83b7ea65ec15e68f94c), kargs);
  TVM_FFI_CHECK(launch_status == cudaSuccess, RuntimeError)
      << "cudaLaunchKernelExC for kernel_cake_warp_decode_d83b7ea65ec15e68f94c failed: "
      << cudaGetErrorString(launch_status);
}

}  // namespace cake_host_shim_9f651fd8e3764dac

TVM_FFI_DLL_EXPORT_TYPED_FUNC(run, cake_host_shim_9f651fd8e3764dac::Run);
