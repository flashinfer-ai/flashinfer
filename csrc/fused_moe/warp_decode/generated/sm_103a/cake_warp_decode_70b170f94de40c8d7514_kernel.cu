        ...
        { // mma_main
            ...
            for (unsigned int _tile_iter_7 = 0; _tile_iter_7 < grid_m * grid_n; _tile_iter_7++) {
                ...
                for (int route_k_4 = 0; route_k_4 < route_k_extent_6; route_k_4++) {
                    ...
                    if (route_k_4 * 512 + 256 < K) {
                        int sfa_base_col_1 = 16;
                        ...
                        if (elect_sync()) {
                            {
                                ...
                                tcgen05_mma_mxf4nvf4_bs((tmem_accum + ((acc_stage_1 + (unsigned int)route_slot) * 8)), a_desc + 0, b_desc + 0,
                                    0x8020480U, (unsigned int)tmem_sfa + (k_stage * 32 + (unsigned int)sfa_base_col_1) + 0, (unsigned int)tmem_sfb + (k_stage * 16 + (unsigned int)sfb_base_col_2) + 0, ((((0) ? ((0) ? ((route_k_4 % K_tiles == 0) ? 1 : 0) : ((route_k_4 == 0) ? 1 : 0)) : 0)) ? 0 : 1));
                            }
                        }
                        int sfa_base_col_0_1 = 20;
                        int sfb_base_col_1_1 = 10;
                        ...
                        if (elect_sync()) {
                            {
                                ...
                                tcgen05_mma_mxf4nvf4_bs((tmem_accum + ((acc_stage_1 + (unsigned int)route_slot) * 8)), a_desc + 0, b_desc + 0,
                                    0x8020480U, (unsigned int)tmem_sfa + (k_stage * 32 + (unsigned int)sfa_base_col_0_1) + 0, (unsigned int)tmem_sfb + (k_stage * 16 + (unsigned int)sfb_base_col_1_1) + 0, ((((0) ? ((0) ? ((route_k_4 % K_tiles == 0) ? 1 : 0) : ((route_k_4 == 0) ? 1 : 0)) : 0)) ? 0 : 1));
                            }
                        }
                        int sfa_base_col_2_1 = 24;
                        int sfb_base_col_3_1 = 12;
                        ...
                        if (elect_sync()) {
                            {
                                ...
                                tcgen05_mma_mxf4nvf4_bs((tmem_accum + ((acc_stage_1 + (unsigned int)route_slot) * 8)), a_desc + 0, b_desc + 0,
                                    0x8020480U, (unsigned int)tmem_sfa + (k_stage * 32 + (unsigned int)sfa_base_col_2_1) + 0, (unsigned int)tmem_sfb + (k_stage * 16 + (unsigned int)sfb_base_col_3_1) + 0, ((((0) ? ((0) ? ((route_k_4 % K_tiles == 0) ? 1 : 0) : ((route_k_4 == 0) ? 1 : 0)) : 0)) ? 0 : 1));
                            }
                        }
                        int sfa_base_col_4_1 = 28;
                        int sfb_base_col_5_1 = 14;
                        ...
                        if (elect_sync()) {
                            {
                                ...
                                tcgen05_mma_mxf4nvf4_bs((tmem_accum + ((acc_stage_1 + (unsigned int)route_slot) * 8)), a_desc + 0, b_desc + 0,
                                    0x8020480U, (unsigned int)tmem_sfa + (k_stage * 32 + (unsigned int)sfa_base_col_4_1) + 0, (unsigned int)tmem_sfb + (k_stage * 16 + (unsigned int)sfb_base_col_5_1) + 0, ((((0) ? ((0) ? ((route_k_4 % K_tiles == 0) ? 1 : 0) : ((route_k_4 == 0) ? 1 : 0)) : 0)) ? 0 : 1));
                            }
                        }
                    }
                    if (elect_sync()) {
