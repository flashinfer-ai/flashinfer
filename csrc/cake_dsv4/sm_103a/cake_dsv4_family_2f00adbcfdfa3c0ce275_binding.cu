...
// tvm-ffi dispatch module for kernel family 'cake_dsv4_family_2f00adbcfdfa3c0ce275'.
...
extern "C" __global__ void kernel_cake_dsv4_c4da1f84a10b724c24bb(const __grid_constant__ CUtensorMap tmap_q, const __grid_constant__ CUtensorMap tmap_swa_k, const __grid_constant__ CUtensorMap tmap_compressed_k, const __grid_constant__ CUtensorMap tmap_swa_v, const __grid_constant__ CUtensorMap tmap_compressed_v, __nv_bfloat16* __restrict__ O, float* __restrict__ partial_lse, int* __restrict__ sparse_indices, int* __restrict__ sparse_topk_lens, float* __restrict__ sinks, float* __restrict__ bmm1_scale, float* __restrict__ bmm2_scale, int num_heads, int num_query_tokens, int sparse_topk, int has_sinks, int total_work_items);

namespace cake_host_shim_309fdbbf2f31536e {
...
namespace variant_cake_dsv4_c4da1f84a10b724c24bb_sm_103a_42173ca2e846 {
...
void Run(TensorView arg_tmap_q, TensorView arg_tmap_swa_k, TensorView arg_tmap_compressed_k, TensorView arg_tmap_swa_v, TensorView arg_tmap_compressed_v, TensorView arg_O, TensorView arg_partial_lse, TensorView arg_sparse_indices, TensorView arg_sparse_topk_lens, TensorView arg_sinks, TensorView arg_bmm1_scale, TensorView arg_bmm2_scale, int64_t arg_num_heads, int64_t arg_num_query_tokens, int64_t arg_sparse_topk, int64_t arg_has_sinks, int64_t arg_total_work_items, int64_t grid_x, int64_t grid_y, int64_t grid_z, cudaStream_t stream) {
    ...
    if (it == smem_status_by_device->end()) {
      ...
      if (smem_status == cudaSuccess) {
        smem_status = cudaFuncSetAttribute(
            reinterpret_cast<const void*>(kernel_cake_dsv4_c4da1f84a10b724c24bb),
  ...
  TVM_FFI_CHECK(smem_status == cudaSuccess, RuntimeError)
      << "cudaFuncSetAttribute for kernel_cake_dsv4_c4da1f84a10b724c24bb failed: "
  ...
  cudaError_t launch_status = cudaLaunchKernelExC(
      &config, reinterpret_cast<const void*>(kernel_cake_dsv4_c4da1f84a10b724c24bb), kargs);
  TVM_FFI_CHECK(launch_status == cudaSuccess, RuntimeError)
      << "cudaLaunchKernelExC for kernel_cake_dsv4_c4da1f84a10b724c24bb failed: "
    ...
    case 0: {
      {
        ...
        int64_t gy = 1;
        int64_t gz = 1;
        cake_host_shim_309fdbbf2f31536e::variant_cake_dsv4_c4da1f84a10b724c24bb_sm_103a_42173ca2e846::Run(arg_Q, arg_SWA_cache, arg_compressed_KV_cache, arg_SWA_cache, arg_compressed_KV_cache, arg_O, arg_partial_lse, arg_sparse_indices, arg_sparse_topk_lens, arg_sinks, arg_bmm1_scale, arg_bmm2_scale, num_heads, num_query_tokens, sparse_topk, has_sinks, total_work_items, gx, gy, gz, stream);
      }
      return;
    }
    default:
      TVM_FFI_CHECK(false, ValueError) << "no dispatch route for cake_dsv4_family_2f00adbcfdfa3c0ce275 shape (num_heads=" << num_heads << ", num_query_tokens=" << num_query_tokens << ", sparse_topk=" << sparse_topk << ", has_sinks=" << has_sinks << ", total_work_items=" << total_work_items << ")";
  }
}
...
TVM_FFI_DLL_EXPORT_TYPED_FUNC(run, cake_host_shim_309fdbbf2f31536e::Dispatch);
TVM_FFI_DLL_EXPORT_TYPED_FUNC(route_of, cake_host_shim_309fdbbf2f31536e::RouteOf);
