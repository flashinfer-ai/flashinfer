...
// tvm-ffi dispatch module for kernel family 'cake_dsv4_family_6768e68f37d965f30be9'.
...
namespace variant_cake_dsv4_458fa3d009d7c13d7d35_sm_103a_2ce1b8f97668 {
...
void Run(TensorView arg_tmap_q, TensorView arg_tmap_swa_kv, TensorView arg_tmap_compressed_kv, TensorView arg_O, TensorView arg_partial_lse, TensorView arg_sparse_indices, TensorView arg_sparse_topk_lens, TensorView arg_sinks, TensorView arg_bmm1_scale, TensorView arg_bmm2_scale, int64_t arg_num_heads, int64_t arg_num_query_tokens, int64_t arg_sparse_topk, int64_t arg_has_sinks, int64_t arg_total_work_items, int64_t arg_num_split, int64_t grid_x, int64_t grid_y, int64_t grid_z, cudaStream_t stream) {
    ...
    if (it == smem_status_by_device->end()) {
      ...
      if (smem_status == cudaSuccess) {
        smem_status = cudaFuncSetAttribute(
            reinterpret_cast<const void*>(kernel_cake_dsv4_458fa3d009d7c13d7d35),
  ...
  TVM_FFI_CHECK(smem_status == cudaSuccess, RuntimeError)
      << "cudaFuncSetAttribute for kernel_cake_dsv4_458fa3d009d7c13d7d35 failed: "
  ...
  cudaError_t launch_status = cudaLaunchKernelExC(
      &config, reinterpret_cast<const void*>(kernel_cake_dsv4_458fa3d009d7c13d7d35), kargs);
  TVM_FFI_CHECK(launch_status == cudaSuccess, RuntimeError)
      << "cudaLaunchKernelExC for kernel_cake_dsv4_458fa3d009d7c13d7d35 failed: "
      << cudaGetErrorString(launch_status);
}
}  // namespace variant_cake_dsv4_458fa3d009d7c13d7d35_sm_103a_2ce1b8f97668

namespace variant_cake_dsv4_f731feb117a6ece1f855_sm_103a_e6a9bfaa3148 {
...
void Run(TensorView arg_partial_O, TensorView arg_partial_lse, TensorView arg_O, int64_t arg_num_q_heads, int64_t arg_num_split, int64_t grid_x, int64_t grid_y, int64_t grid_z, cudaStream_t stream) {
  ...
  config.stream = stream;
  cudaError_t launch_status = cudaLaunchKernelExC(
      &config, reinterpret_cast<const void*>(kernel_cake_dsv4_f731feb117a6ece1f855), kargs);
  TVM_FFI_CHECK(launch_status == cudaSuccess, RuntimeError)
      << "cudaLaunchKernelExC for kernel_cake_dsv4_f731feb117a6ece1f855 failed: "
      << cudaGetErrorString(launch_status);
}
}  // namespace variant_cake_dsv4_f731feb117a6ece1f855_sm_103a_e6a9bfaa3148
...
void Dispatch(tvm::ffi::TensorView arg_Q, tvm::ffi::TensorView arg_SWA_cache, tvm::ffi::TensorView arg_compressed_KV_cache, tvm::ffi::TensorView arg_partial_O, tvm::ffi::TensorView arg_partial_lse, tvm::ffi::TensorView arg_sparse_indices, tvm::ffi::TensorView arg_sparse_topk_lens, tvm::ffi::TensorView arg_sinks, tvm::ffi::TensorView arg_bmm1_scale, tvm::ffi::TensorView arg_bmm2_scale, tvm::ffi::TensorView arg_O, int32_t num_heads, int32_t num_query_tokens, int32_t sparse_topk, int32_t has_sinks, int32_t total_work_items, int32_t num_split, int64_t cuda_stream_ptr) {
  ...
  switch (v) {
    ...
    default:
      TVM_FFI_CHECK(false, ValueError) << "no dispatch route for cake_dsv4_family_6768e68f37d965f30be9 shape (num_heads=" << num_heads << ", num_query_tokens=" << num_query_tokens << ", sparse_topk=" << sparse_topk << ", has_sinks=" << has_sinks << ", total_work_items=" << total_work_items << ", num_split=" << num_split << ")";
  }
}
...
TVM_FFI_DLL_EXPORT_TYPED_FUNC(run, cake_host_shim_3b448ed5d4bfb3f8::Dispatch);
TVM_FFI_DLL_EXPORT_TYPED_FUNC(route_of, cake_host_shim_3b448ed5d4bfb3f8::RouteOf);
