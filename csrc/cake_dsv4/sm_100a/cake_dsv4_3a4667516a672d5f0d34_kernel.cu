            ...
            for (unsigned int work_slot = work_begin; work_slot < work_end; work_slot++) {
                ...
                for (int tile = 0; tile < num_kv_tiles; tile++) {
                    ...
                    if (valid_cols == 64) {
                        ...
                        #endif
                        asm volatile("max.f32 %0, %1, %2, %3;" : "=f"(_max3_0) : "f"(scores[0]), "f"(scores[1]), "f"(scores[2]));
                        float _max3_1;
                        #if defined(__CUDA_ARCH__) && (__CUDA_ARCH__ < 1000)
                        #error "Max3 requires PTX three-input max.f32 support on sm_100+"
                        #endif
                        asm volatile("max.f32 %0, %1, %2, %3;" : "=f"(_max3_1) : "f"(scores[3]), "f"(scores[4]), "f"(scores[5]));
                        float _max3_2;
                        #if defined(__CUDA_ARCH__) && (__CUDA_ARCH__ < 1000)
                        #error "Max3 requires PTX three-input max.f32 support on sm_100+"
                        #endif
                        asm volatile("max.f32 %0, %1, %2, %3;" : "=f"(_max3_2) : "f"(scores[6]), "f"(scores[7]), "f"(scores[8]));
                        float _max3_3;
                        #if defined(__CUDA_ARCH__) && (__CUDA_ARCH__ < 1000)
                        #error "Max3 requires PTX three-input max.f32 support on sm_100+"
                        #endif
                        asm volatile("max.f32 %0, %1, %2, %3;" : "=f"(_max3_3) : "f"(scores[9]), "f"(scores[10]), "f"(scores[11]));
                        float _max3_4;
                        #if defined(__CUDA_ARCH__) && (__CUDA_ARCH__ < 1000)
                        #error "Max3 requires PTX three-input max.f32 support on sm_100+"
                        #endif
                        asm volatile("max.f32 %0, %1, %2, %3;" : "=f"(_max3_4) : "f"(scores[12]), "f"(scores[13]), "f"(scores[14]));
                        float _max3_5;
                        #if defined(__CUDA_ARCH__) && (__CUDA_ARCH__ < 1000)
                        #error "Max3 requires PTX three-input max.f32 support on sm_100+"
                        #endif
                        asm volatile("max.f32 %0, %1, %2, %3;" : "=f"(_max3_5) : "f"(scores[15]), "f"(scores[16]), "f"(scores[17]));
                        float _max3_6;
                        #if defined(__CUDA_ARCH__) && (__CUDA_ARCH__ < 1000)
                        #error "Max3 requires PTX three-input max.f32 support on sm_100+"
                        #endif
                        asm volatile("max.f32 %0, %1, %2, %3;" : "=f"(_max3_6) : "f"(scores[18]), "f"(scores[19]), "f"(scores[20]));
                        float _max3_7;
                        #if defined(__CUDA_ARCH__) && (__CUDA_ARCH__ < 1000)
                        #error "Max3 requires PTX three-input max.f32 support on sm_100+"
                        #endif
                        asm volatile("max.f32 %0, %1, %2, %3;" : "=f"(_max3_7) : "f"(scores[21]), "f"(scores[22]), "f"(scores[23]));
                        float _max3_8;
                        #if defined(__CUDA_ARCH__) && (__CUDA_ARCH__ < 1000)
                        #error "Max3 requires PTX three-input max.f32 support on sm_100+"
                        #endif
                        asm volatile("max.f32 %0, %1, %2, %3;" : "=f"(_max3_8) : "f"(scores[24]), "f"(scores[25]), "f"(scores[26]));
                        float _max3_9;
                        #if defined(__CUDA_ARCH__) && (__CUDA_ARCH__ < 1000)
                        #error "Max3 requires PTX three-input max.f32 support on sm_100+"
                        #endif
                        asm volatile("max.f32 %0, %1, %2, %3;" : "=f"(_max3_9) : "f"(scores[27]), "f"(scores[28]), "f"(scores[29]));
                        float _max3_10;
                        #if defined(__CUDA_ARCH__) && (__CUDA_ARCH__ < 1000)
                        #error "Max3 requires PTX three-input max.f32 support on sm_100+"
                        #endif
                        asm volatile("max.f32 %0, %1, %2, %3;" : "=f"(_max3_10) : "f"(scores[30]), "f"(scores[31]), "f"(scores[32]));
                        float _max3_11;
                        #if defined(__CUDA_ARCH__) && (__CUDA_ARCH__ < 1000)
                        #error "Max3 requires PTX three-input max.f32 support on sm_100+"
                        #endif
                        asm volatile("max.f32 %0, %1, %2, %3;" : "=f"(_max3_11) : "f"(scores[33]), "f"(scores[34]), "f"(scores[35]));
                        float _max3_12;
                        #if defined(__CUDA_ARCH__) && (__CUDA_ARCH__ < 1000)
                        #error "Max3 requires PTX three-input max.f32 support on sm_100+"
                        #endif
                        asm volatile("max.f32 %0, %1, %2, %3;" : "=f"(_max3_12) : "f"(scores[36]), "f"(scores[37]), "f"(scores[38]));
                        float _max3_13;
                        #if defined(__CUDA_ARCH__) && (__CUDA_ARCH__ < 1000)
                        #error "Max3 requires PTX three-input max.f32 support on sm_100+"
                        #endif
                        asm volatile("max.f32 %0, %1, %2, %3;" : "=f"(_max3_13) : "f"(scores[39]), "f"(scores[40]), "f"(scores[41]));
                        float _max3_14;
                        #if defined(__CUDA_ARCH__) && (__CUDA_ARCH__ < 1000)
                        #error "Max3 requires PTX three-input max.f32 support on sm_100+"
                        #endif
                        asm volatile("max.f32 %0, %1, %2, %3;" : "=f"(_max3_14) : "f"(scores[42]), "f"(scores[43]), "f"(scores[44]));
                        float _max3_15;
                        #if defined(__CUDA_ARCH__) && (__CUDA_ARCH__ < 1000)
                        #error "Max3 requires PTX three-input max.f32 support on sm_100+"
                        #endif
                        asm volatile("max.f32 %0, %1, %2, %3;" : "=f"(_max3_15) : "f"(scores[45]), "f"(scores[46]), "f"(scores[47]));
                        float _max3_16;
                        #if defined(__CUDA_ARCH__) && (__CUDA_ARCH__ < 1000)
                        #error "Max3 requires PTX three-input max.f32 support on sm_100+"
                        #endif
                        asm volatile("max.f32 %0, %1, %2, %3;" : "=f"(_max3_16) : "f"(scores[48]), "f"(scores[49]), "f"(scores[50]));
                        float _max3_17;
                        #if defined(__CUDA_ARCH__) && (__CUDA_ARCH__ < 1000)
                        #error "Max3 requires PTX three-input max.f32 support on sm_100+"
                        #endif
                        asm volatile("max.f32 %0, %1, %2, %3;" : "=f"(_max3_17) : "f"(scores[51]), "f"(scores[52]), "f"(scores[53]));
                        float _max3_18;
                        #if defined(__CUDA_ARCH__) && (__CUDA_ARCH__ < 1000)
                        #error "Max3 requires PTX three-input max.f32 support on sm_100+"
                        #endif
                        asm volatile("max.f32 %0, %1, %2, %3;" : "=f"(_max3_18) : "f"(scores[54]), "f"(scores[55]), "f"(scores[56]));
                        float _max3_19;
                        #if defined(__CUDA_ARCH__) && (__CUDA_ARCH__ < 1000)
                        #error "Max3 requires PTX three-input max.f32 support on sm_100+"
                        #endif
                        asm volatile("max.f32 %0, %1, %2, %3;" : "=f"(_max3_19) : "f"(scores[57]), "f"(scores[58]), "f"(scores[59]));
                        float _max3_20;
                        #if defined(__CUDA_ARCH__) && (__CUDA_ARCH__ < 1000)
                        #error "Max3 requires PTX three-input max.f32 support on sm_100+"
                        #endif
                        asm volatile("max.f32 %0, %1, %2, %3;" : "=f"(_max3_20) : "f"(scores[60]), "f"(scores[61]), "f"(scores[62]));
                        float _max3_21;
                        #if defined(__CUDA_ARCH__) && (__CUDA_ARCH__ < 1000)
                        #error "Max3 requires PTX three-input max.f32 support on sm_100+"
                        #endif
                        ...
                        float _max_0 = max_noftz(_max3_27, scores[63]);
                        float _max3_30;
                        #if defined(__CUDA_ARCH__) && (__CUDA_ARCH__ < 1000)
                        #error "Max3 requires PTX three-input max.f32 support on sm_100+"
                        #endif
                        asm volatile("max.f32 %0, %1, %2, %3;" : "=f"(_max3_30) : "f"(_max3_28), "f"(_max3_29), "f"(_max_0));
                        tile_max = _max3_30;
                    } else {
                        asm volatile(
                            "tcgen05.ld.sync.aligned.32x32b.x64.b32"
                    ...
                    float _max_1 = max_noftz(tile_max, row_max_val);
        ...
        { // index_warp_main
            ...
            for (unsigned int work_slot_4 = work_begin_4; work_slot_4 < work_end_4; work_slot_4++) {
                ...
                for (int index_pass = 0; index_pass < 9 / ((0) ? 3 : 1); index_pass++) {
                    ...
                    int _vec_load_0[4];
                    {
                        const int4* _ivptr_0 = reinterpret_cast<const int4*>(sparse_indices + (sparse_base + index_offset_2) + 0);
                        int4 _ivld_0;
                        _ivld_0 = *_ivptr_0;
