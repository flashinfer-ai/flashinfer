...
// tvm-ffi dispatch module for kernel family 'cake_dsv4_family_a818877b1ee958a10d04'.
...
namespace cake_host_shim_78daac1c4f179c2a {
...
namespace variant_cake_dsv4_3a4667516a672d5f0d34_sm_100a_338ba8582df4 {
    ...
    case 0: {
      {
        ...
        int64_t gy = 1;
        int64_t gz = 1;
        cake_host_shim_78daac1c4f179c2a::variant_cake_dsv4_3a4667516a672d5f0d34_sm_100a_338ba8582df4::Run(arg_Q, arg_SWA_cache, arg_compressed_KV_cache, arg_SWA_cache, arg_compressed_KV_cache, arg_O, arg_partial_lse, arg_sparse_indices, arg_sparse_topk_lens, arg_sinks, arg_bmm1_scale, arg_bmm2_scale, num_heads, num_query_tokens, sparse_topk, has_sinks, total_work_items, gx, gy, gz, stream);
      }
      return;
    }
    default:
      TVM_FFI_CHECK(false, ValueError) << "no dispatch route for cake_dsv4_family_a818877b1ee958a10d04 shape (num_heads=" << num_heads << ", num_query_tokens=" << num_query_tokens << ", sparse_topk=" << sparse_topk << ", has_sinks=" << has_sinks << ", total_work_items=" << total_work_items << ")";
  }
}
...
TVM_FFI_DLL_EXPORT_TYPED_FUNC(run, cake_host_shim_78daac1c4f179c2a::Dispatch);
TVM_FFI_DLL_EXPORT_TYPED_FUNC(route_of, cake_host_shim_78daac1c4f179c2a::RouteOf);
