...
// tvm-ffi dispatch module for kernel family 'cake_dsv4_family_338b58d0d4e7434b1d49'.
...
namespace cake_host_shim_f6f50ade91e7901e {
...
namespace variant_cake_dsv4_3854f4e22a47aea4a5f0_sm_100a_c2ba38a96274 {
...
namespace variant_cake_dsv4_41b621f401cc72ee4a93_sm_100a_d207adf12462 {
    ...
    case 0: {
      {
        ...
        int64_t gy = 1;
        int64_t gz = 1;
        cake_host_shim_f6f50ade91e7901e::variant_cake_dsv4_3854f4e22a47aea4a5f0_sm_100a_c2ba38a96274::Run(arg_Q, arg_SWA_cache, arg_compressed_KV_cache, arg_SWA_cache, arg_compressed_KV_cache, arg_partial_O, arg_partial_lse, arg_sparse_indices, arg_sparse_topk_lens, arg_sinks, arg_bmm1_scale, arg_bmm2_scale, num_heads, num_query_tokens, sparse_topk, has_sinks, total_work_items, gx, gy, gz, stream);
      }
      {
        int64_t gx = num_query_tokens;
        int64_t gy = num_heads;
        int64_t gz = 1;
        cake_host_shim_f6f50ade91e7901e::variant_cake_dsv4_41b621f401cc72ee4a93_sm_100a_d207adf12462::Run(arg_partial_O, arg_partial_lse, arg_O, num_heads, num_split, gx, gy, gz, stream);
      }
      return;
    }
    default:
      TVM_FFI_CHECK(false, ValueError) << "no dispatch route for cake_dsv4_family_338b58d0d4e7434b1d49 shape (num_heads=" << num_heads << ", num_query_tokens=" << num_query_tokens << ", sparse_topk=" << sparse_topk << ", has_sinks=" << has_sinks << ", total_work_items=" << total_work_items << ", num_split=" << num_split << ")";
  }
}
...
TVM_FFI_DLL_EXPORT_TYPED_FUNC(run, cake_host_shim_f6f50ade91e7901e::Dispatch);
TVM_FFI_DLL_EXPORT_TYPED_FUNC(route_of, cake_host_shim_f6f50ade91e7901e::RouteOf);
