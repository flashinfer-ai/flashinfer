...
// tvm-ffi dispatch module for kernel family 'cake_dsv4_family_27bbd9f38eb7736ba471'.
...
extern "C" __global__ void kernel_cake_dsv4_176daeff2cabcee91620(const __grid_constant__ CUtensorMap tmap_q, const __grid_constant__ CUtensorMap tmap_swa_kv, const __grid_constant__ CUtensorMap tmap_compressed_kv, __nv_bfloat16* __restrict__ O, float* __restrict__ partial_lse, int* __restrict__ sparse_indices, int* __restrict__ sparse_topk_lens, float* __restrict__ sinks, float* __restrict__ bmm1_scale, float* __restrict__ bmm2_scale, int num_heads, int num_query_tokens, int sparse_topk, int has_sinks, int total_work_items, int num_split);
extern "C" __global__ void kernel_cake_dsv4_b167b5862f6d4b417d00(__nv_bfloat16* __restrict__ partial_O, float* __restrict__ partial_lse, __nv_bfloat16* __restrict__ O, int num_q_heads, int num_split);

namespace cake_host_shim_446c9849f2412829 {
...
namespace variant_cake_dsv4_176daeff2cabcee91620_sm_100a_de080e19f0e1 {
...
void Run(TensorView arg_tmap_q, TensorView arg_tmap_swa_kv, TensorView arg_tmap_compressed_kv, TensorView arg_O, TensorView arg_partial_lse, TensorView arg_sparse_indices, TensorView arg_sparse_topk_lens, TensorView arg_sinks, TensorView arg_bmm1_scale, TensorView arg_bmm2_scale, int64_t arg_num_heads, int64_t arg_num_query_tokens, int64_t arg_sparse_topk, int64_t arg_has_sinks, int64_t arg_total_work_items, int64_t arg_num_split, int64_t grid_x, int64_t grid_y, int64_t grid_z, cudaStream_t stream) {
  ...
  void* kargs[] = {&p_tmap_q, &p_tmap_swa_kv, &p_tmap_compressed_kv, &p_O, &p_partial_lse, &p_sparse_indices, &p_sparse_topk_lens, &p_sinks, &p_bmm1_scale, &p_bmm2_scale, &v_num_heads, &v_num_query_tokens, &v_sparse_topk, &v_has_sinks, &v_total_work_items, &v_num_split};
    ...
    if (it == smem_status_by_device->end()) {
      ...
      if (smem_status == cudaSuccess) {
        smem_status = cudaFuncSetAttribute(
            reinterpret_cast<const void*>(kernel_cake_dsv4_176daeff2cabcee91620),
  ...
  TVM_FFI_CHECK(smem_status == cudaSuccess, RuntimeError)
      << "cudaFuncSetAttribute for kernel_cake_dsv4_176daeff2cabcee91620 failed: "
  ...
  cudaError_t launch_status = cudaLaunchKernelExC(
      &config, reinterpret_cast<const void*>(kernel_cake_dsv4_176daeff2cabcee91620), kargs);
  TVM_FFI_CHECK(launch_status == cudaSuccess, RuntimeError)
      << "cudaLaunchKernelExC for kernel_cake_dsv4_176daeff2cabcee91620 failed: "
      << cudaGetErrorString(launch_status);
}
}  // namespace variant_cake_dsv4_176daeff2cabcee91620_sm_100a_de080e19f0e1

namespace variant_cake_dsv4_b167b5862f6d4b417d00_sm_100a_3203b22c11bb {

void Run(TensorView arg_partial_O, TensorView arg_partial_lse, TensorView arg_O, int64_t arg_num_q_heads, int64_t arg_num_split, int64_t grid_x, int64_t grid_y, int64_t grid_z, cudaStream_t stream) {
  ...
  config.gridDim = grid;
  config.blockDim = block;
  config.dynamicSmemBytes = 1024u;
  config.stream = stream;
  cudaError_t launch_status = cudaLaunchKernelExC(
      &config, reinterpret_cast<const void*>(kernel_cake_dsv4_b167b5862f6d4b417d00), kargs);
  TVM_FFI_CHECK(launch_status == cudaSuccess, RuntimeError)
      << "cudaLaunchKernelExC for kernel_cake_dsv4_b167b5862f6d4b417d00 failed: "
      << cudaGetErrorString(launch_status);
}
}  // namespace variant_cake_dsv4_b167b5862f6d4b417d00_sm_100a_3203b22c11bb

int SelectVariant(int32_t num_heads, int32_t num_query_tokens, int32_t sparse_topk, int32_t has_sinks, int32_t total_work_items, int32_t num_split) {
  if ((num_split > 1)) return 0;
  if ((num_split == 1)) return 1;
  return -1;
}

void Dispatch(tvm::ffi::TensorView arg_Q, tvm::ffi::TensorView arg_SWA_cache, tvm::ffi::TensorView arg_compressed_KV_cache, tvm::ffi::TensorView arg_partial_O, tvm::ffi::TensorView arg_partial_lse, tvm::ffi::TensorView arg_sparse_indices, tvm::ffi::TensorView arg_sparse_topk_lens, tvm::ffi::TensorView arg_sinks, tvm::ffi::TensorView arg_bmm1_scale, tvm::ffi::TensorView arg_bmm2_scale, tvm::ffi::TensorView arg_O, int32_t num_heads, int32_t num_query_tokens, int32_t sparse_topk, int32_t has_sinks, int32_t total_work_items, int32_t num_split, int64_t cuda_stream_ptr) {
  ...
  int v = SelectVariant(num_heads, num_query_tokens, sparse_topk, has_sinks, total_work_items, num_split);
  switch (v) {
    case 0: {
      {
        ...
        int64_t gy = 1;
        int64_t gz = 1;
        cake_host_shim_446c9849f2412829::variant_cake_dsv4_176daeff2cabcee91620_sm_100a_de080e19f0e1::Run(arg_Q, arg_SWA_cache, arg_compressed_KV_cache, arg_partial_O, arg_partial_lse, arg_sparse_indices, arg_sparse_topk_lens, arg_sinks, arg_bmm1_scale, arg_bmm2_scale, num_heads, num_query_tokens, sparse_topk, has_sinks, total_work_items, num_split, gx, gy, gz, stream);
      }
      {
        int64_t gx = num_query_tokens;
        int64_t gy = num_heads;
        int64_t gz = 1;
        cake_host_shim_446c9849f2412829::variant_cake_dsv4_b167b5862f6d4b417d00_sm_100a_3203b22c11bb::Run(arg_partial_O, arg_partial_lse, arg_O, num_heads, num_split, gx, gy, gz, stream);
      }
      return;
    }
    case 1: {
    ...
    default:
      TVM_FFI_CHECK(false, ValueError) << "no dispatch route for cake_dsv4_family_27bbd9f38eb7736ba471 shape (num_heads=" << num_heads << ", num_query_tokens=" << num_query_tokens << ", sparse_topk=" << sparse_topk << ", has_sinks=" << has_sinks << ", total_work_items=" << total_work_items << ", num_split=" << num_split << ")";
  }
}

int64_t RouteOf(int32_t num_heads, int32_t num_query_tokens, int32_t sparse_topk, int32_t has_sinks, int32_t total_work_items, int32_t num_split) { return SelectVariant(num_heads, num_query_tokens, sparse_topk, has_sinks, total_work_items, num_split); }

}  // namespace cake_host_shim_446c9849f2412829

TVM_FFI_DLL_EXPORT_TYPED_FUNC(run, cake_host_shim_446c9849f2412829::Dispatch);
TVM_FFI_DLL_EXPORT_TYPED_FUNC(route_of, cake_host_shim_446c9849f2412829::RouteOf);
