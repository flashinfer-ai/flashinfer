...
// tvm-ffi dispatch module for kernel family 'cake_dsv4_family_92205cb3f5a030687afd'.
...
extern "C" __global__ void kernel_cake_dsv4_d6920d5533a70720af01(const __grid_constant__ CUtensorMap tmap_q, const __grid_constant__ CUtensorMap tmap_swa_k, const __grid_constant__ CUtensorMap tmap_compressed_k, const __grid_constant__ CUtensorMap tmap_swa_v, const __grid_constant__ CUtensorMap tmap_compressed_v, __nv_bfloat16* __restrict__ O, float* __restrict__ partial_lse, int* __restrict__ sparse_indices, int* __restrict__ sparse_topk_lens, float* __restrict__ sinks, float* __restrict__ bmm1_scale, float* __restrict__ bmm2_scale, int num_heads, int num_query_tokens, int sparse_topk, int has_sinks, int total_work_items);
extern "C" __global__ void kernel_cake_dsv4_a543fde632e55040fda4(__nv_bfloat16* __restrict__ partial_O, float* __restrict__ partial_lse, __nv_bfloat16* __restrict__ O, int num_q_heads, int num_split);

namespace cake_host_shim_bdfaf7c0a1f16957 {
...
namespace variant_cake_dsv4_d6920d5533a70720af01_sm_100a_63122d9279e9 {
...
void Run(TensorView arg_tmap_q, TensorView arg_tmap_swa_k, TensorView arg_tmap_compressed_k, TensorView arg_tmap_swa_v, TensorView arg_tmap_compressed_v, TensorView arg_O, TensorView arg_partial_lse, TensorView arg_sparse_indices, TensorView arg_sparse_topk_lens, TensorView arg_sinks, TensorView arg_bmm1_scale, TensorView arg_bmm2_scale, int64_t arg_num_heads, int64_t arg_num_query_tokens, int64_t arg_sparse_topk, int64_t arg_has_sinks, int64_t arg_total_work_items, int64_t grid_x, int64_t grid_y, int64_t grid_z, cudaStream_t stream) {
    ...
    if (it == smem_status_by_device->end()) {
      ...
      if (smem_status == cudaSuccess) {
        smem_status = cudaFuncSetAttribute(
            reinterpret_cast<const void*>(kernel_cake_dsv4_d6920d5533a70720af01),
  ...
  TVM_FFI_CHECK(smem_status == cudaSuccess, RuntimeError)
      << "cudaFuncSetAttribute for kernel_cake_dsv4_d6920d5533a70720af01 failed: "
  ...
  cudaError_t launch_status = cudaLaunchKernelExC(
      &config, reinterpret_cast<const void*>(kernel_cake_dsv4_d6920d5533a70720af01), kargs);
  TVM_FFI_CHECK(launch_status == cudaSuccess, RuntimeError)
      << "cudaLaunchKernelExC for kernel_cake_dsv4_d6920d5533a70720af01 failed: "
      << cudaGetErrorString(launch_status);
}
}  // namespace variant_cake_dsv4_d6920d5533a70720af01_sm_100a_63122d9279e9

namespace variant_cake_dsv4_a543fde632e55040fda4_sm_100a_3203b22c11bb {
...
void Run(TensorView arg_partial_O, TensorView arg_partial_lse, TensorView arg_O, int64_t arg_num_q_heads, int64_t arg_num_split, int64_t grid_x, int64_t grid_y, int64_t grid_z, cudaStream_t stream) {
  ...
  config.stream = stream;
  cudaError_t launch_status = cudaLaunchKernelExC(
      &config, reinterpret_cast<const void*>(kernel_cake_dsv4_a543fde632e55040fda4), kargs);
  TVM_FFI_CHECK(launch_status == cudaSuccess, RuntimeError)
      << "cudaLaunchKernelExC for kernel_cake_dsv4_a543fde632e55040fda4 failed: "
      << cudaGetErrorString(launch_status);
}
}  // namespace variant_cake_dsv4_a543fde632e55040fda4_sm_100a_3203b22c11bb
    ...
    case 0: {
      {
        ...
        int64_t gy = 1;
        int64_t gz = 1;
        cake_host_shim_bdfaf7c0a1f16957::variant_cake_dsv4_d6920d5533a70720af01_sm_100a_63122d9279e9::Run(arg_Q, arg_SWA_cache, arg_compressed_KV_cache, arg_SWA_cache, arg_compressed_KV_cache, arg_partial_O, arg_partial_lse, arg_sparse_indices, arg_sparse_topk_lens, arg_sinks, arg_bmm1_scale, arg_bmm2_scale, num_heads, num_query_tokens, sparse_topk, has_sinks, total_work_items, gx, gy, gz, stream);
      }
      {
        int64_t gx = num_query_tokens;
        int64_t gy = num_heads;
        int64_t gz = 1;
        cake_host_shim_bdfaf7c0a1f16957::variant_cake_dsv4_a543fde632e55040fda4_sm_100a_3203b22c11bb::Run(arg_partial_O, arg_partial_lse, arg_O, num_heads, num_split, gx, gy, gz, stream);
      }
      return;
    }
    default:
      TVM_FFI_CHECK(false, ValueError) << "no dispatch route for cake_dsv4_family_92205cb3f5a030687afd shape (num_heads=" << num_heads << ", num_query_tokens=" << num_query_tokens << ", sparse_topk=" << sparse_topk << ", has_sinks=" << has_sinks << ", total_work_items=" << total_work_items << ", num_split=" << num_split << ")";
  }
}
...
TVM_FFI_DLL_EXPORT_TYPED_FUNC(run, cake_host_shim_bdfaf7c0a1f16957::Dispatch);
TVM_FFI_DLL_EXPORT_TYPED_FUNC(route_of, cake_host_shim_bdfaf7c0a1f16957::RouteOf);
