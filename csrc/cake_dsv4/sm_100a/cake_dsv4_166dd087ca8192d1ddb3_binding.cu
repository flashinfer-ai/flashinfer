...
// tvm-ffi direct-source launcher for Cake kernel 'kernel_cake_dsv4_166dd087ca8192d1ddb3'.
#include <cuda.h>
#include <cuda_bf16.h>
#include <cuda_fp16.h>
...
extern "C" __global__ void kernel_cake_dsv4_166dd087ca8192d1ddb3(__nv_bfloat16* __restrict__ partial_O, float* __restrict__ partial_lse, __nv_bfloat16* __restrict__ O, int num_q_heads);


namespace cake_host_shim_a004770e12959394 {
...
void Run(TensorView arg_partial_O, TensorView arg_partial_lse, TensorView arg_O, int64_t arg_num_q_heads, int64_t grid_x, int64_t grid_y, int64_t grid_z) {
  ...
  void* kargs[] = {&p_partial_O, &p_partial_lse, &p_O, &v_num_q_heads};
  ...
  cudaError_t launch_status = cudaLaunchKernelExC(
      &config, reinterpret_cast<const void*>(kernel_cake_dsv4_166dd087ca8192d1ddb3), kargs);
  TVM_FFI_CHECK(launch_status == cudaSuccess, RuntimeError)
      << "cudaLaunchKernelExC for kernel_cake_dsv4_166dd087ca8192d1ddb3 failed: "
      << cudaGetErrorString(launch_status);
}

}  // namespace cake_host_shim_a004770e12959394

TVM_FFI_DLL_EXPORT_TYPED_FUNC(run, cake_host_shim_a004770e12959394::Run);
