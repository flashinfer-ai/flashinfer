...
// tvm-ffi dispatch module for kernel family 'cake_dsv4_family_51871d3dbfe2fb3d96de'.
...
extern "C" __global__ void kernel_cake_dsv4_b8575ba76d96232c5908(__nv_bfloat16* __restrict__ partial_O, float* __restrict__ partial_lse, __nv_bfloat16* __restrict__ O, int num_q_heads, int num_split);
...
namespace cake_host_shim_d1b40104b4558490 {
...
namespace variant_cake_dsv4_9d2ce77cf70b38c423ed_sm_100a_46c048f207cb {
...
namespace variant_cake_dsv4_b8575ba76d96232c5908_sm_100a_2aa406beaee4 {
...
void Run(TensorView arg_partial_O, TensorView arg_partial_lse, TensorView arg_O, int64_t arg_num_q_heads, int64_t arg_num_split, int64_t grid_x, int64_t grid_y, int64_t grid_z, cudaStream_t stream) {
  ...
  config.stream = stream;
  cudaError_t launch_status = cudaLaunchKernelExC(
      &config, reinterpret_cast<const void*>(kernel_cake_dsv4_b8575ba76d96232c5908), kargs);
  TVM_FFI_CHECK(launch_status == cudaSuccess, RuntimeError)
      << "cudaLaunchKernelExC for kernel_cake_dsv4_b8575ba76d96232c5908 failed: "
      << cudaGetErrorString(launch_status);
}
}  // namespace variant_cake_dsv4_b8575ba76d96232c5908_sm_100a_2aa406beaee4
    ...
    case 0: {
      {
        ...
        int64_t gy = 1;
        int64_t gz = 1;
        cake_host_shim_d1b40104b4558490::variant_cake_dsv4_9d2ce77cf70b38c423ed_sm_100a_46c048f207cb::Run(arg_Q, arg_SWA_cache, arg_compressed_KV_cache, arg_SWA_cache, arg_compressed_KV_cache, arg_partial_O, arg_partial_lse, arg_sparse_indices, arg_sparse_topk_lens, arg_sinks, arg_bmm1_scale, arg_bmm2_scale, num_heads, num_query_tokens, sparse_topk, has_sinks, total_work_items, gx, gy, gz, stream);
      }
      {
        int64_t gx = num_query_tokens;
        int64_t gy = num_heads;
        int64_t gz = 1;
        cake_host_shim_d1b40104b4558490::variant_cake_dsv4_b8575ba76d96232c5908_sm_100a_2aa406beaee4::Run(arg_partial_O, arg_partial_lse, arg_O, num_heads, num_split, gx, gy, gz, stream);
      }
      return;
    }
    default:
      TVM_FFI_CHECK(false, ValueError) << "no dispatch route for cake_dsv4_family_51871d3dbfe2fb3d96de shape (num_heads=" << num_heads << ", num_query_tokens=" << num_query_tokens << ", sparse_topk=" << sparse_topk << ", has_sinks=" << has_sinks << ", total_work_items=" << total_work_items << ", num_split=" << num_split << ")";
  }
}
...
TVM_FFI_DLL_EXPORT_TYPED_FUNC(run, cake_host_shim_d1b40104b4558490::Dispatch);
TVM_FFI_DLL_EXPORT_TYPED_FUNC(route_of, cake_host_shim_d1b40104b4558490::RouteOf);
