...
kernel_cake_dsv4_946717a427863b26891e(__nv_bfloat16* __restrict__ partial_O, float* __restrict__ partial_lse, __nv_bfloat16* __restrict__ O, int num_q_heads)
{
    ...
    float _shfl_0;
    asm volatile("shfl.sync.idx.b32 %0, %1, %2, 0x1f, 0xffffffff;" : "=f"(_shfl_0) : "f"(local_lse), "r"(0));
    float lse0 = _shfl_0;
    float _shfl_1;
    asm volatile("shfl.sync.idx.b32 %0, %1, %2, 0x1f, 0xffffffff;" : "=f"(_shfl_1) : "f"(local_lse), "r"(1));
    float lse1 = _shfl_1;
