...
kernel_cake_dsv4_fp8_lowhead_prefill(CakeTensorMap const* tmap_q, CakeTensorMap const* tmap_swa_kv, CakeTensorMap const* tmap_compressed_kv, __nv_bfloat16* __restrict__ O, float* __restrict__ partial_lse, int* __restrict__ sparse_indices, int* __restrict__ sparse_topk_lens, float* __restrict__ sinks, float* __restrict__ bmm1_scale, float* __restrict__ bmm2_scale, int num_heads, int num_query_tokens, int sparse_topk, int has_sinks, int total_work_items)
{
    ...
    if (warp >= 9 && warp <= 12) {
        { // load_warp_main
            ...
            const int load_warp_rank = warp - (unsigned int)(((0) ? 12 : 9));
            ...
            for (unsigned int work_idx_1 = bid; work_idx_1 < total_work_items; work_idx_1 += num_bids) {
                ...
                }
                {
                    ...
                    for (int index_pass = load_warp_rank; index_pass < num_index_passes; index_pass += 4) {
                        int index_offset = (unsigned int)(index_pass * 128) + lane * 4;
                    ...
                    {
                        {
                            ...
                            for (int frag = 0; frag < 4; frag++) {
                                ...
                                if (!(_slice_lo_mask_1 & (1u << 0))) _tmem_load_2[0] = -CAKE_INF;
                                if (!(_slice_lo_mask_1 & (1u << 1))) _tmem_load_2[1] = -CAKE_INF;
                                if (!(_slice_lo_mask_1 & (1u << 2))) _tmem_load_2[2] = -CAKE_INF;
                                if (!(_slice_lo_mask_1 & (1u << 3))) _tmem_load_2[3] = -CAKE_INF;
                                if (!(_slice_lo_mask_1 & (1u << 4))) _tmem_load_2[4] = -CAKE_INF;
                                if (!(_slice_lo_mask_1 & (1u << 5))) _tmem_load_2[5] = -CAKE_INF;
                                if (!(_slice_lo_mask_1 & (1u << 6))) _tmem_load_2[6] = -CAKE_INF;
                                if (!(_slice_lo_mask_1 & (1u << 7))) _tmem_load_2[7] = -CAKE_INF;
                                if (!(_slice_lo_mask_1 & (1u << 8))) _tmem_load_2[8] = -CAKE_INF;
                                if (!(_slice_lo_mask_1 & (1u << 9))) _tmem_load_2[9] = -CAKE_INF;
                                if (!(_slice_lo_mask_1 & (1u << 10))) _tmem_load_2[10] = -CAKE_INF;
                                if (!(_slice_lo_mask_1 & (1u << 11))) _tmem_load_2[11] = -CAKE_INF;
                                if (!(_slice_lo_mask_1 & (1u << 12))) _tmem_load_2[12] = -CAKE_INF;
                                if (!(_slice_lo_mask_1 & (1u << 13))) _tmem_load_2[13] = -CAKE_INF;
                                if (!(_slice_lo_mask_1 & (1u << 14))) _tmem_load_2[14] = -CAKE_INF;
                                if (!(_slice_lo_mask_1 & (1u << 15))) _tmem_load_2[15] = -CAKE_INF;
                                if (!(_slice_lo_mask_1 & (1u << 16))) _tmem_load_2[16] = -CAKE_INF;
                                if (!(_slice_lo_mask_1 & (1u << 17))) _tmem_load_2[17] = -CAKE_INF;
                                if (!(_slice_lo_mask_1 & (1u << 18))) _tmem_load_2[18] = -CAKE_INF;
                                if (!(_slice_lo_mask_1 & (1u << 19))) _tmem_load_2[19] = -CAKE_INF;
                                if (!(_slice_lo_mask_1 & (1u << 20))) _tmem_load_2[20] = -CAKE_INF;
                                if (!(_slice_lo_mask_1 & (1u << 21))) _tmem_load_2[21] = -CAKE_INF;
                                if (!(_slice_lo_mask_1 & (1u << 22))) _tmem_load_2[22] = -CAKE_INF;
                                if (!(_slice_lo_mask_1 & (1u << 23))) _tmem_load_2[23] = -CAKE_INF;
                                if (!(_slice_lo_mask_1 & (1u << 24))) _tmem_load_2[24] = -CAKE_INF;
                                if (!(_slice_lo_mask_1 & (1u << 25))) _tmem_load_2[25] = -CAKE_INF;
                                if (!(_slice_lo_mask_1 & (1u << 26))) _tmem_load_2[26] = -CAKE_INF;
                                if (!(_slice_lo_mask_1 & (1u << 27))) _tmem_load_2[27] = -CAKE_INF;
                                if (!(_slice_lo_mask_1 & (1u << 28))) _tmem_load_2[28] = -CAKE_INF;
                                if (!(_slice_lo_mask_1 & (1u << 29))) _tmem_load_2[29] = -CAKE_INF;
                                if (!(_slice_lo_mask_1 & (1u << 30))) _tmem_load_2[30] = -CAKE_INF;
                                if (!(_slice_lo_mask_1 & (1u << 31))) _tmem_load_2[31] = -CAKE_INF;
                    ...
                    {
                        {
                            ...
                            for (int frag_1 = 0; frag_1 < 4; frag_1++) {
                                ...
                                {
                                    int _lim_2 = frag_valid_1;
                                    if (_lim_2 <= 0) { _slice_lo_mask_3 = 0u; }
                                    else if (_lim_2 >= 32) { _slice_lo_mask_3 = 0xFFFFFFFFu; }
                                    else {
                                        asm volatile("{"
                                            ".reg .u32 t;\n\t"
                                            "shl.b32 t, 1, %1;\n\t"
                                            "add.u32 %0, t, -1;\n\t"
                                            "}" : "=r"(_slice_lo_mask_3) : "r"(_lim_2));
                                    }
                                }
                                ...
                                float2 _fma_pair_5 = fma_f32x2(make_float2(_tmem_load_3[0], _tmem_load_3[1]), _fma_b2_3, _fma_c2_4);
                                _tmem_load_3[0] = _fma_pair_5.x;
                                _tmem_load_3[1] = _fma_pair_5.y;
                                float2 _fma_pair_6 = fma_f32x2(make_float2(_tmem_load_3[2], _tmem_load_3[3]), _fma_b2_3, _fma_c2_4);
                                _tmem_load_3[2] = _fma_pair_6.x;
                                _tmem_load_3[3] = _fma_pair_6.y;
                                float2 _fma_pair_7 = fma_f32x2(make_float2(_tmem_load_3[4], _tmem_load_3[5]), _fma_b2_3, _fma_c2_4);
                                _tmem_load_3[4] = _fma_pair_7.x;
                                _tmem_load_3[5] = _fma_pair_7.y;
                                float2 _fma_pair_8 = fma_f32x2(make_float2(_tmem_load_3[6], _tmem_load_3[7]), _fma_b2_3, _fma_c2_4);
                                _tmem_load_3[6] = _fma_pair_8.x;
                                _tmem_load_3[7] = _fma_pair_8.y;
                                float2 _fma_pair_9 = fma_f32x2(make_float2(_tmem_load_3[8], _tmem_load_3[9]), _fma_b2_3, _fma_c2_4);
                                _tmem_load_3[8] = _fma_pair_9.x;
                                _tmem_load_3[9] = _fma_pair_9.y;
                                float2 _fma_pair_10 = fma_f32x2(make_float2(_tmem_load_3[10], _tmem_load_3[11]), _fma_b2_3, _fma_c2_4);
                                _tmem_load_3[10] = _fma_pair_10.x;
                                _tmem_load_3[11] = _fma_pair_10.y;
                                float2 _fma_pair_11 = fma_f32x2(make_float2(_tmem_load_3[12], _tmem_load_3[13]), _fma_b2_3, _fma_c2_4);
                                _tmem_load_3[12] = _fma_pair_11.x;
                                _tmem_load_3[13] = _fma_pair_11.y;
                                float2 _fma_pair_12 = fma_f32x2(make_float2(_tmem_load_3[14], _tmem_load_3[15]), _fma_b2_3, _fma_c2_4);
                                _tmem_load_3[14] = _fma_pair_12.x;
                                _tmem_load_3[15] = _fma_pair_12.y;
                                float2 _fma_pair_13 = fma_f32x2(make_float2(_tmem_load_3[16], _tmem_load_3[17]), _fma_b2_3, _fma_c2_4);
                                _tmem_load_3[16] = _fma_pair_13.x;
                                _tmem_load_3[17] = _fma_pair_13.y;
                                float2 _fma_pair_14 = fma_f32x2(make_float2(_tmem_load_3[18], _tmem_load_3[19]), _fma_b2_3, _fma_c2_4);
                                _tmem_load_3[18] = _fma_pair_14.x;
                                _tmem_load_3[19] = _fma_pair_14.y;
                                float2 _fma_pair_15 = fma_f32x2(make_float2(_tmem_load_3[20], _tmem_load_3[21]), _fma_b2_3, _fma_c2_4);
                                _tmem_load_3[20] = _fma_pair_15.x;
                                _tmem_load_3[21] = _fma_pair_15.y;
                                float2 _fma_pair_16 = fma_f32x2(make_float2(_tmem_load_3[22], _tmem_load_3[23]), _fma_b2_3, _fma_c2_4);
                                _tmem_load_3[22] = _fma_pair_16.x;
                                _tmem_load_3[23] = _fma_pair_16.y;
                                float2 _fma_pair_17 = fma_f32x2(make_float2(_tmem_load_3[24], _tmem_load_3[25]), _fma_b2_3, _fma_c2_4);
                                _tmem_load_3[24] = _fma_pair_17.x;
                                _tmem_load_3[25] = _fma_pair_17.y;
                                float2 _fma_pair_18 = fma_f32x2(make_float2(_tmem_load_3[26], _tmem_load_3[27]), _fma_b2_3, _fma_c2_4);
                                _tmem_load_3[26] = _fma_pair_18.x;
                                _tmem_load_3[27] = _fma_pair_18.y;
                                float2 _fma_pair_19 = fma_f32x2(make_float2(_tmem_load_3[28], _tmem_load_3[29]), _fma_b2_3, _fma_c2_4);
                                _tmem_load_3[28] = _fma_pair_19.x;
                                _tmem_load_3[29] = _fma_pair_19.y;
                                float2 _fma_pair_20 = fma_f32x2(make_float2(_tmem_load_3[30], _tmem_load_3[31]), _fma_b2_3, _fma_c2_4);
                                _tmem_load_3[30] = _fma_pair_20.x;
                                _tmem_load_3[31] = _fma_pair_20.y;
                                #pragma unroll
                                for (int _le = 0; _le < 32; _le++) {
                                    _tmem_load_3[_le] = approx_exp2(_tmem_load_3[_le]);
                                }
                                float2 _reg_reduce_sum2_21 = make_float2(0.0f, 0.0f);
                                _reg_reduce_sum2_21 = add_f32x2(_reg_reduce_sum2_21, make_float2(_tmem_load_3[0], _tmem_load_3[1]));
                                _reg_reduce_sum2_21 = add_f32x2(_reg_reduce_sum2_21, make_float2(_tmem_load_3[2], _tmem_load_3[3]));
                                _reg_reduce_sum2_21 = add_f32x2(_reg_reduce_sum2_21, make_float2(_tmem_load_3[4], _tmem_load_3[5]));
                                _reg_reduce_sum2_21 = add_f32x2(_reg_reduce_sum2_21, make_float2(_tmem_load_3[6], _tmem_load_3[7]));
                                _reg_reduce_sum2_21 = add_f32x2(_reg_reduce_sum2_21, make_float2(_tmem_load_3[8], _tmem_load_3[9]));
                                _reg_reduce_sum2_21 = add_f32x2(_reg_reduce_sum2_21, make_float2(_tmem_load_3[10], _tmem_load_3[11]));
                                _reg_reduce_sum2_21 = add_f32x2(_reg_reduce_sum2_21, make_float2(_tmem_load_3[12], _tmem_load_3[13]));
                                _reg_reduce_sum2_21 = add_f32x2(_reg_reduce_sum2_21, make_float2(_tmem_load_3[14], _tmem_load_3[15]));
                                _reg_reduce_sum2_21 = add_f32x2(_reg_reduce_sum2_21, make_float2(_tmem_load_3[16], _tmem_load_3[17]));
                                _reg_reduce_sum2_21 = add_f32x2(_reg_reduce_sum2_21, make_float2(_tmem_load_3[18], _tmem_load_3[19]));
                                _reg_reduce_sum2_21 = add_f32x2(_reg_reduce_sum2_21, make_float2(_tmem_load_3[20], _tmem_load_3[21]));
                                _reg_reduce_sum2_21 = add_f32x2(_reg_reduce_sum2_21, make_float2(_tmem_load_3[22], _tmem_load_3[23]));
                                _reg_reduce_sum2_21 = add_f32x2(_reg_reduce_sum2_21, make_float2(_tmem_load_3[24], _tmem_load_3[25]));
                                _reg_reduce_sum2_21 = add_f32x2(_reg_reduce_sum2_21, make_float2(_tmem_load_3[26], _tmem_load_3[27]));
                                _reg_reduce_sum2_21 = add_f32x2(_reg_reduce_sum2_21, make_float2(_tmem_load_3[28], _tmem_load_3[29]));
                                _reg_reduce_sum2_21 = add_f32x2(_reg_reduce_sum2_21, make_float2(_tmem_load_3[30], _tmem_load_3[31]));
                                float _tmem_load_3_sum = _reg_reduce_sum2_21.x + _reg_reduce_sum2_21.y;
