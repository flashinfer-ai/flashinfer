...
kernel_cake_grouped_fp8_gemm_ee7f6d407fcf62bd1dfc(CakeTensorMap const* A, CakeTensorMap const* B, CakeTensorMap const* C_tma, __nv_bfloat16* __restrict__ C, float* __restrict__ a_scale, float* __restrict__ b_scale, int* __restrict__ m_indices, int M, int N, int K, int G)
{
    ...
    #define scale_free_addr (mbar_base + 168)
    ...
    uint8_t* smem_b_half0 = reinterpret_cast<uint8_t*>(smem_raw + 82944);
    const int smem_b_half0_addr = smem + 82944;
    uint8_t* smem_b_half1 = reinterpret_cast<uint8_t*>(smem_raw + 91136);
    const int smem_b_half1_addr = smem + 91136;
    __nv_bfloat16* epi_staging = reinterpret_cast<__nv_bfloat16*>(smem_raw + 164864);
    const int epi_staging_addr = smem + 164864;
    float* smem_ascale = reinterpret_cast<float*>(smem_raw + 214016);
    const int smem_ascale_addr = smem + 214016;
    float* smem_bscale = reinterpret_cast<float*>(smem_raw + 220160);
    const int smem_bscale_addr = smem + 220160;
    ...
    if (warp <= 7) {
        ...
        { // acc_epi_main
            ...
            int total_tiles = m_tiles * 16;
            int cluster_m_tile = cluster_id >> 4;
            int n_tile = cluster_id & 15;
            unsigned int _phase_scale_full = 0;
            #pragma unroll 1
            for (int tile_id = cluster_id; tile_id < total_tiles; tile_id += 64) {
                ...
                for (int segment_iter = 0; segment_iter < tile_rows; segment_iter++) {
                    ...
                    group = _shfl_9;
                    uint32_t _mbar_token_0 = mbarrier_test_wait(partial_full_addr + (partial_stage) * 8, partial_full_phase);
                    unsigned int partial_full_token = _mbar_token_0;
                    float acc0[32];
                    float acc1[32];
                    float acc2[32];
                    float acc3[32];
                    ...
                    for (int scale_group = 0; scale_group < scale_groups; scale_group++) {
                        ...
                        if (scale_group != 0) {
                            uint32_t _mbar_token_1 = mbarrier_test_wait(partial_full_addr + (partial_stage) * 8, partial_full_phase);
                            partial_full_token = _mbar_token_1;
                        }
                        ...
                        for (int k_inner = 0; k_inner < 4; k_inner++) {
                            ...
                            int _trl_addr_1 = tmem_partials + (partial_stage * 128 + (unsigned int)(acc_wg * 64)) + (row_base << 16);
                            tmem_ld_x16(&partial_fragment_a[0], _trl_addr_1);
                            int _trl_addr_2 = tmem_partials + (partial_stage * 128 + (unsigned int)(acc_wg * 64) + 16) + (row_base << 16);
                            tmem_ld_x16(&partial_fragment_b[0], _trl_addr_2);
                            int _trl_addr_3 = tmem_partials + (partial_stage * 128 + (unsigned int)(acc_wg * 64) + 32) + (row_base << 16);
                            tmem_ld_x16(&partial_fragment_c[0], _trl_addr_3);
                            int _trl_addr_4 = tmem_partials + (partial_stage * 128 + (unsigned int)(acc_wg * 64) + 32 + 16) + (row_base << 16);
                            ...
                            asm volatile("tcgen05.wait::ld.sync.aligned;" ::: "memory");
                            {
                                ...
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc0[0]), "+f"(acc0[1]) : "f"(partial_fragment_a[0]), "f"(partial_fragment_a[1]), "l"(_fma_acc_scale2_5));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc0[2]), "+f"(acc0[3]) : "f"(partial_fragment_a[2]), "f"(partial_fragment_a[3]), "l"(_fma_acc_scale2_5));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc0[4]), "+f"(acc0[5]) : "f"(partial_fragment_a[4]), "f"(partial_fragment_a[5]), "l"(_fma_acc_scale2_5));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc0[6]), "+f"(acc0[7]) : "f"(partial_fragment_a[6]), "f"(partial_fragment_a[7]), "l"(_fma_acc_scale2_5));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc0[8]), "+f"(acc0[9]) : "f"(partial_fragment_a[8]), "f"(partial_fragment_a[9]), "l"(_fma_acc_scale2_5));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc0[10]), "+f"(acc0[11]) : "f"(partial_fragment_a[10]), "f"(partial_fragment_a[11]), "l"(_fma_acc_scale2_5));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc0[12]), "+f"(acc0[13]) : "f"(partial_fragment_a[12]), "f"(partial_fragment_a[13]), "l"(_fma_acc_scale2_5));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc0[14]), "+f"(acc0[15]) : "f"(partial_fragment_a[14]), "f"(partial_fragment_a[15]), "l"(_fma_acc_scale2_5));
                            }
                            {
                                unsigned long long _fma_acc_scale2_6;
                                asm volatile("mov.b64 %0, {%1, %1};" : "=l"(_fma_acc_scale2_6) : "f"(combined));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc0[16]), "+f"(acc0[17]) : "f"(partial_fragment_b[0]), "f"(partial_fragment_b[1]), "l"(_fma_acc_scale2_6));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc0[18]), "+f"(acc0[19]) : "f"(partial_fragment_b[2]), "f"(partial_fragment_b[3]), "l"(_fma_acc_scale2_6));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc0[20]), "+f"(acc0[21]) : "f"(partial_fragment_b[4]), "f"(partial_fragment_b[5]), "l"(_fma_acc_scale2_6));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc0[22]), "+f"(acc0[23]) : "f"(partial_fragment_b[6]), "f"(partial_fragment_b[7]), "l"(_fma_acc_scale2_6));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc0[24]), "+f"(acc0[25]) : "f"(partial_fragment_b[8]), "f"(partial_fragment_b[9]), "l"(_fma_acc_scale2_6));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc0[26]), "+f"(acc0[27]) : "f"(partial_fragment_b[10]), "f"(partial_fragment_b[11]), "l"(_fma_acc_scale2_6));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc0[28]), "+f"(acc0[29]) : "f"(partial_fragment_b[12]), "f"(partial_fragment_b[13]), "l"(_fma_acc_scale2_6));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc0[30]), "+f"(acc0[31]) : "f"(partial_fragment_b[14]), "f"(partial_fragment_b[15]), "l"(_fma_acc_scale2_6));
                            }
                            {
                                unsigned long long _fma_acc_scale2_7;
                                asm volatile("mov.b64 %0, {%1, %1};" : "=l"(_fma_acc_scale2_7) : "f"(combined));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc1[0]), "+f"(acc1[1]) : "f"(partial_fragment_c[0]), "f"(partial_fragment_c[1]), "l"(_fma_acc_scale2_7));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc1[2]), "+f"(acc1[3]) : "f"(partial_fragment_c[2]), "f"(partial_fragment_c[3]), "l"(_fma_acc_scale2_7));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc1[4]), "+f"(acc1[5]) : "f"(partial_fragment_c[4]), "f"(partial_fragment_c[5]), "l"(_fma_acc_scale2_7));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc1[6]), "+f"(acc1[7]) : "f"(partial_fragment_c[6]), "f"(partial_fragment_c[7]), "l"(_fma_acc_scale2_7));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc1[8]), "+f"(acc1[9]) : "f"(partial_fragment_c[8]), "f"(partial_fragment_c[9]), "l"(_fma_acc_scale2_7));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc1[10]), "+f"(acc1[11]) : "f"(partial_fragment_c[10]), "f"(partial_fragment_c[11]), "l"(_fma_acc_scale2_7));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc1[12]), "+f"(acc1[13]) : "f"(partial_fragment_c[12]), "f"(partial_fragment_c[13]), "l"(_fma_acc_scale2_7));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc1[14]), "+f"(acc1[15]) : "f"(partial_fragment_c[14]), "f"(partial_fragment_c[15]), "l"(_fma_acc_scale2_7));
                            }
                            {
                                unsigned long long _fma_acc_scale2_8;
                                asm volatile("mov.b64 %0, {%1, %1};" : "=l"(_fma_acc_scale2_8) : "f"(combined));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc1[16]), "+f"(acc1[17]) : "f"(partial_fragment_d[0]), "f"(partial_fragment_d[1]), "l"(_fma_acc_scale2_8));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc1[18]), "+f"(acc1[19]) : "f"(partial_fragment_d[2]), "f"(partial_fragment_d[3]), "l"(_fma_acc_scale2_8));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc1[20]), "+f"(acc1[21]) : "f"(partial_fragment_d[4]), "f"(partial_fragment_d[5]), "l"(_fma_acc_scale2_8));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc1[22]), "+f"(acc1[23]) : "f"(partial_fragment_d[6]), "f"(partial_fragment_d[7]), "l"(_fma_acc_scale2_8));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc1[24]), "+f"(acc1[25]) : "f"(partial_fragment_d[8]), "f"(partial_fragment_d[9]), "l"(_fma_acc_scale2_8));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc1[26]), "+f"(acc1[27]) : "f"(partial_fragment_d[10]), "f"(partial_fragment_d[11]), "l"(_fma_acc_scale2_8));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc1[28]), "+f"(acc1[29]) : "f"(partial_fragment_d[12]), "f"(partial_fragment_d[13]), "l"(_fma_acc_scale2_8));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc1[30]), "+f"(acc1[31]) : "f"(partial_fragment_d[14]), "f"(partial_fragment_d[15]), "l"(_fma_acc_scale2_8));
                            }
                            ...
                            partial_stage += 1;
                            if (partial_stage == 4) { partial_stage = 0; partial_full_phase ^= 1; }
                            mbarrier_wait(partial_full_addr + (partial_stage) * 8, partial_full_phase);
                            asm volatile("tcgen05.fence::after_thread_sync;");
                            int _trl_addr_9 = tmem_partials + (partial_stage * 128 + (unsigned int)(acc_wg * 64)) + (row_base << 16);
                            tmem_ld_x16(&partial_fragment_a[0], _trl_addr_9);
                            int _trl_addr_10 = tmem_partials + (partial_stage * 128 + (unsigned int)(acc_wg * 64) + 16) + (row_base << 16);
                            tmem_ld_x16(&partial_fragment_b[0], _trl_addr_10);
                            int _trl_addr_11 = tmem_partials + (partial_stage * 128 + (unsigned int)(acc_wg * 64) + 32) + (row_base << 16);
                            tmem_ld_x16(&partial_fragment_c[0], _trl_addr_11);
                            int _trl_addr_12 = tmem_partials + (partial_stage * 128 + (unsigned int)(acc_wg * 64) + 32 + 16) + (row_base << 16);
                            tmem_ld_x16(&partial_fragment_d[0], _trl_addr_12);
                            asm volatile("tcgen05.wait::ld.sync.aligned;" ::: "memory");
                            if (k_inner == 2) {
                                asm volatile("tcgen05.fence::before_thread_sync;");
                                if (lane == 0) {
                                ...
                                unsigned int next_partial_stage = partial_stage + 1;
                                unsigned int next_partial_phase = partial_full_phase;
                                if (partial_stage == 3) {
                                    next_partial_stage = 0;
                                    next_partial_phase ^= 1;
                                }
                                uint32_t _mbar_token_2 = mbarrier_test_wait(partial_full_addr + (next_partial_stage) * 8, next_partial_phase);
                                partial_full_token = _mbar_token_2;
                            }
                            {
                                unsigned long long _fma_acc_scale2_13;
                                asm volatile("mov.b64 %0, {%1, %1};" : "=l"(_fma_acc_scale2_13) : "f"(combined));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc2[0]), "+f"(acc2[1]) : "f"(partial_fragment_a[0]), "f"(partial_fragment_a[1]), "l"(_fma_acc_scale2_13));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc2[2]), "+f"(acc2[3]) : "f"(partial_fragment_a[2]), "f"(partial_fragment_a[3]), "l"(_fma_acc_scale2_13));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc2[4]), "+f"(acc2[5]) : "f"(partial_fragment_a[4]), "f"(partial_fragment_a[5]), "l"(_fma_acc_scale2_13));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc2[6]), "+f"(acc2[7]) : "f"(partial_fragment_a[6]), "f"(partial_fragment_a[7]), "l"(_fma_acc_scale2_13));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc2[8]), "+f"(acc2[9]) : "f"(partial_fragment_a[8]), "f"(partial_fragment_a[9]), "l"(_fma_acc_scale2_13));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc2[10]), "+f"(acc2[11]) : "f"(partial_fragment_a[10]), "f"(partial_fragment_a[11]), "l"(_fma_acc_scale2_13));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc2[12]), "+f"(acc2[13]) : "f"(partial_fragment_a[12]), "f"(partial_fragment_a[13]), "l"(_fma_acc_scale2_13));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc2[14]), "+f"(acc2[15]) : "f"(partial_fragment_a[14]), "f"(partial_fragment_a[15]), "l"(_fma_acc_scale2_13));
                            }
                            {
                                unsigned long long _fma_acc_scale2_14;
                                asm volatile("mov.b64 %0, {%1, %1};" : "=l"(_fma_acc_scale2_14) : "f"(combined));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc2[16]), "+f"(acc2[17]) : "f"(partial_fragment_b[0]), "f"(partial_fragment_b[1]), "l"(_fma_acc_scale2_14));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc2[18]), "+f"(acc2[19]) : "f"(partial_fragment_b[2]), "f"(partial_fragment_b[3]), "l"(_fma_acc_scale2_14));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc2[20]), "+f"(acc2[21]) : "f"(partial_fragment_b[4]), "f"(partial_fragment_b[5]), "l"(_fma_acc_scale2_14));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc2[22]), "+f"(acc2[23]) : "f"(partial_fragment_b[6]), "f"(partial_fragment_b[7]), "l"(_fma_acc_scale2_14));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc2[24]), "+f"(acc2[25]) : "f"(partial_fragment_b[8]), "f"(partial_fragment_b[9]), "l"(_fma_acc_scale2_14));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc2[26]), "+f"(acc2[27]) : "f"(partial_fragment_b[10]), "f"(partial_fragment_b[11]), "l"(_fma_acc_scale2_14));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc2[28]), "+f"(acc2[29]) : "f"(partial_fragment_b[12]), "f"(partial_fragment_b[13]), "l"(_fma_acc_scale2_14));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc2[30]), "+f"(acc2[31]) : "f"(partial_fragment_b[14]), "f"(partial_fragment_b[15]), "l"(_fma_acc_scale2_14));
                            }
                            {
                                unsigned long long _fma_acc_scale2_15;
                                asm volatile("mov.b64 %0, {%1, %1};" : "=l"(_fma_acc_scale2_15) : "f"(combined));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc3[0]), "+f"(acc3[1]) : "f"(partial_fragment_c[0]), "f"(partial_fragment_c[1]), "l"(_fma_acc_scale2_15));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc3[2]), "+f"(acc3[3]) : "f"(partial_fragment_c[2]), "f"(partial_fragment_c[3]), "l"(_fma_acc_scale2_15));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc3[4]), "+f"(acc3[5]) : "f"(partial_fragment_c[4]), "f"(partial_fragment_c[5]), "l"(_fma_acc_scale2_15));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc3[6]), "+f"(acc3[7]) : "f"(partial_fragment_c[6]), "f"(partial_fragment_c[7]), "l"(_fma_acc_scale2_15));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc3[8]), "+f"(acc3[9]) : "f"(partial_fragment_c[8]), "f"(partial_fragment_c[9]), "l"(_fma_acc_scale2_15));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc3[10]), "+f"(acc3[11]) : "f"(partial_fragment_c[10]), "f"(partial_fragment_c[11]), "l"(_fma_acc_scale2_15));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc3[12]), "+f"(acc3[13]) : "f"(partial_fragment_c[12]), "f"(partial_fragment_c[13]), "l"(_fma_acc_scale2_15));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc3[14]), "+f"(acc3[15]) : "f"(partial_fragment_c[14]), "f"(partial_fragment_c[15]), "l"(_fma_acc_scale2_15));
                            }
                            {
                                unsigned long long _fma_acc_scale2_16;
                                asm volatile("mov.b64 %0, {%1, %1};" : "=l"(_fma_acc_scale2_16) : "f"(combined));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc3[16]), "+f"(acc3[17]) : "f"(partial_fragment_d[0]), "f"(partial_fragment_d[1]), "l"(_fma_acc_scale2_16));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc3[18]), "+f"(acc3[19]) : "f"(partial_fragment_d[2]), "f"(partial_fragment_d[3]), "l"(_fma_acc_scale2_16));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc3[20]), "+f"(acc3[21]) : "f"(partial_fragment_d[4]), "f"(partial_fragment_d[5]), "l"(_fma_acc_scale2_16));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc3[22]), "+f"(acc3[23]) : "f"(partial_fragment_d[6]), "f"(partial_fragment_d[7]), "l"(_fma_acc_scale2_16));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc3[24]), "+f"(acc3[25]) : "f"(partial_fragment_d[8]), "f"(partial_fragment_d[9]), "l"(_fma_acc_scale2_16));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc3[26]), "+f"(acc3[27]) : "f"(partial_fragment_d[10]), "f"(partial_fragment_d[11]), "l"(_fma_acc_scale2_16));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc3[28]), "+f"(acc3[29]) : "f"(partial_fragment_d[12]), "f"(partial_fragment_d[13]), "l"(_fma_acc_scale2_16));
                                asm volatile("{\n\t" ".reg .b64 _src2, _acc2, _out2;\n\t" "mov.b64 _src2, {%2, %3};\n\t" "mov.b64 _acc2, {%0, %1};\n\t" "fma.rn.f32x2 _out2, _src2, %4, _acc2;\n\t" "mov.b64 {%0, %1}, _out2;\n\t" "}" : "+f"(acc3[30]), "+f"(acc3[31]) : "f"(partial_fragment_d[14]), "f"(partial_fragment_d[15]), "l"(_fma_acc_scale2_16));
                            }
                            if (k_inner != 2) {
                                asm volatile("tcgen05.fence::before_thread_sync;");
                                if (lane == 0) {
                    ...
                    if (homogeneous != 0) {
                        unsigned int epi_addr_0 = epi_staging_addr + (epi_panel_cursor + (unsigned int)acc_wg) * 8192;
                        ...
                        for (int chunk = 0; chunk < 4; chunk++) {
                            asm volatile("st.shared.v4.b32 [%0], {%1,%2,%3,%4};" :: "r"((epi_addr_0 + (unsigned int)(row * 64 + chunk * 16 ^ (row * 64 + chunk * 16 >> 7 & 3) << 4))), "r"(acc0_bf16[chunk * 4]), "r"(acc0_bf16[chunk * 4 + 1]), "r"(acc0_bf16[chunk * 4 + 2]), "r"(acc0_bf16[chunk * 4 + 3]) : "memory");
                        }
                        asm volatile("fence.proxy.async.shared::cta;" ::: "memory");
                        if (acc_warp_in_wg == 0) {
                            if (elect_sync()) {
                        ...
                        if (acc_warp_in_wg == 0) {
                            if (elect_sync()) {
                                tma_store_2d(C_tma, n_tile * 256 + wg_col_base, m_tile * 128, epi_addr_0);
                                asm volatile("cp.async.bulk.commit_group;");
                            }
                        }
                        epi_panel_cursor += 2;
                        if (epi_panel_cursor >= 6) {
                            epi_panel_cursor -= 6;
                        }
                        unsigned int epi_addr_1 = epi_staging_addr + (epi_panel_cursor + (unsigned int)acc_wg) * 8192;
                        ...
                        for (int chunk_1 = 0; chunk_1 < 4; chunk_1++) {
                            asm volatile("st.shared.v4.b32 [%0], {%1,%2,%3,%4};" :: "r"((epi_addr_1 + (unsigned int)(row * 64 + chunk_1 * 16 ^ (row * 64 + chunk_1 * 16 >> 7 & 3) << 4))), "r"(acc1_bf16[chunk_1 * 4]), "r"(acc1_bf16[chunk_1 * 4 + 1]), "r"(acc1_bf16[chunk_1 * 4 + 2]), "r"(acc1_bf16[chunk_1 * 4 + 3]) : "memory");
                        }
                        asm volatile("fence.proxy.async.shared::cta;" ::: "memory");
                        if (acc_warp_in_wg == 0) {
                            if (elect_sync()) {
                        ...
                        if (acc_warp_in_wg == 0) {
                            if (elect_sync()) {
                                tma_store_2d(C_tma, n_tile * 256 + wg_col_base + 32, m_tile * 128, epi_addr_1);
                                asm volatile("cp.async.bulk.commit_group;");
                            }
                        }
                        epi_panel_cursor += 2;
                        ...
                        unsigned int epi_addr_2 = epi_staging_addr + (epi_panel_cursor + (unsigned int)acc_wg) * 8192;
                        ...
                        for (int chunk_2 = 0; chunk_2 < 4; chunk_2++) {
                            asm volatile("st.shared.v4.b32 [%0], {%1,%2,%3,%4};" :: "r"((epi_addr_2 + (unsigned int)(row * 64 + chunk_2 * 16 ^ (row * 64 + chunk_2 * 16 >> 7 & 3) << 4))), "r"(acc2_bf16[chunk_2 * 4]), "r"(acc2_bf16[chunk_2 * 4 + 1]), "r"(acc2_bf16[chunk_2 * 4 + 2]), "r"(acc2_bf16[chunk_2 * 4 + 3]) : "memory");
                        }
                        asm volatile("fence.proxy.async.shared::cta;" ::: "memory");
                        if (acc_warp_in_wg == 0) {
                            if (elect_sync()) {
                        ...
                        if (acc_warp_in_wg == 0) {
                            if (elect_sync()) {
                                tma_store_2d(C_tma, n_tile * 256 + wg_col_base + 64, m_tile * 128, epi_addr_2);
                                asm volatile("cp.async.bulk.commit_group;");
                            }
                        }
                        epi_panel_cursor += 2;
                        ...
                        unsigned int epi_addr_3 = epi_staging_addr + (epi_panel_cursor + (unsigned int)acc_wg) * 8192;
                        ...
                        for (int chunk_3 = 0; chunk_3 < 4; chunk_3++) {
                            asm volatile("st.shared.v4.b32 [%0], {%1,%2,%3,%4};" :: "r"((epi_addr_3 + (unsigned int)(row * 64 + chunk_3 * 16 ^ (row * 64 + chunk_3 * 16 >> 7 & 3) << 4))), "r"(acc3_bf16[chunk_3 * 4]), "r"(acc3_bf16[chunk_3 * 4 + 1]), "r"(acc3_bf16[chunk_3 * 4 + 2]), "r"(acc3_bf16[chunk_3 * 4 + 3]) : "memory");
                        }
                        asm volatile("fence.proxy.async.shared::cta;" ::: "memory");
                        if (acc_warp_in_wg == 0) {
                            if (elect_sync()) {
                        ...
                        if (acc_warp_in_wg == 0) {
                            if (elect_sync()) {
                                tma_store_2d(C_tma, n_tile * 256 + wg_col_base + 96, m_tile * 128, epi_addr_3);
                                asm volatile("cp.async.bulk.commit_group;");
                            }
                        }
                        epi_panel_cursor += 2;
    ...
    if (warp == 8) {
        { // mma_role_main
            ...
            int total_tiles_1 = m_tiles_1 * 16;
            unsigned int _phase_ab_full = 0;
            if (cta_rank == 0) {
                int cluster_m_tile_1 = cluster_id >> 4;
                int n_tile_1 = cluster_id & 15;
                #pragma unroll 1
                for (int _tile_id = cluster_id; _tile_id < total_tiles_1; _tile_id += 64) {
                    ...
                    for (int segment_iter_1 = 0; segment_iter_1 < tile_rows_1; segment_iter_1++) {
                        ...
                        group_1 = _shfl_7;
                        #pragma unroll 1
                        for (int mma_pair = 0; mma_pair < 4; mma_pair++) {
                            #pragma unroll
                            for (int k_in_pair = 0; k_in_pair < 2; k_in_pair++) {
                                mbarrier_wait(partial_free_addr + (k_in_pair * 2) * 8, partial_free_phase);
                    ...
                    "@leader tcgen05.mma.cta_group::2.kind::f8f6f4 [%2], da, db, id, {m0, m1, m2, m3, m4, m5, m6, m7}, p1;\n\t"
                    "}\n"
                    :: "r"(_mma_a_lo_0), "r"(_mma_b_lo_0), "r"((tmem_partials + (k_in_pair * 2 * 128))), "r"(0));
                                elect_commit_cg2_multicast(partial_full_addr + (k_in_pair * 2) * 8, (uint16_t)(3));
                                mbarrier_wait(partial_free_addr + (k_in_pair * 2 + 1) * 8, partial_free_phase);
                                asm volatile("tcgen05.fence::after_thread_sync;");
                    ...
                    "@leader tcgen05.mma.cta_group::2.kind::f8f6f4 [%2], da, db, id, {m0, m1, m2, m3, m4, m5, m6, m7}, p1;\n\t"
                    "}\n"
                    :: "r"(_mma_a_lo_1), "r"(_mma_b_lo_1), "r"((tmem_partials + ((k_in_pair * 2 + 1) * 128))), "r"(0));
                                elect_commit_cg2_multicast(ab_free_addr + (ab_stage) * 8, (uint16_t)(3));
                                elect_commit_cg2_multicast(partial_full_addr + (k_in_pair * 2 + 1) * 8, (uint16_t)(3));
                                ab_stage += 1;
                                if (ab_stage == 5) { ab_stage = 0; _phase_ab_full ^= 1; }
                            }
                            partial_free_phase ^= 1;
                        }
    ...
    if (warp == 9) {
        { // tma_role_main
            ...
            int total_tiles_2 = m_tiles_2 * 16;
            int cluster_m_tile_2 = cluster_id >> 4;
            int n_tile_2 = cluster_id & 15;
            unsigned int _phase_ab_free = 1;
            #pragma unroll 1
            for (int tile_id_1 = cluster_id; tile_id_1 < total_tiles_2; tile_id_1 += 64) {
                ...
                for (int segment_iter_2 = 0; segment_iter_2 < tile_rows_2; segment_iter_2++) {
                    ...
                    for (int iter_k = 0; iter_k < k_blocks_1; iter_k++) {
                        ...
                        if (elect_sync()) {
                            tma_3d_gmem2smem_cta2(smem_a_addr + ab_stage_1 * 16384, A, 0, m_tile_1 * 128, iter_k, ((ab_full_addr + (ab_stage_1) * 8) & 0xFEFFFFFF));
                        }
                        if (elect_sync()) {
                            asm volatile(
    ...
    if (warp == 10) {
        { // scale_role_main
            ...
            int total_tiles_3 = m_tiles_3 * 16;
            int cluster_m_tile_3 = cluster_id >> 4;
            int n_tile_3 = cluster_id & 15;
            unsigned int _phase_scale_free = 1;
            #pragma unroll 1
            for (int tile_id_2 = cluster_id; tile_id_2 < total_tiles_3; tile_id_2 += 64) {
                ...
                for (int segment_iter_3 = 0; segment_iter_3 < tile_rows_3; segment_iter_3++) {
                    ...
                    int scale_groups_1 = k_blocks_2 / 4;
                    int n_blocks = N / 128;
                    #pragma unroll 1
                    for (int scale_group_1 = 0; scale_group_1 < scale_groups_1; scale_group_1++) {
                        ...
                        for (int chunk_4 = 0; chunk_4 < 4; chunk_4++) {
                            ...
                            asm volatile("cp.async.ca.shared::cta.global [%0], [%1], 16, %2;"
                                :: "r"(smem_ascale_addr + (unsigned int)((stage_base + row_1 * 4) * 4)), "l"(a_scale + (g_row * k_blocks_2 + scale_group_1 * 4)), "r"((g_row < M) ? 16 : 0));
                        }
                        #pragma unroll
                        for (int n_half = 0; n_half < 2; n_half++) {
                            asm volatile(
                                ...
                                "}"
                                :: "r"((lane == 0) ? 1 : 0), "r"(smem_bscale_addr + (scale_stage_1 * 2 + (unsigned int)n_half) * 4 * 4), "l"(b_scale + ((group_3 * n_blocks + n_tile_3 * 2 + n_half) * k_blocks_2 + scale_group_1 * 4)));
                        }
                        asm volatile(
                            "{\n\t"
    ...
    if (warp == 11) {
        { // tma_b_role_main
            ...
            int total_tiles_b = m_tiles_b * 16;
            int cluster_m_tile_b = cluster_id >> 4;
            int n_tile_b = cluster_id & 15;
            unsigned int _phase_ab_free_1 = 1;
            #pragma unroll 1
            for (int tile_id_b = cluster_id; tile_id_b < total_tiles_b; tile_id_b += 64) {
                int m_tile_b = cluster_m_tile_b * 2 + cta_rank;
                int cluster_m_base_4 = cluster_m_tile_b * 256;
                int tile_rows_4 = 256;
                if (tile_rows_4 > M - cluster_m_base_4) {
                    tile_rows_4 = M - cluster_m_base_4;
                }
                int last_group_4 = 0;
                if (lane == 0) {
                    last_group_4 = m_indices[cluster_m_base_4 + tile_rows_4 - 1];
                }
                int run_begin_4 = 0;
                #pragma unroll 1
                for (int segment_iter_4 = 0; segment_iter_4 < tile_rows_4; segment_iter_4++) {
                    ...
                    int group_b = 0;
                    if (lane == 0) {
                        group_b = m_indices[cluster_m_base_4 + run_begin_4];
                    ...
                    for (int iter_k_b = 0; iter_k_b < k_blocks_b; iter_k_b++) {
                        ...
                        ab_stage_b += 1;
                        if (ab_stage_b == 5) { ab_stage_b = 0; _phase_ab_free_1 ^= 1; }
                    }
            ...
            if (elect_sync()) {
                #pragma unroll
                for (int _ab_drain_b = 0; _ab_drain_b < 5; _ab_drain_b++) {
                    mbarrier_wait(ab_free_addr + (ab_stage_b) * 8, _phase_ab_free_1);
                    ab_stage_b += 1;
                    if (ab_stage_b == 5) { ab_stage_b = 0; _phase_ab_free_1 ^= 1; }
                }
