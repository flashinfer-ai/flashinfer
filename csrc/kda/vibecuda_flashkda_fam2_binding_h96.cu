// Round-182 (supervisor directive): fam v2 head-family path, H=96
...
#define kernel_flashkda_bf16_fused_m128 kernel_flashkda_fam2_h96
#define kernel_flashkda_split_scan_m128 kernel_flashkda_split_scan_m128_fam2h96
#define kernel_flashkda_split_scan_bf16_m128 kernel_flashkda_split_scan_bf16_m128_fam2h96
#define kernel_flashkda_split_lookback_m128 kernel_flashkda_split_lookback_m128_fam2h96
#define kernel_flashkda_split_out_add_m128 kernel_flashkda_split_out_add_m128_fam2h96
#define KDA_FAM
#define KDA_FAM_H 96
...
void RunFam2H96(const void* q_ptr, const void* k_ptr, const void* v_ptr, const void* g_ptr,
  ...
  static const bool kSmemAttrOnce = [] {
    CheckCuda(cudaFuncSetAttribute(kernel_flashkda_fam2_h96,
              ...
              "cudaFuncSetAttribute(kernel_flashkda_fam2_h96)");
    return true;
  }();
  (void)kSmemAttrOnce;
...
#endif
  kernel_flashkda_fam2_h96<<<grid, block, SMEM_TOTAL, stream>>>(
      reinterpret_cast<__nv_bfloat16*>(const_cast<void*>(q_ptr)), tma.q,
      reinterpret_cast<__nv_bfloat16*>(const_cast<void*>(k_ptr)), tma.k,
      reinterpret_cast<__nv_bfloat16*>(const_cast<void*>(v_ptr)), tma.v,
      reinterpret_cast<__nv_bfloat16*>(const_cast<void*>(g_ptr)), tma.g,
      ...
      /*fixup_mode=*/0, /*progress_flags=*/nullptr,
      /*map_state_bf16=*/nullptr, static_cast<int>(ft_slab));
  CheckCuda(cudaGetLastError(), "kernel_flashkda_fam2_h96 launch");
}
