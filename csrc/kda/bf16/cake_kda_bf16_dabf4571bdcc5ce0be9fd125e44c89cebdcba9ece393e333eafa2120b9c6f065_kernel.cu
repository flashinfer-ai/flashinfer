            ...
            for (int prep_iter = 0; prep_iter < num_prep_iters; prep_iter++) {
                ...
                if (prep_tid < 128) {
                    ...
                    float prefix_log2 = 0.0f;
                    {
                        ...
                        if (chunk_is_full_1 == 0) {
                            float _cvt_f32_6 = __bfloat162float(first_gate_raw);
                        ...
                        for (int gate_pair = 0; gate_pair < 7; gate_pair++) {
                            ...
                            float _cvt_f32_7 = __bfloat162float(pair_raw0);
                            float gate_arg_1 = gate_rate * (_cvt_f32_7 + gate_bias);
                            ...
                            float _cvt_f32_8 = __bfloat162float(pair_raw1);
                            float gate_arg_0 = gate_rate * (_cvt_f32_8 + gate_bias);
                        ...
                        float _cvt_f32_9 = __bfloat162float(last_gate_raw);
                        float gate_arg_2 = gate_rate * (_cvt_f32_9 + gate_bias);
                ...
                for (int work_pass = 0; work_pass < 2; work_pass++) {
                    ...
                    float _cvt_f32_10 = __bfloat162float(_cvt_bf16_1);
                    ...
                    const float2 _scale2_3 = {_cvt_f32_10, _cvt_f32_10};
                    #pragma unroll
                    for (int _ls = 0; _ls < 4; _ls++)
                ...
                }
                {
                    ...
                    for (int restore_k_pass = 0; restore_k_pass < 2; restore_k_pass++) {
                        ...
                        for (int restore_elem = 0; restore_elem < 8; restore_elem++) {
                            ...
                            float _cvt_f32_23 = __bfloat162float(_cvt_bf16_10);
                            float restore_ki_carrier = _cvt_f32_23;
                            ...
                            float restore_total_carrier = _cvt_f32_24;
                            ...
                            restore_kr_values[restore_elem] = _cvt_f32_25;
                        }
