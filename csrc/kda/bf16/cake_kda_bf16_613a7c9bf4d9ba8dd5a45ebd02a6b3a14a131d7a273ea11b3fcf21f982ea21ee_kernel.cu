...
kernel_cake_kda_bf16_613a7c9bf4d9ba8dd5a45ebd02a6b3a14a131d7a273ea11b3fcf21f982ea21ee(__nv_bfloat16* __restrict__ q, CakeTensorMap const* q_tma, __nv_bfloat16* __restrict__ k, CakeTensorMap const* k_tma, __nv_bfloat16* __restrict__ v, CakeTensorMap const* v_tma, __nv_bfloat16* __restrict__ g, CakeTensorMap const* g_tma, __nv_bfloat16* __restrict__ beta, CakeTensorMap const* beta_tma, float* __restrict__ A_log, float* __restrict__ dt_bias, long long* __restrict__ cu_seqlens, int* __restrict__ seq_order, __nv_bfloat16* __restrict__ initial_state, __nv_bfloat16* __restrict__ out, CakeTensorMap const* out_tma, __nv_bfloat16* __restrict__ final_state, int num_heads, int use_initial_state, int store_final_state, float scale, float lower_bound, unsigned long long state_indices_addr, unsigned long long state_checkpoints_addr, unsigned long long checkpoint_cu_starts_addr, long long beta_token_stride, long long state_slot_stride, int use_state_indices, int checkpoint_every_n_tokens, long long* __restrict__ cu_chunk_offsets, __nv_bfloat16* __restrict__ chunk_state, unsigned int* __restrict__ state_checkpoint_needed, __nv_bfloat16* __restrict__ tape_qd, __nv_bfloat16* __restrict__ tape_kd, __nv_bfloat16* __restrict__ tape_kr, __nv_bfloat16* __restrict__ tape_j, float* __restrict__ tape_restore_factor, __nv_bfloat16* __restrict__ tape_e, __nv_bfloat16* __restrict__ tape_x, __nv_bfloat16* __restrict__ tape_r, float* __restrict__ norm_inv_out, __nv_bfloat16* __restrict__ decay_out, float* __restrict__ beta_active_out, float* __restrict__ initial_state_f32, unsigned int* __restrict__ zero_workspace, int zero_words, int num_sequences, CakeTensorMap const* state_checkpoints_tma, float* __restrict__ final_state_f32, long long g_token_stride)
{
            ...
            for (int chunk_idx = 0; chunk_idx < num_chunks_0; chunk_idx++) {
                ...
                if (checkpoint_every_n_tokens != 0 && checkpoint_token < seq_len && checkpoint_token % checkpoint_every_n_tokens == 0) {
                    ...
                    for (int state_col_block_3 = 0; state_col_block_3 < 4; state_col_block_3++) {
                        ...
                        asm volatile("tcgen05.wait::ld.sync.aligned;" ::: "memory");
                        {
                            unsigned _stv8_5_0 = __float_as_uint(_tmem_load_4[0 + 0]);
                            unsigned _stv8_5_1 = __float_as_uint(_tmem_load_4[0 + 1]);
                            unsigned _stv8_5_2 = __float_as_uint(_tmem_load_4[0 + 2]);
                            unsigned _stv8_5_3 = __float_as_uint(_tmem_load_4[0 + 3]);
                            unsigned _stv8_5_4 = __float_as_uint(_tmem_load_4[0 + 4]);
                            unsigned _stv8_5_5 = __float_as_uint(_tmem_load_4[0 + 5]);
                            unsigned _stv8_5_6 = __float_as_uint(_tmem_load_4[0 + 6]);
                            unsigned _stv8_5_7 = __float_as_uint(_tmem_load_4[0 + 7]);
                            asm volatile(
                                "st.global.v8.b32 [%0], {%1, %2, %3, %4, %5, %6, %7, %8};"
                                :: "l"((void*)(reinterpret_cast<float*>(state_checkpoints_addr) + (checkpoint_base_1 + (long long)(state_col_block_3 * 32)) + (0))), "r"(_stv8_5_0), "r"(_stv8_5_1), "r"(_stv8_5_2), "r"(_stv8_5_3), "r"(_stv8_5_4), "r"(_stv8_5_5), "r"(_stv8_5_6), "r"(_stv8_5_7) : "memory");
                        }
                        {
                            unsigned _stv8_6_0 = __float_as_uint(_tmem_load_4[8 + 0]);
                            unsigned _stv8_6_1 = __float_as_uint(_tmem_load_4[8 + 1]);
                            unsigned _stv8_6_2 = __float_as_uint(_tmem_load_4[8 + 2]);
                            unsigned _stv8_6_3 = __float_as_uint(_tmem_load_4[8 + 3]);
                            unsigned _stv8_6_4 = __float_as_uint(_tmem_load_4[8 + 4]);
                            unsigned _stv8_6_5 = __float_as_uint(_tmem_load_4[8 + 5]);
                            unsigned _stv8_6_6 = __float_as_uint(_tmem_load_4[8 + 6]);
                            unsigned _stv8_6_7 = __float_as_uint(_tmem_load_4[8 + 7]);
                            asm volatile(
                                "st.global.v8.b32 [%0], {%1, %2, %3, %4, %5, %6, %7, %8};"
                                :: "l"((void*)(reinterpret_cast<float*>(state_checkpoints_addr) + (checkpoint_base_1 + (long long)(state_col_block_3 * 32) + 8) + (0))), "r"(_stv8_6_0), "r"(_stv8_6_1), "r"(_stv8_6_2), "r"(_stv8_6_3), "r"(_stv8_6_4), "r"(_stv8_6_5), "r"(_stv8_6_6), "r"(_stv8_6_7) : "memory");
                        }
                        {
                            unsigned _stv8_7_0 = __float_as_uint(_tmem_load_4[16 + 0]);
                            unsigned _stv8_7_1 = __float_as_uint(_tmem_load_4[16 + 1]);
                            unsigned _stv8_7_2 = __float_as_uint(_tmem_load_4[16 + 2]);
                            unsigned _stv8_7_3 = __float_as_uint(_tmem_load_4[16 + 3]);
                            unsigned _stv8_7_4 = __float_as_uint(_tmem_load_4[16 + 4]);
                            unsigned _stv8_7_5 = __float_as_uint(_tmem_load_4[16 + 5]);
                            unsigned _stv8_7_6 = __float_as_uint(_tmem_load_4[16 + 6]);
                            unsigned _stv8_7_7 = __float_as_uint(_tmem_load_4[16 + 7]);
                            asm volatile(
                                "st.global.v8.b32 [%0], {%1, %2, %3, %4, %5, %6, %7, %8};"
                                :: "l"((void*)(reinterpret_cast<float*>(state_checkpoints_addr) + (checkpoint_base_1 + (long long)(state_col_block_3 * 32) + 16) + (0))), "r"(_stv8_7_0), "r"(_stv8_7_1), "r"(_stv8_7_2), "r"(_stv8_7_3), "r"(_stv8_7_4), "r"(_stv8_7_5), "r"(_stv8_7_6), "r"(_stv8_7_7) : "memory");
                        }
                        {
                            unsigned _stv8_8_0 = __float_as_uint(_tmem_load_4[24 + 0]);
                            unsigned _stv8_8_1 = __float_as_uint(_tmem_load_4[24 + 1]);
                            unsigned _stv8_8_2 = __float_as_uint(_tmem_load_4[24 + 2]);
                            unsigned _stv8_8_3 = __float_as_uint(_tmem_load_4[24 + 3]);
                            unsigned _stv8_8_4 = __float_as_uint(_tmem_load_4[24 + 4]);
                            unsigned _stv8_8_5 = __float_as_uint(_tmem_load_4[24 + 5]);
                            unsigned _stv8_8_6 = __float_as_uint(_tmem_load_4[24 + 6]);
                            unsigned _stv8_8_7 = __float_as_uint(_tmem_load_4[24 + 7]);
                            asm volatile(
                                "st.global.v8.b32 [%0], {%1, %2, %3, %4, %5, %6, %7, %8};"
                                :: "l"((void*)(reinterpret_cast<float*>(state_checkpoints_addr) + (checkpoint_base_1 + (long long)(state_col_block_3 * 32) + 24) + (0))), "r"(_stv8_8_0), "r"(_stv8_8_1), "r"(_stv8_8_2), "r"(_stv8_8_3), "r"(_stv8_8_4), "r"(_stv8_8_5), "r"(_stv8_8_6), "r"(_stv8_8_7) : "memory");
                        }
                    }
                }
                compute_stage += 1;
                ...
                for (int state_col_block_4 = 0; state_col_block_4 < 4; state_col_block_4++) {
                        ...
                        : "r"(taddr + 64 + (unsigned int)tmem_row_base + (unsigned int)(state_col_block_4 * 32)));
                    {
                        ...
                        for (int state_vec = 0; state_vec < 4; state_vec++) {
                            {
                                unsigned _stv8_9_0 = __float_as_uint(_tmem_load_5[state_vec * 8 + 0]);
                                unsigned _stv8_9_1 = __float_as_uint(_tmem_load_5[state_vec * 8 + 1]);
                                unsigned _stv8_9_2 = __float_as_uint(_tmem_load_5[state_vec * 8 + 2]);
                                unsigned _stv8_9_3 = __float_as_uint(_tmem_load_5[state_vec * 8 + 3]);
                                unsigned _stv8_9_4 = __float_as_uint(_tmem_load_5[state_vec * 8 + 4]);
                                unsigned _stv8_9_5 = __float_as_uint(_tmem_load_5[state_vec * 8 + 5]);
                                unsigned _stv8_9_6 = __float_as_uint(_tmem_load_5[state_vec * 8 + 6]);
                                unsigned _stv8_9_7 = __float_as_uint(_tmem_load_5[state_vec * 8 + 7]);
                                asm volatile(
                                    "st.global.v8.b32 [%0], {%1, %2, %3, %4, %5, %6, %7, %8};"
                                    :: "l"((void*)(final_state_f32 + (state_base + (long long)(state_col_block_4 * 32) + (long long)(state_vec * 8)) + (0))), "r"(_stv8_9_0), "r"(_stv8_9_1), "r"(_stv8_9_2), "r"(_stv8_9_3), "r"(_stv8_9_4), "r"(_stv8_9_5), "r"(_stv8_9_6), "r"(_stv8_9_7) : "memory");
                            }
                        }
                    }
                }
