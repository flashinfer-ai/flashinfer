...
kernel_cake_kda_bf16_8b181ca4765e748a239de105965a7f06cd4b6f8aeae95d03edbc65953872717a(float* __restrict__ split_state, __nv_bfloat16* __restrict__ map_state_bf16, float* __restrict__ carry, float* __restrict__ final_state, int write_final_state, int num_heads, int* __restrict__ part_cu_seqlens)
{
