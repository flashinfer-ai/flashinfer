...
kernel_cake_kda_bf16_3165ba99d92124bc2d8c35061380566420ae5c0a689d8b85f0a75b3f29e92dcb(__nv_bfloat16* __restrict__ q, CakeTensorMap const* q_tma, __nv_bfloat16* __restrict__ k, CakeTensorMap const* k_tma, __nv_bfloat16* __restrict__ v, CakeTensorMap const* v_tma, __nv_bfloat16* __restrict__ g, CakeTensorMap const* g_tma, __nv_bfloat16* __restrict__ beta, CakeTensorMap const* beta_tma, float* __restrict__ A_log, float* __restrict__ dt_bias, long long* __restrict__ cu_seqlens, int* __restrict__ seq_order, __nv_bfloat16* __restrict__ initial_state, __nv_bfloat16* __restrict__ out, CakeTensorMap const* out_tma, __nv_bfloat16* __restrict__ final_state, int num_heads, int use_initial_state, int store_final_state, float scale, float lower_bound, unsigned long long state_indices_addr, unsigned long long state_checkpoints_addr, unsigned long long checkpoint_cu_starts_addr, long long beta_token_stride, long long state_slot_stride, int use_state_indices, int checkpoint_every_n_tokens, long long* __restrict__ cu_chunk_offsets, __nv_bfloat16* __restrict__ chunk_state, unsigned int* __restrict__ state_checkpoint_needed, __nv_bfloat16* __restrict__ tape_qd, __nv_bfloat16* __restrict__ tape_kd, __nv_bfloat16* __restrict__ tape_kr, __nv_bfloat16* __restrict__ tape_j, float* __restrict__ tape_restore_factor, __nv_bfloat16* __restrict__ tape_e, __nv_bfloat16* __restrict__ tape_x, __nv_bfloat16* __restrict__ tape_r, float* __restrict__ norm_inv_out, __nv_bfloat16* __restrict__ decay_out, float* __restrict__ beta_active_out, float* __restrict__ initial_state_f32, unsigned int* __restrict__ zero_workspace, int zero_words, int num_sequences, CakeTensorMap const* state_checkpoints_tma, float* __restrict__ final_state_f32, long long g_token_stride)
{
        ...
        { // compute_main
            ...
            if (checkpoint_every_n_tokens != 0) {
                ...
                for (int state_col_block_1 = 0; state_col_block_1 < 4; state_col_block_1++) {
                    ...
                    asm volatile("red.global.add.v4.f32 [%0], {%1, %2, %3, %4};" :: "l"(reinterpret_cast<uint64_t>(&reinterpret_cast<float*>(state_checkpoints_addr)[checkpoint_base + (long long)(state_col_block_1 * 32)])), "f"(_tmem_load_0[0]), "f"(_tmem_load_0[1]), "f"(_tmem_load_0[2]), "f"(_tmem_load_0[3]) : "memory");
                    asm volatile("red.global.add.v4.f32 [%0], {%1, %2, %3, %4};" :: "l"(reinterpret_cast<uint64_t>(&reinterpret_cast<float*>(state_checkpoints_addr)[checkpoint_base + (long long)(state_col_block_1 * 32) + 4])), "f"(_tmem_load_0[4]), "f"(_tmem_load_0[5]), "f"(_tmem_load_0[6]), "f"(_tmem_load_0[7]) : "memory");
                    asm volatile("red.global.add.v4.f32 [%0], {%1, %2, %3, %4};" :: "l"(reinterpret_cast<uint64_t>(&reinterpret_cast<float*>(state_checkpoints_addr)[checkpoint_base + (long long)(state_col_block_1 * 32) + 8])), "f"(_tmem_load_0[8]), "f"(_tmem_load_0[9]), "f"(_tmem_load_0[10]), "f"(_tmem_load_0[11]) : "memory");
                    asm volatile("red.global.add.v4.f32 [%0], {%1, %2, %3, %4};" :: "l"(reinterpret_cast<uint64_t>(&reinterpret_cast<float*>(state_checkpoints_addr)[checkpoint_base + (long long)(state_col_block_1 * 32) + 12])), "f"(_tmem_load_0[12]), "f"(_tmem_load_0[13]), "f"(_tmem_load_0[14]), "f"(_tmem_load_0[15]) : "memory");
                    asm volatile("red.global.add.v4.f32 [%0], {%1, %2, %3, %4};" :: "l"(reinterpret_cast<uint64_t>(&reinterpret_cast<float*>(state_checkpoints_addr)[checkpoint_base + (long long)(state_col_block_1 * 32) + 16])), "f"(_tmem_load_0[16]), "f"(_tmem_load_0[17]), "f"(_tmem_load_0[18]), "f"(_tmem_load_0[19]) : "memory");
                    asm volatile("red.global.add.v4.f32 [%0], {%1, %2, %3, %4};" :: "l"(reinterpret_cast<uint64_t>(&reinterpret_cast<float*>(state_checkpoints_addr)[checkpoint_base + (long long)(state_col_block_1 * 32) + 20])), "f"(_tmem_load_0[20]), "f"(_tmem_load_0[21]), "f"(_tmem_load_0[22]), "f"(_tmem_load_0[23]) : "memory");
                    asm volatile("red.global.add.v4.f32 [%0], {%1, %2, %3, %4};" :: "l"(reinterpret_cast<uint64_t>(&reinterpret_cast<float*>(state_checkpoints_addr)[checkpoint_base + (long long)(state_col_block_1 * 32) + 24])), "f"(_tmem_load_0[24]), "f"(_tmem_load_0[25]), "f"(_tmem_load_0[26]), "f"(_tmem_load_0[27]) : "memory");
                    asm volatile("red.global.add.v4.f32 [%0], {%1, %2, %3, %4};" :: "l"(reinterpret_cast<uint64_t>(&reinterpret_cast<float*>(state_checkpoints_addr)[checkpoint_base + (long long)(state_col_block_1 * 32) + 28])), "f"(_tmem_load_0[28]), "f"(_tmem_load_0[29]), "f"(_tmem_load_0[30]), "f"(_tmem_load_0[31]) : "memory");
                }
            }
            ...
            for (int chunk_idx = 0; chunk_idx < num_chunks_0; chunk_idx++) {
                ...
                for (int state_col_block_2 = 0; state_col_block_2 < ((0) ? 4 : 3); state_col_block_2++) {
                    ...
                    if (checkpoint_entering != 0 && chunk_idx != 0) {
                        ...
                        asm volatile("red.global.add.v4.f32 [%0], {%1, %2, %3, %4};" :: "l"(reinterpret_cast<uint64_t>(&reinterpret_cast<float*>(state_checkpoints_addr)[entering_checkpoint_col])), "f"(_tmem_load_1[0]), "f"(_tmem_load_1[1]), "f"(_tmem_load_1[2]), "f"(_tmem_load_1[3]) : "memory");
                        asm volatile("red.global.add.v4.f32 [%0], {%1, %2, %3, %4};" :: "l"(reinterpret_cast<uint64_t>(&reinterpret_cast<float*>(state_checkpoints_addr)[entering_checkpoint_col + 4])), "f"(_tmem_load_1[4]), "f"(_tmem_load_1[5]), "f"(_tmem_load_1[6]), "f"(_tmem_load_1[7]) : "memory");
                        asm volatile("red.global.add.v4.f32 [%0], {%1, %2, %3, %4};" :: "l"(reinterpret_cast<uint64_t>(&reinterpret_cast<float*>(state_checkpoints_addr)[entering_checkpoint_col + 8])), "f"(_tmem_load_1[8]), "f"(_tmem_load_1[9]), "f"(_tmem_load_1[10]), "f"(_tmem_load_1[11]) : "memory");
                        asm volatile("red.global.add.v4.f32 [%0], {%1, %2, %3, %4};" :: "l"(reinterpret_cast<uint64_t>(&reinterpret_cast<float*>(state_checkpoints_addr)[entering_checkpoint_col + 12])), "f"(_tmem_load_1[12]), "f"(_tmem_load_1[13]), "f"(_tmem_load_1[14]), "f"(_tmem_load_1[15]) : "memory");
                        asm volatile("red.global.add.v4.f32 [%0], {%1, %2, %3, %4};" :: "l"(reinterpret_cast<uint64_t>(&reinterpret_cast<float*>(state_checkpoints_addr)[entering_checkpoint_col + 16])), "f"(_tmem_load_1[16]), "f"(_tmem_load_1[17]), "f"(_tmem_load_1[18]), "f"(_tmem_load_1[19]) : "memory");
                        asm volatile("red.global.add.v4.f32 [%0], {%1, %2, %3, %4};" :: "l"(reinterpret_cast<uint64_t>(&reinterpret_cast<float*>(state_checkpoints_addr)[entering_checkpoint_col + 20])), "f"(_tmem_load_1[20]), "f"(_tmem_load_1[21]), "f"(_tmem_load_1[22]), "f"(_tmem_load_1[23]) : "memory");
                        asm volatile("red.global.add.v4.f32 [%0], {%1, %2, %3, %4};" :: "l"(reinterpret_cast<uint64_t>(&reinterpret_cast<float*>(state_checkpoints_addr)[entering_checkpoint_col + 24])), "f"(_tmem_load_1[24]), "f"(_tmem_load_1[25]), "f"(_tmem_load_1[26]), "f"(_tmem_load_1[27]) : "memory");
                        asm volatile("red.global.add.v4.f32 [%0], {%1, %2, %3, %4};" :: "l"(reinterpret_cast<uint64_t>(&reinterpret_cast<float*>(state_checkpoints_addr)[entering_checkpoint_col + 28])), "f"(_tmem_load_1[28]), "f"(_tmem_load_1[29]), "f"(_tmem_load_1[30]), "f"(_tmem_load_1[31]) : "memory");
                    }
                    {
                ...
                unsigned int state_tail_packed[16];
                {
                    ...
                    if (checkpoint_entering != 0 && chunk_idx != 0) {
                        ...
                        asm volatile("red.global.add.v4.f32 [%0], {%1, %2, %3, %4};" :: "l"(reinterpret_cast<uint64_t>(&reinterpret_cast<float*>(state_checkpoints_addr)[entering_tail_col])), "f"(state_tail_frag[0]), "f"(state_tail_frag[1]), "f"(state_tail_frag[2]), "f"(state_tail_frag[3]) : "memory");
                        asm volatile("red.global.add.v4.f32 [%0], {%1, %2, %3, %4};" :: "l"(reinterpret_cast<uint64_t>(&reinterpret_cast<float*>(state_checkpoints_addr)[entering_tail_col + 4])), "f"(state_tail_frag[4]), "f"(state_tail_frag[5]), "f"(state_tail_frag[6]), "f"(state_tail_frag[7]) : "memory");
                        asm volatile("red.global.add.v4.f32 [%0], {%1, %2, %3, %4};" :: "l"(reinterpret_cast<uint64_t>(&reinterpret_cast<float*>(state_checkpoints_addr)[entering_tail_col + 8])), "f"(state_tail_frag[8]), "f"(state_tail_frag[9]), "f"(state_tail_frag[10]), "f"(state_tail_frag[11]) : "memory");
                        asm volatile("red.global.add.v4.f32 [%0], {%1, %2, %3, %4};" :: "l"(reinterpret_cast<uint64_t>(&reinterpret_cast<float*>(state_checkpoints_addr)[entering_tail_col + 12])), "f"(state_tail_frag[12]), "f"(state_tail_frag[13]), "f"(state_tail_frag[14]), "f"(state_tail_frag[15]) : "memory");
                        asm volatile("red.global.add.v4.f32 [%0], {%1, %2, %3, %4};" :: "l"(reinterpret_cast<uint64_t>(&reinterpret_cast<float*>(state_checkpoints_addr)[entering_tail_col + 16])), "f"(state_tail_frag[16]), "f"(state_tail_frag[17]), "f"(state_tail_frag[18]), "f"(state_tail_frag[19]) : "memory");
                        asm volatile("red.global.add.v4.f32 [%0], {%1, %2, %3, %4};" :: "l"(reinterpret_cast<uint64_t>(&reinterpret_cast<float*>(state_checkpoints_addr)[entering_tail_col + 20])), "f"(state_tail_frag[20]), "f"(state_tail_frag[21]), "f"(state_tail_frag[22]), "f"(state_tail_frag[23]) : "memory");
                        asm volatile("red.global.add.v4.f32 [%0], {%1, %2, %3, %4};" :: "l"(reinterpret_cast<uint64_t>(&reinterpret_cast<float*>(state_checkpoints_addr)[entering_tail_col + 24])), "f"(state_tail_frag[24]), "f"(state_tail_frag[25]), "f"(state_tail_frag[26]), "f"(state_tail_frag[27]) : "memory");
                        asm volatile("red.global.add.v4.f32 [%0], {%1, %2, %3, %4};" :: "l"(reinterpret_cast<uint64_t>(&reinterpret_cast<float*>(state_checkpoints_addr)[entering_tail_col + 28])), "f"(state_tail_frag[28]), "f"(state_tail_frag[29]), "f"(state_tail_frag[30]), "f"(state_tail_frag[31]) : "memory");
                    }
                }
                asm volatile("tcgen05.wait::st.sync.aligned;" ::: "memory");
                if (elect_sync()) {
                ...
                for (int state_col_block_3 = 0; state_col_block_3 < 4; state_col_block_3++) {
                        ...
                        : "r"(taddr + 64 + (unsigned int)tmem_row_base + (unsigned int)(state_col_block_3 * 32)));
                    {
                        ...
                        for (int state_vec = 0; state_vec < 4; state_vec++) {
                            {
                                unsigned _stv8_1_0 = __float_as_uint(_tmem_load_4[state_vec * 8 + 0]);
                                unsigned _stv8_1_1 = __float_as_uint(_tmem_load_4[state_vec * 8 + 1]);
                                unsigned _stv8_1_2 = __float_as_uint(_tmem_load_4[state_vec * 8 + 2]);
                                unsigned _stv8_1_3 = __float_as_uint(_tmem_load_4[state_vec * 8 + 3]);
                                unsigned _stv8_1_4 = __float_as_uint(_tmem_load_4[state_vec * 8 + 4]);
                                unsigned _stv8_1_5 = __float_as_uint(_tmem_load_4[state_vec * 8 + 5]);
                                unsigned _stv8_1_6 = __float_as_uint(_tmem_load_4[state_vec * 8 + 6]);
                                unsigned _stv8_1_7 = __float_as_uint(_tmem_load_4[state_vec * 8 + 7]);
                                asm volatile(
                                    "st.global.v8.b32 [%0], {%1, %2, %3, %4, %5, %6, %7, %8};"
                                    :: "l"((void*)(final_state_f32 + (state_base + (long long)(state_col_block_3 * 32) + (long long)(state_vec * 8)) + (0))), "r"(_stv8_1_0), "r"(_stv8_1_1), "r"(_stv8_1_2), "r"(_stv8_1_3), "r"(_stv8_1_4), "r"(_stv8_1_5), "r"(_stv8_1_6), "r"(_stv8_1_7) : "memory");
                            }
                        }
                    }
                }
