        ...
        { // compute_main
            ...
            for (int chunk_idx = 0; chunk_idx < num_chunks_0; chunk_idx++) {
                ...
                if (checkpoint_entering != 0 && chunk_idx != 0) {
                    long long early_checkpoint_idx = reinterpret_cast<long long*>(checkpoint_cu_starts_addr)[seq_idx] + (long long)(chunk_idx * 32 / checkpoint_every_n_tokens);
                ...
                asm volatile(
                    ...
                    : "r"(state_addr_0));
                if (checkpoint_entering != 0 && chunk_idx != 0) {
                    long long early_checkpoint_idx_1 = reinterpret_cast<long long*>(checkpoint_cu_starts_addr)[seq_idx] + (long long)(chunk_idx * 32 / checkpoint_every_n_tokens);
                ...
                asm volatile(
                    ...
                    : "r"(state_addr_1));
                if (checkpoint_entering != 0 && chunk_idx != 0) {
                    long long early_checkpoint_idx_2 = reinterpret_cast<long long*>(checkpoint_cu_starts_addr)[seq_idx] + (long long)(chunk_idx * 32 / checkpoint_every_n_tokens);
                ...
                asm volatile(
                    ...
                    : "r"(state_addr_2));
                if (checkpoint_entering != 0 && chunk_idx != 0) {
                    long long early_checkpoint_idx_3 = reinterpret_cast<long long*>(checkpoint_cu_starts_addr)[seq_idx] + (long long)(chunk_idx * 32 / checkpoint_every_n_tokens);
