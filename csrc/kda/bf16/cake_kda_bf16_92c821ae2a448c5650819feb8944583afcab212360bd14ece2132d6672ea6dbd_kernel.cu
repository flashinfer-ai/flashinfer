...
kernel_cake_kda_bf16_92c821ae2a448c5650819feb8944583afcab212360bd14ece2132d6672ea6dbd(float* __restrict__ split_state, __nv_bfloat16* __restrict__ map_state_bf16, float* __restrict__ carry, float* __restrict__ final_state, int write_final_state, int num_heads, int* __restrict__ part_cu_seqlens)
{
