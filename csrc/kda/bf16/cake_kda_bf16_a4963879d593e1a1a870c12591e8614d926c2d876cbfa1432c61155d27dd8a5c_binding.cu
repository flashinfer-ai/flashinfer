...
// tvm-ffi direct-source launcher for Cake kernel 'kernel_cake_kda_bf16_a4963879d593e1a1a870c12591e8614d926c2d876cbfa1432c61155d27dd8a5c'.
#include <cuda.h>
#include <cuda_bf16.h>
#include <cuda_fp16.h>
...
void RunWithDescriptors(TensorView arg_q, TensorView arg_q_tma, TensorView arg_k, TensorView arg_k_tma, TensorView arg_v, TensorView arg_v_tma, TensorView arg_g, TensorView arg_g_tma, TensorView arg_beta, TensorView arg_beta_tma, TensorView arg_A_log, TensorView arg_dt_bias, TensorView arg_cu_seqlens, TensorView arg_seq_order, TensorView arg_initial_state, TensorView arg_out, TensorView arg_out_tma, TensorView arg_final_state, int64_t arg_state_indices_addr, int64_t arg_state_slot_stride, int64_t arg_use_state_indices, TensorView arg_initial_state_f32, TensorView arg_final_state_f32, int64_t arg_state_checkpoints_addr, int64_t arg_checkpoint_cu_starts_addr, TensorView arg_beta_active_out, int64_t arg_beta_token_stride, int64_t arg_g_token_stride, int64_t arg_checkpoint_every_n_tokens, int64_t arg_num_heads, int64_t arg_use_initial_state, int64_t arg_store_final_state, double arg_scale, double arg_lower_bound, TensorView arg_tma_descriptor_workspace, int64_t grid_x, int64_t grid_y, int64_t grid_z, int descriptor_action) {
  ...
  TVM_FFI_CHECK(arg_tma_descriptor_workspace.numel() >= 768, ValueError)
      << "tma_descriptor_workspace requires at least 768 bytes";
  TVM_FFI_CHECK(
  ...
  void* kargs[] = {&p_q, &p_q_tma, &p_k, &p_k_tma, &p_v, &p_v_tma, &p_g, &p_g_tma, &p_beta, &p_beta_tma, &p_A_log, &p_dt_bias, &p_cu_seqlens, &p_seq_order, &p_initial_state, &p_out, &p_out_tma, &p_final_state, &v_state_indices_addr, &v_state_slot_stride, &v_use_state_indices, &p_initial_state_f32, &p_final_state_f32, &v_state_checkpoints_addr, &v_checkpoint_cu_starts_addr, &p_beta_active_out, &v_beta_token_stride, &v_g_token_stride, &v_checkpoint_every_n_tokens, &v_num_heads, &v_use_initial_state, &v_store_final_state, &v_scale, &v_lower_bound};
    ...
    if (it == smem_status_by_device->end()) {
      ...
      if (smem_status == cudaSuccess) {
        smem_status = cudaFuncSetAttribute(
            reinterpret_cast<const void*>(kernel_cake_kda_bf16_a4963879d593e1a1a870c12591e8614d926c2d876cbfa1432c61155d27dd8a5c),
  ...
  TVM_FFI_CHECK(smem_status == cudaSuccess, RuntimeError)
      << "cudaFuncSetAttribute for kernel_cake_kda_bf16_a4963879d593e1a1a870c12591e8614d926c2d876cbfa1432c61155d27dd8a5c failed: "
  ...
  const CUtensorMap workspace_maps[] = {h_q_tma, h_k_tma, h_v_tma, h_g_tma, h_beta_tma, h_out_tma};
  ...
  cudaError_t launch_status = cudaLaunchKernelExC(
      &config, reinterpret_cast<const void*>(kernel_cake_kda_bf16_a4963879d593e1a1a870c12591e8614d926c2d876cbfa1432c61155d27dd8a5c), kargs);
  TVM_FFI_CHECK(launch_status == cudaSuccess, RuntimeError)
      << "cudaLaunchKernelExC for kernel_cake_kda_bf16_a4963879d593e1a1a870c12591e8614d926c2d876cbfa1432c61155d27dd8a5c failed: "
...
void Run(TensorView arg_q, TensorView arg_q_tma, TensorView arg_k, TensorView arg_k_tma, TensorView arg_v, TensorView arg_v_tma, TensorView arg_g, TensorView arg_g_tma, TensorView arg_beta, TensorView arg_beta_tma, TensorView arg_A_log, TensorView arg_dt_bias, TensorView arg_cu_seqlens, TensorView arg_seq_order, TensorView arg_initial_state, TensorView arg_out, TensorView arg_out_tma, TensorView arg_final_state, int64_t arg_state_indices_addr, int64_t arg_state_slot_stride, int64_t arg_use_state_indices, TensorView arg_initial_state_f32, TensorView arg_final_state_f32, int64_t arg_state_checkpoints_addr, int64_t arg_checkpoint_cu_starts_addr, TensorView arg_beta_active_out, int64_t arg_beta_token_stride, int64_t arg_g_token_stride, int64_t arg_checkpoint_every_n_tokens, int64_t arg_num_heads, int64_t arg_use_initial_state, int64_t arg_store_final_state, double arg_scale, double arg_lower_bound, TensorView arg_tma_descriptor_workspace, int64_t grid_x, int64_t grid_y, int64_t grid_z) {
  RunWithDescriptors(arg_q, arg_q_tma, arg_k, arg_k_tma, arg_v, arg_v_tma, arg_g, arg_g_tma, arg_beta, arg_beta_tma, arg_A_log, arg_dt_bias, arg_cu_seqlens, arg_seq_order, arg_initial_state, arg_out, arg_out_tma, arg_final_state, arg_state_indices_addr, arg_state_slot_stride, arg_use_state_indices, arg_initial_state_f32, arg_final_state_f32, arg_state_checkpoints_addr, arg_checkpoint_cu_starts_addr, arg_beta_active_out, arg_beta_token_stride, arg_g_token_stride, arg_checkpoint_every_n_tokens, arg_num_heads, arg_use_initial_state, arg_store_final_state, arg_scale, arg_lower_bound, arg_tma_descriptor_workspace, grid_x, grid_y, grid_z, 2);
}
...
TVM_FFI_DLL_EXPORT_TYPED_FUNC(run, cake_host_shim_a4963879d593e1a1a870c12591e8614d926c2d876cbfa1432c61155d27dd8a5c::Run);
TVM_FFI_DLL_EXPORT_TYPED_FUNC(run_prepare_tma, cake_host_shim_a4963879d593e1a1a870c12591e8614d926c2d876cbfa1432c61155d27dd8a5c::PrepareTma);
TVM_FFI_DLL_EXPORT_TYPED_FUNC(run_prepared, cake_host_shim_a4963879d593e1a1a870c12591e8614d926c2d876cbfa1432c61155d27dd8a5c::RunPrepared);
