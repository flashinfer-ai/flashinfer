...
// tvm-ffi direct-source launcher for Cake kernel 'kernel_cake_kda_bf16_48bdd6d0e6b34d52faabcf0c775a1ad36d3a56388e8fb9f260448daf7834b7ee'.
#include <cuda.h>
#include <cuda_bf16.h>
#include <cuda_fp16.h>
...
void RunWithDescriptors(TensorView arg_items, int64_t arg_num_heads, TensorView arg_carry_hi, TensorView arg_carry_hi_tma, TensorView arg_carry_lo, TensorView arg_carry_lo_tma, TensorView arg_maps, TensorView arg_maps_tma, TensorView arg_map_final, TensorView arg_map_final_tma, TensorView arg_op_qd, TensorView arg_op_kd, TensorView arg_op_ft, TensorView arg_op_inv, TensorView arg_op_vec, TensorView arg_out, TensorView arg_out_tma, TensorView arg_rows, TensorView arg_rows_tma, TensorView arg_row_starts, TensorView arg_final, TensorView arg_final_tma, TensorView arg_pair, TensorView arg_pair_tma, TensorView arg_dpair, TensorView arg_tma_descriptor_workspace, int64_t grid_x, int64_t grid_y, int64_t grid_z, int descriptor_action) {
    ...
    if (it == smem_status_by_device->end()) {
      ...
      if (smem_status == cudaSuccess) {
        smem_status = cudaFuncSetAttribute(
            reinterpret_cast<const void*>(kernel_cake_kda_bf16_48bdd6d0e6b34d52faabcf0c775a1ad36d3a56388e8fb9f260448daf7834b7ee),
  ...
  TVM_FFI_CHECK(smem_status == cudaSuccess, RuntimeError)
      << "cudaFuncSetAttribute for kernel_cake_kda_bf16_48bdd6d0e6b34d52faabcf0c775a1ad36d3a56388e8fb9f260448daf7834b7ee failed: "
  ...
  cudaError_t launch_status = cudaLaunchKernelExC(
      &config, reinterpret_cast<const void*>(kernel_cake_kda_bf16_48bdd6d0e6b34d52faabcf0c775a1ad36d3a56388e8fb9f260448daf7834b7ee), kargs);
  TVM_FFI_CHECK(launch_status == cudaSuccess, RuntimeError)
      << "cudaLaunchKernelExC for kernel_cake_kda_bf16_48bdd6d0e6b34d52faabcf0c775a1ad36d3a56388e8fb9f260448daf7834b7ee failed: "
...
TVM_FFI_DLL_EXPORT_TYPED_FUNC(run, cake_host_shim_48bdd6d0e6b34d52faabcf0c775a1ad36d3a56388e8fb9f260448daf7834b7ee::Run);
TVM_FFI_DLL_EXPORT_TYPED_FUNC(run_prepare_tma, cake_host_shim_48bdd6d0e6b34d52faabcf0c775a1ad36d3a56388e8fb9f260448daf7834b7ee::PrepareTma);
TVM_FFI_DLL_EXPORT_TYPED_FUNC(run_prepared, cake_host_shim_48bdd6d0e6b34d52faabcf0c775a1ad36d3a56388e8fb9f260448daf7834b7ee::RunPrepared);
