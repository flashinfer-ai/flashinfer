        ...
        { // mma_main
            ...
            for (int _chunk_idx = 0; _chunk_idx < num_chunks_0_2; _chunk_idx++) {
                ...
                }
                {
                    ...
                    {
                        {
                            int _mma_b_lo_4 = make_warp_uniform((((smem_kd_addr) >> 4) & 0x3FFF) + (mma_stage) * 2624);
                            asm volatile(
                    "{\n\t"
