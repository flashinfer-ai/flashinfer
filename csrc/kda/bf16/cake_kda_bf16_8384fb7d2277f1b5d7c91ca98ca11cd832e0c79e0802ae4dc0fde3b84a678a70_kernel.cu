...
kernel_cake_kda_bf16_8384fb7d2277f1b5d7c91ca98ca11cd832e0c79e0802ae4dc0fde3b84a678a70(float* __restrict__ split_state, __nv_bfloat16* __restrict__ map_state_bf16, float* __restrict__ carry, float* __restrict__ final_state, int write_final_state, int num_heads, int* __restrict__ part_cu_seqlens)
{
