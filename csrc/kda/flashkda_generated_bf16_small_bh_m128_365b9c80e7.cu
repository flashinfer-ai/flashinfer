                ...
                for (int state_col_block_2 = 0; state_col_block_2 < 4; state_col_block_2++) {
                        ...
                        : "r"(taddr + 64 + (unsigned int)tmem_row_base + (unsigned int)(state_col_block_2 * 32)));
                    {
                        ...
                        for (int state_vec_1 = 0; state_vec_1 < 4; state_vec_1++) {
                            {
                                unsigned _stv8_1_0 = __float_as_uint(_tmem_load_3[state_vec_1 * 8 + 0]);
                                unsigned _stv8_1_1 = __float_as_uint(_tmem_load_3[state_vec_1 * 8 + 1]);
                                unsigned _stv8_1_2 = __float_as_uint(_tmem_load_3[state_vec_1 * 8 + 2]);
                                unsigned _stv8_1_3 = __float_as_uint(_tmem_load_3[state_vec_1 * 8 + 3]);
                                unsigned _stv8_1_4 = __float_as_uint(_tmem_load_3[state_vec_1 * 8 + 4]);
                                unsigned _stv8_1_5 = __float_as_uint(_tmem_load_3[state_vec_1 * 8 + 5]);
                                unsigned _stv8_1_6 = __float_as_uint(_tmem_load_3[state_vec_1 * 8 + 6]);
                                unsigned _stv8_1_7 = __float_as_uint(_tmem_load_3[state_vec_1 * 8 + 7]);
                                asm volatile(
                                    "st.global.v8.b32 [%0], {%1, %2, %3, %4, %5, %6, %7, %8};"
                                    :: "l"((void*)(final_state_f32 + (state_base + (long long)(state_col_block_2 * 32) + (long long)(state_vec_1 * 8)) + (0))), "r"(_stv8_1_0), "r"(_stv8_1_1), "r"(_stv8_1_2), "r"(_stv8_1_3), "r"(_stv8_1_4), "r"(_stv8_1_5), "r"(_stv8_1_6), "r"(_stv8_1_7) : "memory");
                            }
                        }
                    }
                }
