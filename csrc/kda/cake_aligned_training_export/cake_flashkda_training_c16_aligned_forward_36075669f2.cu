 ...
 *
 * Generated by Cake for the aligned C16 recurrent-KDA forward schedule.
 * The FP32 final-state epilogue is part of this exported schedule.
...
#define CHECKPOINT_STRIDE_CHUNKS 1
        ...
        { // cg1_main
            ...
            for (int __1 = 0; __1 < total_work_items + 1; __1++) {
                ...
                if (chunks_cg1 > 0) {
                    ...
                    int logical_chunk_cg1 = cstart_cg1;
                    bool checkpoint_chunk_cg1 = logical_chunk_cg1 % CHECKPOINT_STRIDE_CHUNKS == 0;
                    int checkpoint_event_cg1 = cumulative_cg1 / CHECKPOINT_STRIDE_CHUNKS;
                    ...
                    unsigned int checkpoint_stage_cg1 = (unsigned int)(checkpoint_event_cg1 % 2);
                    ...
                    if (ENABLE_CHECKPOINTS != 0 && checkpoint_chunk_cg1) {
                        mbarrier_wait(checkpoint_done_addr + (checkpoint_stage_cg1) * 8, (unsigned int)(checkpoint_event_cg1 / 2 + 1 & 1));
                    }
                ...
                for (int chunk_cg1 = 1; chunk_cg1 < chunks_cg1; chunk_cg1++) {
                    ...
                    int logical_chunk_cg1_1 = cstart_cg1 + chunk_cg1;
                    bool checkpoint_chunk_cg1_1 = logical_chunk_cg1_1 % CHECKPOINT_STRIDE_CHUNKS == 0;
                    int checkpoint_event_cg1_1 = cumulative_cg1_1 / CHECKPOINT_STRIDE_CHUNKS;
                    ...
                    unsigned int checkpoint_stage_cg1_1 = (unsigned int)(checkpoint_event_cg1_1 % 2);
                    ...
                    asm volatile("tcgen05.wait::ld.sync.aligned;" ::: "memory");
                    if (ENABLE_CHECKPOINTS != 0 && checkpoint_chunk_cg1_1) {
                        mbarrier_wait(checkpoint_done_addr + (checkpoint_stage_cg1_1) * 8, (unsigned int)(checkpoint_event_cg1_1 / 2 + 1 & 1));
                    }
                        ...
                        if (wend_cg1 == sequence_chunks_cg1) {
                            ...
                            for (int final_block_cg1 = 0; final_block_cg1 < 4; final_block_cg1++) {
                                ...
                                asm volatile(
                                    ...
                                    : "r"(taddr + (unsigned int)tmem_row_base_cg1 + (unsigned int)(final_block_cg1 * 32)));
                                #pragma unroll
                                for (int final_vec_cg1 = 0; final_vec_cg1 < 4; final_vec_cg1++) {
                                    {
                                        ...
                                        asm volatile(
                                            ...
                                            :: "l"((void*)(final_state + (state_base_cg1 + (long long)(final_block_cg1 * 32) + (long long)(final_vec_cg1 * 8)) + (0))), "r"(_stv8_9_0), "r"(_stv8_9_1), "r"(_stv8_9_2), "r"(_stv8_9_3), "r"(_stv8_9_4), "r"(_stv8_9_5), "r"(_stv8_9_6), "r"(_stv8_9_7) : "memory");
                                    }
                                }
                            }
                        }
    ...
    if (warp == 13) {
        { // tcgen_main
            ...
            for (int __3 = 0; __3 < total_work_items + 1; __3++) {
                ...
                int cstart_tcgen = work_items[item_base_tcgen + 4];
                ...
                for (int chunk_tcgen = 0; chunk_tcgen < chunks_tcgen; chunk_tcgen++) {
                    ...
                    int logical_chunk_tcgen = cstart_tcgen + chunk_tcgen;
                    int checkpoint_event_tcgen = cumulative_tcgen / CHECKPOINT_STRIDE_CHUNKS;
                    ...
                    if (ENABLE_CHECKPOINTS != 0 && logical_chunk_tcgen % CHECKPOINT_STRIDE_CHUNKS == 0) {
                        mbarrier_wait(state_read_done_addr, (unsigned int)(checkpoint_event_tcgen & 1));
                    }
                    #pragma unroll
        ...
        { // epilogue_main
            ...
            for (int __4 = 0; __4 < total_work_items + 1; __4++) {
                ...
                if (ENABLE_CHECKPOINTS != 0 && chunks_epi > 0) {
                    int checkpoint_event_epi = cumulative_chunk_epi / CHECKPOINT_STRIDE_CHUNKS;
                ...
                for (int chunk_epi = 0; chunk_epi < chunks_epi; chunk_epi++) {
                    ...
                    if (chunk_epi > 0) {
                        if (ENABLE_CHECKPOINTS != 0 && logical_chunk_epi % CHECKPOINT_STRIDE_CHUNKS == 0) {
                            int checkpoint_event_loop_epi = cumulative_epi / CHECKPOINT_STRIDE_CHUNKS;
                            ...
                            if (logical_chunk_epi >= wstart_epi) {
                                if (elect_sync()) {
                                    ...
                                    for (int checkpoint_segment_loop_epi = 0; checkpoint_segment_loop_epi < 2; checkpoint_segment_loop_epi++) {
                                        tma_store_4d((&checkpoint_tma), checkpoint_segment_loop_epi * 64, 0, head_epi, checkpoint_base_epi + (long long)(logical_chunk_epi / CHECKPOINT_STRIDE_CHUNKS), smem_checkpoint_addr + checkpoint_stage_loop_epi * 32768 + (unsigned int)(checkpoint_segment_loop_epi * 128 * 64 * 2));
                                    }
                                }
                                asm volatile("cp.async.bulk.commit_group;");
                                asm volatile("cp.async.bulk.wait_group.read 0;");
