                                    ...
                                    for (int half_5 = 0; half_5 < 2; half_5++) {
                                        ...
                                        asm volatile("tcgen05.wait::ld.sync.aligned;" ::: "memory");
                                        {
                                            ...
                                            for (int group_1 = 0; group_1 < 8; group_1++) {
                                                ...
                                                float2 _f2_156 = make_float2(smem_diag[factor_stage * 18688 + column_1], smem_diag[factor_stage * 18688 + column_1 + 1]);
                                                ...
                                                for (int pair_row_1 = 0; pair_row_1 < 2; pair_row_1++) {
                                                    float2 _f2_158 = make_float2(_tmem_load_33[group_1 * 4 + pair_row_1 * 2], _tmem_load_33[group_1 * 4 + pair_row_1 * 2 + 1]);
                                                    ...
                                                    _tmem_load_33[group_1 * 4 + pair_row_1 * 2] = state_pair.x;
                                                    _tmem_load_33[group_1 * 4 + pair_row_1 * 2 + 1] = state_pair.y;
                                                }
                                            }
                                            asm volatile(
                                                "tcgen05.st.sync.aligned.16x256b.x8.b32"
                                    ...
                                    for (int half_6 = 0; half_6 < 2; half_6++) {
                                        ...
                                        for (int group_2 = 0; group_2 < 8; group_2++) {
                                            ...
                                            for (int pair_row_2 = 0; pair_row_2 < 2; pair_row_2++) {
                                                ...
                                                _tmem_load_40[group_2 * 4 + pair_row_2 * 2] = state_pair_1.x;
                                                _tmem_load_40[group_2 * 4 + pair_row_2 * 2 + 1] = state_pair_1.y;
                                            }
                                        }
                                        asm volatile(
                                            "tcgen05.st.sync.aligned.16x256b.x8.b32"
                        ...
                        for (int row_band_3 = 0; row_band_3 < 2; row_band_3++) {
                            ...
                            for (int group_3 = 0; group_3 < 4; group_3++) {
                                ...
                                for (int pair_row_3 = 0; pair_row_3 < 2; pair_row_3++) {
                                    int sr_1 = row_top + row_band_3 * 16 + pair_row_3 * 8;
                                    #pragma unroll
                                    for (int adjacent_2 = 0; adjacent_2 < 2; adjacent_2++) {
                                        ...
                                        {
                                            float _fma_56 = __fmaf_rn(_tmem_load_41[group_3 * 4 + pair_row_3 * 2 + adjacent_2], -5.421010862427522e-20f, value_1);
                                            residual[group_3 * 4 + pair_row_3 * 2 + adjacent_2] = _fma_56;
                                        }
                                    }
                                }
                            }
                                ...
                                for (int row_band_4 = 0; row_band_4 < 2; row_band_4++) {
                                    ...
                                    for (int group_4 = 0; group_4 < 4; group_4++) {
                                        ...
                                        for (int pair_row_4 = 0; pair_row_4 < 2; pair_row_4++) {
                                            int sr_2 = row_top + row_band_4 * 16 + pair_row_4 * 8;
                                            #pragma unroll
                                            for (int adjacent_3 = 0; adjacent_3 < 2; adjacent_3++) {
                                                long long token_2 = token_base_1 + (long long)(group_4 * 8) + (long long)lane_column + (long long)adjacent_3;
                                                if (token_2 < eos_1) {
                                                    {
                                                        out[(token_2 * (long long)num_heads + (long long)head_idx_1) * 128 + (long long)sr_2] = _tmem_load_45[group_4 * 4 + pair_row_4 * 2 + adjacent_3] * output_scale;
                                                    }
                                                }
                                            }
                                        }
                                ...
                                for (int half_7 = 0; half_7 < 2; half_7++) {
                                    ...
                                    for (int group_5 = 0; group_5 < 8; group_5++) {
                                        ...
                                        for (int pair_row_5 = 0; pair_row_5 < 2; pair_row_5++) {
                                            int sr_3 = row_top + row_band_5 * 16 + pair_row_5 * 8;
                                            {
                                                {
                                                    if (task_destination < 0 && ((unsigned long long)final_state_f32 + (unsigned long long)state_head * 4 & 7) == 0) {
                                                        {
                                                            float2 _v2 = make_float2(_tmem_load_47[group_5 * 4 + pair_row_5 * 2 + 0], _tmem_load_47[group_5 * 4 + pair_row_5 * 2 + 1]);
                                                            *reinterpret_cast<float2*>(final_state_f32 + (state_head + (long long)sr_3 * 128 + (long long)column_3) + 0) = _v2;
                                                        }
                                                    } else {
                                                        #pragma unroll
                                                        for (int adjacent_4 = 0; adjacent_4 < 2; adjacent_4++) {
                                                            long long si_1 = state_head + (long long)sr_3 * 128 + (long long)column_3 + (long long)adjacent_4;
                                                            if (task_destination >= 0) {
                                                                mid_state_f32[(long long)task_destination * 128 * 128 + (long long)sr_3 * 128 + (long long)column_3 + (long long)adjacent_4] = _tmem_load_47[group_5 * 4 + pair_row_5 * 2 + adjacent_4];
                                                            } else if (1) {
