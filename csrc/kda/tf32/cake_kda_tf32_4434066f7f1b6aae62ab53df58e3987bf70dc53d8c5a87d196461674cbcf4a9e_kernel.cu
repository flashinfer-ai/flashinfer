...
kernel_cake_kda_tf32_4434066f7f1b6aae62ab53df58e3987bf70dc53d8c5a87d196461674cbcf4a9e(float* __restrict__ carry, CakeTensorMap const* carry_tma, float* __restrict__ coefficients, CakeTensorMap const* coefficients_tma, __nv_bfloat16* __restrict__ out, int* __restrict__ token_starts, int* __restrict__ token_counts, int* __restrict__ part_ids, int num_heads)
{
    ...
    for (int inner = 0; inner < 2; inner++) {
        ...
        if (warp == 0) {
            ...
            int _mma_b_lo_0 = make_warp_uniform(((state_addr) >> 4) & 0x3FFF);
            {
                ...
                if (elect_sync()) {
                    tcgen05_mma_tf32(tmem_result, _mma_ss_a_desc_0, _mma_ss_b_desc_0, 136317200, ((inner == 0) ? 0 : 1));
                }
                incr_smem_desc_lo(_mma_ss_a_desc_0, 2U);
                incr_smem_desc_lo(_mma_ss_b_desc_0, 2U);
                if (elect_sync()) {
                    tcgen05_mma_tf32(tmem_result, _mma_ss_a_desc_0, _mma_ss_b_desc_0, 136317200, 1);
                }
                incr_smem_desc_lo(_mma_ss_a_desc_0, 2U);
                incr_smem_desc_lo(_mma_ss_b_desc_0, 2U);
                if (elect_sync()) {
