            ...
            {
                {
                    ...
                    if (blockIdx.x % 8 != 0) {
                        int value_offset = 0;
                        int seq_idx = seq_order[task / num_heads];
                        int head_idx = task % num_heads;
                        ...
                        for (int cta_chunk = first_chunk; cta_chunk < my_chunks; cta_chunk += 3 * ((1) ? 7 : 1)) {
                                    ...
                                    for (int row = 0; row < 32; row++) {
                                        ...
                                        float gate_increment = 0.0f;
                                        {
                                            ...
                                            if (unbounded_biased <= 20.0f) {
                                                float _exp2_1 = approx_exp2(unbounded_biased * 1.4426950408889634f);
                                                if (unbounded_biased < -4.0f) {
                                                    float _fma_0 = __fmaf_rn(_exp2_1, 0.2f, -0.25f);
                                                    float _fma_1 = __fmaf_rn(_exp2_1, _fma_0, 0.3333333333333333f);
                                                    float _fma_2 = __fmaf_rn(_exp2_1, _fma_1, -0.5f);
                                                    float _fma_3 = __fmaf_rn(_exp2_1 * _exp2_1, _fma_2, _exp2_1);
                                                    unbounded_softplus_log2 = _fma_3 * 1.4426950408889634f;
                                                }
                                                if (unbounded_biased >= -4.0f) {
                                                    float _log2_0;
                                                    asm volatile("lg2.approx.ftz.f32 %0, %1;" : "=f"(_log2_0) : "f"(1.0f + _exp2_1));
                                        ...
                                        if (eos > token_base + (long long)row_1) {
                                            ...
                                            float gate_raw_value_1 = _cvt_f32_1;
                                            {
                                                ...
                                                if (unbounded_biased_1 <= 20.0f) {
                                                    float _exp2_2 = approx_exp2(unbounded_biased_1 * 1.4426950408889634f);
                                                    if (unbounded_biased_1 < -4.0f) {
                                                        float _fma_5 = __fmaf_rn(_exp2_2, 0.2f, -0.25f);
                                                        float _fma_6 = __fmaf_rn(_exp2_2, _fma_5, 0.3333333333333333f);
                                                        float _fma_7 = __fmaf_rn(_exp2_2, _fma_6, -0.5f);
                                                        float _fma_8 = __fmaf_rn(_exp2_2 * _exp2_2, _fma_7, _exp2_2);
                                                        unbounded_softplus_log2_1 = _fma_8 * 1.4426950408889634f;
                                                    }
                                                    if (unbounded_biased_1 >= -4.0f) {
                                                        float _log2_1;
                                                        asm volatile("lg2.approx.ftz.f32 %0, %1;" : "=f"(_log2_1) : "f"(1.0f + _exp2_2));
                            ...
                            asm volatile("barrier.sync %0, 128;" :: "r"(prep_instance + 1) : "memory");
                            {
                                if (prep_tid < 128) {
                                    ...
                                    float _shfl_xor_0 = __shfl_xor_sync(0xFFFFFFFF, warp_min, 16);
                                    float _min_0 = fminf(warp_min, _shfl_xor_0);
                                    warp_min = _min_0;
                                    float _shfl_xor_1 = __shfl_xor_sync(0xFFFFFFFF, warp_max, 16);
                                    float _max_0 = max_noftz(warp_max, _shfl_xor_1);
                                    warp_max = _max_0;
                                    float _shfl_xor_2 = __shfl_xor_sync(0xFFFFFFFF, warp_min, 8);
                                    float _min_1 = fminf(warp_min, _shfl_xor_2);
                                    warp_min = _min_1;
                                    float _shfl_xor_3 = __shfl_xor_sync(0xFFFFFFFF, warp_max, 8);
                                    float _max_1 = max_noftz(warp_max, _shfl_xor_3);
                                    warp_max = _max_1;
                                    float _shfl_xor_4 = __shfl_xor_sync(0xFFFFFFFF, warp_min, 4);
                                    float _min_2 = fminf(warp_min, _shfl_xor_4);
                                    warp_min = _min_2;
                                    float _shfl_xor_5 = __shfl_xor_sync(0xFFFFFFFF, warp_max, 4);
                                    float _max_2 = max_noftz(warp_max, _shfl_xor_5);
                                    warp_max = _max_2;
                                    float _shfl_xor_6 = __shfl_xor_sync(0xFFFFFFFF, warp_min, 2);
                                    float _min_3 = fminf(warp_min, _shfl_xor_6);
                                    warp_min = _min_3;
                                    float _shfl_xor_7 = __shfl_xor_sync(0xFFFFFFFF, warp_max, 2);
                                    float _max_3 = max_noftz(warp_max, _shfl_xor_7);
                                    warp_max = _max_3;
                                    float _shfl_xor_8 = __shfl_xor_sync(0xFFFFFFFF, warp_min, 1);
                                    float _min_4 = fminf(warp_min, _shfl_xor_8);
                                    warp_min = _min_4;
                                    float _shfl_xor_9 = __shfl_xor_sync(0xFFFFFFFF, warp_max, 1);
                                    float _max_4 = max_noftz(warp_max, _shfl_xor_9);
                                    warp_max = _max_4;
                                    if (lane == 0) {
                                ...
                                for (int warp_1 = 1; warp_1 < 4; warp_1++) {
                                    float _min_5 = fminf(group_min, smem_abt[prep_instance * 18688 + warp_1]);
                                    group_min = _min_5;
                                    float _max_5 = max_noftz(group_max, smem_abt[prep_instance * 18688 + 4 + warp_1]);
                                    group_max = _max_5;
                                }
                                ...
                                if (prep_tid < 128) {
                                    ...
                                    for (int row_2 = 0; row_2 < 32; row_2++) {
                                        ...
                                        if (prefix_log2 < -240.0f) {
                                            float _exp2_3 = approx_exp2(gate_decay[row_2]);
                                            gate_factor = _exp2_3;
                                        } else {
                                            float _exp2_4 = approx_exp2(running_prefix - prefix_log2 * 0.5f);
                                            gate_factor = _exp2_4;
                                        }
                                        smem_gate[prep_instance * 18688 + row_2 * 128 + col] = gate_factor;
                                    }
                                    float _exp2_5 = approx_exp2(prefix_log2 * 0.5f);
                                    float feature_center = _exp2_5;
                                    if (prefix_log2 < -240.0f) {
                                        feature_center = -1.0f;
                                    }
                                    ...
                                    for (int elem_pair_1 = 0; elem_pair_1 < 4; elem_pair_1++) {
                                        ...
                                        }
                                        {
                                            ...
                                            asm volatile(
                                                ...
                                                "fma.rn.f32.bf16 %0, a_hi, b_hi, %0;\n\t"
                                                "}\n"
                                                : "=f"(_bf16x2_dot_f32_2) : "r"(normalized_words[0]), "r"(normalized_words[1]), "f"(qk_self[norm_tile]));
                                            qk_self[norm_tile] = _bf16x2_dot_f32_2;
                                        }
                            ...
                            }
                            {
                                ...
                                for (int tile_1 = 0; tile_1 < 2; tile_1++) {
                                    ...
                                    float _shfl_xor_24 = __shfl_xor_sync(0xFFFFFFFF, diagonal_dot, 4);
                                    diagonal_dot += _shfl_xor_24;
                                    float _shfl_xor_25 = __shfl_xor_sync(0xFFFFFFFF, diagonal_dot, 2);
                                    diagonal_dot += _shfl_xor_25;
                                    float _shfl_xor_26 = __shfl_xor_sync(0xFFFFFFFF, diagonal_dot, 1);
                                    diagonal_dot += _shfl_xor_26;
                            ...
                            }
                            {
                                ...
                                if (prep_tid < 128) {
                                    ...
                                    {
                                        float _max_6 = max_noftz(center_1, 0.0f);
                                        center_1 = _max_6;
                                    }
        ...
        { // recurrence_role_main
            ...
            unsigned int factor_epoch_bits = 0;
            {
                if (blockIdx.x % 8 == 0) {
                    ...
                    int seq_idx_1 = seq_order[blockIdx.x / 8 / num_heads];
                    int head_idx_1 = blockIdx.x / 8 % num_heads;
                                            ...
                                            {
                                                {
                                                    ...
                                                    float _cvt_f32_6 = __bfloat162float(smem_v_raw[factor_stage * 37376 + v_offset / 2]);
                                                    value_1 = _cvt_f32_6;
                                                }
                                            }
                                        }
