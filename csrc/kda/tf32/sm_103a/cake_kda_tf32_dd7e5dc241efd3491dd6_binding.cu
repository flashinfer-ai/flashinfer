...
// tvm-ffi direct-source launcher for Cake kernel 'kernel_cake_kda_tf32_dd7e5dc241efd3491dd6'.
#include <cuda.h>
#include <cuda_bf16.h>
#include <cuda_fp16.h>
...
namespace cake_host_shim_ad5a5a117f52b4a3 {
...
TVM_FFI_DLL_EXPORT_TYPED_FUNC(run, cake_host_shim_ad5a5a117f52b4a3::Run);
TVM_FFI_DLL_EXPORT_TYPED_FUNC(run_prepare_tma, cake_host_shim_ad5a5a117f52b4a3::PrepareTma);
TVM_FFI_DLL_EXPORT_TYPED_FUNC(run_prepared, cake_host_shim_ad5a5a117f52b4a3::RunPrepared);
