                            ...
                            asm volatile("barrier.sync %0, 128;" :: "r"(prep_instance + 1) : "memory");
                            {
                                ...
                                if (prep_tid < 128) {
                                    ...
                                    for (int row_2 = 0; row_2 < 32; row_2++) {
                                        ...
                                        smem_gate[prep_instance * 18688 + (row_2 * 128 + (col ^ (row_2 & 3) << 1))] = gate_factor;
                                    }
                                ...
                                for (int row_band_2 = 0; row_band_2 < 2; row_band_2++) {
                                    ...
                                    for (int half_6 = 0; half_6 < 2; half_6++) {
                                        ...
                                        for (int group_2 = 0; group_2 < 8; group_2++) {
                                            int column_2 = half_6 * 64 + group_2 * 8 + lane_column;
                                            float2 _f2_203 = make_float2(smem_diag[factor_stage * 18688 + column_2], smem_diag[factor_stage * 18688 + column_2 + 1]);
                                            float2 decay_pair_1 = _f2_203;
                                            #pragma unroll
                                            for (int pair_row_2 = 0; pair_row_2 < 2; pair_row_2++) {
                                                float2 _f2_206 = make_float2(_tmem_load_40[group_2 * 4 + pair_row_2 * 2], _tmem_load_40[group_2 * 4 + pair_row_2 * 2 + 1]);
                                                float2 state_pair = _f2_206;
                                                {
                                                    float2 _mul_f32x2_120;
                                                    asm("mul.rn.ftz.f32x2 %0, %1, %2;" : "=l"(*(unsigned long long*)&_mul_f32x2_120) : "l"(*(const unsigned long long*)&state_pair), "l"(*(const unsigned long long*)&decay_pair_1));
                                                    state_pair = _mul_f32x2_120;
                                                }
                                                _tmem_load_40[group_2 * 4 + pair_row_2 * 2] = state_pair.x;
                                                _tmem_load_40[group_2 * 4 + pair_row_2 * 2 + 1] = state_pair.y;
                                            }
                                        }
                                        asm volatile(
                                            "tcgen05.st.sync.aligned.16x256b.x8.b32"
                            ...
                            for (int group_3 = 0; group_3 < 4; group_3++) {
                                ...
                                for (int pair_row_3 = 0; pair_row_3 < 2; pair_row_3++) {
                                    ...
                                    for (int adjacent_1 = 0; adjacent_1 < 2; adjacent_1++) {
                                        long long token = token_base_1 + (long long)(group_3 * 8) + (long long)lane_column + (long long)adjacent_1;
                                        float value_1 = 0.0f;
                                        if (token < eos_1) {
                                            {
                                                {
                                        ...
                                        {
                                            residual[group_3 * 4 + pair_row_3 * 2 + adjacent_1] = value_1 - _tmem_load_41[group_3 * 4 + pair_row_3 * 2 + adjacent_1];
                                        }
                                    }
                                }
                            }
                                        ...
                                        for (int group_4 = 0; group_4 < 4; group_4++) {
                                            ...
                                            for (int pair_row_4 = 0; pair_row_4 < 2; pair_row_4++) {
                                                ...
                                                for (int adjacent_2 = 0; adjacent_2 < 2; adjacent_2++) {
                                                    long long token_1 = token_base_1 + (long long)(group_4 * 8) + (long long)lane_column + (long long)adjacent_2;
                                                    if (token_1 < eos_1) {
                                                        {
                                                            out[(token_1 * (long long)num_heads + (long long)head_idx_1) * 128 + (long long)sr_3] = _tmem_load_45[group_4 * 4 + pair_row_4 * 2 + adjacent_2] * output_scale;
                                                        }
                                                    }
                                                }
                                            }
                            ...
                            for (int row_band_5 = 0; row_band_5 < 2; row_band_5++) {
                                ...
                                for (int half_7 = 0; half_7 < 2; half_7++) {
                                    ...
                                    for (int group_5 = 0; group_5 < 8; group_5++) {
                                        int column_3 = half_7 * 64 + group_5 * 8 + lane_column;
                                        #pragma unroll
                                        for (int pair_row_5 = 0; pair_row_5 < 2; pair_row_5++) {
                                            int sr_4 = row_top + row_band_5 * 16 + pair_row_5 * 8;
                                            {
                                                {
                                                    #pragma unroll
                                                    for (int adjacent_3 = 0; adjacent_3 < 2; adjacent_3++) {
                                                        long long si_1 = state_head + (long long)sr_4 * 128 + (long long)column_3 + (long long)adjacent_3;
                                                        if (task_destination >= 0) {
                                                            mid_state_f32[(long long)task_destination * 128 * 128 + (long long)sr_4 * 128 + (long long)column_3 + (long long)adjacent_3] = _tmem_load_47[group_5 * 4 + pair_row_5 * 2 + adjacent_3];
                                                        } else if (1) {
                                                            final_state_f32[si_1] = _tmem_load_47[group_5 * 4 + pair_row_5 * 2 + adjacent_3];
                                                        } else {
                                                            final_state[si_1] = _tmem_load_47[group_5 * 4 + pair_row_5 * 2 + adjacent_3];
                                                        }
                                                    }
                                                }
                                            }
