                                ...
                                for (int row_band = 0; row_band < 1; row_band++) {
                                    ...
                                    for (int half_4 = 0; half_4 < 2; half_4++) {
                                        ...
                                        for (int group = 0; group < 8; group++) {
                                            ...
                                            float2 _f2_171 = make_float2(smem_diag[factor_stage * 18688 + column], smem_diag[factor_stage * 18688 + column + 1]);
                                            ...
                                            for (int pair_row = 0; pair_row < 2; pair_row++) {
                                                float2 _f2_174 = make_float2(_tmem_load_36[group * 4 + pair_row * 2], _tmem_load_36[group * 4 + pair_row * 2 + 1]);
                                                ...
                                                _tmem_load_36[group * 4 + pair_row * 2] = state_pair.x;
                                                _tmem_load_36[group * 4 + pair_row * 2 + 1] = state_pair.y;
                                            }
                                        }
                                        {
                                            asm volatile(
                    ...
                    :: "r"(tmem_tmem_output), "r"(_mma_b_lo_20), "r"(tmem_tmem_state + state_buffer * 128), "r"(0));
                        ...
                        for (int row_band_1 = 0; row_band_1 < 1; row_band_1++) {
                            ...
                            for (int group_1 = 0; group_1 < 4; group_1++) {
                                ...
                                {
                                    int v_ld_token = (unsigned int)(group_1 * 8) + (lane & 7);
                                ...
                                for (int pair_row_1 = 0; pair_row_1 < 2; pair_row_1++) {
                                    int sr = row_top + row_band_1 * 16 + pair_row_1 * 8;
                                    #pragma unroll
                                    for (int adjacent = 0; adjacent < 2; adjacent++) {
                                        long long token = token_base_1 + (long long)(group_1 * 8) + (long long)lane_column + (long long)adjacent;
                                        float value_1 = 0.0f;
                                        if (token < eos_1) {
                                            {
                                                {
                                                    value_1 = v_pair_values[pair_row_1 * 2 + adjacent];
                                                }
                                            }
                                        }
                                        {
                                            float _fma_56 = __fmaf_rn(_tmem_load_41[group_1 * 4 + pair_row_1 * 2 + adjacent], -5.421010862427522e-20f, value_1);
                                            residual[group_1 * 4 + pair_row_1 * 2 + adjacent] = _fma_56;
                                        }
                                    }
                                }
                            }
                                        ...
                                        for (int group_2 = 0; group_2 < 4; group_2++) {
                                            ...
                                            for (int pair_row_2 = 0; pair_row_2 < 2; pair_row_2++) {
                                                ...
                                                for (int adjacent_1 = 0; adjacent_1 < 2; adjacent_1++) {
                                                    long long token_1 = token_base_1 + (long long)(group_2 * 8) + (long long)lane_column + (long long)adjacent_1;
                                                    if (token_1 < eos_1) {
                                                        {
                                                            out[(token_1 * (long long)num_heads + (long long)head_idx_1) * 128 + (long long)sr_1] = _tmem_load_45[group_2 * 4 + pair_row_2 * 2 + adjacent_1] * output_scale;
                                                        }
                                                    }
                                                }
                                            }
