                    ...
                    {
                        {
                            ...
                            for (int initial_quarter = 0; initial_quarter < 4; initial_quarter++) {
                                ...
                                for (int initial_item = 0; initial_item < 8; initial_item++) {
                                    __nv_bfloat16 _cvt_bf16_14 = __float2bfloat16(initial_values[initial_item]);
                                    float _cvt_f32_24 = __bfloat162float(_cvt_bf16_14);
                                    state_frag[initial_quarter * 8 + initial_item] = _cvt_f32_24;
                                }
                            }
                        }
                    }
