...
// Cake generated BT=16 chain kernel, S8 pipeline schedule (8 stages, m64
...
#define kernel_flashkda_bf16_bt16_chain_m64 kernel_flashkda_bf16_bt16_chain_m64_fn16_s8_local
...
#include "vibecuda_cakebt16_chain_s8_gen.cu"
...
void RunFull(const void* ws_qd_ptr, const void* ws_kd_ptr, const void* ws_w_ptr,
  ...
  kernel_flashkda_bf16_bt16_chain_m64_fn16_s8_local<<<grid, block, SMEM_TOTAL, stream>>>(
  ...
  CheckCuda(cudaGetLastError(), "kernel_flashkda_bf16_bt16_chain_m64_fn16_s8_local launch");
}
