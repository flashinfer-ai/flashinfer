...
// tvm-ffi host launcher for generated kernel 'kernel_flashkda_bf16_fused_m128_vtile'.
#include <cuda.h>
...
TVM_FFI_EMBED_CUBIN(flashkda_bf16_fused_m128_vtile_4b7d3b6523);

namespace cuda_host_shim_2c892b904bc3e19d {
...
void Run(TensorView arg_q, TensorView arg_q_tma, TensorView arg_k, TensorView arg_k_tma, TensorView arg_v, TensorView arg_v_tma, TensorView arg_g, TensorView arg_g_tma, TensorView arg_beta, TensorView arg_beta_tma, TensorView arg_A_log, TensorView arg_dt_bias, TensorView arg_cu_seqlens, TensorView arg_seq_order, TensorView arg_initial_state, TensorView arg_out, TensorView arg_out_tma, TensorView arg_final_state, int64_t arg_state_indices_addr, int64_t arg_state_slot_stride, int64_t arg_use_state_indices, TensorView arg_initial_state_f32, TensorView arg_final_state_f32, int64_t arg_uniform_seq_len, int64_t arg_persistent_tasks, int64_t arg_persistent_stride, int64_t arg_num_heads, int64_t arg_use_initial_state, int64_t arg_store_final_state, double arg_scale, double arg_lower_bound, int64_t grid_x, int64_t grid_y, int64_t grid_z) {
  ...
  static auto kernel = EmbedCubinModule_flashkda_bf16_fused_m128_vtile_4b7d3b6523::Global()->mod.GetKernel("kernel_flashkda_bf16_fused_m128_vtile");
  static signed char cuda_smem_mode_cache[64] = {0};
  const bool use_oversized_smem = CudaConfigureDynamicSmem(
      kernel, (int)arg_q.device().device_id, 226304,
  ...
  TVM_FFI_CHECK_CUBIN_LAUNCHER_CUDA_ERROR(kernel.Launch(kargs, grid, block, stream, 226304u));
}

}  // namespace cuda_host_shim_2c892b904bc3e19d

TVM_FFI_DLL_EXPORT_TYPED_FUNC(run, cuda_host_shim_2c892b904bc3e19d::Run);
