...
__global__ __launch_bounds__(384, 1) void kernel_flashkda_blackwell_prefill_fp32_state_initial(
    CakeTensorMap const* Q, CakeTensorMap const* K, CakeTensorMap const* V, CakeTensorMap const* G,
    CakeTensorMap const* O, __nv_bfloat16* __restrict__ beta, float* __restrict__ A_log,
