...
kernel_cake_kda_chunk_train_6d7d29fb2f4abc9f0dcf(CakeTensorMap const* w_tma, CakeTensorMap const* kg_tma, __nv_bfloat16* __restrict__ u, float* __restrict__ gk, __nv_bfloat16* __restrict__ h_out, __nv_bfloat16* __restrict__ v_new, int num_heads, int seq_len, int num_chunks)
{
