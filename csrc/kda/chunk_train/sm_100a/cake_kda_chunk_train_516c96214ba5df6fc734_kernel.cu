...
kernel_cake_kda_chunk_train_516c96214ba5df6fc734(float* __restrict__ dA_part, float* __restrict__ dbias_part, float* __restrict__ dA_log, float* __restrict__ dt_bias_grad, int num_chunks, int num_heads)
{
