#pragma once
#ifndef CAKE_KDA_SHARED_DEVICE_KERNEL
#error "CAKE_KDA_SHARED_DEVICE_KERNEL must name the exported Cake device kernel"
#endif
...
#undef CAKE_KDA_SHARED_DEVICE_KERNEL
