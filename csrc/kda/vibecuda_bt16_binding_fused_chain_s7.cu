...
// Cake generated BT=16 chain kernel, S7 pipeline schedule (7 stages, m64
...
#define kernel_flashkda_bf16_bt16_chain_m64 kernel_flashkda_bf16_bt16_chain_m64_fn16_s7_local
...
#include "vibecuda_cakebt16_chain_s7_gen.cu"
...
void RunFull(const void* ws_qd_ptr, const void* ws_kd_ptr, const void* ws_w_ptr,
  ...
  CheckCuda(cudaFuncSetAttribute(kernel_flashkda_bf16_bt16_chain_m64_fn16_s7_local,
                                 cudaFuncAttributeMaxDynamicSharedMemorySize, SMEM_TOTAL),
            "cudaFuncSetAttribute(BT16 chain s7)");
  ...
  kernel_flashkda_bf16_bt16_chain_m64_fn16_s7_local<<<grid, block, SMEM_TOTAL, stream>>>(
  ...
  CheckCuda(cudaGetLastError(), "kernel_flashkda_bf16_bt16_chain_m64_fn16_s7_local launch");
}
