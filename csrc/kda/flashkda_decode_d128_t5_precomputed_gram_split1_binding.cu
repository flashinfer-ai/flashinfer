...
#define FLASHKDA_DECODE_VALUE_SPLIT 1
#define FLASHKDA_DECODE_LAUNCH_THREADS 256
#define FLASHKDA_DECODE_EXPECTED_SMEM 49024
...
#include "flashkda_decode_d128_t5_precomputed_gram_split1.cu"
#undef uint8_t
#undef uint16_t
#undef uint32_t
#undef uint64_t
