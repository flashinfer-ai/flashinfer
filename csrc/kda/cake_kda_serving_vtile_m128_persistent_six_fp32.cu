...
#define PERSISTENT_SIX_TASK_SCHEDULE 1
#define PERSISTENT_STRIDE_HEAD_ALIGNED 0
...
kernel_cake_kda_serving_vtile_m128_persistent_six_fp32(__nv_bfloat16* __restrict__ q, CakeTensorMap const* q_tma, __nv_bfloat16* __restrict__ k, CakeTensorMap const* k_tma, __nv_bfloat16* __restrict__ v, CakeTensorMap const* v_tma, __nv_bfloat16* __restrict__ g, CakeTensorMap const* g_tma, __nv_bfloat16* __restrict__ beta, CakeTensorMap const* beta_tma, float* __restrict__ A_log, float* __restrict__ dt_bias, long long* __restrict__ cu_seqlens, int* __restrict__ seq_order, __nv_bfloat16* __restrict__ initial_state, __nv_bfloat16* __restrict__ out, CakeTensorMap const* out_tma, __nv_bfloat16* __restrict__ final_state, unsigned long long state_indices_addr, long long state_slot_stride, int use_state_indices, float* __restrict__ initial_state_f32, float* __restrict__ final_state_f32, int uniform_seq_len, int persistent_tasks, int persistent_stride, int num_heads, int use_initial_state, int store_final_state, float scale, float lower_bound)
{
    ...
    if (warp <= 3) {
        ...
        { // compute_main
                        ...
                        for (int state_col_group = 0; state_col_group < 4; state_col_group++) {
                            {
                                ...
                                asm volatile(
                                    ...
                                    : "=r"(_ldv8_0_0), "=r"(_ldv8_0_1), "=r"(_ldv8_0_2), "=r"(_ldv8_0_3), "=r"(_ldv8_0_4), "=r"(_ldv8_0_5), "=r"(_ldv8_0_6), "=r"(_ldv8_0_7) : "l"((const void*)(initial_state_f32 + (state_base + (long long)(state_col_block * 32) + (long long)(state_col_group * 8)))) : "memory");
                                state_init[state_col_group * 8 + 0] = __uint_as_float(_ldv8_0_0);
                                state_init[state_col_group * 8 + 1] = __uint_as_float(_ldv8_0_1);
                                state_init[state_col_group * 8 + 2] = __uint_as_float(_ldv8_0_2);
                                state_init[state_col_group * 8 + 3] = __uint_as_float(_ldv8_0_3);
                                state_init[state_col_group * 8 + 4] = __uint_as_float(_ldv8_0_4);
                                state_init[state_col_group * 8 + 5] = __uint_as_float(_ldv8_0_5);
                                state_init[state_col_group * 8 + 6] = __uint_as_float(_ldv8_0_6);
                                state_init[state_col_group * 8 + 7] = __uint_as_float(_ldv8_0_7);
                            }
                        }
                    }
                }
            ...
            for (int global_chunk_idx = 0; global_chunk_idx < total_chunks; global_chunk_idx++) {
                {
                    if (task_round != 0 && chunk_idx == 0) {
                        int current_task_idx = blockIdx.x + task_round * persistent_stride;
                        int current_seq_idx = current_task_idx / num_heads;
                        int current_head_idx = current_task_idx % num_heads;
                        int current_state_slot = current_seq_idx;
                        if (use_state_indices != 0) {
                            current_state_slot = reinterpret_cast<int*>(state_indices_addr)[current_seq_idx];
                        }
                        current_state_base = (long long)current_state_slot * state_slot_stride + (long long)current_head_idx * 128 * 128 + (long long)state_row * 128;
                        #pragma unroll
                        for (int state_col_block_1 = 0; state_col_block_1 < 4; state_col_block_1++) {
                            {
                                mbarrier_wait(state_copy_ready_addr + (state_copy_stage) * 8, _phase_state_copy_ready);
                                state_copy_stage += 1;
                                if (state_copy_stage == 4) { state_copy_stage = 0; _phase_state_copy_ready ^= 1; }
                            }
                            ...
                            state_init_1[31] = 0.0f;
                            {
                                {
                                    #pragma unroll
                                    for (int state_col_group_1 = 0; state_col_group_1 < 4; state_col_group_1++) {
                                        {
                                            unsigned _ldv8_3_0;
                                            unsigned _ldv8_3_1;
                                            unsigned _ldv8_3_2;
                                            ...
                                            asm volatile(
                                                "ld.global.v8.b32 {%0, %1, %2, %3, %4, %5, %6, %7}, [%8];"
                                                : "=r"(_ldv8_3_0), "=r"(_ldv8_3_1), "=r"(_ldv8_3_2), "=r"(_ldv8_3_3), "=r"(_ldv8_3_4), "=r"(_ldv8_3_5), "=r"(_ldv8_3_6), "=r"(_ldv8_3_7) : "l"((const void*)(initial_state_f32 + (current_state_base + (long long)(state_col_block_1 * 32) + (long long)(state_col_group_1 * 8)))) : "memory");
                                            state_init_1[state_col_group_1 * 8 + 0] = __uint_as_float(_ldv8_3_0);
                                            state_init_1[state_col_group_1 * 8 + 1] = __uint_as_float(_ldv8_3_1);
                                            state_init_1[state_col_group_1 * 8 + 2] = __uint_as_float(_ldv8_3_2);
                                            state_init_1[state_col_group_1 * 8 + 3] = __uint_as_float(_ldv8_3_3);
                                            state_init_1[state_col_group_1 * 8 + 4] = __uint_as_float(_ldv8_3_4);
                                            state_init_1[state_col_group_1 * 8 + 5] = __uint_as_float(_ldv8_3_5);
                                            state_init_1[state_col_group_1 * 8 + 6] = __uint_as_float(_ldv8_3_6);
                                            state_init_1[state_col_group_1 * 8 + 7] = __uint_as_float(_ldv8_3_7);
                                        }
                                    }
                                }
                            }
                            tmem_st_x32_f32(taddr + 64 + (unsigned int)tmem_row_base + (unsigned int)(state_col_block_1 * 32), state_init_1);
                        }
                        asm volatile("tcgen05.wait::st.sync.aligned;" ::: "memory");
                    }
                }
                    ...
                    for (int state_col_block_2 = 0; state_col_block_2 < 4; state_col_block_2++) {
                            ...
                            : "r"(taddr + 64 + (unsigned int)tmem_row_base + (unsigned int)(state_col_block_2 * 32)));
                        {
                            ...
                            for (int state_col_group_2 = 0; state_col_group_2 < 4; state_col_group_2++) {
                                {
                                    unsigned _stv8_6_0 = __float_as_uint(_tmem_load_6[state_col_group_2 * 8 + 0]);
                                    unsigned _stv8_6_1 = __float_as_uint(_tmem_load_6[state_col_group_2 * 8 + 1]);
                                    unsigned _stv8_6_2 = __float_as_uint(_tmem_load_6[state_col_group_2 * 8 + 2]);
                                    unsigned _stv8_6_3 = __float_as_uint(_tmem_load_6[state_col_group_2 * 8 + 3]);
                                    unsigned _stv8_6_4 = __float_as_uint(_tmem_load_6[state_col_group_2 * 8 + 4]);
                                    unsigned _stv8_6_5 = __float_as_uint(_tmem_load_6[state_col_group_2 * 8 + 5]);
                                    unsigned _stv8_6_6 = __float_as_uint(_tmem_load_6[state_col_group_2 * 8 + 6]);
                                    unsigned _stv8_6_7 = __float_as_uint(_tmem_load_6[state_col_group_2 * 8 + 7]);
                                    asm volatile(
                                        "st.global.v8.b32 [%0], {%1, %2, %3, %4, %5, %6, %7, %8};"
                                        :: "l"((void*)(final_state_f32 + (current_state_base + (long long)(state_col_block_2 * 32) + (long long)(state_col_group_2 * 8)) + (0))), "r"(_stv8_6_0), "r"(_stv8_6_1), "r"(_stv8_6_2), "r"(_stv8_6_3), "r"(_stv8_6_4), "r"(_stv8_6_5), "r"(_stv8_6_6), "r"(_stv8_6_7) : "memory");
                                }
                            }
                        }
                    }
            ...
            for (int global_chunk_idx_1 = 0; global_chunk_idx_1 < total_chunks_1; global_chunk_idx_1++) {
                ...
                if (PERSISTENT_MODE && (STORE_FINAL_STATE && chunk_idx_1 + 1 == num_chunks_1 && task_round_1 + 1 != persistent_tasks)) {
                    ...
                    for (int state_col_block_3 = 0; state_col_block_3 < 4; state_col_block_3++) {
                        ...
                        {
                            #pragma unroll
                            for (int state_col_group_3 = 0; state_col_group_3 < 4; state_col_group_3++) {
                                {
                                    unsigned _stv8_1_0 = __float_as_uint(_tmem_load_11[state_col_group_3 * 8 + 0]);
                                    unsigned _stv8_1_1 = __float_as_uint(_tmem_load_11[state_col_group_3 * 8 + 1]);
                                    unsigned _stv8_1_2 = __float_as_uint(_tmem_load_11[state_col_group_3 * 8 + 2]);
                                    unsigned _stv8_1_3 = __float_as_uint(_tmem_load_11[state_col_group_3 * 8 + 3]);
                                    unsigned _stv8_1_4 = __float_as_uint(_tmem_load_11[state_col_group_3 * 8 + 4]);
                                    unsigned _stv8_1_5 = __float_as_uint(_tmem_load_11[state_col_group_3 * 8 + 5]);
                                    unsigned _stv8_1_6 = __float_as_uint(_tmem_load_11[state_col_group_3 * 8 + 6]);
                                    unsigned _stv8_1_7 = __float_as_uint(_tmem_load_11[state_col_group_3 * 8 + 7]);
                                    asm volatile(
                                        "st.global.v8.b32 [%0], {%1, %2, %3, %4, %5, %6, %7, %8};"
                                        :: "l"((void*)(final_state_f32 + (state_base_1 + (long long)(state_col_block_3 * 32) + (long long)(state_col_group_3 * 8)) + (0))), "r"(_stv8_1_0), "r"(_stv8_1_1), "r"(_stv8_1_2), "r"(_stv8_1_3), "r"(_stv8_1_4), "r"(_stv8_1_5), "r"(_stv8_1_6), "r"(_stv8_1_7) : "memory");
                                }
                            }
                        }
                    }
                ...
                {
                    chunk_idx_1 += 1;
                    if (chunk_idx_1 == num_chunks_1) {
                        chunk_idx_1 = 0;
                        task_round_1 += 1;
                        task_idx_1 = blockIdx.x + task_round_1 * persistent_stride;
                        seq_idx_1 = task_idx_1 / num_heads;
                        head_idx_1 = task_idx_1 % num_heads;
                        bos_1 = (long long)seq_idx_1 * (long long)uniform_seq_len;
                        eos_1 = bos_1 + (long long)uniform_seq_len;
                    }
                }
            }
            if (epilogue_local_warp == 0) {
    ...
    // ---- Role: mma ----
        ...
        { // mma_main
            ...
            for (int _global_chunk_idx = 0; _global_chunk_idx < total_chunks_2; _global_chunk_idx++) {
                ...
                {
                    int _mma_b_lo_11 = make_warp_uniform(((((smem_kr_trans_addr) >> 4) & 0x3FFF) | 0x1000000) + (mma_stage) * 2560);
                    asm volatile(
                    "{\n\t"
                    ".reg .pred leader, p0, p1;\n\t"
                    ".reg .b32 dhi, blo, ta, id;\n\t"
                    ...
                    "@leader tcgen05.mma.cta_group::1.kind::f16 [%0], [ta], db, id, p1;\n\t"
                    "}\n"
                    :: "r"(tmem_tmem_state), "r"(_mma_b_lo_11), "r"(tmem_tmem_u2_inp), "r"(1));
                    elect_commit(state_ready_addr + (mma_stage) * 8);
                    int _mma_b_lo_12 = make_warp_uniform(((((smem_mqk_trans_addr) >> 4) & 0x3FFF) | 0x1000000) + (mma_stage) * 2560);
                    asm volatile(
                    "{\n\t"
                    ".reg .pred leader, p0, p1;\n\t"
                    ".reg .b32 dhi, blo, ta, id;\n\t"
                    ...
                    "@leader tcgen05.mma.cta_group::1.kind::f16 [%0], [ta], db, id, p1;\n\t"
                    "}\n"
                    :: "r"(tmem_tmem_out), "r"(_mma_b_lo_12), "r"(tmem_tmem_u2_inp), "r"(1));
    ...
    // ---- Role: load ----
        ...
        { // load_main
            ...
            for (int global_chunk_idx_2 = 0; global_chunk_idx_2 < total_chunks_3; global_chunk_idx_2++) {
                ...
                {
                    chunk_idx_2 += 1;
                    if (chunk_idx_2 == num_chunks_3) {
                        chunk_idx_2 = 0;
                        task_round_2 += 1;
                        task_idx_2 = blockIdx.x + task_round_2 * persistent_stride;
                        seq_idx_2 = task_idx_2 / num_heads;
                        head_idx_2 = task_idx_2 % num_heads;
                        bos_2 = (long long)seq_idx_2 * (long long)uniform_seq_len;
                        eos_2 = bos_2 + (long long)uniform_seq_len;
                    }
                }
            }
        }
    // ---- Role: prep ----
        ...
        { // prep_main
            ...
            for (int prep_iter = 0; prep_iter < num_prep_iters; prep_iter++) {
                ...
                {
                    if (task_round_3 != cached_task_round) {
                        float gate_rate_lane = 0.0f;
                        if (lane == 0) {
                            float _expf_1 = __expf(A_log[head_idx_3]);
                            gate_rate_lane = _expf_1;
                        }
                        float _shfl_1 = __shfl_sync(0xFFFFFFFF, gate_rate_lane, 0);
                        gate_rate_task_cached = _shfl_1;
                        if (prep_tid < 128) {
                            gate_bias_task_cached = dt_bias[head_idx_3 * 128 + prep_tid];
                        }
                        cached_task_round = task_round_3;
                    }
                    gate_rate_cached = gate_rate_task_cached;
                    gate_bias_cached = gate_bias_task_cached;
                }
                ...
                if (prep_tid < 128) {
                    ...
                    {
                        smem_restore_factor_all[stage_f32 + 144 + restore_publish_col] = restore_factor_value;
                    }
                }
                if (prep_tid == 0) {
                ...
                if (prep_local_warp >= 2) {
                    ...
                    {
                        int restore_copy = (lane >> 4) * 144;
                        float restore_factor_lo[4];
                        float restore_factor_hi[4];
                        asm volatile("ld.shared.v4.b32 {%0,%1,%2,%3}, [%4];"
                            : "=r"(*reinterpret_cast<uint32_t*>(&restore_factor_lo[0])), "=r"(*reinterpret_cast<uint32_t*>(&restore_factor_lo[(0) + 1])), "=r"(*reinterpret_cast<uint32_t*>(&restore_factor_lo[(0) + 2])), "=r"(*reinterpret_cast<uint32_t*>(&restore_factor_lo[(0) + 3]))
                            : "r"(smem_restore_factor_all_addr + (unsigned int)((stage_f32_0 + restore_copy + (restore_segment * 8 & 99 | restore_segment * 8 >> 1 & 12 | (restore_segment * 8 >> 1 ^ restore_segment * 8 << 2) & 16)) * 4)));
                        asm volatile("ld.shared.v4.b32 {%0,%1,%2,%3}, [%4];"
                            : "=r"(*reinterpret_cast<uint32_t*>(&restore_factor_hi[0])), "=r"(*reinterpret_cast<uint32_t*>(&restore_factor_hi[(0) + 1])), "=r"(*reinterpret_cast<uint32_t*>(&restore_factor_hi[(0) + 2])), "=r"(*reinterpret_cast<uint32_t*>(&restore_factor_hi[(0) + 3]))
                            : "r"(smem_restore_factor_all_addr + (unsigned int)((stage_f32_0 + restore_copy + (restore_segment * 8 + 4 & 99 | restore_segment * 8 + 4 >> 1 & 12 | (restore_segment * 8 + 4 >> 1 ^ restore_segment * 8 + 4 << 2) & 16)) * 4)));
                        #pragma unroll
                        for (int restore_elem = 0; restore_elem < 4; restore_elem++) {
                            restore_factor[restore_elem] = restore_factor_lo[restore_elem];
                            restore_factor[restore_elem + 4] = restore_factor_hi[restore_elem];
                        }
                    }
                    #pragma unroll 1
                    ...
                    {
                        int restore_copy_1 = (lane >> 4) * 144;
                        float restore_factor_lo_1[4];
                        float restore_factor_hi_1[4];
                        asm volatile("ld.shared.v4.b32 {%0,%1,%2,%3}, [%4];"
                            : "=r"(*reinterpret_cast<uint32_t*>(&restore_factor_lo_1[0])), "=r"(*reinterpret_cast<uint32_t*>(&restore_factor_lo_1[(0) + 1])), "=r"(*reinterpret_cast<uint32_t*>(&restore_factor_lo_1[(0) + 2])), "=r"(*reinterpret_cast<uint32_t*>(&restore_factor_lo_1[(0) + 3]))
                            : "r"(smem_restore_factor_all_addr + (unsigned int)((stage_f32_0_1 + restore_copy_1 + (restore_segment_1 * 8 & 99 | restore_segment_1 * 8 >> 1 & 12 | (restore_segment_1 * 8 >> 1 ^ restore_segment_1 * 8 << 2) & 16)) * 4)));
                        asm volatile("ld.shared.v4.b32 {%0,%1,%2,%3}, [%4];"
                            : "=r"(*reinterpret_cast<uint32_t*>(&restore_factor_hi_1[0])), "=r"(*reinterpret_cast<uint32_t*>(&restore_factor_hi_1[(0) + 1])), "=r"(*reinterpret_cast<uint32_t*>(&restore_factor_hi_1[(0) + 2])), "=r"(*reinterpret_cast<uint32_t*>(&restore_factor_hi_1[(0) + 3]))
                            : "r"(smem_restore_factor_all_addr + (unsigned int)((stage_f32_0_1 + restore_copy_1 + (restore_segment_1 * 8 + 4 & 99 | restore_segment_1 * 8 + 4 >> 1 & 12 | (restore_segment_1 * 8 + 4 >> 1 ^ restore_segment_1 * 8 + 4 << 2) & 16)) * 4)));
                        #pragma unroll
                        for (int restore_elem_2 = 0; restore_elem_2 < 4; restore_elem_2++) {
                            restore_factor_1[restore_elem_2] = restore_factor_lo_1[restore_elem_2];
                            restore_factor_1[restore_elem_2 + 4] = restore_factor_hi_1[restore_elem_2];
                        }
                    }
                    #pragma unroll 1
                ...
                if (prep_local_warp == 0) {
                    ...
                    {
                        int restore_copy_2 = (lane >> 4) * 144;
                        float restore_factor_lo_2[4];
                        float restore_factor_hi_2[4];
                        asm volatile("ld.shared.v4.b32 {%0,%1,%2,%3}, [%4];"
                            : "=r"(*reinterpret_cast<uint32_t*>(&restore_factor_lo_2[0])), "=r"(*reinterpret_cast<uint32_t*>(&restore_factor_lo_2[(0) + 1])), "=r"(*reinterpret_cast<uint32_t*>(&restore_factor_lo_2[(0) + 2])), "=r"(*reinterpret_cast<uint32_t*>(&restore_factor_lo_2[(0) + 3]))
                            : "r"(smem_restore_factor_all_addr + (unsigned int)((stage_f32_0_2 + restore_copy_2 + (restore_segment_2 * 8 & 99 | restore_segment_2 * 8 >> 1 & 12 | (restore_segment_2 * 8 >> 1 ^ restore_segment_2 * 8 << 2) & 16)) * 4)));
                        asm volatile("ld.shared.v4.b32 {%0,%1,%2,%3}, [%4];"
                            : "=r"(*reinterpret_cast<uint32_t*>(&restore_factor_hi_2[0])), "=r"(*reinterpret_cast<uint32_t*>(&restore_factor_hi_2[(0) + 1])), "=r"(*reinterpret_cast<uint32_t*>(&restore_factor_hi_2[(0) + 2])), "=r"(*reinterpret_cast<uint32_t*>(&restore_factor_hi_2[(0) + 3]))
                            : "r"(smem_restore_factor_all_addr + (unsigned int)((stage_f32_0_2 + restore_copy_2 + (restore_segment_2 * 8 + 4 & 99 | restore_segment_2 * 8 + 4 >> 1 & 12 | (restore_segment_2 * 8 + 4 >> 1 ^ restore_segment_2 * 8 + 4 << 2) & 16)) * 4)));
                        #pragma unroll
                        for (int restore_elem_4 = 0; restore_elem_4 < 4; restore_elem_4++) {
                            restore_factor_2[restore_elem_4] = restore_factor_lo_2[restore_elem_4];
                            restore_factor_2[restore_elem_4 + 4] = restore_factor_hi_2[restore_elem_4];
                        }
                    }
                    #pragma unroll 1
                ...
                {
                    chunk_idx_3 += 5;
                    if (chunk_idx_3 >= num_chunks_4) {
                        chunk_idx_3 -= num_chunks_4;
                        task_round_3 += 1;
                        task_idx_3 = blockIdx.x + task_round_3 * persistent_stride;
                        seq_idx_3 = task_idx_3 / num_heads;
                        head_idx_3 = task_idx_3 % num_heads;
                        bos_3 = (long long)seq_idx_3 * (long long)uniform_seq_len;
                        eos_3 = bos_3 + (long long)uniform_seq_len;
                    }
                }
            }
        }
