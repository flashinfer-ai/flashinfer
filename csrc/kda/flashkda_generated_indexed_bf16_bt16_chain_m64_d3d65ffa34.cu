...
kernel_flashkda_bf16_bt16_chain_m64(__nv_bfloat16* __restrict__ ws_qd, CudaTensorMap const* ws_qd_tma, __nv_bfloat16* __restrict__ ws_kd, CudaTensorMap const* ws_kd_tma, __nv_bfloat16* __restrict__ ws_w, CudaTensorMap const* ws_w_tma, __nv_bfloat16* __restrict__ ws_qk, CudaTensorMap const* ws_qk_tma, float* __restrict__ ws_diag, CudaTensorMap const* ws_diag_tma, __nv_bfloat16* __restrict__ v, CudaTensorMap const* v_tma, long long* __restrict__ cu_seqlens, int* __restrict__ cu_chunks, int* __restrict__ seq_order, __nv_bfloat16* __restrict__ initial_state, __nv_bfloat16* __restrict__ out, CudaTensorMap const* out_tma, __nv_bfloat16* __restrict__ final_state, int num_heads, int use_initial_state, int store_final_state, float scale, unsigned long long state_indices_addr, long long state_slot_stride, int use_state_indices, float* __restrict__ initial_state_f32, float* __restrict__ final_state_f32)
{
