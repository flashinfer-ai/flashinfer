...
kernel_cake_fused_kda_decode_compact_async_pr_eval_h96_f32(__nv_bfloat16* __restrict__ x, float* __restrict__ weight, __nv_bfloat16* __restrict__ conv_state, __nv_bfloat16* __restrict__ raw_gate, __nv_bfloat16* __restrict__ raw_beta, float* __restrict__ A_log, float* __restrict__ dt_bias, int* __restrict__ state_indices, float* __restrict__ state, __nv_bfloat16* __restrict__ output_gate, float* __restrict__ norm_weight, __nv_bfloat16* __restrict__ output, int x_row_stride, int conv_slot_stride, int beta_row_stride, int state_slot_stride, int output_gate_row_stride, int H, int use_lower_bound, float lower_bound_log2, float norm_eps)
{
    ...
    if (tid_0 < 96) {
        ...
        int conv_base = slot * 3256320 + channel_base;
        #pragma unroll
        ...
        int x_base = row * 36881 + channel_base;
        #pragma unroll
    ...
    if (tid_0 >= 128) {
        ...
        decay_log2 = -7.213475204444817f * (_tanh_approx_4 * 0.5f + 0.5f);
        int gate_smem_idx = k_idx + k_idx / 8 * 4;
        float _exp2_0 = approx_exp2(decay_log2);
        sGateDecay[gate_smem_idx] = _exp2_0;
        float output_gate_value = (float)output_gate[row * 12295 + head * 128 + k_idx];
    ...
    for (int local_row = 0; local_row < 4; local_row++) {
        {
            ...
            asm volatile("ld.global.L1::no_allocate.v8.b32 {%0, %1, %2, %3, %4, %5, %6, %7}, [%8];"
                : "=r"(_ldv8_2_0), "=r"(_ldv8_2_1), "=r"(_ldv8_2_2), "=r"(_ldv8_2_3), "=r"(_ldv8_2_4), "=r"(_ldv8_2_5), "=r"(_ldv8_2_6), "=r"(_ldv8_2_7) : "l"((const void*)(state + (state_group_base + local_row * 128))) : "memory");
    ...
    for (int local_row_1 = 0; local_row_1 < 4; local_row_1++) {
        ...
        asm volatile("cp.async.ca.shared::cta.global [%0], [%1], 16;"
            :: "r"(sAsyncState_addr + (unsigned int)(async_state_elem * 4)), "l"(state + (async_state_src_base + local_row_1 * 128)));
        asm volatile("cp.async.ca.shared::cta.global [%0], [%1], 16;"
            :: "r"(sAsyncState_addr + (unsigned int)(async_state_elem * 4) + 16), "l"(state + (async_state_src_base + local_row_1 * 128 + 4)));
    }
            ...
            if (is_live != 0) {
                {
                    ...
                    asm volatile(
                        ...
                        :: "l"((void*)(state + (state_tile_base + local_row_a * 128))), "r"(_stv8_3_0), "r"(_stv8_3_1), "r"(_stv8_3_2), "r"(_stv8_3_3), "r"(_stv8_3_4), "r"(_stv8_3_5), "r"(_stv8_3_6), "r"(_stv8_3_7) : "memory");
                }
                {
                    ...
                    asm volatile(
                        "st.global.v8.b32 [%0], {%1, %2, %3, %4, %5, %6, %7, %8};"
                        :: "l"((void*)(state + (state_tile_base + local_row_b * 128))), "r"(_stv8_4_0), "r"(_stv8_4_1), "r"(_stv8_4_2), "r"(_stv8_4_3), "r"(_stv8_4_4), "r"(_stv8_4_5), "r"(_stv8_4_6), "r"(_stv8_4_7) : "memory");
                }
            }
    ...
    if (warp == 0) {
        ...
        float _rsqrt_2 = rsqrtf(sum_squares * 0.0078125f + 1e-05f);
