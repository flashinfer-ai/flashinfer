...
kernel_flashkda_bf16_bt16_chain_m64(__nv_bfloat16* __restrict__ ws_qd, FlashKDATensorMap const* ws_qd_tma, __nv_bfloat16* __restrict__ ws_kd, FlashKDATensorMap const* ws_kd_tma, __nv_bfloat16* __restrict__ ws_w, FlashKDATensorMap const* ws_w_tma, __nv_bfloat16* __restrict__ ws_qk, FlashKDATensorMap const* ws_qk_tma, float* __restrict__ ws_diag, FlashKDATensorMap const* ws_diag_tma, __nv_bfloat16* __restrict__ v, FlashKDATensorMap const* v_tma, long long* __restrict__ cu_seqlens, int* __restrict__ cu_chunks, int* __restrict__ seq_order, __nv_bfloat16* __restrict__ initial_state, __nv_bfloat16* __restrict__ out, FlashKDATensorMap const* out_tma, __nv_bfloat16* __restrict__ final_state, int num_heads, int use_initial_state, int store_final_state, float scale, unsigned long long state_indices_addr, long long state_slot_stride, int use_state_indices, float* __restrict__ initial_state_f32, float* __restrict__ final_state_f32)
{
        ...
        { // compute_left_main
            ...
            if (store_final_state != 0) {
                ...
                for (int state_col_group_2 = 0; state_col_group_2 < 8; state_col_group_2++) {
                    ...
                    {
                        {
                            float2 _v2 = make_float2(_tmem_load_1[state_reg_base_2 + 0], _tmem_load_1[state_reg_base_2 + 1]);
                            *reinterpret_cast<float2*>(final_state_f32 + (state_base_top + (long long)state_col_pair_2) + 0) = _v2;
                        }
                        {
                            float2 _v2 = make_float2(_tmem_load_1[state_reg_base_2 + 2 + 0], _tmem_load_1[state_reg_base_2 + 2 + 1]);
                            *reinterpret_cast<float2*>(final_state_f32 + (state_base_bot + (long long)state_col_pair_2) + 0) = _v2;
                        }
                    }
                }
            }
            ...
            for (int state_col_half = 1; state_col_half < 2; state_col_half++) {
                ...
                if (use_initial_state != 0) {
                    ...
                    for (int state_col_group_3 = 0; state_col_group_3 < 8; state_col_group_3++) {
                        ...
                        {
                            {
                                float2 _v2_0 = *reinterpret_cast<const float2*>(initial_state_f32 + state_base_top_1 + (long long)state_col_pair_3);
                                state_init_1[state_reg_base_3] = _v2_0.x;
                                state_init_1[state_reg_base_3 + 1] = _v2_0.y;
                            }
                            {
                                float2 _v2_1 = *reinterpret_cast<const float2*>(initial_state_f32 + state_base_bot_1 + (long long)state_col_pair_3);
                                state_init_1[state_reg_base_3 + 2] = _v2_1.x;
                                state_init_1[state_reg_base_3 + 2 + 1] = _v2_1.y;
                            }
                        }
                    }
                }
            ...
            if (store_final_state != 0) {
                ...
                for (int state_col_half_1 = 1; state_col_half_1 < 2; state_col_half_1++) {
                    ...
                    for (int state_col_group_5 = 0; state_col_group_5 < 8; state_col_group_5++) {
                        ...
                        {
                            {
                                float2 _v2 = make_float2(_tmem_load_4[state_reg_base_5 + 0], _tmem_load_4[state_reg_base_5 + 1]);
                                *reinterpret_cast<float2*>(final_state_f32 + (state_base_top_1 + (long long)state_col_pair_5) + 0) = _v2;
                            }
                            {
                                float2 _v2 = make_float2(_tmem_load_4[state_reg_base_5 + 2 + 0], _tmem_load_4[state_reg_base_5 + 2 + 1]);
                                *reinterpret_cast<float2*>(final_state_f32 + (state_base_bot_1 + (long long)state_col_pair_5) + 0) = _v2;
                            }
                        }
                    }
                }
