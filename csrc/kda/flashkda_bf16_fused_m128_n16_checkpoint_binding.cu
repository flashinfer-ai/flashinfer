...
#define FlashKDATensorMap flashkda_checkpoint_generated_FlashKDATensorMap
#define FlashKDATensorMapPack flashkda_checkpoint_generated_FlashKDATensorMapPack
...
static_assert(SMEM_TOTAL == 183296);
...
void RunM128N16Checkpoint(TensorView q, TensorView k, TensorView v, TensorView g, TensorView beta,
  ...
  kernel_flashkda_bf16_fused_m128<<<grid, block, kSmemBytes, stream>>>(
      ...
      reinterpret_cast<flashkda_checkpoint_generated_FlashKDATensorMap const*>(tma.q),
      reinterpret_cast<__nv_bfloat16*>(k.data_ptr()),
      reinterpret_cast<flashkda_checkpoint_generated_FlashKDATensorMap const*>(tma.k),
      reinterpret_cast<__nv_bfloat16*>(v.data_ptr()),
      reinterpret_cast<flashkda_checkpoint_generated_FlashKDATensorMap const*>(tma.v),
      reinterpret_cast<__nv_bfloat16*>(g.data_ptr()),
      reinterpret_cast<flashkda_checkpoint_generated_FlashKDATensorMap const*>(tma.g),
      reinterpret_cast<__nv_bfloat16*>(beta.data_ptr()),
      reinterpret_cast<flashkda_checkpoint_generated_FlashKDATensorMap const*>(tma.beta),
      ...
      reinterpret_cast<flashkda_checkpoint_generated_FlashKDATensorMap const*>(tma.out),
      ...
      reinterpret_cast<flashkda_checkpoint_generated_FlashKDATensorMap const*>(
