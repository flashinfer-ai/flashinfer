...
kernel_cake_fused_kda_decode_compact_async_positive_f32_wide_slot_offsets(__nv_bfloat16* __restrict__ x, float* __restrict__ weight, __nv_bfloat16* __restrict__ conv_state, __nv_bfloat16* __restrict__ raw_gate, __nv_bfloat16* __restrict__ raw_beta, float* __restrict__ A_log, float* __restrict__ dt_bias, int* __restrict__ state_indices, float* __restrict__ state, __nv_bfloat16* __restrict__ output_gate, float* __restrict__ norm_weight, __nv_bfloat16* __restrict__ output, int x_row_stride, int conv_slot_stride, int beta_row_stride, int state_slot_stride, int output_gate_row_stride, int H, int use_lower_bound, float lower_bound_log2, float norm_eps)
{
    ...
    long long async_state_src_base = state_group_base + 8192;
    #pragma unroll
    for (int local_row_1 = 0; local_row_1 < 4; local_row_1++) {
        ...
        asm volatile("cp.async.ca.shared::cta.global [%0], [%1], 16;"
            :: "r"(sAsyncState_addr + (unsigned int)(async_state_elem * 4)), "l"(state + (async_state_src_base + (long long)(local_row_1 * 128))));
        asm volatile("cp.async.ca.shared::cta.global [%0], [%1], 16;"
            :: "r"(sAsyncState_addr + (unsigned int)(async_state_elem * 4) + 16), "l"(state + (async_state_src_base + (long long)(local_row_1 * 128) + 4)));
    }
    ...
    for (int value_tile = 0; value_tile < 2; value_tile++) {
        ...
        if (value_tile > 0) {
            ...
            for (int local_row_2 = 0; local_row_2 < 4; local_row_2++) {
                ...
                asm volatile("ld.shared.v4.b32 {%0,%1,%2,%3}, [%4];"
                    ...
                    : "r"(sAsyncState_addr + (unsigned int)(async_state_elem_1 * 4)));
                asm volatile("ld.shared.v4.b32 {%0,%1,%2,%3}, [%4];"
                    ...
                    : "r"(sAsyncState_addr + (unsigned int)(async_state_elem_1 * 4) + 16));
            }
        }
        #pragma unroll
        for (int row_group = 0; row_group < 4 / ((0) ? 4 : 2); row_group++) {
            ...
            if (is_live != 0) {
                {
                    unsigned _stv8_3_0 = __float_as_uint(state_regs[local_row_a * 8 + 0]);
                    unsigned _stv8_3_1 = __float_as_uint(state_regs[local_row_a * 8 + 1]);
                    unsigned _stv8_3_2 = __float_as_uint(state_regs[local_row_a * 8 + 2]);
                    unsigned _stv8_3_3 = __float_as_uint(state_regs[local_row_a * 8 + 3]);
                    unsigned _stv8_3_4 = __float_as_uint(state_regs[local_row_a * 8 + 4]);
                    unsigned _stv8_3_5 = __float_as_uint(state_regs[local_row_a * 8 + 5]);
                    unsigned _stv8_3_6 = __float_as_uint(state_regs[local_row_a * 8 + 6]);
                    unsigned _stv8_3_7 = __float_as_uint(state_regs[local_row_a * 8 + 7]);
                    asm volatile(
                        "st.global.v8.b32 [%0], {%1, %2, %3, %4, %5, %6, %7, %8};"
                        :: "l"((void*)(state + (state_tile_base + (long long)(local_row_a * 128)))), "r"(_stv8_3_0), "r"(_stv8_3_1), "r"(_stv8_3_2), "r"(_stv8_3_3), "r"(_stv8_3_4), "r"(_stv8_3_5), "r"(_stv8_3_6), "r"(_stv8_3_7) : "memory");
                }
                {
                    unsigned _stv8_4_0 = __float_as_uint(state_regs[local_row_b * 8 + 0]);
                    unsigned _stv8_4_1 = __float_as_uint(state_regs[local_row_b * 8 + 1]);
                    unsigned _stv8_4_2 = __float_as_uint(state_regs[local_row_b * 8 + 2]);
                    unsigned _stv8_4_3 = __float_as_uint(state_regs[local_row_b * 8 + 3]);
                    unsigned _stv8_4_4 = __float_as_uint(state_regs[local_row_b * 8 + 4]);
                    unsigned _stv8_4_5 = __float_as_uint(state_regs[local_row_b * 8 + 5]);
                    unsigned _stv8_4_6 = __float_as_uint(state_regs[local_row_b * 8 + 6]);
                    unsigned _stv8_4_7 = __float_as_uint(state_regs[local_row_b * 8 + 7]);
                    asm volatile(
                        "st.global.v8.b32 [%0], {%1, %2, %3, %4, %5, %6, %7, %8};"
                        :: "l"((void*)(state + (state_tile_base + (long long)(local_row_b * 128)))), "r"(_stv8_4_0), "r"(_stv8_4_1), "r"(_stv8_4_2), "r"(_stv8_4_3), "r"(_stv8_4_4), "r"(_stv8_4_5), "r"(_stv8_4_6), "r"(_stv8_4_7) : "memory");
                }
            }
