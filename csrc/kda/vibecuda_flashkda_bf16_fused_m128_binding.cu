// VibeCUDA binding TU for the generated FlashKDA M128 prefill kernel
// (vibecuda_flashkda_bf16_fused_m128.cu). Plain C++ launcher; grid, block,
// dynamic shared memory, and kernel argument order match the M128 prefill
// schedule.
//
