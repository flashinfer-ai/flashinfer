...
kernel_cake_kda_serving_small_bh_m128_fp32(__nv_bfloat16* __restrict__ q, CakeTensorMap const* q_tma, __nv_bfloat16* __restrict__ k, CakeTensorMap const* k_tma, __nv_bfloat16* __restrict__ v, CakeTensorMap const* v_tma, __nv_bfloat16* __restrict__ g, CakeTensorMap const* g_tma, __nv_bfloat16* __restrict__ beta, CakeTensorMap const* beta_tma, float* __restrict__ A_log, float* __restrict__ dt_bias, long long* __restrict__ cu_seqlens, int* __restrict__ seq_order, __nv_bfloat16* __restrict__ initial_state, __nv_bfloat16* __restrict__ out, CakeTensorMap const* out_tma, __nv_bfloat16* __restrict__ final_state, int num_heads, int use_initial_state, int store_final_state, float scale, float lower_bound, unsigned long long state_indices_addr, unsigned long long state_checkpoints_addr, unsigned long long checkpoint_cu_starts_addr, long long beta_token_stride, long long state_slot_stride, int use_state_indices, int checkpoint_every_n_tokens, CakeTensorMap const* packet_workspace, unsigned int* __restrict__ packet_ready, unsigned int* __restrict__ packet_consumed, unsigned int* __restrict__ helper_done, float* __restrict__ initial_state_f32, float* __restrict__ final_state_f32)
{
        ...
        { // compute_main
                        ...
                        for (int state_vec = 0; state_vec < 4; state_vec++) {
                            {
                                ...
                                asm volatile(
                                    ...
                                    : "=r"(_ldv8_0_0), "=r"(_ldv8_0_1), "=r"(_ldv8_0_2), "=r"(_ldv8_0_3), "=r"(_ldv8_0_4), "=r"(_ldv8_0_5), "=r"(_ldv8_0_6), "=r"(_ldv8_0_7) : "l"((const void*)(initial_state_f32 + (state_base + (long long)(state_col_block * 32) + (long long)(state_vec * 8)))) : "memory");
                                state_frag[state_vec * 8 + 0] = __uint_as_float(_ldv8_0_0);
                                state_frag[state_vec * 8 + 1] = __uint_as_float(_ldv8_0_1);
                                state_frag[state_vec * 8 + 2] = __uint_as_float(_ldv8_0_2);
                                state_frag[state_vec * 8 + 3] = __uint_as_float(_ldv8_0_3);
                                state_frag[state_vec * 8 + 4] = __uint_as_float(_ldv8_0_4);
                                state_frag[state_vec * 8 + 5] = __uint_as_float(_ldv8_0_5);
                                state_frag[state_vec * 8 + 6] = __uint_as_float(_ldv8_0_6);
                                state_frag[state_vec * 8 + 7] = __uint_as_float(_ldv8_0_7);
                            }
                        }
                    }
                }
            ...
            if (group_rank == 0 && store_final_state != 0) {
                ...
                for (int state_col_block_4 = 0; state_col_block_4 < 4; state_col_block_4++) {
                    ...
                    {
                        #pragma unroll
                        for (int state_vec_1 = 0; state_vec_1 < 4; state_vec_1++) {
                            {
                                unsigned _stv8_1_0 = __float_as_uint(_tmem_load_5[state_vec_1 * 8 + 0]);
                                unsigned _stv8_1_1 = __float_as_uint(_tmem_load_5[state_vec_1 * 8 + 1]);
                                unsigned _stv8_1_2 = __float_as_uint(_tmem_load_5[state_vec_1 * 8 + 2]);
                                unsigned _stv8_1_3 = __float_as_uint(_tmem_load_5[state_vec_1 * 8 + 3]);
                                unsigned _stv8_1_4 = __float_as_uint(_tmem_load_5[state_vec_1 * 8 + 4]);
                                unsigned _stv8_1_5 = __float_as_uint(_tmem_load_5[state_vec_1 * 8 + 5]);
                                unsigned _stv8_1_6 = __float_as_uint(_tmem_load_5[state_vec_1 * 8 + 6]);
                                unsigned _stv8_1_7 = __float_as_uint(_tmem_load_5[state_vec_1 * 8 + 7]);
                                asm volatile(
                                    "st.global.v8.b32 [%0], {%1, %2, %3, %4, %5, %6, %7, %8};"
                                    :: "l"((void*)(final_state_f32 + (state_base + (long long)(state_col_block_4 * 32) + (long long)(state_vec_1 * 8)) + (0))), "r"(_stv8_1_0), "r"(_stv8_1_1), "r"(_stv8_1_2), "r"(_stv8_1_3), "r"(_stv8_1_4), "r"(_stv8_1_5), "r"(_stv8_1_6), "r"(_stv8_1_7) : "memory");
                            }
                        }
                    }
                }
        ...
        { // prep_main
            ...
            for (int prep_iter = 0; prep_iter < num_prep_iters; prep_iter++) {
                ...
                if (prep_local_warp == 0) {
                    if (elect_sync()) {
                        {
                            unsigned int* _gc_p = reinterpret_cast<unsigned int*>(packet_ready) + (packet_slot);
            ...
            if (group_rank_3 != 0) {
                ...
                if (prep_all_tid == 0) {
                    {
                        unsigned int* _gc_p = reinterpret_cast<unsigned int*>(helper_done) + (task_idx_3);
                        unsigned int _gc_old;
                        asm volatile("atom.release.gpu.global.add.u32 %0, [%1], 1;" : "=r"(_gc_old) : "l"(_gc_p) : "memory");
                    }
                }
                ...
                for (int owner_iter = 0; owner_iter < owner_iters; owner_iter++) {
                    ...
                    if (prep_local_warp == 0) {
                        if (elect_sync()) {
                            ...
                            {
                                unsigned int* _gc_p = reinterpret_cast<unsigned int*>(packet_consumed) + (owner_packet_slot);
                                unsigned int _gc_old;
                                asm volatile("atom.release.gpu.global.add.u32 %0, [%1], 1;" : "=r"(_gc_old) : "l"(_gc_p) : "memory");
                            }
                        }
