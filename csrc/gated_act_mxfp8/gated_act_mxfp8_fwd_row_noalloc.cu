...
kernel_gated_act_mxfp8_fwd_row_direct_128x64_noalloc(__nv_bfloat16* __restrict__ gated_input, const __grid_constant__ CUtensorMap row_output_tma, uint8_t* __restrict__ row_scales, int M, int K)
{
