...
__global__ __launch_bounds__(288, 4) void kernel_cake_selective_state_update_stp_bf16_persistent(
    ...
    int total_head_tiles, int dt_softplus, int has_z, int disable_state_update) {
