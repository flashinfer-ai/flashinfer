...
__global__ __launch_bounds__(128, 8) void kernel_cake_selective_state_update_mtp_short(
...
#pragma unroll
    for (int pair_base = 0; pair_base < 2; pair_base += 2) {
      ...
      float2 _f2_1 = make_float2(dt_value_0 * (float)s_x[pair_base * 128 + dim_index],
                                 dt_value_0 * (float)s_x[pair_base * 128 + dim_index]);
...
#pragma unroll
      ...
      float2 _projection_pair_4_2_11 =
          fma_f32x2(_state_pair_4_2_10, _f2_45, _projection_pair_4_1_7);
...
#pragma unroll
      ...
      float2 _projection_pair_0_3_13 =
          fma_f32x2(_state_pair_0_3_12, _f2_48, _projection_pair_0_2_9);
...
#pragma unroll
      ...
      float2 _projection_pair_4_3_15 =
          fma_f32x2(_state_pair_4_3_14, _f2_51, _projection_pair_4_2_11);
      state_values[30] = _state_pair_4_3_14.x;
      state_values[31] = _state_pair_4_3_14.y;
      float _shfl_down_0 =
          __shfl_down_sync(0xFFFFFFFF,
                           _projection_pair_0_3_13.x + _projection_pair_0_3_13.y +
                               (_projection_pair_4_3_15.x + _projection_pair_4_3_15.y),
                           2, 4);
      float _shfl_down_1 = __shfl_down_sync(
          0xFFFFFFFF,
          _projection_pair_0_3_13.x + _projection_pair_0_3_13.y +
              (_projection_pair_4_3_15.x + _projection_pair_4_3_15.y) + _shfl_down_0,
          1, 4);
      if (member == 0) {
        int output_index = ((token_base + pair_base) * nheads + head) * dim + dim_index;
        output[output_index] = _projection_pair_0_3_13.x + _projection_pair_0_3_13.y +
                               (_projection_pair_4_3_15.x + _projection_pair_4_3_15.y) +
                               _shfl_down_0 + _shfl_down_1 +
                               d_value * (float)s_x[pair_base * 128 + dim_index];
      }
        ...
        if (source_slot != pad_slot_id) {
              ...
              (unsigned long long)publication_row_offset_i32;
          {
            ...
            *reinterpret_cast<uint4*>(&(
                (__nv_bfloat16*)(state))[(unsigned long long)source_slot * state_stride_slot +
                                         publication_row_offset + (unsigned long long)(member * 8) +
                                         0]) = *reinterpret_cast<uint4*>(&_pk[0]);
          }
          {
            __nv_bfloat162 _pk[4];
            ...
            *reinterpret_cast<uint4*>(
                &((__nv_bfloat16*)(state))[(unsigned long long)source_slot * state_stride_slot +
                                           publication_row_offset +
                                           (unsigned long long)(32 + member * 8) + 0]) =
          ...
          }
          {
            ...
            *reinterpret_cast<uint4*>(
                &((__nv_bfloat16*)(state))[(unsigned long long)source_slot * state_stride_slot +
                                           publication_row_offset +
                                           (unsigned long long)(64 + member * 8) + 0]) =
                *reinterpret_cast<uint4*>(&_pk[0]);
          }
          {
            __nv_bfloat162 _pk[4];
            ...
            *reinterpret_cast<uint4*>(
                &((__nv_bfloat16*)(state))[(unsigned long long)source_slot * state_stride_slot +
                                           publication_row_offset +
                                           (unsigned long long)(96 + member * 8) + 0]) =
                *reinterpret_cast<uint4*>(&_pk[0]);
          }
        }
      }
      if (pair_base + 1 < token_steps) {
        ...
        float2 _f2_53 = make_float2(dt_value_1 * (float)s_x[(pair_base + 1) * 128 + dim_index],
                                    dt_value_1 * (float)s_x[(pair_base + 1) * 128 + dim_index]);
...
#pragma unroll
        ...
        float2 _projection_pair_0_1_6 =
            fma_f32x2(_state_pair_0_1_5, _f2_64, _projection_pair_0_0_2);
...
#pragma unroll
        ...
        float2 _projection_pair_4_1_8 =
            fma_f32x2(_state_pair_4_1_7, _f2_67, _projection_pair_4_0_4);
...
#pragma unroll
        ...
        float2 _projection_pair_0_2_10 =
            fma_f32x2(_state_pair_0_2_9, _f2_70, _projection_pair_0_1_6);
...
#pragma unroll
        ...
        float2 _projection_pair_4_2_12 =
            fma_f32x2(_state_pair_4_2_11, _f2_73, _projection_pair_4_1_8);
...
#pragma unroll
        ...
        float2 _projection_pair_0_3_14 =
            fma_f32x2(_state_pair_0_3_13, _f2_76, _projection_pair_0_2_10);
...
#pragma unroll
        ...
        float2 _projection_pair_4_3_16 =
            fma_f32x2(_state_pair_4_3_15, _f2_79, _projection_pair_4_2_12);
...
#pragma unroll
        ...
        float2 _projection_pair_0_0_18 =
            fma_f32x2(_state_pair_0_0_17, _f2_82, _projection_pair_0_3_14);
...
#pragma unroll
        ...
        float2 _projection_pair_4_0_20 =
            fma_f32x2(_state_pair_4_0_19, _f2_85, _projection_pair_4_3_16);
...
#pragma unroll
        ...
        float2 _projection_pair_0_1_22 =
            fma_f32x2(_state_pair_0_1_21, _f2_88, _projection_pair_0_0_18);
...
#pragma unroll
        ...
        float2 _projection_pair_4_1_24 =
            fma_f32x2(_state_pair_4_1_23, _f2_91, _projection_pair_4_0_20);
...
#pragma unroll
        ...
        float2 _projection_pair_0_2_26 =
            fma_f32x2(_state_pair_0_2_25, _f2_94, _projection_pair_0_1_22);
...
#pragma unroll
        ...
        float2 _projection_pair_4_2_28 =
            fma_f32x2(_state_pair_4_2_27, _f2_97, _projection_pair_4_1_24);
...
#pragma unroll
        ...
        float2 _projection_pair_0_3_30 =
            fma_f32x2(_state_pair_0_3_29, _f2_100, _projection_pair_0_2_26);
...
#pragma unroll
        ...
        float2 _projection_pair_4_3_32 =
            fma_f32x2(_state_pair_4_3_31, _f2_103, _projection_pair_4_2_28);
        state_values[30] = _state_pair_4_3_31.x;
        state_values[31] = _state_pair_4_3_31.y;
        float _shfl_down_2 =
            __shfl_down_sync(0xFFFFFFFF,
                             _projection_pair_0_3_30.x + _projection_pair_0_3_30.y +
                                 (_projection_pair_4_3_32.x + _projection_pair_4_3_32.y),
                             2, 4);
        float _shfl_down_3 = __shfl_down_sync(
            0xFFFFFFFF,
            _projection_pair_0_3_30.x + _projection_pair_0_3_30.y +
                (_projection_pair_4_3_32.x + _projection_pair_4_3_32.y) + _shfl_down_2,
            1, 4);
        if (member == 0) {
          int output_index_1 = ((token_base + pair_base + 1) * nheads + head) * dim + dim_index;
          output[output_index_1] = _projection_pair_0_3_30.x + _projection_pair_0_3_30.y +
                                   (_projection_pair_4_3_32.x + _projection_pair_4_3_32.y) +
                                   _shfl_down_2 + _shfl_down_3 +
                                   d_value * (float)s_x[(pair_base + 1) * 128 + dim_index];
        }
        if (source_slot != pad_slot_id) {
              ...
              (unsigned long long)publication_row_offset_i32_1;
          {
            ...
            *reinterpret_cast<uint4*>(
                &((__nv_bfloat16*)(state))[(unsigned long long)source_slot * state_stride_slot +
                                           publication_row_offset_1 +
                                           (unsigned long long)(member * 8) + 0]) =
                *reinterpret_cast<uint4*>(&_pk[0]);
          }
          {
            __nv_bfloat162 _pk[4];
