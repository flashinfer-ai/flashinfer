...
// tvm-ffi host launcher for Cake kernel
// 'kernel_cake_selective_state_update_stp_bf16_ratio8_saturated'.
#include <cuda.h>
...
TVM_FFI_EMBED_CUBIN(cake_selective_state_update_stp_bf16_ratio8_saturated_6caa473c10);
