...
TVM_FFI_EMBED_CUBIN(cake_selective_state_update_dynamic_checkpoint3_a1482464e7);
...
void Run(TensorView arg_state, TensorView arg_x, TensorView arg_dt, TensorView arg_A,
  ...
  static auto kernel =
      TVM_FFI_EMBED_CUBIN_GET_KERNEL(cake_selective_state_update_dynamic_checkpoint3_a1482464e7,
