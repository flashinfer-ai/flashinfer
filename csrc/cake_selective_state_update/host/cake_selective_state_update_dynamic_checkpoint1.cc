...
// tvm-ffi host launcher for Cake kernel 'kernel_cake_selective_state_update_dynamic_checkpoint1'.
#include <cuda.h>
...
TVM_FFI_EMBED_CUBIN(cake_selective_state_update_dynamic_checkpoint1_36de5e4ac0);
...
void Run(TensorView arg_state, TensorView arg_x, TensorView arg_dt, TensorView arg_A,
         ...
         TensorView arg_dst_state_batch_indices, int64_t arg_batch_size, int64_t arg_token_steps,
         int64_t arg_previous_tokens, int64_t arg_state_stride_slot, int64_t arg_pad_slot_id,
  ...
  TVM_FFI_CHECK(arg_token_steps >= -2147483648LL && arg_token_steps <= 2147483647LL, ValueError)
      ...
      << " is outside i32 range [-2147483648, 2147483647]";
  TVM_FFI_CHECK(arg_previous_tokens >= -2147483648LL && arg_previous_tokens <= 2147483647LL,
                ValueError)
  ...
  static auto kernel =
      TVM_FFI_EMBED_CUBIN_GET_KERNEL(cake_selective_state_update_dynamic_checkpoint1_36de5e4ac0,
                                     "kernel_cake_selective_state_update_dynamic_checkpoint1");
