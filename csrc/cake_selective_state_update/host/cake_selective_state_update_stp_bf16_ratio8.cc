...
TVM_FFI_EMBED_CUBIN(cake_selective_state_update_stp_bf16_ratio8_2b01869233);
...
inline CUtensorMap EncodeTma_state_tma(const TensorView& t) {
  ...
  TVM_FFI_CHECK(
      32u <= global_dim[0] && 128u <= global_dim[1] && 1u <= global_dim[2] && 1u <= global_dim[3],
      ValueError)
...
void Run(TensorView arg_state_tma, TensorView arg_x, TensorView arg_dt, TensorView arg_A,
         TensorView arg_B, TensorView arg_C, TensorView arg_D, TensorView arg_z,
         TensorView arg_dt_bias, TensorView arg_output, TensorView arg_state_batch_indices,
         TensorView arg_dst_state_batch_indices, int64_t arg_nheads, int64_t arg_ngroups,
         int64_t arg_head_tiles, int64_t arg_dt_softplus, int64_t arg_has_z,
         int64_t arg_disable_state_update, int64_t grid_x, int64_t grid_y, int64_t grid_z) {
  ...
  TVM_FFI_CHECK(
      arg_disable_state_update >= -2147483648LL && arg_disable_state_update <= 2147483647LL,
      ValueError)
  ...
  CheckSameCudaDevice(arg_dst_state_batch_indices, arg_state_tma, "dst_state_batch_indices",
                      "state_tma");
  ...
  void* kargs[] = {&p_state_tma,
                   ...
                   &v_dt_softplus,
                   &v_has_z,
                   &v_disable_state_update};

  static auto kernel =
      TVM_FFI_EMBED_CUBIN_GET_KERNEL(cake_selective_state_update_stp_bf16_ratio8_2b01869233,
                                     "kernel_cake_selective_state_update_stp_bf16_ratio8");
