...
TVM_FFI_EMBED_CUBIN(cake_selective_state_update_stp_bf16_direct_7f536ad937);
...
void Run(TensorView arg_state_tma, TensorView arg_x, TensorView arg_dt, TensorView arg_A,
  ...
  static auto kernel =
      TVM_FFI_EMBED_CUBIN_GET_KERNEL(cake_selective_state_update_stp_bf16_direct_7f536ad937,
                                     "kernel_cake_selective_state_update_stp_bf16_direct");
