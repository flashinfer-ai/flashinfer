...
TVM_FFI_EMBED_CUBIN(cake_selective_state_update_dynamic_checkpoint7_b2c8658514);
...
void Run(TensorView arg_state, TensorView arg_x, TensorView arg_dt, TensorView arg_A,
  ...
  static auto kernel =
      TVM_FFI_EMBED_CUBIN_GET_KERNEL(cake_selective_state_update_dynamic_checkpoint7_b2c8658514,
                                     "kernel_cake_selective_state_update_dynamic_checkpoint7");
