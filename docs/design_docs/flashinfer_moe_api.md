...
| `cudnn` | `CudnnMoeConfig` | `BF16×BF16` | `SwiGLU`, `SiTU`, `GeGLU`, `GeGLUTanh`, `SwiGLUStep` |
| `cudnn_fp8_per_tensor` | `CudnnFp8PerTensorConfig` | `FP8PerTensor×FP8PerTensor` | `SwiGLU`, `SiTU`, `GeGLU`, `GeGLUTanh`, `SwiGLUStep` |
