...
def prepare_mega_mhc(*, x, residual, post_mix, comb_res_mix, shifted_prev_mix,
    ...
    return MegaMHCPlan(x=x, residual=residual, post_mix=post_mix, comb_res_mix=comb_res_mix,
        shifted_prev_mix=shifted_prev_mix, fn=fn, mix_scales=mix_scales, mix_bases=mix_bases,
        rmsnorm_weight=rmsnorm_weight, hc_mult=hc_mult, hc_norm_eps=hc_norm_eps,
        hc_pre_eps=hc_pre_eps, hc_post_scale=hc_post_scale, sinkhorn_eps=sinkhorn_eps,
        num_sinkhorn_iters=num_sinkhorn_iters, rmsnorm_eps=rmsnorm_eps, rmsnorm_scale=rmsnorm_scale,
        sf_layout=sf_layout, shared_sf_block_m=shared_sf_block_m, out=out, deterministic=deterministic,
        scratch=scratch, split_barriers=split_barriers, launch_epochs=launch_epochs,
