...
from .jit.glm5_moe import gen_glm5_low_latency_moe_module
...
def gen_all_modules(
    ...
    if add_moe:
        ...
        if has_sm100 or has_sm103:
            ...
            # GLM5 low-latency block-FP8 MoE (SM100-family, TP4/TP8).
            jit_specs.append(gen_glm5_low_latency_moe_module())
        if has_sm103:
