...
def prepare_fp8_fp4_gemm(a,b,a_scales,b_scales,*,m,out=None,block_n=128,gran_k_a=32,
    ...
    return MixedGemmPlan(a,b,a_scales,b_scales,m=m,out=out,block_n=block_n,gran_k_a=gran_k_a,
        variant=variant,descriptor_workspace=descriptor_workspace)
