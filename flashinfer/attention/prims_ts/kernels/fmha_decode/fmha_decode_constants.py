...
# Conservative per-CTA budget for CGA distributed-SMEM reduction leader
...
CGA_PARTIAL_SMEM_LIMIT_KIB = 96
MAX_CGA_PARTIAL_SMEM_BYTES = CGA_PARTIAL_SMEM_LIMIT_KIB * BYTES_PER_KIB

# Fused GMEM/CGA partial O is staged in 16-bit elements, and each row's stats
...
# Hardware CGA clusterDim.x limit for this decode reduction layout.
MAX_CGA_CLUSTER_DIM_X = 16
