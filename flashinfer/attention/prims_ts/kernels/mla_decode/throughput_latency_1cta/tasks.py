...
def create_throughput_latency_scheduler_task(
    ...
    **kw,
    ...
    captured_schedule = (
        ...
        else scheduler_schedule(work_queue, work_id_throttle)
    )
    src = [work_queue]
    if work_id_throttle is not None:
        src.append(work_id_throttle)
    return task_class(
        src_resources=src,
