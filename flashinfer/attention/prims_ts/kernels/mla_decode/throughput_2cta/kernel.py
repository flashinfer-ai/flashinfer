...
class MlaDecodeTs:
    ...
    def __init__(
        ...
        skip_correction_threshold : float, optional
            Reserved for future use: threshold below which the softmax correction
            step can be skipped. Not yet implemented for the TS kernel.
        ...
        if skip_correction_threshold != 0.0:
            raise NotImplementedError(
                "skip_correction_threshold is not implemented for TS MLA decode"
            )
    ...
    def initialize_workspace(
        ...
        if cutlass.const_expr(workspace is not None):
            ...
            acc_lse_iter = cute.recast_ptr(
                workspace.iterator
                + cute.cosize(acc_o_layout) * (cutlass.BFloat16.width // 8),
