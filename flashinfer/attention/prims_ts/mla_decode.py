...
class BatchMLADecodePagedTSWrapper:
    ...
    def plan(
        ...
        *,
        ...
        offsets to validate their nonnegative deltas and fixed final total.
        Individual packed requests may be empty. If a Q or K/V bound is omitted,
        the corresponding metadata maximum becomes the exact static plan bound;
        an all-empty packed plan requires an explicit positive
        ``max_seq_len_q``. An explicit bound may be larger but is still checked
        ...
        offsets must start at zero, be nondecreasing, end at the runtime
