...
def gen_mqa_histogram_module() -> JitSpec:
    ...
    return gen_jit_spec(
        ...
        [
            ...
            jit_env.FLASHINFER_CSRC_DIR / "dsv3_ops" / "fast_topk_clusters.cu",
            jit_env.FLASHINFER_CSRC_DIR / "dsv3_ops" / "fast_topk_clusters_exact.cu",
            jit_env.FLASHINFER_CSRC_DIR
            / "dsv3_ops"
            / "flashinfer_mqa_histogram_binding.cu",
        ],
