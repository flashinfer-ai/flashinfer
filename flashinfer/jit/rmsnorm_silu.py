...
_KNOB_RANGE_LUT_SM90 = {
    # C=48
    (48, 0, 1372007, "bf16"): (32, 0, 0, 2, 4),
    (48, 1372007, 2**31, "bf16"): (32, 0, 0, 2, 4),
    # C=96
    (96, 0, 322194, "bf16"): (4, 0, 1, 16, 2),
    (96, 322194, 490559, "bf16"): (8, 0, 1, 8, 2),
    (96, 490559, 822692, "bf16"): (8, 0, 1, 8, 2),
    ...
    (192, 18565, 42875, "bf16"): (8, 0, 1, 16, 4),
    (192, 42875, 86719, "bf16"): (8, 0, 1, 16, 4),
...
# secondary lookup when `_KNOB_LUT` does not have an exact entry — the exact
# LUT continues to take priority for the LLM shapes it was tuned on.
...
_KNOB_RANGE_LUT_SM100PLUS = {
    # C=48
    (48, 0, 1372007, "bf16"): (4, 0, 0, 16, 4),
    (48, 1372007, 2**31, "bf16"): (4, 0, 0, 16, 4),
    # C=96
    (96, 0, 322194, "bf16"): (32, 0, 1, 2, 2),
    (96, 322194, 490559, "bf16"): (32, 0, 1, 2, 2),
    (96, 490559, 822692, "bf16"): (32, 0, 1, 2, 2),
    (96, 822692, 2**31, "bf16"): (32, 0, 1, 2, 2),
    # C=192
    (192, 0, 2489, "bf16"): (32, 0, 0, 1, 2),
    ...
    (384, 10718, 26255, "bf16"): (32, 0, 0, 1, 4),
    (384, 26255, 2**31, "bf16"): (32, 0, 0, 1, 4),
}
