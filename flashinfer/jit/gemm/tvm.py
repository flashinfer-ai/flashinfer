...
def gen_grouped_gemm_fp8_tvm_binding(
    ...
    tvm_binding_src = jit_env.FLASHINFER_TVM_BINDING_DIR / "grouped_gemm_fp8_jit_tvm_binding.cu"
...
def get_grouped_gemm_fp8_uri(
    ...
    return (f"group_gemm_fp8_{dtype_a_str}_{dtype_b_str}_{dtype_out_str}_"
