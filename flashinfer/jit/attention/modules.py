...
def gen_trtllm_fmha_v2_module() -> JitSpec:
    ...
    binding_path = temp_dir / "trtllm_fmha_v2_binding.cu"
    ...
    # Source paths
    source_paths = kernel_paths + [binding_path]
