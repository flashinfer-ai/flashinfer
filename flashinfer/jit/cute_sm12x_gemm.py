...
def gen_gemm_sm120_module_cute() -> JitSpec:
    ...
    """
    csrc_dir = jit_env.FLASHINFER_CSRC_DIR / "cute_sm12x_gemm"
    source_paths = [
        csrc_dir / "cute_sm12x_mxfp8_runner.cu",
        csrc_dir / "cute_sm12x_mxfp8_op.cu",
        csrc_dir / "cute_sm12x_mxfp8_op_jit_binding.cu",
        csrc_dir / "cute_sm12x_fp8_runner.cu",
        csrc_dir / "cute_sm12x_fp8_op.cu",
        csrc_dir / "cute_sm12x_fp8_op_jit_binding.cu",
    ]
