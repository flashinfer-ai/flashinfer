...
MODULES: dict[str, dict[str, Any]] = {
    ...
    "cake_kimi_k3_mla_fp8_paged_attention_11658d29da8d74e847ed": {
        "arch": "sm_100a",
        "role": "kernel",
        "sources": [
            "cake_kimi_k3_mla/sm_100a/cake_kimi_k3_mla_fp8_paged_attention_11658d29da8d74e847ed_kernel.cu",
            "cake_kimi_k3_mla/sm_100a/cake_kimi_k3_mla_fp8_paged_attention_11658d29da8d74e847ed_binding.cu",
        ],
        "compile_flags": ["--use_fast_math"],
        "ffi_entry": "run",
        "arg_plan": [
        ...
        "closure_sha256": "9881fa84a4e6b696011ba5f785b4ade5e639fdbb18f220d9da631dded4ab7684",
        "tma_workspace_bytes": 0,
    },
...
ROUTES: dict[str, dict[str, Any]] = {
    ...
    "main_wide__sm_100a": {
        "arch": "sm_100a",
        "kind": "main_wide",
        "module": "cake_kimi_k3_mla_fp8_paged_attention_11658d29da8d74e847ed",
    },
    "main_wide__sm_103a": {
        "arch": "sm_103a",
        "kind": "main_wide",
