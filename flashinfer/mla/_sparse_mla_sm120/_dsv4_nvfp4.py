...
def _nvfp4_sparse_mla_m16n32k64(
    ...
    *,
    ...
    get_sparse_mla_dsv4_nvfp4_module().sparse_mla_sm120_nvfp4_m16n32k64(
...
def _nvfp4_sparse_mla_m16n8k64_candidate_major(
    ...
    *,
    ...
    get_sparse_mla_dsv4_nvfp4_module().sparse_mla_sm120_nvfp4_m16n8k64_candidate_major(
        a, b, sfa, sfb, output, iterations
    )
    return output
...
def _nvfp4_sparse_mla_decode(
    ...
    *,
    ...
    mid_out = torch.empty(
        (num_tokens, num_heads, num_splits, dsv4_nvfp4_format_info()["query_dim"]),
