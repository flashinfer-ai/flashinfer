...
def trtllm_batch_decode_sparse_mla_dsv4(
    ...
    *,
    ...
    kv_cache_format : {"fp8", "nvfp4"}
        ...
        NVFP4 currently supports 16/32/64/128 heads, any primary top-k >= 1
        (128 and 512 are the calibrated widths), primary page size 64, and
        optional extra-cache page size 2 or 64.
    """
