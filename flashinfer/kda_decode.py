...
This file preserves the public recurrent KDA decode API. Eligible ordinary
multi-token prefill calls are dispatched to the frozen backend implemented in
``flashinfer.kda_prefill``; decode and speculative decode retain the
CuTe-DSL backend under ``flashinfer.kda_kernels``.
"""
