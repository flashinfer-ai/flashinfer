...
"""FlashInfer flashinfer solution for mla_rope_quantize_fp8."""

from flashinfer.rope import mla_rope_quantize_fp8 as _api
from flashinfer.trace.solutions._helpers import solution_autotune

definition = "mla_rope_quantize_fp8"
api = "flashinfer.rope.mla_rope_quantize_fp8"
backend = "flashinfer"
inputs = (
    "q_rope",
    "k_rope",
