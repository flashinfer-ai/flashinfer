    ...
    inputs.update(
        {
            ...
            "seq_lens_kv": Tensor(
                ...
                optional=True,
                description=(
                    "Optional live per-request logical K/V lengths read for this call; "
                    "omission selects the static maximum for every request."
                ),
            ),
        }
    )
        ...
        constraints=[
            *(
            ...
            (
                ...
                "(seq_len_q if mask_type == 'causal' else 1)"
            ),
