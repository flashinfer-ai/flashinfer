...
def gen_sparse_combine_module() -> JitSpec:
    """JIT module generator for the split-KV combine kernel (SM120/SM121)."""
    nvcc_flags = current_compilation_context.get_nvcc_flags_list(
        supported_major_versions=[12]
    )

    return gen_jit_spec(
        "msa_ops_sparse_combine",
        sources=[_MSA_CSRC_DIR / "sparse_combine.cu"],
