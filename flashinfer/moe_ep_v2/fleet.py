...
:class:`flashinfer.moe_ep_v2.Handle` instances created by
:meth:`Fleet.create_handle`.

Backends register themselves in :data:`_BACKEND_REGISTRY` at import time
(see :mod:`flashinfer.moe_ep_v2.split.nccl_ep` and
:mod:`flashinfer.moe_ep_v2.split.nixl_ep`).
...
def create_fleet(
    ...
    from :mod:`flashinfer.moe_ep_v2.split.backends`).
    """
