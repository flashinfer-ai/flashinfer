...
``flashinfer.moe_ep_v2``) if the lib staging is incomplete.
"""
...
if not any(_libs_dir.glob("nixl_ep_cpp*.so")):
    _libs_dir = _pkg_dir.parent.parent.parent / "moe_ep" / "nixl_ep" / "_libs"
