...
class TorchSymmetricMemoryAllReduceFusionWorksWorkspace(AllReduceFusionWorkspace):
    """Torch Symmetric Memory workspace for AllReduce fusion."""
    ...
    def __init__(self,
        ...
        """
        Create Torch Symmetric Memory AllReduce fusion workspace.
        ...
        self.workspace_tensor = torch.empty(0, dtype=dtype, device=torch.device("cuda"))
