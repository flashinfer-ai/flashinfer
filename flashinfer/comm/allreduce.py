...
def allreduce_fusion(
    ...
    **Note on Workspace Reusability:**
    ...
    Args:
        ...
        pattern: Fusion pattern (AllReduceFusionPattern constant, 0-11)
                 - kAllReduce = 0
                 ...
                 and dynamic FP8 patterns (10-11). MoE and packed group quant
        ...
        scale_out: Quantization scale factors. Dynamic FP8 uses shape
                   [token_num, 1] and dtype torch.float32. NVFP4 uses the
                   layout selected by layout_code. Per-tensor FP8 does not use
                   scale_out.
