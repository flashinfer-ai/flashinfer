...
class ArtifactPath:
    ...
    TRTLLM_GEN_BMM: str = "bd3ad8a50eaa71ea88e02749304131de57936a83/60363289/batched_gemm-20ac5a5-ab74c5b/"
    TRTLLM_GEN_GEMM: str = (
...
class CheckSumHash:
    ...
    TRTLLM_GEN_BMM: str = (
        "d6087919d4797b3a602079d6983229215f5a67b82abdf6bf21771ce4668eb7a9"
    )
