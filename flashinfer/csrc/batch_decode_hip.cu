            ...
            DISPATCH_GQA_GROUP_SIZE(num_qo_heads / num_kv_heads, GROUP_SIZE, {
                auto work_estimation_func =
                    BatchDecodeWithPagedKVCacheWorkEstimationDispatched<
                        GROUP_SIZE, HEAD_DIM_QK, POS_ENCODING_MODE,
                        AttentionVariant, Params>;
                hipError_t status = DecodePlan<HEAD_DIM_QK, POS_ENCODING_MODE,
                                               AttentionVariant, Params>(
                    ...
                    static_cast<IdType *>(indptr.data_ptr()), batch_size,
    ...
    DISPATCH_context(
        ...
        AttentionVariant, Params, [&] {
            ...
            if (plan_info.split_kv) {
                tmp_v = GetPtrFromBaseOffset<DTypeO>(float_buffer,
                                                     plan_info.v_offset);
                tmp_s = GetPtrFromBaseOffset<float>(float_buffer,
                                                    plan_info.s_offset);
