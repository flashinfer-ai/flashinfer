...
def fp8_gemm_sm100(
    ...
    is_sm120 = _match_sm_version(a.device, "120")
    is_sm121 = _match_sm_version(a.device, "121")
    ...
    if "cutlass" in runner_names and not is_e5m2:
        ...
        elif (is_sm120 or is_sm121) and k_dim >= 128:
            # SM120/SM121 blockwise scaling requires k >= 128
            runners.append(get_gemm_sm120_module_cutlass_fp8().cutlass_fp8_gemm_runner())
        # Note: No CUTLASS support for SM120/SM121 with k < 128 due to hardware limitations
