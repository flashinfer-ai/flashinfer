...
def gen_gemm_module() -> JitSpec:
    return gen_jit_spec(
        ...
        [
            ...
            jit_env.FLASHINFER_CSRC_DIR / "flashinfer_gemm_bindings.cu",
        ],
...
def gen_gemm_sm100_module() -> JitSpec:
    ...
    for filename in [
        ...
        "gemm_sm100_bindings.cu",
        "group_gemm_sm100_bindings.cu",
    ]:
...
def gen_gemm_sm120_module() -> JitSpec:
    ...
    for filename in [
        ...
        "gemm_sm120_bindings.cu",
        "group_gemm_sm120_bindings.cu",
    ]:
        src_path = jit_env.FLASHINFER_CSRC_DIR / filename
        dest_path = gen_directory / filename
        source_paths.append(dest_path)
...
def gen_gemm_sm90_module() -> JitSpec:
    ...
    for filename in [
        "group_gemm_sm90.cu",
        "flashinfer_gemm_sm90_bindings.cu",
    ]:
        src_path = jit_env.FLASHINFER_CSRC_DIR / filename
        dest_path = gen_directory / filename
        source_paths.append(dest_path)
