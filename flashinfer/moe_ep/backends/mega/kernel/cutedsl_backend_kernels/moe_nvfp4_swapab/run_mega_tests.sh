...
declare -a TESTS=(
    ...
    "M03_mr_balanced_topk3_dual_sa   | multi  | --num_tokens_per_rank 256  --num_topk 3  --num_total_experts 24  --hidden 1568 --intermediate 2112 --enable_static_expert_shape --load_balance_mode atomic_counter --token_back_mode standalone_warps"
    ...
    "M05_mr_balanced_topk7           | multi  | --num_tokens_per_rank 448  --num_topk 7  --num_total_experts 56  --hidden 2048 --intermediate 2368 --enable_static_expert_shape --use_bulk_fc2_store"
    ...
    "M07_mr_power_law_topk3_dual_sa  | multi  | --num_tokens_per_rank 320  --num_topk 3  --num_total_experts 24  --hidden 1632 --intermediate 1728 --enable_static_expert_shape --route_distribution power_law --token_back_mode standalone_warps"
    "M08_mr_power_law_topk7_dual_ru  | multi  | --num_tokens_per_rank 640  --num_topk 7  --num_total_experts 56  --hidden 1440 --intermediate 1920 --enable_static_expert_shape --route_distribution power_law --load_balance_mode atomic_counter --ref_compute_graph transformers --token_back_mode reuse_dispatch_warps"
    ...
    "M11_mr_large_topk11_aligned_clamp_ru | multi | --num_tokens_per_rank 1792 --num_topk 11 --num_total_experts 88  --hidden 2944 --intermediate 4096 --enable_static_expert_shape --load_balance_mode atomic_counter --gate_up_clamp 10 --token_back_mode reuse_dispatch_warps"
    ...
    "M13_mr_T256_clm2_pl_topk7_dual_ru | multi  | --num_tokens_per_rank 896  --num_topk 7  --num_total_experts 56  --hidden 2272 --intermediate 2624 --enable_static_expert_shape --mma_tiler_mnk 256,256,256 --cluster_shape_mnk 2,1,1 --use_2cta_instrs --route_distribution power_law --token_back_mode reuse_dispatch_warps"
    "M14_mr_T256_clm2_balanced_topk13_sa | multi  | --num_tokens_per_rank 1280 --num_topk 13 --num_total_experts 104 --hidden 2816 --intermediate 4288 --enable_static_expert_shape --mma_tiler_mnk 256,256,256 --cluster_shape_mnk 2,1,1 --use_2cta_instrs --load_balance_mode atomic_counter --ref_compute_graph transformers --gate_up_clamp 10 --token_back_mode standalone_warps"
    ...
    "M20_mr_balanced_wide_intermed   | multi  | --num_tokens_per_rank 64   --num_topk 3  --num_total_experts 24  --hidden 1792 --intermediate 4928 --enable_static_expert_shape --load_balance_mode atomic_counter --use_bulk_fc2_store --ref_compute_graph transformers --gate_up_clamp 11"
    ...
    "M26_mr_tbstandalone_atomic3_powerlaw      | multi  | --num_tokens_per_rank 1024 --num_topk 5 --num_total_experts 72 --hidden 6176 --intermediate 6080 --enable_static_expert_shape --mma_tiler_mnk 256,256,256 --cluster_shape_mnk 2,1,1 --use_2cta_instrs --route_distribution power_law --load_balance_mode atomic_counter --flag_batch 8 --epi_flag_batch 2,4 --token_back_mode standalone_warps | MEGA_TOKEN_BACK_ATOMIC_BATCH=3"
