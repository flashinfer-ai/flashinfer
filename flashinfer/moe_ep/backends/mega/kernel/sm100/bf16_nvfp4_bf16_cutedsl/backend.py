"""CuTeDSL mixed NVFP4-weight/BF16-activation MegaMoE backend."""
...
from ......core.runtime import bf16_nvfp4_cutedsl_runtime_requirements
from ......core.validation.common import (
    validate_bf16_nvfp4_cutedsl_cuda,
    validate_mega_arch,
...
def _clamp(config: Sm100_Bf16_Nvfp4_Bf16_Cutedsl_MegaMoeConfig) -> float | None:
    return (
...
class Bf16Nvfp4CutedslMegaKernelBackend(MegaKernelBackend):
    ...
    def runtime_requirements(self, bootstrap: BootstrapConfig) -> frozenset[str]:
        return bf16_nvfp4_cutedsl_runtime_requirements(bootstrap)
    ...
    def validate_init(
        ...
        if self._kernel_config.intermediate_size % 64:
            raise ValueError(
                "Mixed BF16 x NVFP4 MegaMoE requires intermediate size divisible by 64."
            )
