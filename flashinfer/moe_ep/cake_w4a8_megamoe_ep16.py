...
class CakeW4A8MegaMoeEp16Weights:
...
@flashinfer_experimental_api(feature="Cake W4A8 MegaMoE EP16 preprocessing")
def preprocess_cake_w4a8_megamoe_ep16_weights(
    weights: MoEWeightPack,
) -> CakeW4A8MegaMoeEp16Weights:
    ...
    """
    from ..experimental.cake_w4a8_megamoe_ep16.backend import preprocess_weights

    return preprocess_weights(weights)


@flashinfer_experimental_api(feature="Cake W4A8 MegaMoE EP16")
def CakeW4A8MegaMoeEp16(
    weights: CakeW4A8MegaMoeEp16Weights,
    ...
    *,
    ...
    """
    from ..experimental.cake_w4a8_megamoe_ep16.backend import Session
