...
"""K3 reduction for the opt-in owner-local BF16 combine path.

K2 writes one BF16 partial per source token and expert-owner rank.  K3 waits
only for owners selected by the current route, widens those partials to FP32,
sums them in ascending owner order, and returns BF16.  This intentionally adds
one BF16 rounding point relative to the ordinary top-k-slot reduction.
"""
