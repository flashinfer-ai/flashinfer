...
class Sm120SwapABNvfp4Fc12WorkTileInfo(MoEWorkTileInfo):
    ...
    ) -> "Sm120SwapABNvfp4Fc12WorkTileInfo":
    ...
    @classmethod
    def from_rmem(cls, rmem: cute.Tensor) -> "Sm120SwapABNvfp4Fc12WorkTileInfo":
        return cls(
...
class Sm120SwapABNvfp4Fc12SchedExtension(MoESchedExtension):
    """Sched extension for the fused fc1+fc2 swap-AB SwiGLU MXFP8 kernel.

    ``WorkTileInfo = Sm120SwapABNvfp4Fc12WorkTileInfo``.  The 8th slot stores
    ...
    WorkTileInfo = Sm120SwapABNvfp4Fc12WorkTileInfo
    ...
    def __new_from_mlir_values__(
        self, values: List[ir.Value]
    ) -> "Sm120SwapABNvfp4Fc12SchedExtension":
        ...
        assert idx == len(values), (
            f"Sm120SwapABNvfp4Fc12SchedExtension serialization mismatch: "
            f"idx={idx} len(values)={len(values)}"
        )
        result = Sm120SwapABNvfp4Fc12SchedExtension.__new__(
            Sm120SwapABNvfp4Fc12SchedExtension
        )
    ...
    def enrich_work_tile_info(
        self,
        base_work: Sm120SwapABNvfp4Fc12WorkTileInfo,
    ) -> Sm120SwapABNvfp4Fc12WorkTileInfo:
        ...
        return Sm120SwapABNvfp4Fc12WorkTileInfo(
    ...
    def get_gmem_tensor(
        ...
        work_tile_info: Sm120SwapABNvfp4Fc12WorkTileInfo,
