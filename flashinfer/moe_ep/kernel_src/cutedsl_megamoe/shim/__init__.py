...
def _check_dsl_perf_floor() -> None:
    ...
    if parts and parts < (4, 5, 2):
        ...
        _warnings.warn(
            ...
            "Install nvidia-cutlass-dsl[cu13]>=4.6.1 (or ==4.5.2, covered by "
            "the MR!27 WAR) — see kernel_src/cutedsl_megamoe/TUNING.md "
            "'CuTe-DSL runtime sensitivity'. Silence with "
