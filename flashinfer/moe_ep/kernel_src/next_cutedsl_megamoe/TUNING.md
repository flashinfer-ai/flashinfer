...
| Tokens/rank | Avg latency (us) | Min-max (us) | TFLOP/s | Upstream (us) | Delta (ours/upstream) | Knobs |
|---|---|---|---|---|---|---|
| 1K | 218.83 | 215.62-226.11 | 3,709.5 | 372.22 | -41.21% (0.59x) | tile 256x128x256; hint 4; epi 1x4; tif 1 |
| 2K | 290.53 | 286.02-300.00 | 5,588.0 | 410.48 | -29.22% (0.71x) | tile 256x256x256; hint 3; epi 2x4; tif 1 |
| 4K | 454.13 | 445.09-461.06 | 7,149.9 | 529.56 | -14.24% (0.86x) | tile 256x256x256; hint 3; epi 2x4; tif 1 |
| 8K | 802.92 | 798.46-807.23 | 8,087.9 | 800.48 | +0.31% (1.00x) | tile 256x256x256; hint 3; epi 1x4; tif 1 |
| 16K | 1,504.68 | 1,496.13-1,510.98 | 8,631.7 | 1,484.16 | +1.38% (1.01x) | tile 256x256x256; hint 3; epi 1x4; tif 1 |
| 32K | 3,014.84 | 3,003.90-3,026.98 | 8,616.0 | 2,960.92 | +1.82% (1.02x) | tile 256x256x256; hint 3; epi 1x4; tif 1 |

#### NVFP4, power-law routing (alpha=0.8)

| Tokens/rank | Avg latency (us) | Min-max (us) | Upstream (us) | Delta (ours/upstream) | Knobs |
|---|---|---|---|---|---|
| 1K | 315.28 | 311.68-321.89 | 399.75 | -21.13% (0.79x) | tile 256x128x256; hint 3; epi 1x4; tif 1 |
| 2K | 378.97 | 373.79-387.55 | 474.56 | -20.14% (0.80x) | tile 256x256x256; hint 3; epi 1x4; tif 1 |
| 4K | 532.55 | 525.98-537.28 | 621.76 | -14.35% (0.86x) | tile 256x256x256; hint 4; epi 1x4; tif 1 |
| 8K | 1,255.96 | 1,247.71-1,265.28 | 1,053.01 | +19.27% (1.19x) | tile 256x256x256; hint 3; epi 1x4; tif 1 |
| 16K | 2,040.66 | 2,019.62-2,056.86 | 2,081.84 | -1.98% (0.98x) | tile 256x256x256; hint 3; epi 1x4; tif 4 |
| 32K | 4,497.98 | 4,466.43-4,606.08 | 4,023.79 | +11.78% (1.12x) | tile 256x256x256; hint 3; epi 1x4; tif 4 |
