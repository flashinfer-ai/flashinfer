...
def _resolve_mxfp4_split_fc1_store_overlap(
    ...
    *,
    ...
    """Resolve the split-K1 store-overlap implementation.

    The configured selector is harmless to the peer split-K2 object (and to
    every FP8/fused object) constructed in the same process. Once it reaches
    the intended MXFP4 split-K1 path, unsupported geometry and conflicting
    PR357 chunk overrides fail closed.
    """
