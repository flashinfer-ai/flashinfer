...
cudaError_t configure_w4a8_kernel_variant(int opt_in_smem, W4A8KernelResources* bf16_resources,
  ...
  constexpr size_t kSmemBytes =
      w4a8_smem_bytes<BlockM, BlockN, GroupSize, Scheme, PipelineStages>();
  constexpr int kThreads = W4A8LaunchTraits<BlockM, BlockN, PipelineStages>::kThreads;
  auto bf16_kernel = grouped_w4a8_bf16_kernel<BlockM, BlockN, GroupSize, Scheme, PipelineStages>;
  auto fp32_kernel =
      grouped_w4a8_fp32_debug_kernel<BlockM, BlockN, GroupSize, Scheme, PipelineStages>;
...
W4A8KernelVariant make_w4a8_kernel_variant() {
  ...
  return W4A8KernelVariant{
      ...
      Traits::kConsumerRegisterCap,
      Traits::kRegisterFootprintTarget,
      w4a8_smem_bytes<BlockM, BlockN, GroupSize, Scheme, PipelineStages>(),
      &configure_w4a8_kernel_variant<BlockM, BlockN, GroupSize, Scheme, PipelineStages>,
      &launch_w4a8_kernel_variant<BlockM, BlockN, GroupSize, Scheme, PipelineStages>,
  };
}

template <int BlockM, int BlockN, int GroupSize, ResidualScheme Scheme>
W4A8KernelVariant make_w4a8_alternate_kernel_variant() {
  return make_w4a8_kernel_variant<BlockM, BlockN, GroupSize, Scheme,
                                  alternate_w4a8_pipeline_stages<BlockM>()>();
}
...
#define FLASHINFER_SM90_W4A8_ALTERNATE_ACCESSOR_NAME_IMPL(BlockM, BlockN) \
  get_w4a8_m##BlockM##_n##BlockN##_alternate_stage_variants
#define FLASHINFER_SM90_W4A8_ALTERNATE_ACCESSOR_NAME(BlockM, BlockN) \
  FLASHINFER_SM90_W4A8_ALTERNATE_ACCESSOR_NAME_IMPL(BlockM, BlockN)
...
#define FLASHINFER_SM90_W4A8_DEFINE_MN_VARIANTS(BlockM, BlockN)                                   \
  ...
  const W4A8KernelVariant* FLASHINFER_SM90_W4A8_ACCESSOR_NAME(BlockM, BlockN)() {                 \
    static const W4A8KernelVariant variants[kW4A8VariantsPerMN] = {                               \
        detail::make_w4a8_kernel_variant<BlockM, BlockN, 32, ResidualScheme::kGeneric,            \
                                         default_w4a8_pipeline_stages<BlockM>()>(),               \
  ...
  const W4A8KernelVariant* FLASHINFER_SM90_W4A8_ALTERNATE_ACCESSOR_NAME(BlockM, BlockN)() {       \
    static const W4A8KernelVariant variants[kW4A8VariantsPerMN] = {                               \
        detail::make_w4a8_alternate_kernel_variant<BlockM, BlockN, 32,                            \
                                                   ResidualScheme::kGeneric>(),                   \
        detail::make_w4a8_alternate_kernel_variant<BlockM, BlockN, 64,                            \
                                                   ResidualScheme::kGeneric>(),                   \
        detail::make_w4a8_alternate_kernel_variant<BlockM, BlockN, 128,                           \
                                                   ResidualScheme::kGeneric>(),                   \
        detail::make_w4a8_alternate_kernel_variant<BlockM, BlockN, 32, ResidualScheme::kPow2>(),  \
        detail::make_w4a8_alternate_kernel_variant<BlockM, BlockN, 64, ResidualScheme::kPow2>(),  \
        detail::make_w4a8_alternate_kernel_variant<BlockM, BlockN, 128, ResidualScheme::kPow2>(), \
    };                                                                                            \
    return variants;                                                                              \
  }                                                                                               \
  }                                                                                               \
