...
The private FP8 and NVFP4 W4A8 grouped-GEMM implementations build on the
DeepGEMM execution model and TensorRT-LLM CUDA support code shipped in FlashInfer's
