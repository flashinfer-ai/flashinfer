                        ...
                        if row_active and row < group_end:
                            for j in cutlass.range_constexpr(subtile_w // vsize):
                                ...
                                if col_j + vsize <= N:
                                    ...
                                    _e_x2 = _c_2_a
                                    _e_erf2 = cute.math.erf(_e_x2 * cutlass.full_like(_e_x2, cutlass.Float32(0.7071067811865475)))
                                    _op_2 = cutlass.full_like(_e_x2, cutlass.Float32(0.5)) * _e_x2 * (cutlass.full_like(_e_x2, cutlass.Float32(1.0)) + _e_erf2)
                                    _c_3_a = (_op_2).to(cutlass.Float32)
                                    _c_3_b = (_op_1).to(cutlass.Float32)
                                    _op_3 = _c_3_a * _c_3_b
