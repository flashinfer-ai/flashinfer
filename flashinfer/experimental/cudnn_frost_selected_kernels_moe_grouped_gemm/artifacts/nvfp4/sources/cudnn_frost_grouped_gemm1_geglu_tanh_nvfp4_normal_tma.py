            ...
            if is_valid != 0:
                ...
                for mi in cutlass.range_constexpr(mma_size_m):
                    ...
                    for subtile_idx in cutlass.range_constexpr(subtile_cnt):
                        ...
                        _g_x2 = _c_2_a
                        _g_inner2 = cutlass.full_like(_g_x2, cutlass.Float32(0.7978845608028654)) * (_g_x2 + cutlass.full_like(_g_x2, cutlass.Float32(0.044715)) * _g_x2 * _g_x2 * _g_x2)
                        _g_tanh2 = (cutlass.full_like(_g_inner2, cutlass.Float32(1.0)) - cutlass.full_like(_g_inner2, cutlass.Float32(2.0)) * cute.math.rcp(cute.math.exp2(_g_inner2 * cutlass.full_like(_g_inner2, cutlass.Float32(2.8853900817779268)), fastmath=True) + cutlass.full_like(_g_inner2, cutlass.Float32(1.0)), approx=True, ftz=True))
                        _op_2 = cutlass.full_like(_g_x2, cutlass.Float32(0.5)) * _g_x2 * (cutlass.full_like(_g_x2, cutlass.Float32(1.0)) + _g_tanh2)
...
def compile() -> Callable:
    ...
    return cute.compile(_host, problem_size, fake_first_token_offset, fake_a_tma_workspace, fake_a_0, fake_b_0, fake_b_1, fake_sfa_0, fake_sfb_0, fake_sfb_1, fake_gate_alpha, fake_up_alpha, fake_scale, fake_c_0, stream=_fake_stream, options=frost_compile_options)
