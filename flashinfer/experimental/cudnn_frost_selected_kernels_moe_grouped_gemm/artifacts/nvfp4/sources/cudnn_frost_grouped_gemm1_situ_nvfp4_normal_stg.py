        ...
        while is_valid != 0:
            ...
            if is_valid != 0:
                ...
                for mi in cutlass.range_constexpr(mma_size_m):
                    ...
                    _aux_up_alpha_ptr = up_alpha.iterator.raw_ptr()
                    _aux_up_alpha_pre = (_aux_up_alpha_ptr + group_idx).load()
                        ...
                        if row_active and row < group_end:
                            for j in cutlass.range_constexpr(subtile_w // vsize):
                                ...
                                if col_j + vsize <= N:
                                    ...
                                    _c_1_a = (vec_f32_1).to(cutlass.Float32)
                                    _op_1 = _c_1_a * (cutlass.full_like(_c_1_a, _aux_up_alpha_pre.to(cutlass.Float32)))
                                    _c_2_a = (_op_0).to(cutlass.Float32)
                                    _op_2 = _c_2_a / (cutlass.full_like(_c_2_a, _aux_gate_scale_pre.to(cutlass.Float32)))
                                    _c_3_a = (_op_2).to(cutlass.Float32)
                                    _op_3 = (cutlass.full_like(_c_3_a, cutlass.Float32(1.0)) - cutlass.full_like(_c_3_a, cutlass.Float32(2.0)) * cute.math.rcp(cute.math.exp2(_c_3_a * cutlass.full_like(_c_3_a, cutlass.Float32(2.8853900817779268)), fastmath=True) + cutlass.full_like(_c_3_a, cutlass.Float32(1.0)), approx=True, ftz=True))
                                    _c_4_a = (_op_3).to(cutlass.Float32)
                                    _op_4 = (cutlass.full_like(_c_4_a, _aux_gate_scale_pre.to(cutlass.Float32))) * _c_4_a
                                    _c_5_a = (_op_0).to(cutlass.Float32)
                                    _op_5 = cute.math.rcp(cutlass.full_like(_c_5_a, cutlass.Float32(1.0)) + cute.math.exp2(-_c_5_a * cutlass.full_like(_c_5_a, cutlass.Float32(1.4426950408889634)), fastmath=True), approx=True, ftz=True)
                                    _c_6_a = (_op_4).to(cutlass.Float32)
                                    _c_6_b = (_op_5).to(cutlass.Float32)
                                    _op_6 = _c_6_a * _c_6_b
                                    _c_7_a = (_op_1).to(cutlass.Float32)
                                    _op_7 = _c_7_a / (cutlass.full_like(_c_7_a, _aux_linear_scale_pre.to(cutlass.Float32)))
                                    _c_8_a = (_op_7).to(cutlass.Float32)
                                    _op_8 = (cutlass.full_like(_c_8_a, cutlass.Float32(1.0)) - cutlass.full_like(_c_8_a, cutlass.Float32(2.0)) * cute.math.rcp(cute.math.exp2(_c_8_a * cutlass.full_like(_c_8_a, cutlass.Float32(2.8853900817779268)), fastmath=True) + cutlass.full_like(_c_8_a, cutlass.Float32(1.0)), approx=True, ftz=True))
                                    _c_9_a = (_op_8).to(cutlass.Float32)
                                    _op_9 = (cutlass.full_like(_c_9_a, _aux_linear_scale_pre.to(cutlass.Float32))) * _c_9_a
                                    _c_10_a = (_op_6).to(cutlass.Float32)
                                    _c_10_b = (_op_9).to(cutlass.Float32)
                                    _op_10 = _c_10_a * _c_10_b
                                    _c_11_a = (_op_10).to(cutlass.Float32)
                                    _op_11 = _c_11_a * (cutlass.full_like(_c_11_a, _aux_scale_pre.to(cutlass.Float32)))
                                    _r_11 = (_op_11).to(cutlass.BFloat16)
                                    _tap_0 = (_r_11).to(cutlass.BFloat16)
...
def compile() -> Callable:
    ...
    fake_up_alpha = cute.runtime.make_fake_tensor(cutlass.Float32, (sym_g, 1, 1), stride=(1, 1, 1), assumed_align=4)
    ...
    return cute.compile(_host, problem_size, fake_first_token_offset, fake_a_tma_workspace, fake_a_0, fake_b_0, fake_b_1, fake_sfa_0, fake_sfb_0, fake_sfb_1, fake_c_tap_0, fake_gate_alpha, fake_up_alpha, fake_gate_scale, fake_linear_scale, fake_scale, stream=_fake_stream, options=frost_compile_options)
