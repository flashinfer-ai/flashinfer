            ...
            if is_valid != 0:
                ...
                for mi in cutlass.range_constexpr(mma_size_m):
                    ...
                    for subtile_idx in cutlass.range_constexpr(subtile_cnt):
                        ...
                        _op_1 = _c_1_a * cute.math.rcp(cutlass.full_like(_c_1_a, cutlass.Float32(1.0)) + cute.math.exp2(-_c_1_a * cutlass.full_like(_c_1_a, cutlass.Float32(1.4426950408889634)), fastmath=True), approx=True, ftz=True)
...
def _host(
    ...
    tma_c_desc_0 = _tma.create_tensor_map_tiled(
        ...
        box_dims=[FROST_EPI_ROW_ELEMS, epi_tile_mn[0]],
        swizzle=FROST_EPI_SWIZZLE,
    )
...
def compile() -> Callable:
    ...
    return cute.compile(_host, problem_size, fake_first_token_offset, fake_a_tma_workspace, fake_a_0, fake_b_0, fake_sfa_0, fake_sfb_0, fake_gate_alpha, fake_scale, fake_c_0, stream=_fake_stream, options=frost_compile_options)
