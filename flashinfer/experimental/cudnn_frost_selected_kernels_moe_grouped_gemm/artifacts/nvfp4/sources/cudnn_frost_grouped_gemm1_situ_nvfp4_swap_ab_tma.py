            ...
            if is_valid != 0:
                ...
                for mi in cutlass.range_constexpr(mma_size_m):
                    ...
                    for subtile_idx in cutlass.range_constexpr(subtile_cnt):
                        ...
                        vec_out = (_r_11).to(cutlass.BFloat16)
...
def compile() -> Callable:
    ...
    return cute.compile(_host, problem_size, fake_first_token_offset, fake_tma_workspace, fake_a_0, fake_a_1, fake_b_0, fake_sfa_0, fake_sfa_1, fake_sfb_0, fake_gate_alpha, fake_up_alpha, fake_gate_scale, fake_linear_scale, fake_scale, fake_c_0, stream=_fake_stream, options=frost_compile_options)
