                        ...
                        if row_active and row < group_end:
                            for j in cutlass.range_constexpr(subtile_w // vsize):
                                ...
                                if col_j + vsize <= N:
                                    ...
                                    _e_x1 = _c_1_a
                                    _e_erf1 = cute.math.erf(_e_x1 * cutlass.full_like(_e_x1, cutlass.Float32(0.7071067811865475)))
                                    _op_1 = cutlass.full_like(_e_x1, cutlass.Float32(0.5)) * _e_x1 * (cutlass.full_like(_e_x1, cutlass.Float32(1.0)) + _e_erf1)
