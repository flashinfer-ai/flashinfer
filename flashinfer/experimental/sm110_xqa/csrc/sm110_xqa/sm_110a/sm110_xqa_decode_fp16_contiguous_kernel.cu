            ...
            for (unsigned int group = 0; group < (ratio + 7) / 8; group++) {
                ...
                if (local_row < ratio) {
                    ...
                    if (partitions <= 4) {
                        float maxima[4];
                        float sums[4];
                        maxima[0] = -SM110_XQA_INF;
                        maxima[1] = -SM110_XQA_INF;
                        maxima[2] = -SM110_XQA_INF;
                        maxima[3] = -SM110_XQA_INF;
                        sums[0] = 0.0f;
                        sums[1] = 0.0f;
                        sums[2] = 0.0f;
                        sums[3] = 0.0f;
                        float cached_max = -SM110_XQA_INF;
                        {
                            if (partitions > 0) {
                                float _vec_load_0[2];
                                {
                                    float2 _v2_23 = *reinterpret_cast<const float2*>(statistics + merge_row * partitions * 2);
                                    _vec_load_0[0] = _v2_23.x;
                                    _vec_load_0[0 + 1] = _v2_23.y;
                                }
                                maxima[0] = _vec_load_0[0];
                                sums[0] = _vec_load_0[1];
                                float _max_3 = max_noftz(cached_max, _vec_load_0[0]);
                                cached_max = _max_3;
                            }
                        }
                        {
                            if (partitions > 1) {
                                float _vec_load_1[2];
                                {
                                    float2 _v2_24 = *reinterpret_cast<const float2*>(statistics + (merge_row * partitions + 1) * 2);
                                    _vec_load_1[0] = _v2_24.x;
                                    _vec_load_1[0 + 1] = _v2_24.y;
                                }
                                maxima[1] = _vec_load_1[0];
                                sums[1] = _vec_load_1[1];
                                float _max_4 = max_noftz(cached_max, _vec_load_1[0]);
                                cached_max = _max_4;
                            }
                        }
                        {
                            if (partitions > 2) {
                                float _vec_load_2[2];
                                {
                                    float2 _v2_25 = *reinterpret_cast<const float2*>(statistics + (merge_row * partitions + 2) * 2);
                                    _vec_load_2[0] = _v2_25.x;
                                    _vec_load_2[0 + 1] = _v2_25.y;
                                }
                                maxima[2] = _vec_load_2[0];
                                sums[2] = _vec_load_2[1];
                                float _max_5 = max_noftz(cached_max, _vec_load_2[0]);
                                cached_max = _max_5;
                            }
                        }
                        {
                            if (partitions > 3) {
                                float _vec_load_3[2];
                                {
                                    float2 _v2_26 = *reinterpret_cast<const float2*>(statistics + (merge_row * partitions + 3) * 2);
                                    _vec_load_3[0] = _v2_26.x;
                                    _vec_load_3[0 + 1] = _v2_26.y;
                                }
                                maxima[3] = _vec_load_3[0];
                                sums[3] = _vec_load_3[1];
                                float _max_6 = max_noftz(cached_max, _vec_load_3[0]);
                                cached_max = _max_6;
                            }
                        }
                        float safe_cached_max = ((cached_max == -SM110_XQA_INF) ? 0.0f : cached_max);
                        {
                            if (partitions > 0) {
                                unsigned int cached_partial_row = merge_row * partitions;
                                float _exp2_1 = approx_exp2(maxima[0] - safe_cached_max);
                                float cached_weight = _exp2_1;
                                float _vec_load_4[4];
                                {
                                    float4 _v4 = *reinterpret_cast<const float4*>(partial + cached_partial_row * 128 + merge_col);
                                ...
                                float _vec_load_5[4];
                                {
                                    float4 _v4 = *reinterpret_cast<const float4*>(partial + cached_partial_row * 128 + merge_col + 4);
                                    _vec_load_5[0 + 0] = _v4.x;
                                    _vec_load_5[0 + 1] = _v4.y;
                                    _vec_load_5[0 + 2] = _v4.z;
                                    _vec_load_5[0 + 3] = _v4.w;
                                }
                                float _fma_0 = __fmaf_rn(_vec_load_4[0], cached_weight, numerator[0]);
                                numerator[0] = _fma_0;
                                float _fma_1 = __fmaf_rn(_vec_load_5[0], cached_weight, numerator[4]);
                                numerator[4] = _fma_1;
                                float _fma_2 = __fmaf_rn(_vec_load_4[1], cached_weight, numerator[1]);
                                numerator[1] = _fma_2;
                                float _fma_3 = __fmaf_rn(_vec_load_5[1], cached_weight, numerator[5]);
                                numerator[5] = _fma_3;
                                float _fma_4 = __fmaf_rn(_vec_load_4[2], cached_weight, numerator[2]);
                                numerator[2] = _fma_4;
                                float _fma_5 = __fmaf_rn(_vec_load_5[2], cached_weight, numerator[6]);
                                numerator[6] = _fma_5;
                                float _fma_6 = __fmaf_rn(_vec_load_4[3], cached_weight, numerator[3]);
                                numerator[3] = _fma_6;
                                float _fma_7 = __fmaf_rn(_vec_load_5[3], cached_weight, numerator[7]);
                                numerator[7] = _fma_7;
                                float _fma_8 = __fmaf_rn(sums[0], cached_weight, denominator);
                                denominator = _fma_8;
                            }
                        }
                        {
                            if (partitions > 1) {
                                unsigned int cached_partial_row_1 = merge_row * partitions + 1;
                                float _exp2_2 = approx_exp2(maxima[1] - safe_cached_max);
                                float cached_weight_1 = _exp2_2;
                                float _vec_load_6[4];
                                {
                                    float4 _v4 = *reinterpret_cast<const float4*>(partial + cached_partial_row_1 * 128 + merge_col);
                                ...
                                float _vec_load_7[4];
                                {
                                    float4 _v4 = *reinterpret_cast<const float4*>(partial + cached_partial_row_1 * 128 + merge_col + 4);
                                    _vec_load_7[0 + 0] = _v4.x;
                                    _vec_load_7[0 + 1] = _v4.y;
                                    _vec_load_7[0 + 2] = _v4.z;
                                    _vec_load_7[0 + 3] = _v4.w;
                                }
                                float _fma_9 = __fmaf_rn(_vec_load_6[0], cached_weight_1, numerator[0]);
                                numerator[0] = _fma_9;
                                float _fma_10 = __fmaf_rn(_vec_load_7[0], cached_weight_1, numerator[4]);
                                numerator[4] = _fma_10;
                                float _fma_11 = __fmaf_rn(_vec_load_6[1], cached_weight_1, numerator[1]);
                                numerator[1] = _fma_11;
                                float _fma_12 = __fmaf_rn(_vec_load_7[1], cached_weight_1, numerator[5]);
                                numerator[5] = _fma_12;
                                float _fma_13 = __fmaf_rn(_vec_load_6[2], cached_weight_1, numerator[2]);
                                numerator[2] = _fma_13;
                                float _fma_14 = __fmaf_rn(_vec_load_7[2], cached_weight_1, numerator[6]);
                                numerator[6] = _fma_14;
                                float _fma_15 = __fmaf_rn(_vec_load_6[3], cached_weight_1, numerator[3]);
                                numerator[3] = _fma_15;
                                float _fma_16 = __fmaf_rn(_vec_load_7[3], cached_weight_1, numerator[7]);
                                numerator[7] = _fma_16;
                                float _fma_17 = __fmaf_rn(sums[1], cached_weight_1, denominator);
                                denominator = _fma_17;
                            }
                        }
                        {
                            if (partitions > 2) {
                                unsigned int cached_partial_row_2 = merge_row * partitions + 2;
                                float _exp2_3 = approx_exp2(maxima[2] - safe_cached_max);
                                float cached_weight_2 = _exp2_3;
                                float _vec_load_8[4];
                                {
                                    float4 _v4 = *reinterpret_cast<const float4*>(partial + cached_partial_row_2 * 128 + merge_col);
                                ...
                                float _vec_load_9[4];
                                {
                                    float4 _v4 = *reinterpret_cast<const float4*>(partial + cached_partial_row_2 * 128 + merge_col + 4);
                                    _vec_load_9[0 + 0] = _v4.x;
                                    _vec_load_9[0 + 1] = _v4.y;
                                    _vec_load_9[0 + 2] = _v4.z;
                                    _vec_load_9[0 + 3] = _v4.w;
                                }
                                float _fma_18 = __fmaf_rn(_vec_load_8[0], cached_weight_2, numerator[0]);
                                numerator[0] = _fma_18;
                                float _fma_19 = __fmaf_rn(_vec_load_9[0], cached_weight_2, numerator[4]);
                                numerator[4] = _fma_19;
                                float _fma_20 = __fmaf_rn(_vec_load_8[1], cached_weight_2, numerator[1]);
                                numerator[1] = _fma_20;
                                float _fma_21 = __fmaf_rn(_vec_load_9[1], cached_weight_2, numerator[5]);
                                numerator[5] = _fma_21;
                                float _fma_22 = __fmaf_rn(_vec_load_8[2], cached_weight_2, numerator[2]);
                                numerator[2] = _fma_22;
                                float _fma_23 = __fmaf_rn(_vec_load_9[2], cached_weight_2, numerator[6]);
                                numerator[6] = _fma_23;
                                float _fma_24 = __fmaf_rn(_vec_load_8[3], cached_weight_2, numerator[3]);
                                numerator[3] = _fma_24;
                                float _fma_25 = __fmaf_rn(_vec_load_9[3], cached_weight_2, numerator[7]);
                                numerator[7] = _fma_25;
                                float _fma_26 = __fmaf_rn(sums[2], cached_weight_2, denominator);
                                denominator = _fma_26;
                            }
                        }
                        {
                            if (partitions > 3) {
                                unsigned int cached_partial_row_3 = merge_row * partitions + 3;
                                float _exp2_4 = approx_exp2(maxima[3] - safe_cached_max);
                                float cached_weight_3 = _exp2_4;
                                float _vec_load_10[4];
                                {
                                    float4 _v4 = *reinterpret_cast<const float4*>(partial + cached_partial_row_3 * 128 + merge_col);
                                ...
                                {
                                    float4 _v4 = *reinterpret_cast<const float4*>(partial + cached_partial_row_3 * 128 + merge_col + 4);
                                    _vec_load_11[0 + 0] = _v4.x;
                                    _vec_load_11[0 + 1] = _v4.y;
                                    _vec_load_11[0 + 2] = _v4.z;
                                    _vec_load_11[0 + 3] = _v4.w;
                                }
                                float _fma_27 = __fmaf_rn(_vec_load_10[0], cached_weight_3, numerator[0]);
                                numerator[0] = _fma_27;
                                float _fma_28 = __fmaf_rn(_vec_load_11[0], cached_weight_3, numerator[4]);
                                numerator[4] = _fma_28;
                                float _fma_29 = __fmaf_rn(_vec_load_10[1], cached_weight_3, numerator[1]);
                                numerator[1] = _fma_29;
                                float _fma_30 = __fmaf_rn(_vec_load_11[1], cached_weight_3, numerator[5]);
                                numerator[5] = _fma_30;
                                float _fma_31 = __fmaf_rn(_vec_load_10[2], cached_weight_3, numerator[2]);
                                numerator[2] = _fma_31;
                                float _fma_32 = __fmaf_rn(_vec_load_11[2], cached_weight_3, numerator[6]);
                                numerator[6] = _fma_32;
                                float _fma_33 = __fmaf_rn(_vec_load_10[3], cached_weight_3, numerator[3]);
                                numerator[3] = _fma_33;
                                float _fma_34 = __fmaf_rn(_vec_load_11[3], cached_weight_3, numerator[7]);
                                numerator[7] = _fma_34;
                                float _fma_35 = __fmaf_rn(sums[3], cached_weight_3, denominator);
                                denominator = _fma_35;
                            }
                        }
                    }
                    if (!1 || partitions > 4) {
                        ...
                        for (unsigned int shard = 0; shard < partitions; shard++) {
                            ...
                            float _max_7 = max_noftz(merge_max, candidate);
                            merge_max = _max_7;
                        }
                        ...
                        for (unsigned int shard_1 = 0; shard_1 < partitions; shard_1++) {
                            ...
                            float _exp2_5 = approx_exp2(shard_max - safe_merge_max);
                            float weight = _exp2_5;
                            ...
                            for (int element = 0; element < 4; element++) {
                                float _fma_36 = __fmaf_rn(_vec_load_12[element], weight, numerator[element]);
                                numerator[element] = _fma_36;
                                float _fma_37 = __fmaf_rn(_vec_load_13[element], weight, numerator[element + 4]);
                                numerator[element + 4] = _fma_37;
                            }
                            float _fma_38 = __fmaf_rn(shard_sum, weight, denominator);
                            denominator = _fma_38;
                        }
                    }
                    ...
                    {
                        const float2 _prescale2_37 = {inverse_1, inverse_1};
                        #if __CUDA_ARCH__ >= 1000
                        #pragma unroll
                        for (int _ps = 0; _ps < 4; _ps++)
                            mul_f32x2_inplace(&reinterpret_cast<float2*>(&numerator[0])[_ps], _prescale2_37);
                        #else
                        #pragma unroll
                        for (int _ps = 0; _ps < 8; _ps++)
