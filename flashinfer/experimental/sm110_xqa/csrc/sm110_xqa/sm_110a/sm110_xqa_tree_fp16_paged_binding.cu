...
void run_tree(
  ...
  CheckCuda(cudaFuncSetAttribute(reinterpret_cast<const void*>(kernel_sm110_xqa_tree_fp16_paged),
  ...
  CheckCuda(cudaLaunchKernel(reinterpret_cast<const void*>(kernel_sm110_xqa_tree_fp16_paged),
