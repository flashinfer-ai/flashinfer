                ...
                for (int i_2 = 0; i_2 < k_count_3; i_2++) {
                    ...
                    for (int it_2 = 0; it_2 < 2; it_2++) {
                        ...
                        for (int j_5 = 0; j_5 < 4; j_5++) {
                            ...
                            unsigned int hi_bits_m = words_all[4 * it_2 + j_5] & 4294901760;
                            float lo_m = 0.0f;
                            float hi_m = 0.0f;
                    ...
                    for (int it_7 = 0; it_7 < 2; it_7++) {
                        ...
                        for (int j_6 = 0; j_6 < 4; j_6++) {
                            ...
                            unsigned int hi_bits = words_all[4 * it_7 + j_6] & 4294901760;
                            float lo = 0.0f;
                            float hi = 0.0f;
