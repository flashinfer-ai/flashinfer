...
kernel_cake_kimi_k3_fp8_projection_8c391ffb3474d5240aba(__nv_bfloat16* __restrict__ x, uint8_t* __restrict__ a_q, uint8_t* __restrict__ a_sf, int M, int K, int units_per_row, int sf_k_sets, int sf_rows)
{
