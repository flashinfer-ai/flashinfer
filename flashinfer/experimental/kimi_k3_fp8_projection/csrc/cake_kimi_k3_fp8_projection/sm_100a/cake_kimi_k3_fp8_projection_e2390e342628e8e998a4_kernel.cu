...
kernel_cake_kimi_k3_fp8_projection_e2390e342628e8e998a4(__nv_bfloat16* __restrict__ x, uint8_t* __restrict__ a_q, uint8_t* __restrict__ a_sf, int M, int K, int units_per_row, int sf_k_sets, int sf_rows)
{
    ...
    if (row < M) {
        int k_block0 = unit - row * units_per_row;
