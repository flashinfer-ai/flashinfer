...
#define SMEM_SCALE_SMEM_OFF 50176
...
kernel_sm110_gqa_decode_long(const __grid_constant__ Sm110GqaTensorMap64 Q, const __grid_constant__ Sm110GqaTensorMap64 K, const __grid_constant__ Sm110GqaTensorMap64 V, __half* __restrict__ O, int* __restrict__ sequence_lengths, float softmax_scale_log2)
{
    ...
    #define corr_sig_addr (mbar_base + 56)
    #define corr_done_addr (mbar_base + 64)
    #define o_full_addr (mbar_base + 72)
    #define tile_done_addr (mbar_base + 80)
    ...
    float* scale_smem = reinterpret_cast<float*>(smem_raw + 50176);
    const int scale_smem_addr = smem + 50176;

    // Mbarrier init (9 pipeline groups, 0 ordered-sequence groups, 11 barriers)
    ...
    if (warp <= 3) {
        ...
        { // softmax_main
            ...
            int num_n_blocks = (seqlen_kv + 64 - 1) / 64;
            ...
            for (int n_block = 0; n_block < num_n_blocks; n_block++) {
                ...
                _phase_s_full_0 ^= 1;
                int valid_cols = seqlen_kv - n_block * 64;
                if (valid_cols > 64) {
                    valid_cols = 64;
                }
                if (row_valid == 0) {
                ...
                if (half_valid <= 0) {
                    if (!(0 & (1u << 0))) _tmem_load_0[0] = -SM110_GQA_INF;
                    if (!(0 & (1u << 1))) _tmem_load_0[1] = -SM110_GQA_INF;
                    if (!(0 & (1u << 2))) _tmem_load_0[2] = -SM110_GQA_INF;
                    if (!(0 & (1u << 3))) _tmem_load_0[3] = -SM110_GQA_INF;
                    if (!(0 & (1u << 4))) _tmem_load_0[4] = -SM110_GQA_INF;
                    if (!(0 & (1u << 5))) _tmem_load_0[5] = -SM110_GQA_INF;
                    if (!(0 & (1u << 6))) _tmem_load_0[6] = -SM110_GQA_INF;
                    if (!(0 & (1u << 7))) _tmem_load_0[7] = -SM110_GQA_INF;
                    if (!(0 & (1u << 8))) _tmem_load_0[8] = -SM110_GQA_INF;
                    if (!(0 & (1u << 9))) _tmem_load_0[9] = -SM110_GQA_INF;
                    if (!(0 & (1u << 10))) _tmem_load_0[10] = -SM110_GQA_INF;
                    if (!(0 & (1u << 11))) _tmem_load_0[11] = -SM110_GQA_INF;
                    if (!(0 & (1u << 12))) _tmem_load_0[12] = -SM110_GQA_INF;
                    if (!(0 & (1u << 13))) _tmem_load_0[13] = -SM110_GQA_INF;
                    if (!(0 & (1u << 14))) _tmem_load_0[14] = -SM110_GQA_INF;
                    if (!(0 & (1u << 15))) _tmem_load_0[15] = -SM110_GQA_INF;
                    if (!(0 & (1u << 16))) _tmem_load_0[16] = -SM110_GQA_INF;
                    if (!(0 & (1u << 17))) _tmem_load_0[17] = -SM110_GQA_INF;
                    if (!(0 & (1u << 18))) _tmem_load_0[18] = -SM110_GQA_INF;
                    if (!(0 & (1u << 19))) _tmem_load_0[19] = -SM110_GQA_INF;
                    if (!(0 & (1u << 20))) _tmem_load_0[20] = -SM110_GQA_INF;
                    if (!(0 & (1u << 21))) _tmem_load_0[21] = -SM110_GQA_INF;
                    if (!(0 & (1u << 22))) _tmem_load_0[22] = -SM110_GQA_INF;
                    if (!(0 & (1u << 23))) _tmem_load_0[23] = -SM110_GQA_INF;
                    if (!(0 & (1u << 24))) _tmem_load_0[24] = -SM110_GQA_INF;
                    if (!(0 & (1u << 25))) _tmem_load_0[25] = -SM110_GQA_INF;
                    if (!(0 & (1u << 26))) _tmem_load_0[26] = -SM110_GQA_INF;
                    if (!(0 & (1u << 27))) _tmem_load_0[27] = -SM110_GQA_INF;
                    if (!(0 & (1u << 28))) _tmem_load_0[28] = -SM110_GQA_INF;
                    if (!(0 & (1u << 29))) _tmem_load_0[29] = -SM110_GQA_INF;
                    if (!(0 & (1u << 30))) _tmem_load_0[30] = -SM110_GQA_INF;
                    if (!(0 & (1u << 31))) _tmem_load_0[31] = -SM110_GQA_INF;
                    ...
                    if (!(_slice_lo_mask_0 & (1u << 0))) _tmem_load_0[0] = -SM110_GQA_INF;
                    if (!(_slice_lo_mask_0 & (1u << 1))) _tmem_load_0[1] = -SM110_GQA_INF;
                    if (!(_slice_lo_mask_0 & (1u << 2))) _tmem_load_0[2] = -SM110_GQA_INF;
                    if (!(_slice_lo_mask_0 & (1u << 3))) _tmem_load_0[3] = -SM110_GQA_INF;
                    if (!(_slice_lo_mask_0 & (1u << 4))) _tmem_load_0[4] = -SM110_GQA_INF;
                    if (!(_slice_lo_mask_0 & (1u << 5))) _tmem_load_0[5] = -SM110_GQA_INF;
                    if (!(_slice_lo_mask_0 & (1u << 6))) _tmem_load_0[6] = -SM110_GQA_INF;
                    if (!(_slice_lo_mask_0 & (1u << 7))) _tmem_load_0[7] = -SM110_GQA_INF;
                    if (!(_slice_lo_mask_0 & (1u << 8))) _tmem_load_0[8] = -SM110_GQA_INF;
                    if (!(_slice_lo_mask_0 & (1u << 9))) _tmem_load_0[9] = -SM110_GQA_INF;
                    if (!(_slice_lo_mask_0 & (1u << 10))) _tmem_load_0[10] = -SM110_GQA_INF;
                    if (!(_slice_lo_mask_0 & (1u << 11))) _tmem_load_0[11] = -SM110_GQA_INF;
                    if (!(_slice_lo_mask_0 & (1u << 12))) _tmem_load_0[12] = -SM110_GQA_INF;
                    if (!(_slice_lo_mask_0 & (1u << 13))) _tmem_load_0[13] = -SM110_GQA_INF;
                    if (!(_slice_lo_mask_0 & (1u << 14))) _tmem_load_0[14] = -SM110_GQA_INF;
                    if (!(_slice_lo_mask_0 & (1u << 15))) _tmem_load_0[15] = -SM110_GQA_INF;
                    if (!(_slice_lo_mask_0 & (1u << 16))) _tmem_load_0[16] = -SM110_GQA_INF;
                    if (!(_slice_lo_mask_0 & (1u << 17))) _tmem_load_0[17] = -SM110_GQA_INF;
                    if (!(_slice_lo_mask_0 & (1u << 18))) _tmem_load_0[18] = -SM110_GQA_INF;
                    if (!(_slice_lo_mask_0 & (1u << 19))) _tmem_load_0[19] = -SM110_GQA_INF;
                    if (!(_slice_lo_mask_0 & (1u << 20))) _tmem_load_0[20] = -SM110_GQA_INF;
                    if (!(_slice_lo_mask_0 & (1u << 21))) _tmem_load_0[21] = -SM110_GQA_INF;
                    if (!(_slice_lo_mask_0 & (1u << 22))) _tmem_load_0[22] = -SM110_GQA_INF;
                    if (!(_slice_lo_mask_0 & (1u << 23))) _tmem_load_0[23] = -SM110_GQA_INF;
                    if (!(_slice_lo_mask_0 & (1u << 24))) _tmem_load_0[24] = -SM110_GQA_INF;
                    if (!(_slice_lo_mask_0 & (1u << 25))) _tmem_load_0[25] = -SM110_GQA_INF;
                    if (!(_slice_lo_mask_0 & (1u << 26))) _tmem_load_0[26] = -SM110_GQA_INF;
                    if (!(_slice_lo_mask_0 & (1u << 27))) _tmem_load_0[27] = -SM110_GQA_INF;
                    if (!(_slice_lo_mask_0 & (1u << 28))) _tmem_load_0[28] = -SM110_GQA_INF;
                    if (!(_slice_lo_mask_0 & (1u << 29))) _tmem_load_0[29] = -SM110_GQA_INF;
                    if (!(_slice_lo_mask_0 & (1u << 30))) _tmem_load_0[30] = -SM110_GQA_INF;
                    if (!(_slice_lo_mask_0 & (1u << 31))) _tmem_load_0[31] = -SM110_GQA_INF;
                }
                ...
                float safe_max = ((new_max == -SM110_GQA_INF) ? 0.0f : new_max);
                ...
                float score_bias = ((valid_cols > 0) ? -new_max_scaled : -SM110_GQA_INF);
    ...
    if (warp >= 4 && warp <= 7) {
        ...
        { // correction_main
            ...
            int num_n_blocks_1 = (seqlen_kv_1 + 64 - 1) / 64;
            ...
            int my_row_1 = (unsigned int)logical_row_origin_1 + lane % 16;
            ...
            #pragma unroll 1
            for (int _n_block = 1; _n_block < num_n_blocks_1; _n_block++) {
                mbarrier_wait(corr_sig_addr, _phase_corr_sig_0);
                _phase_corr_sig_0 ^= 1;
            ...
            if (my_row_1 < 4) {
                int q_head = kv_head_1 * 4 + my_row_1;
                int output_row = (batch_1 * 32 + q_head) * 128;
                #pragma unroll
                for (int offset = 0; offset < 64; offset += 8) {
                    {
                        ...
                        for (int _ps = 0; _ps < 4; _ps++)
                            mul_f32x2_inplace(&reinterpret_cast<float2*>(&_tmem_load_2[offset])[_ps], _prescale2_1);
                        #else
                        #pragma unroll
    ...
    if (warp == 8) {
        { // mma_warp_main
            ...
            int num_n_blocks_2 = (seqlen_kv_2 + 64 - 1) / 64;
            ...
            #pragma unroll 1
            for (int n_block_1 = 0; n_block_1 < num_n_blocks_2; n_block_1++) {
                ...
                _phase_p_full_0 ^= 1;
                if (elect_sync()) {
                    int _mma_b_lo_1 = ((((v_smem_addr) >> 4) & 0x3FFF) | 0x2000000) + (v_stage) * 1024;
                    asm volatile(
                    "{\n\t"
                    ".reg .pred p0, p1;\n\t"
    ...
    if (warp == 9) {
        { // load_warp_main
            int tile_3 = blockIdx.x;
            int batch_3 = tile_3 / 8;
            int kv_head_3 = tile_3 - batch_3 * 8;
            int seqlen_kv_3 = sequence_lengths[batch_3];
            int num_n_blocks_3 = (seqlen_kv_3 + 64 - 1) / 64;
            unsigned int load_stage = 0;
            if (elect_sync()) {
                mbarrier_arrive_expect_tx(q_full_addr, 16384);
                tma_5d_gmem2smem(q_smem_addr, (&Q), 0, 0, 0, kv_head_3, batch_3, q_full_addr);
                tma_5d_gmem2smem(q_smem_addr + 8192, (&Q), 64, 0, 0, kv_head_3, batch_3, q_full_addr);
            }
            unsigned int _phase_kv_empty = 1;
            #pragma unroll 1
            for (int n_block_2 = 0; n_block_2 < num_n_blocks_3; n_block_2++) {
                int token_base = n_block_2 * 64;
                mbarrier_wait(kv_empty_addr + (load_stage) * 8, _phase_kv_empty);
                if (elect_sync()) {
                    mbarrier_arrive_expect_tx(kv_full_addr + (load_stage) * 8, 16384);
                    tma_4d_gmem2smem(kv_smem_addr + load_stage * 16384, (&K), 0, token_base, kv_head_3, batch_3, kv_full_addr + (load_stage) * 8);
                    tma_4d_gmem2smem(kv_smem_addr + load_stage * 16384 + 8192, (&K), 64, token_base, kv_head_3, batch_3, kv_full_addr + (load_stage) * 8);
                }
                load_stage += 1;
                ...
                if (elect_sync()) {
                    mbarrier_arrive_expect_tx(kv_full_addr + (load_stage) * 8, 16384);
                    tma_4d_gmem2smem(kv_smem_addr + load_stage * 16384, (&V), 0, token_base, kv_head_3, batch_3, kv_full_addr + (load_stage) * 8);
                    tma_4d_gmem2smem(kv_smem_addr + load_stage * 16384 + 8192, (&V), 64, token_base, kv_head_3, batch_3, kv_full_addr + (load_stage) * 8);
                }
                load_stage += 1;
                if (load_stage == 2) { load_stage = 0; _phase_kv_empty ^= 1; }
            }
