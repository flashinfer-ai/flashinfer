...
The public entry points live in core (``flashinfer.attention.unified``,
...
Layout (mirrors ``flashinfer/mla/_batch_mla/``):
    ...
    _selection.py    tensor-free resolve_paged_prefill() (level-1 selection)
...
independent reference. ``tests/experimental/test_unified_prefill_fuzzer.py``
enforces it with randomized valid and corrupted inputs.
"""

from ._backends import CAPABILITIES, MIN_DENSE_PAGE_SIZE, PagedPrefillCapabilities
from ._contracts import PlanMetadata, Resolution
from ._controller import PagedPrefillController
from ._planning import Derived, derive
from ._selection import HEURISTIC_ORDER, resolve_paged_prefill
