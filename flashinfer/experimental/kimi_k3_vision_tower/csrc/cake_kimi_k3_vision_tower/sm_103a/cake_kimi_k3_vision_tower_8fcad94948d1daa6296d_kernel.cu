...
kernel_cake_kimi_k3_vision_tower_8fcad94948d1daa6296d(__nv_bfloat16* __restrict__ y, __nv_bfloat16* __restrict__ weight, float* __restrict__ rowsumsq, int M, float eps)
{
