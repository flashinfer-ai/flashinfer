...
kernel_cake_kimi_k3_vision_tower_e540c6015253f7d092f1(__nv_bfloat16* __restrict__ x, __nv_bfloat16* __restrict__ norm_weight, int* __restrict__ merge_table, __nv_bfloat16* __restrict__ m_out, float eps)
{
