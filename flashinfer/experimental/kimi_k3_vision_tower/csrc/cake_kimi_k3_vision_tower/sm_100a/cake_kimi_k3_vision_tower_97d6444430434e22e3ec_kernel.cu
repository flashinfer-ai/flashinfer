...
kernel_cake_kimi_k3_vision_tower_97d6444430434e22e3ec(__nv_bfloat16* __restrict__ y, __nv_bfloat16* __restrict__ weight, float* __restrict__ rowsumsq, int M, float eps)
{
