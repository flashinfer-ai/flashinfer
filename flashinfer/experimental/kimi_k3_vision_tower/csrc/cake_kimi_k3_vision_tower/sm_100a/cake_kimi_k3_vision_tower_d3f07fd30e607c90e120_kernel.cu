...
kernel_cake_kimi_k3_vision_tower_d3f07fd30e607c90e120(__nv_bfloat16* __restrict__ y, __nv_bfloat16* __restrict__ weight, float* __restrict__ rowsumsq, int M, float eps)
{
