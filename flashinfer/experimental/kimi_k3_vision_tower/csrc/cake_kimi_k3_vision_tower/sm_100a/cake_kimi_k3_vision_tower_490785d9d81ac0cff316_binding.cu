...
// tvm-ffi direct-source launcher for Cake kernel 'kernel_cake_kimi_k3_vision_tower_490785d9d81ac0cff316'.
#include <cuda.h>
#include <cuda_bf16.h>
#include <cuda_fp16.h>
...
extern "C" __global__ void kernel_cake_kimi_k3_vision_tower_490785d9d81ac0cff316(__nv_bfloat16* __restrict__ x, __nv_bfloat16* __restrict__ norm_weight, int* __restrict__ merge_table, __nv_bfloat16* __restrict__ m_out, float eps);


namespace cake_host_shim_24fa0cedd2092890 {
...
void Run(TensorView arg_x, TensorView arg_norm_weight, TensorView arg_merge_table, TensorView arg_m_out, double arg_eps, int64_t grid_x, int64_t grid_y, int64_t grid_z) {
  ...
  cudaError_t launch_status = cudaLaunchKernelExC(
      &config, reinterpret_cast<const void*>(kernel_cake_kimi_k3_vision_tower_490785d9d81ac0cff316), kargs);
  TVM_FFI_CHECK(launch_status == cudaSuccess, RuntimeError)
      << "cudaLaunchKernelExC for kernel_cake_kimi_k3_vision_tower_490785d9d81ac0cff316 failed: "
      << cudaGetErrorString(launch_status);
}

}  // namespace cake_host_shim_24fa0cedd2092890

TVM_FFI_DLL_EXPORT_TYPED_FUNC(run, cake_host_shim_24fa0cedd2092890::Run);
