                        ...
                        if (store_row < M) {
                            {
                                ...
                                asm volatile(
                                    ...
                                    :: "l"((void*)(C + (row_out + (unsigned long long)(gcol_1 + c * 16)))), "r"(_raw_stv8_1[0]), "r"(_raw_stv8_1[1]), "r"(_raw_stv8_1[2]), "r"(_raw_stv8_1[3]), "r"(_raw_stv8_1[4]), "r"(_raw_stv8_1[5]), "r"(_raw_stv8_1[6]), "r"(_raw_stv8_1[7]) : "memory");
                            }
                        }
                    }
                }
