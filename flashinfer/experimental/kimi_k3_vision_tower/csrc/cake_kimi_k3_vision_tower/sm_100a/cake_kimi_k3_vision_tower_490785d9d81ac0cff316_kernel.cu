...
kernel_cake_kimi_k3_vision_tower_490785d9d81ac0cff316(__nv_bfloat16* __restrict__ x, __nv_bfloat16* __restrict__ norm_weight, int* __restrict__ merge_table, __nv_bfloat16* __restrict__ m_out, float eps)
{
