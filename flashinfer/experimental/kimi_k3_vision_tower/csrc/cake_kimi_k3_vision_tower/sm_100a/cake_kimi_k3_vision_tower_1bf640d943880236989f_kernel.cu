        ...
        { // load_main
            ...
            if (elect_sync()) {
                ...
                for (unsigned int ct = cluster_id_1; ct < num_cluster_tiles; ct += num_clusters_1) {
                    int this_bid = ct * 2 + (unsigned int)cta_rank;
    ...
    if (warp >= 2 && warp <= 9) {
        { // epilogue_main
            ...
            for (unsigned int ct_1 = epi_cluster_id; ct_1 < num_cluster_tiles; ct_1 += epi_num_clusters) {
                int this_bid_1 = ct_1 * 2 + (unsigned int)cta_rank;
                ...
                #pragma unroll 1
                for (int grp = grp_lo; grp < grp_lo + 2; grp++) {
                    int gcol = grp * 64;
                    ...
                    if (kind < 2) {
                        ...
                        for (int q = 0; q < 4; q++) {
                            float _vec_load_2[8];
                            {
                                ...
                                asm volatile(
                                    "ld.global.v8.b32 {%0, %1, %2, %3, %4, %5, %6, %7}, [%8];"
                                    : "=r"(_ldv8_2_0), "=r"(_ldv8_2_1), "=r"(_ldv8_2_2), "=r"(_ldv8_2_3), "=r"(_ldv8_2_4), "=r"(_ldv8_2_5), "=r"(_ldv8_2_6), "=r"(_ldv8_2_7) : "l"((const void*)(COS + (cs_row + (unsigned long long)(pair0 + q * 8)) + (0))) : "memory");
                            ...
                            float _vec_load_3[8];
                            {
                                ...
                                asm volatile(
                                    "ld.global.v8.b32 {%0, %1, %2, %3, %4, %5, %6, %7}, [%8];"
                                    : "=r"(_ldv8_3_0), "=r"(_ldv8_3_1), "=r"(_ldv8_3_2), "=r"(_ldv8_3_3), "=r"(_ldv8_3_4), "=r"(_ldv8_3_5), "=r"(_ldv8_3_6), "=r"(_ldv8_3_7) : "l"((const void*)(SIN + (cs_row + (unsigned long long)(pair0 + q * 8)) + (0))) : "memory");
                                _vec_load_3[0 + 0] = __uint_as_float(_ldv8_3_0);
                                _vec_load_3[0 + 1] = __uint_as_float(_ldv8_3_1);
                                _vec_load_3[0 + 2] = __uint_as_float(_ldv8_3_2);
                                _vec_load_3[0 + 3] = __uint_as_float(_ldv8_3_3);
                                _vec_load_3[0 + 4] = __uint_as_float(_ldv8_3_4);
                                _vec_load_3[0 + 5] = __uint_as_float(_ldv8_3_5);
                                _vec_load_3[0 + 6] = __uint_as_float(_ldv8_3_6);
                                _vec_load_3[0 + 7] = __uint_as_float(_ldv8_3_7);
                            }
                            #pragma unroll
                            for (int j_2 = 0; j_2 < 8; j_2++) {
                                cs[q * 8 + j_2] = _vec_load_2[j_2];
                                sn[q * 8 + j_2] = _vec_load_3[j_2];
                            }
                        }
                        #pragma unroll
                        for (int c = 0; c < 4; c++) {
