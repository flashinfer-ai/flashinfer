...
// tvm-ffi direct-source launcher for Cake kernel 'kernel_cake_kimi_k3_vision_tower_d3f07fd30e607c90e120'.
#include <cuda.h>
#include <cuda_bf16.h>
#include <cuda_fp16.h>
...
extern "C" __global__ void kernel_cake_kimi_k3_vision_tower_d3f07fd30e607c90e120(__nv_bfloat16* __restrict__ y, __nv_bfloat16* __restrict__ weight, float* __restrict__ rowsumsq, int M, float eps);


namespace cake_host_shim_cd913ccf7f1dcf30 {
...
void Run(TensorView arg_y, TensorView arg_weight, TensorView arg_rowsumsq, int64_t arg_M, double arg_eps, int64_t grid_x, int64_t grid_y, int64_t grid_z) {
  ...
  cudaError_t launch_status = cudaLaunchKernelExC(
      &config, reinterpret_cast<const void*>(kernel_cake_kimi_k3_vision_tower_d3f07fd30e607c90e120), kargs);
  TVM_FFI_CHECK(launch_status == cudaSuccess, RuntimeError)
      << "cudaLaunchKernelExC for kernel_cake_kimi_k3_vision_tower_d3f07fd30e607c90e120 failed: "
      << cudaGetErrorString(launch_status);
}

}  // namespace cake_host_shim_cd913ccf7f1dcf30

TVM_FFI_DLL_EXPORT_TYPED_FUNC(run, cake_host_shim_cd913ccf7f1dcf30::Run);
