...
# Tile config: CONFIG_sm100_128x64x128_128x64x32_cluster1x1_1ctamma
mma_inst_shape_mnk = (128, 64, 16)
mma_k_dim = 0
cta_group = 1
cgrp_tile_mnk = (128, 64, 64)
...
epi_stage_rows = 128
epi_chunk_elems = 16
ab_stages = 10  # SMEM-D 0B fixed + cast LOAD 0B/stage + multi-GEMM 8192B/stage
...
@cute.kernel
def frost_sm100_moe_grouped_matmul_fwd_128x64x128_128x64x32_cluster1x1_1ctamma_stg(
    m: cutlass.Int64,
    n: cutlass.Int64,
    k: cutlass.Int64,
...
frost_sm100_moe_grouped_matmul_fwd_128x64x128_128x64x32_cluster1x1_1ctamma_stg.set_name_prefix("cudnn", remove_cutlass_symbol=True)
...
def _host(
    ...
    frost_sm100_moe_grouped_matmul_fwd_128x64x128_128x64x32_cluster1x1_1ctamma_stg(
        problem_size[0],
        problem_size[1],
        problem_size[2],
