...
# Tile config: CONFIG_sm100_128x32x128_128x32x32_cluster2x1_2ctamma_swapAB
mma_inst_shape_mnk = (256, 32, 16)
mma_k_dim = 0
cta_group = 2
...
epi_stage_rows = 128
epi_chunk_elems = 32
ab_stages = 9  # SMEM-D 16400B fixed + cast LOAD 0B/stage + multi-GEMM 16384B/stage
...
@cute.kernel
def frost_sm100_moe_grouped_matmul_fwd_swap_ab_128x32x128_128x32x32_cluster2x1_2ctamma_swapAB(
    m: cutlass.Int64,
    n: cutlass.Int64,
    k: cutlass.Int64,
...
frost_sm100_moe_grouped_matmul_fwd_swap_ab_128x32x128_128x32x32_cluster2x1_2ctamma_swapAB.set_name_prefix("cudnn", remove_cutlass_symbol=True)
...
def _host(
    ...
    frost_sm100_moe_grouped_matmul_fwd_swap_ab_128x32x128_128x32x32_cluster2x1_2ctamma_swapAB(
        problem_size[0],
        problem_size[1],
        problem_size[2],
