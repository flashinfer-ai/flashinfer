...
# Tile config: CONFIG_sm100_128x256x128_128x256x32_cluster2x2_2ctamma
mma_inst_shape_mnk = (256, 256, 16)
mma_k_dim = 0
cta_group = 2
cgrp_tile_mnk = (256, 512, 64)
...
@cute.kernel
def frost_sm100_moe_grouped_matmul_fwd_128x256x128_128x256x32_cluster2x2_2ctamma_stg(
    m: cutlass.Int64,
    n: cutlass.Int64,
    k: cutlass.Int64,
...
frost_sm100_moe_grouped_matmul_fwd_128x256x128_128x256x32_cluster2x2_2ctamma_stg.set_name_prefix("cudnn", remove_cutlass_symbol=True)
...
def _host(
    ...
    frost_sm100_moe_grouped_matmul_fwd_128x256x128_128x256x32_cluster2x2_2ctamma_stg(
        problem_size[0],
        problem_size[1],
        problem_size[2],
