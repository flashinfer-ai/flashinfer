...
# Inlined from cudnn.gemm.frost.kernel_templates._tile_helpers
# Copyright (c) 2026 NVIDIA CORPORATION & AFFILIATES. All rights reserved.
# SPDX-License-Identifier: MIT
...
# Tile config: CONFIG_sm100_128x128x64_128x128x32_cluster2x1_2ctamma
mma_inst_shape_mnk = (256, 128, 16)
cta_group = 2
cgrp_tile_mnk = (256, 128, 32)
cta_tile_mnk = (128, 64, 32)
epi_tile_mn = (128, 32)
threads_per_cta = 256
...
ab_smem_swizzle = cutlass.experimental.primitives.Tcgen05SmemSwizzle.SWIZZLE_64B
a_smem_desc_leading_byte_offset = 16
a_smem_desc_stride_byte_offset = 512
a_smem_k_step_bytes = 32
a_smem_m_step_bytes = 8192
a_tma_group_elems = 1
b_smem_desc_leading_byte_offset = 16
b_smem_desc_stride_byte_offset = 512
b_smem_k_step_bytes = 32
b_tma_group_elems = 1
mma_size_m = 1
mma_size_n = 1
mma_size_k = 2
ab_tma_swizzle = _tma.TensorMapSwizzle.s64b

# Dtype family: A=bf16->MMAbf16, B=bf16->MMAbf16, out=bf16 (K_BYTES=64)
...
epi_stage_rows = 128
epi_chunk_elems = 32
ab_stages = 16  # SMEM-D 16400B fixed + cast LOAD 0B/stage + multi-GEMM 4096B/stage
...
@cute.kernel
def frost_sm100_moe_grouped_matmul_fwd_128x128x64_128x128x32_cluster2x1_2ctamma(
    m: cutlass.Int64,
    n: cutlass.Int64,
    k: cutlass.Int64,
...
frost_sm100_moe_grouped_matmul_fwd_128x128x64_128x128x32_cluster2x1_2ctamma.set_name_prefix("cudnn", remove_cutlass_symbol=True)
...
def _host(
    ...
    frost_sm100_moe_grouped_matmul_fwd_128x128x64_128x128x32_cluster2x1_2ctamma(
        problem_size[0],
        problem_size[1],
        problem_size[2],
