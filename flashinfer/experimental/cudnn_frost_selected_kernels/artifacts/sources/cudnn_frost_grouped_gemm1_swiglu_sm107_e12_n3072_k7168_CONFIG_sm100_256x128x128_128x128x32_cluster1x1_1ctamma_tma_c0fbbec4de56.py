...
# Tile config: CONFIG_sm100_256x128x128_128x128x32_cluster1x1_1ctamma
...
epi_stage_rows = 128
epi_chunk_elems = 32
ab_stages = 4  # SMEM-D 16400B fixed + cast LOAD 0B/stage + multi-GEMM 16384B/stage
...
@cute.kernel
def frost_sm100_moe_grouped_matmul_fwd_256x128x128_128x128x32_cluster1x1_1ctamma(
    m: cutlass.Int64,
    n: cutlass.Int64,
    k: cutlass.Int64,
...
frost_sm100_moe_grouped_matmul_fwd_256x128x128_128x128x32_cluster1x1_1ctamma.set_name_prefix("cudnn", remove_cutlass_symbol=True)
...
def _host(
    ...
    frost_sm100_moe_grouped_matmul_fwd_256x128x128_128x128x32_cluster1x1_1ctamma(
        problem_size[0],
        problem_size[1],
        problem_size[2],
