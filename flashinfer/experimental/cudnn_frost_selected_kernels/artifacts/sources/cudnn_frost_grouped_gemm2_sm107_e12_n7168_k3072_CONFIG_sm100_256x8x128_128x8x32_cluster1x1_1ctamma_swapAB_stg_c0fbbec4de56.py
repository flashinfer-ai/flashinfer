...
# Tile config: CONFIG_sm100_256x8x128_128x8x32_cluster1x1_1ctamma_swapAB
mma_inst_shape_mnk = (128, 8, 16)
mma_k_dim = 0
cta_group = 1
cgrp_tile_mnk = (256, 8, 64)
...
@cute.kernel
def frost_sm100_moe_grouped_matmul_fwd_swap_ab_256x8x128_128x8x32_cluster1x1_1ctamma_swapAB_stg(
    m: cutlass.Int64,
    n: cutlass.Int64,
    k: cutlass.Int64,
...
frost_sm100_moe_grouped_matmul_fwd_swap_ab_256x8x128_128x8x32_cluster1x1_1ctamma_swapAB_stg.set_name_prefix("cudnn", remove_cutlass_symbol=True)
...
def _host(
    ...
    frost_sm100_moe_grouped_matmul_fwd_swap_ab_256x8x128_128x8x32_cluster1x1_1ctamma_swapAB_stg(
        problem_size[0],
        problem_size[1],
        problem_size[2],
