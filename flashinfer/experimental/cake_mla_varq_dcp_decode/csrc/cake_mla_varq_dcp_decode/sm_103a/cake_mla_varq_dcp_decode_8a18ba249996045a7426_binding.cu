...
// tvm-ffi direct-source launcher for Cake kernel 'kernel_cake_mla_varq_dcp_decode_8a18ba249996045a7426'.
#include <cuda.h>
#include <cuda_bf16.h>
#include <cuda_fp16.h>
...
extern "C" __global__ void kernel_cake_mla_varq_dcp_decode_8a18ba249996045a7426(__nv_bfloat16* __restrict__ partial_O, float* __restrict__ partial_lse, __nv_bfloat16* __restrict__ O, float* __restrict__ LSE, unsigned int* __restrict__ unit_flags, unsigned int* __restrict__ split_meta, unsigned int* __restrict__ merge_ctl, int* __restrict__ cum_seq_lens_q, int num_heads, int tiles_max, int max_records);


namespace cake_host_shim_d9acf47d49142d58 {
...
void Run(TensorView arg_partial_O, TensorView arg_partial_lse, TensorView arg_O, TensorView arg_LSE, TensorView arg_unit_flags, TensorView arg_split_meta, TensorView arg_merge_ctl, TensorView arg_cum_seq_lens_q, int64_t arg_num_heads, int64_t arg_tiles_max, int64_t arg_max_records, int64_t grid_x, int64_t grid_y, int64_t grid_z) {
  ...
  TVM_FFI_CHECK(arg_tiles_max >= -2147483648LL && arg_tiles_max <= 2147483647LL, ValueError)
      ...
      << " is outside i32 range [-2147483648, 2147483647]";
  TVM_FFI_CHECK(arg_max_records >= -2147483648LL && arg_max_records <= 2147483647LL, ValueError)
      << "scalar 'max_records' value " << arg_max_records
      << " is outside i32 range [-2147483648, 2147483647]";
  ...
  CheckSameCudaDevice(arg_unit_flags, arg_partial_O, "unit_flags", "partial_O");
  CheckSameCudaDevice(arg_split_meta, arg_partial_O, "split_meta", "partial_O");
  CheckSameCudaDevice(arg_merge_ctl, arg_partial_O, "merge_ctl", "partial_O");
  CheckSameCudaDevice(arg_cum_seq_lens_q, arg_partial_O, "cum_seq_lens_q", "partial_O");
  ...
  int32_t v_max_records = (int32_t)arg_max_records;
  void* kargs[] = {&p_partial_O, &p_partial_lse, &p_O, &p_LSE, &p_unit_flags, &p_split_meta, &p_merge_ctl, &p_cum_seq_lens_q, &v_num_heads, &v_tiles_max, &v_max_records};
  ...
  cudaError_t launch_status = cudaLaunchKernelExC(
      &config, reinterpret_cast<const void*>(kernel_cake_mla_varq_dcp_decode_8a18ba249996045a7426), kargs);
  TVM_FFI_CHECK(launch_status == cudaSuccess, RuntimeError)
      << "cudaLaunchKernelExC for kernel_cake_mla_varq_dcp_decode_8a18ba249996045a7426 failed: "
      << cudaGetErrorString(launch_status);
}

}  // namespace cake_host_shim_d9acf47d49142d58

TVM_FFI_DLL_EXPORT_TYPED_FUNC(run, cake_host_shim_d9acf47d49142d58::Run);
