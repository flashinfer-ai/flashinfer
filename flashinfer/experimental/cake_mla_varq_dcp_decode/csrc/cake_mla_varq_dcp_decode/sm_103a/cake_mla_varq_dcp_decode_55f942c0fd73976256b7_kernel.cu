        ...
        { // load_warp_main
            ...
            if (cluster_id < (unsigned int)num_items) {
                ...
                for (int kbb = 0; kbb < 1; kbb++) {
                    pg_pf[kbb] = page_table[sb_w2 * max_pages + (tok_b + kbb * 64) / 128];
                }
                ...
                if (n_w2 > 0) {
                    ...
                    for (int kbl = 0; kbl < 1; kbl++) {
                        ...
                        off_k0b[kbl] = tok_kbl % 128;
                        if (one_sp != 0) {
                            pg_k0b[kbl] = pg_pf[kbl];
                        } else {
                            pg_k0b[kbl] = page_table[pt_sp + tok_kbl / 128];
                        }
                    }
                    #pragma unroll
                ...
                if (hit_sp >= 0) {
                    if (end_sp > start_sp) {
                        ...
                        for (int kbl_1 = 0; kbl_1 < 1; kbl_1++) {
                            ...
                            off_k0e[kbl_1] = tok_kbl_1 % 128;
                            {
                                pg_k0e[kbl_1] = page_table[pt_sp + tok_kbl_1 / 128];
                            }
                        }
                        #pragma unroll
                ...
                if (num_kv_tiles_4 > 0) {
                    ...
                    if (spec_left == 0) {
                        ...
                        for (int kbl_2 = 0; kbl_2 < 1; kbl_2++) {
                            ...
                            off_k0[kbl_2] = tok_kbl_2 % 128;
                            if (is_static_3 != 0) {
                                pg_k0[kbl_2] = pg_pf[kbl_2];
                            } else {
                                pg_k0[kbl_2] = page_table[pt_base + tok_kbl_2 / 128];
                            }
                        }
                        #pragma unroll
                    ...
                    if (num_kv_tiles_4 > 1) {
                        ...
                        for (int kbl_3 = 0; kbl_3 < 1; kbl_3++) {
                            ...
                            off_kn[kbl_3] = tok_kbl_3 % 128;
                            {
                                pg_kn[kbl_3] = page_table[pt_base + tok_kbl_3 / 128];
                            }
                        }
                    }
                    if (num_kv_tiles_4 > 0) {
                        ...
                        for (int psv_l = 0; psv_l < 2; psv_l++) {
                            ...
                            for (int vbv_l = 0; vbv_l < 1; vbv_l++) {
                                ...
                                pg_vn[psv_l + vbv_l] = page_table[pt_base + tok_vl / 128];
                                off_vn[psv_l + vbv_l] = tok_vl % 128;
                            }
                        }
                    }
                    #pragma unroll 1
                    for (int tile_3 = 0; tile_3 < num_kv_tiles_4; tile_3++) {
                        ...
                        if (num_kv_tiles_4 > tile_3 + 1 + 1) {
                            ...
                            for (int kbl_4 = 0; kbl_4 < 1; kbl_4++) {
                                ...
                                off_kn[kbl_4] = tok_kbl_4 % 128;
                                {
                                    pg_kn[kbl_4] = page_table[pt_base + tok_kbl_4 / 128];
                                }
                            }
                        }
                        if (num_kv_tiles_4 > tile_3 + 1) {
                            ...
                            for (int psv_l_1 = 0; psv_l_1 < 2; psv_l_1++) {
                                ...
                                for (int vbv_l_1 = 0; vbv_l_1 < 1; vbv_l_1++) {
                                    ...
                                    pg_vn[psv_l_1 + vbv_l_1] = page_table[pt_base + tok_vl_1 / 128];
                                    off_vn[psv_l_1 + vbv_l_1] = tok_vl_1 % 128;
                                }
                            }
                        }
                        if (has_k != 0) {
