...
// tvm-ffi direct-source launcher for Cake kernel 'kernel_cake_mla_varq_dcp_decode_bd9a8b80a732b73de2a5'.
#include <cuda.h>
#include <cuda_bf16.h>
#include <cuda_fp16.h>
...
extern "C" __global__ void kernel_cake_mla_varq_dcp_decode_bd9a8b80a732b73de2a5(__nv_bfloat16* __restrict__ partial_O, float* __restrict__ partial_lse, __nv_bfloat16* __restrict__ O, float* __restrict__ LSE, unsigned int* __restrict__ unit_flags, unsigned int* __restrict__ split_meta, unsigned int* __restrict__ merge_ctl, int* __restrict__ cum_seq_lens_q, int num_heads, int tiles_max, int max_records);


namespace cake_host_shim_68de1f8bd0b8cf8c {
...
void Run(TensorView arg_partial_O, TensorView arg_partial_lse, TensorView arg_O, TensorView arg_LSE, TensorView arg_unit_flags, TensorView arg_split_meta, TensorView arg_merge_ctl, TensorView arg_cum_seq_lens_q, int64_t arg_num_heads, int64_t arg_tiles_max, int64_t arg_max_records, int64_t grid_x, int64_t grid_y, int64_t grid_z) {
  ...
  cudaError_t launch_status = cudaLaunchKernelExC(
      &config, reinterpret_cast<const void*>(kernel_cake_mla_varq_dcp_decode_bd9a8b80a732b73de2a5), kargs);
  TVM_FFI_CHECK(launch_status == cudaSuccess, RuntimeError)
      << "cudaLaunchKernelExC for kernel_cake_mla_varq_dcp_decode_bd9a8b80a732b73de2a5 failed: "
      << cudaGetErrorString(launch_status);
}

}  // namespace cake_host_shim_68de1f8bd0b8cf8c

TVM_FFI_DLL_EXPORT_TYPED_FUNC(run, cake_host_shim_68de1f8bd0b8cf8c::Run);
