...
kernel_cake_mla_varq_dcp_decode_bd9a8b80a732b73de2a5(__nv_bfloat16* __restrict__ partial_O, float* __restrict__ partial_lse, __nv_bfloat16* __restrict__ O, float* __restrict__ LSE, unsigned int* __restrict__ unit_flags, unsigned int* __restrict__ split_meta, unsigned int* __restrict__ merge_ctl, int* __restrict__ cum_seq_lens_q, int num_heads, int tiles_max, int max_records)
{
