...
// tvm-ffi direct-source launcher for Cake kernel 'kernel_cake_nvfp4_mla_decode_dc4be86c62fbaf46c704'.
#include <cuda.h>
#include <cuda_bf16.h>
#include <cuda_fp16.h>
...
extern "C" __global__ void kernel_cake_nvfp4_mla_decode_dc4be86c62fbaf46c704(__nv_bfloat16* __restrict__ o, float* __restrict__ lse, float* __restrict__ partial_o, float* __restrict__ partial_lse, int* __restrict__ row_splits, int num_heads, int max_splits);


namespace cake_host_shim_6b5f83ed33a2e76d {
...
void Run(TensorView arg_o, TensorView arg_lse, TensorView arg_partial_o, TensorView arg_partial_lse, TensorView arg_row_splits, int64_t arg_num_heads, int64_t arg_max_splits, int64_t grid_x, int64_t grid_y, int64_t grid_z) {
  ...
  cudaError_t launch_status = cudaLaunchKernelExC(
      &config, reinterpret_cast<const void*>(kernel_cake_nvfp4_mla_decode_dc4be86c62fbaf46c704), kargs);
  TVM_FFI_CHECK(launch_status == cudaSuccess, RuntimeError)
      << "cudaLaunchKernelExC for kernel_cake_nvfp4_mla_decode_dc4be86c62fbaf46c704 failed: "
      << cudaGetErrorString(launch_status);
}

}  // namespace cake_host_shim_6b5f83ed33a2e76d

TVM_FFI_DLL_EXPORT_TYPED_FUNC(run, cake_host_shim_6b5f83ed33a2e76d::Run);
