...
// tvm-ffi direct-source launcher for Cake kernel 'kernel_cake_nvfp4_mla_decode_8345960a39a614c055f6'.
#include <cuda.h>
#include <cuda_bf16.h>
#include <cuda_fp16.h>
...
extern "C" __global__ void kernel_cake_nvfp4_mla_decode_8345960a39a614c055f6(const __grid_constant__ CUtensorMap Q, const __grid_constant__ CUtensorMap QS, const __grid_constant__ CUtensorMap KV, const __grid_constant__ CUtensorMap KVS, __nv_bfloat16* __restrict__ O, float* __restrict__ LSE, float* __restrict__ partial_o, float* __restrict__ partial_lse, int* __restrict__ work_table, int* __restrict__ unit_first, int* __restrict__ page_table, int* __restrict__ seq_lens, int* __restrict__ q_indptr, float* __restrict__ sinks, int num_heads, int q_len, int max_pages, int max_splits, float scale_log2);


namespace cake_host_shim_01d29a6fd3fd4c5e {
...
void Run(TensorView arg_Q, TensorView arg_QS, TensorView arg_KV, TensorView arg_KVS, TensorView arg_O, TensorView arg_LSE, TensorView arg_partial_o, TensorView arg_partial_lse, TensorView arg_work_table, TensorView arg_unit_first, TensorView arg_page_table, TensorView arg_seq_lens, TensorView arg_q_indptr, TensorView arg_sinks, int64_t arg_num_heads, int64_t arg_q_len, int64_t arg_max_pages, int64_t arg_max_splits, double arg_scale_log2, int64_t grid_x, int64_t grid_y, int64_t grid_z) {
    ...
    if (it == smem_status_by_device->end()) {
      ...
      if (smem_status == cudaSuccess) {
        smem_status = cudaFuncSetAttribute(
            reinterpret_cast<const void*>(kernel_cake_nvfp4_mla_decode_8345960a39a614c055f6),
  ...
  TVM_FFI_CHECK(smem_status == cudaSuccess, RuntimeError)
      << "cudaFuncSetAttribute for kernel_cake_nvfp4_mla_decode_8345960a39a614c055f6 failed: "
  ...
  cudaError_t launch_status = cudaLaunchKernelExC(
      &config, reinterpret_cast<const void*>(kernel_cake_nvfp4_mla_decode_8345960a39a614c055f6), kargs);
  TVM_FFI_CHECK(launch_status == cudaSuccess, RuntimeError)
      << "cudaLaunchKernelExC for kernel_cake_nvfp4_mla_decode_8345960a39a614c055f6 failed: "
      << cudaGetErrorString(launch_status);
}

}  // namespace cake_host_shim_01d29a6fd3fd4c5e

TVM_FFI_DLL_EXPORT_TYPED_FUNC(run, cake_host_shim_01d29a6fd3fd4c5e::Run);
