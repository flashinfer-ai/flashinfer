...
// tvm-ffi direct-source launcher for Cake kernel 'kernel_cake_nvfp4_mla_decode_5c02ef0c72ec6887b7f5'.
#include <cuda.h>
#include <cuda_bf16.h>
#include <cuda_fp16.h>
...
extern "C" __global__ void kernel_cake_nvfp4_mla_decode_5c02ef0c72ec6887b7f5(__nv_bfloat16* __restrict__ o, float* __restrict__ lse, __nv_bfloat16* __restrict__ partial_o, float* __restrict__ partial_lse, int* __restrict__ row_splits, int total_q, int num_heads, int max_splits);


namespace cake_host_shim_be7ef276bbccebd3 {
...
void Run(TensorView arg_o, TensorView arg_lse, TensorView arg_partial_o, TensorView arg_partial_lse, TensorView arg_row_splits, int64_t arg_total_q, int64_t arg_num_heads, int64_t arg_max_splits, int64_t grid_x, int64_t grid_y, int64_t grid_z) {
  ...
  cudaError_t launch_status = cudaLaunchKernelExC(
      &config, reinterpret_cast<const void*>(kernel_cake_nvfp4_mla_decode_5c02ef0c72ec6887b7f5), kargs);
  TVM_FFI_CHECK(launch_status == cudaSuccess, RuntimeError)
      << "cudaLaunchKernelExC for kernel_cake_nvfp4_mla_decode_5c02ef0c72ec6887b7f5 failed: "
      << cudaGetErrorString(launch_status);
}

}  // namespace cake_host_shim_be7ef276bbccebd3

TVM_FFI_DLL_EXPORT_TYPED_FUNC(run, cake_host_shim_be7ef276bbccebd3::Run);
