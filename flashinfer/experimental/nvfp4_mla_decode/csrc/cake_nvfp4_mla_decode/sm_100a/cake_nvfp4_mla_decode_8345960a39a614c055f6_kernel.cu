...
kernel_cake_nvfp4_mla_decode_8345960a39a614c055f6(const __grid_constant__ CUtensorMap Q, const __grid_constant__ CUtensorMap QS, const __grid_constant__ CUtensorMap KV, const __grid_constant__ CUtensorMap KVS, __nv_bfloat16* __restrict__ O, float* __restrict__ LSE, float* __restrict__ partial_o, float* __restrict__ partial_lse, int* __restrict__ work_table, int* __restrict__ unit_first, int* __restrict__ page_table, int* __restrict__ seq_lens, int* __restrict__ q_indptr, float* __restrict__ sinks, int num_heads, int q_len, int max_pages, int max_splits, float scale_log2)
{
