...
kernel_cake_nvfp4_mla_decode_658a7a88207e25d82f4f(__nv_bfloat16* __restrict__ o, float* __restrict__ lse, float* __restrict__ partial_o, float* __restrict__ partial_lse, int* __restrict__ row_splits, int num_heads, int max_splits)
{
