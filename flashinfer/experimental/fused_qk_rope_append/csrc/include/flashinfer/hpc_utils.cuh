...
#ifndef FLASHINFER_HPC_UTILS_CUH_
#define FLASHINFER_HPC_UTILS_CUH_
...
#if 0  // The fused RoPE port only needs the vector and warp helpers above.
...
#endif  // FLASHINFER_HPC_UTILS_CUH_
