                ...
                }
                {
                    ...
                    if (warp_in_role == 0) {
                        if (lane == 0) {
                            ...
                            smem_split_flag[0] = ((old_count + 1 == 8) ? 1 : 0);
                        }
                    }
                    asm volatile("barrier.sync 8, 128;" ::: "memory");
                    if (smem_split_flag[0] != 0) {
                        ...
                        if (m_head < group_size) {
                            ...
                            for (int rs = 0; rs < 8; rs++) {
                                float _max_4 = max_noftz(merge_m, partial_M[(item * 8 + rs) * 128 + m_head]);
                                merge_m = _max_4;
                            }
                            float merge_d = 0.0f;
                            float merge_w[8];
                            ...
                            for (int rs_1 = 0; rs_1 < 8; rs_1++) {
                                int rs_idx = (item * 8 + rs_1) * 128 + m_head;
                            ...
                            for (int rs_2 = 0; rs_2 < 8; rs_2++) {
                                float rs_o[8];
                                {
                                    ...
                                    asm volatile(
                                        ...
                                        : "=r"(_ldv8_0_0), "=r"(_ldv8_0_1), "=r"(_ldv8_0_2), "=r"(_ldv8_0_3), "=r"(_ldv8_0_4), "=r"(_ldv8_0_5), "=r"(_ldv8_0_6), "=r"(_ldv8_0_7) : "l"((const void*)(partial_O + (((item * 8 + rs_2) * 128 + m_head) * 128 + m_dims))) : "memory");
                            ...
                            for (int rs_3 = 0; rs_3 < 8; rs_3++) {
                                float rs_o_1[8];
                                {
                                    ...
                                    asm volatile(
                                        "ld.global.v8.b32 {%0, %1, %2, %3, %4, %5, %6, %7}, [%8];"
                                        : "=r"(_ldv8_2_0), "=r"(_ldv8_2_1), "=r"(_ldv8_2_2), "=r"(_ldv8_2_3), "=r"(_ldv8_2_4), "=r"(_ldv8_2_5), "=r"(_ldv8_2_6), "=r"(_ldv8_2_7) : "l"((const void*)(partial_O + (((item * 8 + rs_3) * 128 + m_head) * 128 + m_dims + 8))) : "memory");
