...
MODULES: dict[str, dict[str, Any]] = {
    ...
    "cake_minimax_h3_varlen_attention_6430ffb533a0f0b84f84": {
        "arch": "sm_100a",
        "role": "kernel",
        "sources": [
            "cake_minimax_h3_varlen_attention/sm_100a/cake_minimax_h3_varlen_attention_6430ffb533a0f0b84f84_kernel.cu",
            "cake_minimax_h3_varlen_attention/sm_100a/cake_minimax_h3_varlen_attention_6430ffb533a0f0b84f84_binding.cu",
        ],
        "compile_flags": [],
        "ffi_entry": "run",
        "arg_plan": [
        ...
        "closure_sha256": "f8e501d7a81d34d6a2375a78e42ce1b65aaf3342643f1ae243b56569d09bc05b",
        "tma_workspace_bytes": 0,
    },
    ...
    "cake_minimax_h3_varlen_attention_b40e2945061cd567f966": {
        "arch": "sm_103a",
        "role": "kernel",
        "sources": [
            "cake_minimax_h3_varlen_attention/sm_103a/cake_minimax_h3_varlen_attention_b40e2945061cd567f966_kernel.cu",
            "cake_minimax_h3_varlen_attention/sm_103a/cake_minimax_h3_varlen_attention_b40e2945061cd567f966_binding.cu",
        ],
        "compile_flags": [],
        "ffi_entry": "run",
        "arg_plan": [
        ...
        "closure_sha256": "ebc5618a88b19bf58fe5032b45f9803bc2b5cce0f23547047076360641291061",
        "tma_workspace_bytes": 0,
    },
...
ROUTES: dict[str, dict[str, Any]] = {
    ...
    "nvfp4_fp8pv__sm_100a": {
        ...
        "stages": ["quantize", "attention", "attention_split", "combine"],
        "modules": {
            "quantize": "cake_minimax_h3_varlen_attention_6430ffb533a0f0b84f84",
    ...
    "nvfp4_fp8pv__sm_103a": {
        ...
        "stages": ["quantize", "attention", "attention_split", "combine"],
        "modules": {
            "quantize": "cake_minimax_h3_varlen_attention_b40e2945061cd567f966",
