...
kernel_cake_minimax_h3_varlen_attention_ccb677c5f7ec9549b929(__nv_bfloat16* __restrict__ v, float* __restrict__ v_amax_partial, int num_vectors, int num_chunks)
{
