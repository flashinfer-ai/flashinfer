...
kernel_cake_minimax_h3_varlen_attention_7de2105cc1efe0aa7c9c(__half* __restrict__ partial_O, float* __restrict__ partial_ML, int* __restrict__ combine_table, int* __restrict__ seg_begin, int* __restrict__ seg_len, __nv_bfloat16* __restrict__ O, int num_heads)
{
