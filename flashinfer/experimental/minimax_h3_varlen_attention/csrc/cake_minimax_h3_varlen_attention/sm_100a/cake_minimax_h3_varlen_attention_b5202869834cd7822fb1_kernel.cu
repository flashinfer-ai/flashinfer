...
kernel_cake_minimax_h3_varlen_attention_b5202869834cd7822fb1(__half* __restrict__ partial_O, float* __restrict__ partial_ML, int* __restrict__ combine_table, int* __restrict__ seg_begin, int* __restrict__ seg_len, __nv_bfloat16* __restrict__ O, int num_heads)
{
