...
kernel_cake_minimax_h3_varlen_attention_f6b0a347ba82c9a16d05(__nv_bfloat16* __restrict__ v, float* __restrict__ v_amax_partial, int num_vectors, int num_chunks)
{
