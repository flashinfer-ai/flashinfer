...
kernel_cake_kimi_k3_latent_moe_4465670f3a04289cee89(__nv_bfloat16* __restrict__ routed, __nv_bfloat16* __restrict__ norm_weight, __nv_bfloat16* __restrict__ y_out, int M, int num_partials, float eps)
{
