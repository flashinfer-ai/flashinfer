        ...
        { // epilogue_main
            ...
            if (fin == 1) {
                if (cls == 2) {
                    ...
                    if (tok < num_tokens) {
                        __nv_bfloat16 _cvt_bf16_12 = __float2bfloat16(red[0]);
                        float _cvt_f32_12 = __bfloat162float(_cvt_bf16_12);
                        float gk = _cvt_f32_12;
                        __nv_bfloat16 _cvt_bf16_13 = __float2bfloat16(red[4]);
                        float _cvt_f32_13 = __bfloat162float(_cvt_bf16_13);
                        float uk = _cvt_f32_13;
                    ...
                    if (tok_0 < num_tokens) {
                        __nv_bfloat16 _cvt_bf16_14 = __float2bfloat16(red[1]);
                        float _cvt_f32_14 = __bfloat162float(_cvt_bf16_14);
                        float gk_1 = _cvt_f32_14;
                        __nv_bfloat16 _cvt_bf16_15 = __float2bfloat16(red[5]);
                        float _cvt_f32_15 = __bfloat162float(_cvt_bf16_15);
                        float uk_1 = _cvt_f32_15;
                    ...
                    if (tok_2 < num_tokens) {
                        __nv_bfloat16 _cvt_bf16_16 = __float2bfloat16(red[2]);
                        float _cvt_f32_16 = __bfloat162float(_cvt_bf16_16);
                        float gk_2 = _cvt_f32_16;
                        __nv_bfloat16 _cvt_bf16_17 = __float2bfloat16(red[6]);
                        float _cvt_f32_17 = __bfloat162float(_cvt_bf16_17);
                        float uk_2 = _cvt_f32_17;
                    ...
                    if (tok_4 < num_tokens) {
                        __nv_bfloat16 _cvt_bf16_18 = __float2bfloat16(red[3]);
                        float _cvt_f32_18 = __bfloat162float(_cvt_bf16_18);
                        float gk_3 = _cvt_f32_18;
                        __nv_bfloat16 _cvt_bf16_19 = __float2bfloat16(red[7]);
                        float _cvt_f32_19 = __bfloat162float(_cvt_bf16_19);
                        float uk_3 = _cvt_f32_19;
        ...
        { // load_main
            ...
            if (elect_sync()) {
                ...
                for (int s = 0; s < u_count_l; s++) {
                    ...
                    {
                        int kb1 = k1_off + m;
                        tma_3d_gmem2smem(smem_b_addr + stage * 1024, (&B_1), 0, 0, kb1, a_full_addr + (stage) * 8);
                    }
                    if (need_a == 1) {
                        {
                            int kc1 = k1_off + m;
                    ...
                    {
                        mbarrier_arrive_expect_tx(a_full_addr + (stage) * 8, 17408);
                    }
                    stage += 1;
                ...
                for (int m_1 = 0; m_1 < u_count_m; m_1++) {
                    ...
                    int init_flag = ((m_1 == 0) ? 1 : 0);
                    {
                        ...
                        if (cls_2 == 2) {
                            ...
                            int _mma_b_lo_0 = (((smem_b_addr) >> 4) & 0x3FFF) + (stage_1) * 64;
                            asm volatile(
                    "{\n\t"
                    ".reg .pred p0, p1;\n\t"
                    ...
                    :: "r"(_mma_a_lo_0), "r"(_mma_b_lo_0), "r"((tmem_acc + (32))), "r"(((init_sub) ? 0 : 1)));
                            ...
                            int _mma_b_lo_1 = (((smem_b_addr) >> 4) & 0x3FFF) + (stage_1) * 64;
                            asm volatile(
                    "{\n\t"
                    ".reg .pred p0, p1;\n\t"
                    ".reg .b32 adhi, bdhi, alo, blo, id;\n\t"
