...
#define SMEM_SMEM_B_OFF 117760
#define SMEM_SMEM_B_STAGE_BYTES 16384
#define SMEM_SMEM_B_STRIDE 16384
#define SMEM_SMEM_BN_OFF 232448
...
kernel_cake_kimi_k3_latent_moe_79f61091d58abcb2eafb(const __grid_constant__ CUtensorMap A_R, const __grid_constant__ CUtensorMap A_L, const __grid_constant__ CUtensorMap A_S, const __grid_constant__ CUtensorMap A_2, const __grid_constant__ CUtensorMap B_1, const __grid_constant__ CUtensorMap B_2, float* __restrict__ out_r, __nv_bfloat16* __restrict__ out_l, __nv_bfloat16* __restrict__ out_s, unsigned int* __restrict__ counters, __nv_bfloat16* __restrict__ routed, __nv_bfloat16* __restrict__ norm_w, __nv_bfloat16* __restrict__ y_out, unsigned long long* __restrict__ tl, int num_tokens, int k1_off, int num_partials, float eps)
{
    ...
    #define a_empty_addr (mbar_base + 56)
    #define acc_full_addr (mbar_base + 112)
    #define acc_empty_addr (mbar_base + 120)
    #define red_bar_addr (mbar_base + 128)
    #define issue_bar_addr (mbar_base + 136)
    #define rows_bar_addr (mbar_base + 144)
    #define bn_bar_addr (mbar_base + 152)
    ...
    __nv_bfloat16* smem_b = reinterpret_cast<__nv_bfloat16*>(smem_raw + 117760);
    const int smem_b_addr = smem + 117760;
    __nv_bfloat16* smem_bn = reinterpret_cast<__nv_bfloat16*>(smem_raw + 232448);
    const int smem_bn_addr = smem + 232448;
    ...
    if (warp == 0) {
        ...
        if (leader) {
            // --- pipeline 'tma_pipe' ---
            // a_full: 7 barriers, init_count=1
            ...
            // a_empty: 7 barriers, init_count=1
            ...
            if (fin == 1) {
                if (cls == 2) {
                    ...
                    if (tok_30 < num_tokens) {
                        ...
                        *(reinterpret_cast<__nv_bfloat16*>(out_s + (tok_30 * 6144 + row_s + frow_31)) + (0)) = __float2bfloat16_rn(aa_16 * bb_16);
                    }
                    ...
                    if (tok_32 < num_tokens) {
                        ...
                        *(reinterpret_cast<__nv_bfloat16*>(out_s + (tok_32 * 6144 + row_s + frow_33)) + (0)) = __float2bfloat16_rn(aa_17 * bb_17);
                    }
                    ...
                    if (tok_34 < num_tokens) {
                        ...
                        *(reinterpret_cast<__nv_bfloat16*>(out_s + (tok_34 * 6144 + row_s + frow_35)) + (0)) = __float2bfloat16_rn(aa_18 * bb_18);
                    }
                    ...
                    if (tok_36 < num_tokens) {
                        ...
                        *(reinterpret_cast<__nv_bfloat16*>(out_s + (tok_36 * 6144 + row_s + frow_37)) + (0)) = __float2bfloat16_rn(aa_19 * bb_19);
                    }
                    ...
                    if (tok_38 < num_tokens) {
                        ...
                        *(reinterpret_cast<__nv_bfloat16*>(out_s + (tok_38 * 6144 + row_s + frow_39)) + (0)) = __float2bfloat16_rn(aa_20 * bb_20);
                    }
                    ...
                    if (tok_40 < num_tokens) {
                        ...
                        *(reinterpret_cast<__nv_bfloat16*>(out_s + (tok_40 * 6144 + row_s + frow_41)) + (0)) = __float2bfloat16_rn(aa_21 * bb_21);
                    }
                    ...
                    if (tok_42 < num_tokens) {
                        ...
                        *(reinterpret_cast<__nv_bfloat16*>(out_s + (tok_42 * 6144 + row_s + frow_43)) + (0)) = __float2bfloat16_rn(aa_22 * bb_22);
                    }
                    ...
                    if (tok_44 < num_tokens) {
                        ...
                        *(reinterpret_cast<__nv_bfloat16*>(out_s + (tok_44 * 6144 + row_s + frow_45)) + (0)) = __float2bfloat16_rn(aa_23 * bb_23);
                    }
                    ...
                    if (tok_46 < num_tokens) {
                        ...
                        *(reinterpret_cast<__nv_bfloat16*>(out_s + (tok_46 * 6144 + row_s + frow_47)) + (0)) = __float2bfloat16_rn(aa_24 * bb_24);
                    }
                    ...
                    if (tok_48 < num_tokens) {
                        ...
                        *(reinterpret_cast<__nv_bfloat16*>(out_s + (tok_48 * 6144 + row_s + frow_49)) + (0)) = __float2bfloat16_rn(aa_25 * bb_25);
                    }
                    ...
                    if (tok_50 < num_tokens) {
                        ...
                        *(reinterpret_cast<__nv_bfloat16*>(out_s + (tok_50 * 6144 + row_s + frow_51)) + (0)) = __float2bfloat16_rn(aa_26 * bb_26);
                    }
                    ...
                    if (tok_52 < num_tokens) {
                        ...
                        *(reinterpret_cast<__nv_bfloat16*>(out_s + (tok_52 * 6144 + row_s + frow_53)) + (0)) = __float2bfloat16_rn(aa_27 * bb_27);
                    }
                    ...
                    if (tok_54 < num_tokens) {
                        ...
                        *(reinterpret_cast<__nv_bfloat16*>(out_s + (tok_54 * 6144 + row_s + frow_55)) + (0)) = __float2bfloat16_rn(aa_28 * bb_28);
                    }
                    ...
                    if (tok_56 < num_tokens) {
                        ...
                        *(reinterpret_cast<__nv_bfloat16*>(out_s + (tok_56 * 6144 + row_s + frow_57)) + (0)) = __float2bfloat16_rn(aa_29 * bb_29);
                    }
                    ...
                    if (tok_58 < num_tokens) {
                        ...
                        *(reinterpret_cast<__nv_bfloat16*>(out_s + (tok_58 * 6144 + row_s + frow_59)) + (0)) = __float2bfloat16_rn(aa_30 * bb_30);
                    }
                    ...
                    if (tok_60 < num_tokens) {
                        ...
                        *(reinterpret_cast<__nv_bfloat16*>(out_s + (tok_60 * 6144 + row_s + frow_61)) + (0)) = __float2bfloat16_rn(aa_31 * bb_31);
                    }
                    ...
                    if (tok_62 < num_tokens) {
                        ...
                        *(reinterpret_cast<__nv_bfloat16*>(out_s + (tok_62 * 6144 + row_s + frow_63)) + (0)) = __float2bfloat16_rn(aa_32 * bb_32);
                    }
                    ...
                    if (tok_64 < num_tokens) {
                        ...
                        *(reinterpret_cast<__nv_bfloat16*>(out_s + (tok_64 * 6144 + row_s + frow_65)) + (0)) = __float2bfloat16_rn(aa_33 * bb_33);
                    }
                    ...
                    if (tok_66 < num_tokens) {
                        ...
                        *(reinterpret_cast<__nv_bfloat16*>(out_s + (tok_66 * 6144 + row_s + frow_67)) + (0)) = __float2bfloat16_rn(aa_34 * bb_34);
                    }
                    ...
                    if (tok_68 < num_tokens) {
                        ...
                        *(reinterpret_cast<__nv_bfloat16*>(out_s + (tok_68 * 6144 + row_s + frow_69)) + (0)) = __float2bfloat16_rn(aa_35 * bb_35);
                    }
                    ...
                    if (tok_70 < num_tokens) {
                        ...
                        *(reinterpret_cast<__nv_bfloat16*>(out_s + (tok_70 * 6144 + row_s + frow_71)) + (0)) = __float2bfloat16_rn(aa_36 * bb_36);
                    }
                    ...
                    if (tok_72 < num_tokens) {
                        ...
                        *(reinterpret_cast<__nv_bfloat16*>(out_s + (tok_72 * 6144 + row_s + frow_73)) + (0)) = __float2bfloat16_rn(aa_37 * bb_37);
                    }
                    ...
                    if (tok_74 < num_tokens) {
                        ...
                        *(reinterpret_cast<__nv_bfloat16*>(out_s + (tok_74 * 6144 + row_s + frow_75)) + (0)) = __float2bfloat16_rn(aa_38 * bb_38);
                    }
                    ...
                    if (tok_76 < num_tokens) {
                        ...
                        *(reinterpret_cast<__nv_bfloat16*>(out_s + (tok_76 * 6144 + row_s + frow_77)) + (0)) = __float2bfloat16_rn(aa_39 * bb_39);
                    }
                    ...
                    if (tok_78 < num_tokens) {
                        ...
                        *(reinterpret_cast<__nv_bfloat16*>(out_s + (tok_78 * 6144 + row_s + frow_79)) + (0)) = __float2bfloat16_rn(aa_40 * bb_40);
                    }
                    ...
                    if (tok_80 < num_tokens) {
                        ...
                        *(reinterpret_cast<__nv_bfloat16*>(out_s + (tok_80 * 6144 + row_s + frow_81)) + (0)) = __float2bfloat16_rn(aa_41 * bb_41);
                    }
                    ...
                    if (tok_82 < num_tokens) {
                        ...
                        *(reinterpret_cast<__nv_bfloat16*>(out_s + (tok_82 * 6144 + row_s + frow_83)) + (0)) = __float2bfloat16_rn(aa_42 * bb_42);
                    }
                    ...
                    if (tok_84 < num_tokens) {
                        ...
                        *(reinterpret_cast<__nv_bfloat16*>(out_s + (tok_84 * 6144 + row_s + frow_85)) + (0)) = __float2bfloat16_rn(aa_43 * bb_43);
                    }
                    ...
                    if (tok_86 < num_tokens) {
                        ...
                        *(reinterpret_cast<__nv_bfloat16*>(out_s + (tok_86 * 6144 + row_s + frow_87)) + (0)) = __float2bfloat16_rn(aa_44 * bb_44);
                    }
                    ...
                    if (tok_88 < num_tokens) {
                        ...
                        *(reinterpret_cast<__nv_bfloat16*>(out_s + (tok_88 * 6144 + row_s + frow_89)) + (0)) = __float2bfloat16_rn(aa_45 * bb_45);
                    }
                    ...
                    if (tok_90 < num_tokens) {
                        ...
                        *(reinterpret_cast<__nv_bfloat16*>(out_s + (tok_90 * 6144 + row_s + frow_91)) + (0)) = __float2bfloat16_rn(aa_46 * bb_46);
                    }
                    ...
                    if (tok_92 < num_tokens) {
                        ...
                        *(reinterpret_cast<__nv_bfloat16*>(out_s + (tok_92 * 6144 + row_s + frow_93)) + (0)) = __float2bfloat16_rn(aa_47 * bb_47);
                    }
                    ...
                    if (tok_94 < num_tokens) {
                        ...
                        *(reinterpret_cast<__nv_bfloat16*>(out_s + (tok_94 * 6144 + row_s + frow_95)) + (0)) = __float2bfloat16_rn(aa_48 * bb_48);
                    }
                    ...
                    if (tok_96 < num_tokens) {
                        ...
                        *(reinterpret_cast<__nv_bfloat16*>(out_s + (tok_96 * 6144 + row_s + frow_97)) + (0)) = __float2bfloat16_rn(aa_49 * bb_49);
                    }
                    ...
                    if (tok_98 < num_tokens) {
                        ...
                        *(reinterpret_cast<__nv_bfloat16*>(out_s + (tok_98 * 6144 + row_s + frow_99)) + (0)) = __float2bfloat16_rn(aa_50 * bb_50);
                    }
                    ...
                    if (tok_100 < num_tokens) {
                        ...
                        *(reinterpret_cast<__nv_bfloat16*>(out_s + (tok_100 * 6144 + row_s + frow_101)) + (0)) = __float2bfloat16_rn(aa_51 * bb_51);
                    }
                    ...
                    if (tok_102 < num_tokens) {
                        ...
                        *(reinterpret_cast<__nv_bfloat16*>(out_s + (tok_102 * 6144 + row_s + frow_103)) + (0)) = __float2bfloat16_rn(aa_52 * bb_52);
                    }
                    ...
                    if (tok_104 < num_tokens) {
                        ...
                        *(reinterpret_cast<__nv_bfloat16*>(out_s + (tok_104 * 6144 + row_s + frow_105)) + (0)) = __float2bfloat16_rn(aa_53 * bb_53);
                    }
                    ...
                    if (tok_106 < num_tokens) {
                        ...
                        *(reinterpret_cast<__nv_bfloat16*>(out_s + (tok_106 * 6144 + row_s + frow_107)) + (0)) = __float2bfloat16_rn(aa_54 * bb_54);
                    }
                    ...
                    if (tok_108 < num_tokens) {
                        ...
                        *(reinterpret_cast<__nv_bfloat16*>(out_s + (tok_108 * 6144 + row_s + frow_109)) + (0)) = __float2bfloat16_rn(aa_55 * bb_55);
                    }
                    ...
                    if (tok_110 < num_tokens) {
                        ...
                        *(reinterpret_cast<__nv_bfloat16*>(out_s + (tok_110 * 6144 + row_s + frow_111)) + (0)) = __float2bfloat16_rn(aa_56 * bb_56);
                    }
                    ...
                    if (tok_112 < num_tokens) {
                        ...
                        *(reinterpret_cast<__nv_bfloat16*>(out_s + (tok_112 * 6144 + row_s + frow_113)) + (0)) = __float2bfloat16_rn(aa_57 * bb_57);
                    }
                    ...
                    if (tok_114 < num_tokens) {
                        ...
                        *(reinterpret_cast<__nv_bfloat16*>(out_s + (tok_114 * 6144 + row_s + frow_115)) + (0)) = __float2bfloat16_rn(aa_58 * bb_58);
                    }
                    ...
                    if (tok_116 < num_tokens) {
                        ...
                        *(reinterpret_cast<__nv_bfloat16*>(out_s + (tok_116 * 6144 + row_s + frow_117)) + (0)) = __float2bfloat16_rn(aa_59 * bb_59);
                    }
                    ...
                    if (tok_118 < num_tokens) {
                        ...
                        *(reinterpret_cast<__nv_bfloat16*>(out_s + (tok_118 * 6144 + row_s + frow_119)) + (0)) = __float2bfloat16_rn(aa_60 * bb_60);
                    }
                    ...
                    if (tok_120 < num_tokens) {
                        ...
                        *(reinterpret_cast<__nv_bfloat16*>(out_s + (tok_120 * 6144 + row_s + frow_121)) + (0)) = __float2bfloat16_rn(aa_61 * bb_61);
                    }
                    ...
                    if (tok_122 < num_tokens) {
                        ...
                        *(reinterpret_cast<__nv_bfloat16*>(out_s + (tok_122 * 6144 + row_s + frow_123)) + (0)) = __float2bfloat16_rn(aa_62 * bb_62);
                    }
                    ...
                    if (tok_124 < num_tokens) {
                        ...
                        *(reinterpret_cast<__nv_bfloat16*>(out_s + (tok_124 * 6144 + row_s + frow_125)) + (0)) = __float2bfloat16_rn(aa_63 * bb_63);
                    }
                } else {
                    if (num_tokens > 0) {
                        if (cls == 0) {
    ...
    if (warp == 4) {
        { // load_main
            ...
            int _min_0 = ((7) < (u_count_l) ? (7) : (u_count_l));
            ...
            if (elect_sync()) {
                ...
                for (int s = 0; s < u_count_l; s++) {
                    ...
                    stage += 1;
                    if (stage == 7) { stage = 0; _phase_a_empty ^= 1; }
                }
            }
        }
    }
        ...
        { // mma_main
            ...
            if (elect_sync()) {
                ...
                for (int m_1 = 0; m_1 < u_count_m; m_1++) {
                    ...
                    stage_1 += 1;
                    if (stage_1 == 7) { stage_1 = 0; _phase_a_full ^= 1; }
                }
