...
kernel_cake_kimi_k3_latent_moe_00b9f732bdd5f209c976(__nv_bfloat16* __restrict__ routed, __nv_bfloat16* __restrict__ norm_weight, __nv_bfloat16* __restrict__ y_out, int M, int num_partials, float eps)
{
