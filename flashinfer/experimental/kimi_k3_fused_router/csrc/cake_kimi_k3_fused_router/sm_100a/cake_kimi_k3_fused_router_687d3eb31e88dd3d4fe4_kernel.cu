...
#define SMEM_SELECTED_IDS_STAGE_BYTES 512
#define SMEM_SELECTED_IDS_STRIDE 512
...
__global__ __launch_bounds__(224) __cluster_dims__(8,1,1) void
kernel_cake_kimi_k3_fused_router_687d3eb31e88dd3d4fe4(float* __restrict__ logits, float* __restrict__ bias, float* __restrict__ topk_weights, int* __restrict__ topk_ids, int* __restrict__ sorted_token_ids, int* __restrict__ expert_ids, int* __restrict__ num_tokens_post_padded, int* __restrict__ expert_counts, int* __restrict__ expert_offsets, int* __restrict__ expert_scatter_offsets, int M)
{
