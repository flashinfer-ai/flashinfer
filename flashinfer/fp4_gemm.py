...
def prepare_fp4_gemm(a, b, a_scales, b_scales, *, m, alpha=1.0, out=None,
    ...
    return Fp4GemmPlan(a,b,a_scales,b_scales,m=m,alpha=alpha,out=out,num_stages=num_stages,
        block_n=block_n,epilogue_store_n=epilogue_store_n,descriptor_workspace=descriptor_workspace)
