...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    m.def("bsa_fused_fwd_blk64", &bsa_fused_fwd_blk64,
          "BSA fused attention forward blk=64 (C++ AOT)",
          py::arg("q"), py::arg("k"), py::arg("v"),
          py::arg("q2k_block_index"), py::arg("block_sparse_num"),
          py::arg("block_sizes"), py::arg("softmax_scale"),
