    ...
    def phase4_histogram_snap(
        ...
        if cand_count == cutlass.Int32(kK):
            ...
            while i7 < cand_count:
                ...
                cute.arch.atomic_add(smem_hist.iterator + bin_i, cutlass.Int32(1))
            ...
            for jb in cutlass.range(bins_per_warp, unroll_full=True):
                bidx_s = (
            ...
            if warp_id == target_warp and lane == cutlass.Int32(0):
                ...
                for jb2 in cutlass.range(bins_per_warp, unroll_full=True):
                    bidx2 = (
                        cutlass.Int32(kBins - 1)
