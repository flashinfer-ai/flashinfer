...
def _get_trtllm_moe_sm100_module_impl(enable_rubin: bool):
    ...
    class MoERunner(TunableRunner):
        ...
        factorized_tactics_dict: dict = dict()
        ...
        def _make_tuning_config(
            ...
            **kwargs,
            ...
            tensor_initializers = tuple(
                (input_i, init) for input_i, _, init in sorted_inputs
            )
    ...
    def trtllm_bf16_moe_op(
        ...
        tactic = da_core.tune_and_publish_tactic(
            da_tuning_execution,
            tuner,
            custom_op=custom_op,
            runner=moe_runner,
            runner_inputs=moe_inputs,
            tune_max_num_tokens=tune_max_num_tokens,
            routing_bias=routing_bias,
