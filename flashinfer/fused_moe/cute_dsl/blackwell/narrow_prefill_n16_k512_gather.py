...
class NarrowPrefillN16K512GatherKernel:
    ...
    def wrapper(
        ...
        bl = sm100_utils.make_smem_layout_b(
            mma, self.tile, cutlass.Float8E4M3FN, self.num_b_stage
        )
    ...
    def _kernel_body(
        ...
        b_nks = storage.b.get_tensor(
            cute.composition(
                bl.outer,
                cute.make_layout((16, 512, self.num_b_stage), stride=(1, 16, 8192)),
            ),
            swizzle=bl.inner,
        )
        ...
        if warp == 14:
            ...
            bc = pipeline.make_pipeline_state(
