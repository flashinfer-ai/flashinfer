...
_CUDNN_GROUPED_GEMM_BF16_ARCHS = (80, 86, 87, 89, 90, 100, 103, 110, 120, 121)
_CUDNN_GROUPED_GEMM_FP8_ARCHS = (89, 90, 100, 103, 110, 120, 121)
_CUDNN_GROUPED_GEMM_MXFP8_ARCHS = (100, 103, 110, 120, 121)
_CUDNN_GROUPED_GEMM_FP4_ARCHS = (100, 103, 110, 120, 121)
...
class CudnnGroupedGemmBf16Config:
    ...
    FlashInfer's ``moe_utils`` kernels on SM90, SM100 and SM103 and torch ops
    elsewhere, so ``do_finalize=True`` returns the finalized ``[M, H]`` output
