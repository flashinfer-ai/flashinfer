...
# Source: ocean/src/tilegym/suites/flashinfer/cutile/per_token_group_quant_8bit.py
# Changes vs Ocean source:
#   - Removed `from tilegym.backend import register_impl` (TileGym-private)
#   - Removed @register_impl decorator; function exposed directly
#   - Added output buffer pre-zeroing (x_q.zero_(), x_s.zero_()) per PR #3426 pattern
#   - Added Apache-2.0 SPDX header
...
def per_token_group_quant_8bit_cutile(
    ...
    Migrated from Ocean cuTile suite. Uses public cuda.tile API only.
    No TileGym runtime dependency.
