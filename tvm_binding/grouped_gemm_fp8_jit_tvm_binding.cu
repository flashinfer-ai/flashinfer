...
IntTuple GroupedGemmGetWorkspaceSize(int64_t batch_size, int64_t max_m, int64_t max_n, int64_t max_k);
...
// TVM_FFI_DLL_EXPORT_TYPED_FUNC(grouped_gemm_fp16_fp16_fp16_run, GroupedGemmFp16Fp16Fp16Run);
