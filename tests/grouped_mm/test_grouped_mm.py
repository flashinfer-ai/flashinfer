...
class TestGroupedMmFp4:
    ...
    def test_graph_cache_reuse(self):
        ...
        out1 = grouped_mm_fp4(
            a_fp4, b_fp4, a_sf, b_sf, m_indptr, alpha=alpha, block_size=16
        )
        out2 = grouped_mm_fp4(
            a_fp4, b_fp4, a_sf, b_sf, m_indptr, alpha=alpha, block_size=16
        )
...
# ---------------------------------------------------------------------------
# FP4 Validation / error tests (do not require cuDNN)
# ---------------------------------------------------------------------------
...
if __name__ == "__main__":
    ...
    test_fp4 = TestGroupedMmFp4()
    test_fp4.test_uniform_distribution(4, 128, 256, 256)
    test_fp4.test_non_uniform_distribution()
    test_fp4.test_empty_experts()
    test_fp4.test_single_expert()
    test_fp4.test_preallocated_output()
    test_fp4.test_out_dtype(torch.bfloat16)
    test_fp4.test_graph_cache_reuse()
    print("All fp4 tests passed!")
