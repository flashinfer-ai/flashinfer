...
def test_dsv3_fused_routing_op(num_tokens, num_experts):
    ...
    NoAuxTc(scores, bias, n_group, topk_group, topk, routed_scaling_factor, topk_values, topk_indices, launch_with_pdl=True)

    topk_values_ref, topk_indices_ref = dsv3_ref_check(scores, bias, n_group, topk_group, topk, routed_scaling_factor)
