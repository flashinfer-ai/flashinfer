...
def test_static_profile_points_8_bit_dtypes_without_sage_at_sage_params() -> None:
...
# exercise the contiguous batch stride and the TMA tail together. Their 240
# Q tiles exceed one resident wave, so the plan takes the persistent scheduler.
...
_DENSE_GQA_Q128_KV128_B10 = _Case(
    "dense_contiguous_gqa_q128_kv128_b10",
    10,
    8,
    256,
    512,
...
# Fine KV blocks select the SwapsMmaAb profiles exactly as block-sparse plans
# do; the twelve-batch Q32 case exceeds one resident wave.
_DENSE_MHA_Q8_KV8 = _Case(
    "dense_contiguous_mha_q8_kv8",
    1,
    4,
    16,
    200,
...
_DENSE_GQA_Q32_KV32_B12 = _Case(
    "dense_contiguous_gqa_q32_kv32_b12",
    12,
    16,
    64,
    512,
...
_DENSE_GQA_Q128_KV128_RAGGED = _Case(
    "dense_contiguous_gqa_q128_kv128_bf16_ragged",
    2,
    8,
    256,
    500,
...
@pytest.mark.parametrize(
    ...
    (
        ...
        _DENSE_GQA_Q128_KV128_B10,
        _DENSE_GQA_Q128_KV128_RAGGED,
        _DENSE_MHA_Q8_KV8,
        _DENSE_GQA_Q32_KV32_B12,
    ),
    ids=(
        "q64-kv256-mha",
        "q128-kv128-gqa8",
        "q64-kv256-mha-b2-ragged-persistent",
        "q128-kv128-gqa8-b10-persistent",
        "q128-kv128-gqa8-bf16-b2-ragged",
        "q8-kv8-mha",
        "q32-kv32-gqa4-b12-persistent",
    ),
)
@torch.no_grad()
