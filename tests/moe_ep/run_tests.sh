...
case "${1:-all}" in
  ...
  all) run_all ;;
  *)
    echo "Usage: $0 [unit|oracle|oracle_sm90|multirank|split_path_correctness_bf16|split_path_correctness_nvfp4|split_path_correctness_ht|mega|mega_sm90|mega_sm120|smoke|ft|all]" >&2
    exit 1
    ;;
esac
