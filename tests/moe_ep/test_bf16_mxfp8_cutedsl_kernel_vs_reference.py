"""Single-rank mixed MXFP8-weight/BF16-activation MegaMoE integration tests."""
...
@pytest.mark.parametrize(
    ...
    [
        ("bf16_mxfp8_e4m3", "float8_e4m3fn"),
        ("bf16_mxfp8_e5m2", "float8_e5m2"),
    ],
)
@pytest.mark.parametrize(
    ("hidden", "intermediate"),
...
def test_bf16_mxfp8_kernel_matches_mega_reference(
    monkeypatch, kind, weight_dtype_name, hidden, intermediate
):
