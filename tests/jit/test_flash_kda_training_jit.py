...
def test_flash_kda_training_jit_spec(target, arch_flag):
    ...
    assert [source.name for source in spec.sources] == [
        ...
        "cake_flashkda_training_c16.cu",
        "cake_flashkda_training_c16_aligned_forward.cu",
        "cake_flashkda_training_c16_aligned_backward.cu",
        "cake_flashkda_training_c16_aligned_param_reduce.cu",
        "cake_flashkda_training_aux.cu",
        "cake_flashkda_training_final_state.cu",
    ...
    assert "kernel_cake_flashkda_forward_checkpoint_c16" in aligned_c16_forward
    assert "kernel_cake_flashkda_backward_persistent_c16" in aligned_c16_backward
    assert "kernel_cake_flashkda_backward_param_reduce_c16" in aligned_c16_param_reduce
...
def test_training_forward_frozen_specialization_contract():
    ...
    c16 = (export_dir / "cake_flashkda_training_c16.cu").read_text()
    final_state = (export_dir / "cake_flashkda_training_final_state.cu").read_text()
