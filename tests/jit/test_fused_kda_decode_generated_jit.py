...
@pytest.mark.parametrize(
    ("num_heads", "num_rows", "expected_variant"),
    [
        (96, 8, "direct_f32"),
        (24, 32, "direct_f32"),
        (48, 4, "direct_positive_f32"),
    ],
)
def test_checked_in_manifest_uses_profiled_positive_direct_routes(
    num_heads, num_rows, expected_variant
):
    csrc_dir = generated.get_kda_csrc_dir()
    variants = generated.load_fused_kda_decode_generated_variants(
    ...
    selected = generated.select_fused_kda_decode_generated_variant(
        target="sm100a",
        num_heads=num_heads,
        num_rows=num_rows,
        state_dtype="float32",
    ...
    assert selected.name == expected_variant
