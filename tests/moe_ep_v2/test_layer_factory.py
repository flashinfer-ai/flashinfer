...
def _mega_fleet_params():
    ...
    from flashinfer.moe_ep_v2 import FleetParams, MoEWeightPack
...
def test_factory_returns_split_for_string_backend():
    from flashinfer.moe_ep_v2 import BootstrapConfig, MoEEpLayer, MoEEpSplitLayer
...
def test_factory_returns_split_for_nvep_config():
    from flashinfer.moe_ep_v2 import BootstrapConfig, MoEEpLayer, MoEEpSplitLayer, NvepConfig
...
def test_split_destroy_is_idempotent(stubbed_fleet_registry):
    ...
    from flashinfer.moe_ep_v2 import BootstrapConfig, MoEEpSplitLayer, MoEEpTensors
