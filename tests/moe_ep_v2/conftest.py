"""Shared fixtures for moe_ep_v2 multirank tests."""
...
# under ``tests/moe_ep_v2/{nccl,nixl}_ep/``.
_MOE_EP_V2_TEST_ROOT = os.path.dirname(os.path.abspath(__file__))
sys.path[:] = [
    p
    for p in sys.path
    if os.path.abspath(p or os.getcwd()) != _MOE_EP_V2_TEST_ROOT
]
