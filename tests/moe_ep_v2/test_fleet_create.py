...
def test_create_fleet_unknown_backend_raises_key_error():
    from flashinfer.moe_ep_v2 import BootstrapConfig, FleetParams, create_fleet
...
def test_create_fleet_accepts_config_object_backend_name(stubbed_fleet_registry):
    from flashinfer.moe_ep_v2 import BootstrapConfig, FleetParams, NvepConfig, create_fleet
