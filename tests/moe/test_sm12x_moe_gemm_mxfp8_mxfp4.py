"""cute_dsl_sm12x_moe_gemm_mxfp8_mxfp4: correctness against a pure-torch reference."""
...
def ref_moe_gemm(a_q, a_sf, b_q, b_sf, offsets):
...
def make_inputs(m_per_expert_list, n, k):
    ...
    ref = ref_moe_gemm(a_q, a_sf, b_q, sfs, m_indptr)
