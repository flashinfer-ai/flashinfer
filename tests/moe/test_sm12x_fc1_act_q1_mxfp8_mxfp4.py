"""cute_dsl_sm12x_fc1_act_q1_mxfp8_mxfp4: wiring smoke test (shape/dtype/no-NaN)."""
...
def test_cute_dsl_sm12x_fc1_act_q1_mxfp8_mxfp4_smoke():
    ...
    a_q, a_scale, b_q, b_scale, m_indptr = make_gated_inputs([64, 64, 64, 64], 512, 512)
    q, sf = cute_dsl_sm12x_fc1_act_q1_mxfp8_mxfp4(a_q, a_scale, b_q, b_scale, m_indptr)
