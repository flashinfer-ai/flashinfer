...
def test_merge_state_preserves_empty_state():
...
@skip_on_gpu_arch_error
def test_merge_state_in_place_preserves_empty_state():
...
def test_merge_states_preserves_empty_state(seq_len, num_states):
