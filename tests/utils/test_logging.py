...
class TestAPILogging:
    ...
    def test_level_2_inputs_outputs(self):
        ...
        try:
            ...
            result = test_function(tensor, 2.0)
    ...
    def test_enum_logging(self):
        ...
        try:
            ...
            result = test_function(TestEnum.OPTION_B, StringEnum.MODE_OPTIMIZED)
            ...
            assert "(value=optimized)" in log_contents or "(value='optimized')" in log_contents or '(value="optimized")' in log_contents
        finally:
            Path(log_file).unlink(missing_ok=True)
    ...
    def test_different_data_types(self):
        ...
        try:
            ...
            def test_function(
                ...
                list_val, tuple_val, dict_val, none_val
            ):
                return "success"
    ...
    def test_cuda_graph_compatibility(self):
        ...
        try:
            ...
            result1 = test_cuda_function(tensor)
            ...
            if hasattr(torch.cuda, 'CUDAGraph'):
                ...
                with torch.cuda.graph(graph):
                    result2 = test_cuda_function(tensor)
                
                with open(log_file, 'r') as f:
                    log_capture = f.read()
                
                # Should skip statistics during capture
                assert "[statistics skipped: CUDA graph capture in progress]" in log_capture or \
                       "statistics" not in log_capture, \
