...
def test_public_gdn_noncp_prefill_api_bf16_indexed_checkpoint_b5_t4296_live_matches_independent_recurrence():
    case = _make_case(
...
def test_public_gdn_noncp_prefill_rejects_invalid_checkpoint_geometry_before_launch():
    case = _make_case(
        seq_lens=(849, 835, 862, 897, 853),
        indexed=True,
        state_dtype=torch.bfloat16,
...
def test_public_gdn_noncp_prefill_checkpoint_is_cuda_graph_safe():
    case = _make_case(
        seq_lens=(64,),
        indexed=True,
        state_dtype=torch.bfloat16,
...
def test_public_gdn_noncp_prefill_invalid_cuda_slots_fail_in_isolated_process(
    case_name,
):
