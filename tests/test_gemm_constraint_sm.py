...
from flashinfer import gemm_constraint_sm
...
@pytest.mark.parametrize("sm_count", [1, 2, 4, 8, 16, 32, 64, 128])
def test_bmm_fp8(input_dtype, mat2_dtype, res_dtype, sm_count):
    ...
    gemm_constraint_sm(input_fp8, mat2_fp8, input_inv_s, mat2_inv_s, res_dtype, res, sm_count=sm_count)
