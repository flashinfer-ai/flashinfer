...
def test_cuda_graph_batch_fast_decode_with_paged_kv_cache(
    batch_size,
    kv_len,
    page_size,
    num_kv_heads,
    ...
    # First call regular plan to initialize _cached_module
    wrapper.plan(
    ...
    # Then replace plan with fast_decode_plan for subsequent calls
