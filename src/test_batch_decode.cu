...
void _TestBatchDecodingKernelCorrectness(size_t page_size, size_t batch_size, size_t num_qo_heads,
  ...
  if (!cooperative) {
    ...
    cudaError_t status =
        flashinfer::BatchDecodeWithPagedKVCacheNoSplitKV<PageStorage::kIndices, kv_layout, T, T, T,
                                                         int32_t>(
    ...
    cudaError_t status =
        flashinfer::BatchDecodeWithPagedKVCacheWrapper<PageStorage::kIndices, kv_layout, T, T, T,
                                                       int32_t>(
